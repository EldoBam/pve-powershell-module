...
.PARAMETER POSTAccessVncticketRB
verify VNC authentication ticket.
...
function New-PVEAccessVncticket {
    ...
    Process {
        'Calling method: New-PVEAccessVncticket' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/access/vncticket'

        $LocalVarBodyParameter = $POSTAccessVncticketRB | ConvertTo-Json -Depth 100
