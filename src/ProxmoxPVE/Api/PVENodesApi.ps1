...
function Get-PVENodesAptUpdateByNode {
    ...
    Process {
        ...
        $LocalVarResult = Invoke-PVEApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "NodesAptUpdateInner[]" `
                                -IsBodyNullable $false
...
#>
function Get-PVENodesCapabilitiesQemuMigrationByNode {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-PVENodesCapabilitiesQemuMigrationByNode' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/nodes/{node}/capabilities/qemu/migration'
        if (!$Node) {
            throw "Error! The required parameter `Node` missing when calling getNodesCapabilitiesQemuMigrationByNode."
        }
        $LocalVarUri = $LocalVarUri.replace('{node}', [System.Web.HTTPUtility]::UrlEncode($Node))
        ...
        $LocalVarResult = Invoke-PVEApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "NodesCapabilitiesQemuMigration" `
                                -IsBodyNullable $false
...
.PARAMETER GETNodesLxcMigrateRB
Get preconditions for migration.
...
NodesLxcMigrate
#>
function Get-PVENodesLxcMigrateByNodeAndVmid {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
        ...
        [Parameter(Position = 2, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
        ${GETNodesLxcMigrateRB},
        [Switch]
        $WithHttpInfo
    )

    Process {
        'Calling method: Get-PVENodesLxcMigrateByNodeAndVmid' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$Node) {
            throw "Error! The required parameter `Node` missing when calling getNodesLxcMigrateByNodeAndVmid."
        }
        $LocalVarUri = $LocalVarUri.replace('{node}', [System.Web.HTTPUtility]::UrlEncode($Node))
        if (!$Vmid) {
            throw "Error! The required parameter `Vmid` missing when calling getNodesLxcMigrateByNodeAndVmid."
        }
        $LocalVarUri = $LocalVarUri.replace('{vmid}', [System.Web.HTTPUtility]::UrlEncode($Vmid))

        $LocalVarBodyParameter = $GETNodesLxcMigrateRB | ConvertTo-Json -Depth 100
...
.PARAMETER POSTNodesQemuDbusvmstateRB
Control the dbus-vmstate helper for a given running VM.
...
None
#>
function New-PVENodesQemuDbusvmstateByNodeAndVmid {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
        ...
        [Parameter(Position = 2, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
        ${POSTNodesQemuDbusvmstateRB},
        [Switch]
        $WithHttpInfo
    )

    Process {
        'Calling method: New-PVENodesQemuDbusvmstateByNodeAndVmid' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/nodes/{node}/qemu/{vmid}/dbus-vmstate'
        if (!$Node) {
            throw "Error! The required parameter `Node` missing when calling newNodesQemuDbusvmstateByNodeAndVmid."
        }
        $LocalVarUri = $LocalVarUri.replace('{node}', [System.Web.HTTPUtility]::UrlEncode($Node))
        if (!$Vmid) {
            throw "Error! The required parameter `Vmid` missing when calling newNodesQemuDbusvmstateByNodeAndVmid."
        }
        $LocalVarUri = $LocalVarUri.replace('{vmid}', [System.Web.HTTPUtility]::UrlEncode($Vmid))

        $LocalVarBodyParameter = $POSTNodesQemuDbusvmstateRB | ConvertTo-Json -Depth 100
