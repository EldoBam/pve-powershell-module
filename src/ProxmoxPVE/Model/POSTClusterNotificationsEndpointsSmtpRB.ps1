...
function Initialize-PVEPOSTClusterNotificationsEndpointsSmtpRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Mode"="mode"; "Password"="password"; "Username"="username"; "Name"="name"; "Mailto"="mailto"; "Disable"="disable"; "Port"="port"; "MailtoUser"="mailto-user"; "FromAddress"="from-address"; "Author"="author"; "Server"="server"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterNotificationsEndpointsSmtpRB {
    ...
    Process {
        ...
        $AllProperties = ("mode", "password", "username", "name", "mailto", "disable", "port", "mailto-user", "from-address", "author", "server", "comment")
