...
function Initialize-PVEPOSTClusterNotificationsEndpointsSmtpRB {
    ...
    Process {
        ...
        if ($Disable -and $Disable -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Username"="username"; "Mode"="mode"; "Password"="password"; "Author"="author"; "MailtoUser"="mailto-user"; "FromAddress"="from-address"; "Port"="port"; "Server"="server"; "Mailto"="mailto"; "Comment"="comment"; "Disable"="disable"; "Name"="name"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterNotificationsEndpointsSmtpRB {
    ...
    Process {
        ...
        $AllProperties = ("username", "mode", "password", "author", "mailto-user", "from-address", "port", "server", "mailto", "comment", "disable", "name")
