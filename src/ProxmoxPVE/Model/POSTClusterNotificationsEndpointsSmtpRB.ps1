...
function Initialize-PVEPOSTClusterNotificationsEndpointsSmtpRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Disable"="disable"; "Author"="author"; "Password"="password"; "Username"="username"; "Mode"="mode"; "Server"="server"; "Comment"="comment"; "Mailto"="mailto"; "Port"="port"; "MailtoUser"="mailto-user"; "Name"="name"; "FromAddress"="from-address"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterNotificationsEndpointsSmtpRB {
    ...
    Process {
        ...
        $AllProperties = ("disable", "author", "password", "username", "mode", "server", "comment", "mailto", "port", "mailto-user", "name", "from-address")
