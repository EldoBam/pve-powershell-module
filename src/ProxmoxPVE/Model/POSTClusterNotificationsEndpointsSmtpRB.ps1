...
function Initialize-PVEPOSTClusterNotificationsEndpointsSmtpRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"FromAddress"="from-address"; "Mode"="mode"; "Port"="port"; "Comment"="comment"; "Name"="name"; "Username"="username"; "Server"="server"; "MailtoUser"="mailto-user"; "Password"="password"; "Author"="author"; "Mailto"="mailto"; "Disable"="disable"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterNotificationsEndpointsSmtpRB {
    ...
    Process {
        ...
        $AllProperties = ("from-address", "mode", "port", "comment", "name", "username", "server", "mailto-user", "password", "author", "mailto", "disable")
