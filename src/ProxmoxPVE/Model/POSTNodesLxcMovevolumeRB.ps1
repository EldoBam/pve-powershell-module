...
function Initialize-PVEPOSTNodesLxcMovevolumeRB {
    ...
    Process {
        ...
        if ($TargetVmid -and $TargetVmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"TargetVolume"="target-volume"; "Delete"="delete"; "TargetDigest"="target-digest"; "Bwlimit"="bwlimit"; "Digest"="digest"; "Volume"="volume"; "TargetVmid"="target-vmid"; "Storage"="storage"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesLxcMovevolumeRB {
    ...
    Process {
        ...
        $AllProperties = ("target-volume", "delete", "target-digest", "bwlimit", "digest", "volume", "target-vmid", "storage")
