...
function Initialize-PVEPOSTNodesLxcMovevolumeRB {
    ...
    Process {
        ...
        if ($TargetVmid -and $TargetVmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"TargetDigest"="target-digest"; "Digest"="digest"; "TargetVolume"="target-volume"; "Delete"="delete"; "TargetVmid"="target-vmid"; "Bwlimit"="bwlimit"; "Volume"="volume"; "Storage"="storage"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesLxcMovevolumeRB {
    ...
    Process {
        ...
        $AllProperties = ("target-digest", "digest", "target-volume", "delete", "target-vmid", "bwlimit", "volume", "storage")
