...
function Initialize-PVEPOSTNodesLxcMovevolumeRB {
    ...
    Process {
        ...
        if (!$TargetDigest -and $TargetDigest.length -gt 40) {
		 ...
		 $DisplayNameMapping =@{
			"Volume"="volume"; "Node"="node"; "Bwlimit"="bwlimit"; "Delete"="delete"; "Vmid"="vmid"; "TargetVmid"="target-vmid"; "Digest"="digest"; "Storage"="storage"; "TargetVolume"="target-volume"; "TargetDigest"="target-digest"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesLxcMovevolumeRB {
    ...
    Process {
        ...
        $AllProperties = ("volume", "node", "bwlimit", "delete", "vmid", "target-vmid", "digest", "storage", "target-volume", "target-digest")
