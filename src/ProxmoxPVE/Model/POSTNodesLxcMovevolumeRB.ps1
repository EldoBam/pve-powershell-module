...
function Initialize-PVEPOSTNodesLxcMovevolumeRB {
    ...
    Process {
        ...
        if (!$TargetDigest -and $TargetDigest.length -gt 40) {
		 ...
		 $DisplayNameMapping =@{
			"Storage"="storage"; "TargetVolume"="target-volume"; "TargetVmid"="target-vmid"; "Volume"="volume"; "Bwlimit"="bwlimit"; "Vmid"="vmid"; "Delete"="delete"; "Digest"="digest"; "TargetDigest"="target-digest"; "Node"="node"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesLxcMovevolumeRB {
    ...
    Process {
        ...
        $AllProperties = ("storage", "target-volume", "target-vmid", "volume", "bwlimit", "vmid", "delete", "digest", "target-digest", "node")
