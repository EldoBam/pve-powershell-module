...
function Initialize-PVEPOSTNodesLxcMovevolumeRB {
    ...
    Process {
        ...
        if ($TargetVmid -and $TargetVmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Delete"="delete"; "TargetDigest"="target-digest"; "Bwlimit"="bwlimit"; "Storage"="storage"; "Volume"="volume"; "TargetVolume"="target-volume"; "Digest"="digest"; "TargetVmid"="target-vmid"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesLxcMovevolumeRB {
    ...
    Process {
        ...
        $AllProperties = ("delete", "target-digest", "bwlimit", "storage", "volume", "target-volume", "digest", "target-vmid")
