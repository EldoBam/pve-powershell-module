...
function Initialize-PVEPOSTNodesLxcMovevolumeRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 40) {
		 ...
		 $DisplayNameMapping =@{
			"TargetDigest"="target-digest"; "Storage"="storage"; "Delete"="delete"; "Bwlimit"="bwlimit"; "Volume"="volume"; "TargetVmid"="target-vmid"; "TargetVolume"="target-volume"; "Digest"="digest"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesLxcMovevolumeRB {
    ...
    Process {
        ...
        $AllProperties = ("target-digest", "storage", "delete", "bwlimit", "volume", "target-vmid", "target-volume", "digest")
