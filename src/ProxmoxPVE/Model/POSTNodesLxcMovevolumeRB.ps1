...
function Initialize-PVEPOSTNodesLxcMovevolumeRB {
    ...
    Process {
        ...
        if ($TargetVmid -and $TargetVmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Vmid"="vmid"; "Delete"="delete"; "Digest"="digest"; "Node"="node"; "TargetDigest"="target-digest"; "Bwlimit"="bwlimit"; "Volume"="volume"; "TargetVmid"="target-vmid"; "Storage"="storage"; "TargetVolume"="target-volume"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesLxcMovevolumeRB {
    ...
    Process {
        ...
        $AllProperties = ("vmid", "delete", "digest", "node", "target-digest", "bwlimit", "volume", "target-vmid", "storage", "target-volume")
