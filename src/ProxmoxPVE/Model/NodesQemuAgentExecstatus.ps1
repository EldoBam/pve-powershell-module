...
function Initialize-PVENodesQemuAgentExecstatus {
    ...
    Process {
        ...
        if ($ErrTruncated -and $ErrTruncated -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"ErrData"="err-data"; "OutData"="out-data"; "Exitcode"="exitcode"; "OutTruncated"="out-truncated"; "Exited"="exited"; "Signal"="signal"; "ErrTruncated"="err-truncated"
        }
...
function ConvertFrom-PVEJsonToNodesQemuAgentExecstatus {
    ...
    Process {
        ...
        $AllProperties = ("err-data", "out-data", "exitcode", "out-truncated", "exited", "signal", "err-truncated")
