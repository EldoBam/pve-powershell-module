...
function Initialize-PVENodesQemuAgentExecstatus {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"OutTruncated"="out-truncated"; "ErrTruncated"="err-truncated"; "Signal"="signal"; "OutData"="out-data"; "ErrData"="err-data"; "Exited"="exited"; "Exitcode"="exitcode"
        }
...
function ConvertFrom-PVEJsonToNodesQemuAgentExecstatus {
    ...
    Process {
        ...
        $AllProperties = ("out-truncated", "err-truncated", "signal", "out-data", "err-data", "exited", "exitcode")
