...
function Initialize-PVENodesSubscription {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Level"="level"; "Sockets"="sockets"; "Productname"="productname"; "Key"="key"; "Regdate"="regdate"; "Checktime"="checktime"; "Signature"="signature"; "Url"="url"; "Message"="message"; "Status"="status"; "Serverid"="serverid"; "Nextduedate"="nextduedate"
        }
...
function ConvertFrom-PVEJsonToNodesSubscription {
    ...
    Process {
        ...
        $AllProperties = ("level", "sockets", "productname", "key", "regdate", "checktime", "signature", "url", "message", "status", "serverid", "nextduedate")
