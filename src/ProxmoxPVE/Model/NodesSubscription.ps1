...
function Initialize-PVENodesSubscription {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Level"="level"; "Signature"="signature"; "Productname"="productname"; "Key"="key"; "Checktime"="checktime"; "Serverid"="serverid"; "Message"="message"; "Regdate"="regdate"; "Url"="url"; "Sockets"="sockets"; "Nextduedate"="nextduedate"; "Status"="status"
        }
...
function ConvertFrom-PVEJsonToNodesSubscription {
    ...
    Process {
        ...
        $AllProperties = ("level", "signature", "productname", "key", "checktime", "serverid", "message", "regdate", "url", "sockets", "nextduedate", "status")
