...
function Initialize-PVENodesSubscription {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Sockets"="sockets"; "Key"="key"; "Checktime"="checktime"; "Serverid"="serverid"; "Signature"="signature"; "Regdate"="regdate"; "Level"="level"; "Message"="message"; "Nextduedate"="nextduedate"; "Productname"="productname"; "Status"="status"; "Url"="url"
        }
...
function ConvertFrom-PVEJsonToNodesSubscription {
    ...
    Process {
        ...
        $AllProperties = ("sockets", "key", "checktime", "serverid", "signature", "regdate", "level", "message", "nextduedate", "productname", "status", "url")
