...
function Initialize-PVENodesSubscription {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Regdate"="regdate"; "Serverid"="serverid"; "Level"="level"; "Url"="url"; "Status"="status"; "Signature"="signature"; "Sockets"="sockets"; "Productname"="productname"; "Nextduedate"="nextduedate"; "Checktime"="checktime"; "Message"="message"; "Key"="key"
        }
...
function ConvertFrom-PVEJsonToNodesSubscription {
    ...
    Process {
        ...
        $AllProperties = ("regdate", "serverid", "level", "url", "status", "signature", "sockets", "productname", "nextduedate", "checktime", "message", "key")
