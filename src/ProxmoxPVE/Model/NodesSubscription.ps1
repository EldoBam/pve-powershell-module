...
function Initialize-PVENodesSubscription {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Signature"="signature"; "Serverid"="serverid"; "Nextduedate"="nextduedate"; "Status"="status"; "Productname"="productname"; "Checktime"="checktime"; "Regdate"="regdate"; "Message"="message"; "Url"="url"; "Level"="level"; "Sockets"="sockets"; "Key"="key"
        }
...
function ConvertFrom-PVEJsonToNodesSubscription {
    ...
    Process {
        ...
        $AllProperties = ("signature", "serverid", "nextduedate", "status", "productname", "checktime", "regdate", "message", "url", "level", "sockets", "key")
