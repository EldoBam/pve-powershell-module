...
function Initialize-PVENodesSubscription {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Url"="url"; "Status"="status"; "Key"="key"; "Sockets"="sockets"; "Nextduedate"="nextduedate"; "Signature"="signature"; "Level"="level"; "Serverid"="serverid"; "Checktime"="checktime"; "Productname"="productname"; "Message"="message"; "Regdate"="regdate"
        }
...
function ConvertFrom-PVEJsonToNodesSubscription {
    ...
    Process {
        ...
        $AllProperties = ("url", "status", "key", "sockets", "nextduedate", "signature", "level", "serverid", "checktime", "productname", "message", "regdate")
