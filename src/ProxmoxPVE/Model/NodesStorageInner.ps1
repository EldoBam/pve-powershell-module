...
function Initialize-PVENodesStorageInner {
    ...
    Process {
        ...
        if ($Shared -and $Shared -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Total"="total"; "Content"="content"; "Storage"="storage"; "Enabled"="enabled"; "Active"="active"; "UsedFraction"="used_fraction"; "Shared"="shared"; "Avail"="avail"; "Used"="used"; "Type"="type"
        }
...
function ConvertFrom-PVEJsonToNodesStorageInner {
    ...
    Process {
        ...
        $AllProperties = ("total", "content", "storage", "enabled", "active", "used_fraction", "shared", "avail", "used", "type")
