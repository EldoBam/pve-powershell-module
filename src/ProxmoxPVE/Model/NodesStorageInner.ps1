...
function Initialize-PVENodesStorageInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Avail"="avail"; "UsedFraction"="used_fraction"; "Shared"="shared"; "Content"="content"; "Total"="total"; "Enabled"="enabled"; "Used"="used"; "Storage"="storage"; "Type"="type"; "Active"="active"
        }
...
function ConvertFrom-PVEJsonToNodesStorageInner {
    ...
    Process {
        ...
        $AllProperties = ("avail", "used_fraction", "shared", "content", "total", "enabled", "used", "storage", "type", "active")
