...
function Initialize-PVEClusterSdnControllersInner {
    ...
    Process {
        ...
        if ($Asn -and $Asn -gt 4294967295) {
		 ...
		 $DisplayNameMapping =@{
			"IsisIfaces"="isis-ifaces"; "EbgpMultihop"="ebgp-multihop"; "IsisDomain"="isis-domain"; "IsisNet"="isis-net"; "BgpMultipathAsRelax"="bgp-multipath-as-relax"; "Asn"="asn"; "State"="state"; "Ebgp"="ebgp"; "Type"="type"; "Digest"="digest"; "Pending"="pending"; "Node"="node"; "Controller"="controller"; "Loopback"="loopback"; "Peers"="peers"
        }
...
function ConvertFrom-PVEJsonToClusterSdnControllersInner {
    ...
    Process {
        ...
        $AllProperties = ("isis-ifaces", "ebgp-multihop", "isis-domain", "isis-net", "bgp-multipath-as-relax", "asn", "state", "ebgp", "type", "digest", "pending", "node", "controller", "loopback", "peers")
