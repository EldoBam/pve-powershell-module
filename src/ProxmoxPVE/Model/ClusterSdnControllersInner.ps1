...
function Initialize-PVEClusterSdnControllersInner {
    ...
    Process {
        ...
        if ($Asn -and $Asn -gt 4294967295) {
		 ...
		 $DisplayNameMapping =@{
			"Type"="type"; "Controller"="controller"; "Asn"="asn"; "Pending"="pending"; "Loopback"="loopback"; "IsisNet"="isis-net"; "IsisIfaces"="isis-ifaces"; "Node"="node"; "BgpMultipathAsRelax"="bgp-multipath-as-relax"; "Digest"="digest"; "EbgpMultihop"="ebgp-multihop"; "Ebgp"="ebgp"; "IsisDomain"="isis-domain"; "State"="state"; "Peers"="peers"
        }
...
function ConvertFrom-PVEJsonToClusterSdnControllersInner {
    ...
    Process {
        ...
        $AllProperties = ("type", "controller", "asn", "pending", "loopback", "isis-net", "isis-ifaces", "node", "bgp-multipath-as-relax", "digest", "ebgp-multihop", "ebgp", "isis-domain", "state", "peers")
