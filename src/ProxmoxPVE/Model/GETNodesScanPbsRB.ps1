...
function Initialize-PVEGETNodesScanPbsRB {
    ...
    Process {
        ...
        if ($Port -and $Port -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Username"="username"; "Fingerprint"="fingerprint"; "Password"="password"; "Port"="port"; "Server"="server"; "Node"="node"
        }
...
function ConvertFrom-PVEJsonToGETNodesScanPbsRB {
    ...
    Process {
        ...
        $AllProperties = ("username", "fingerprint", "password", "port", "server", "node")
