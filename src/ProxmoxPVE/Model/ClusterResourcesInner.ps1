...
function Initialize-PVEClusterResourcesInner {
    ...
    Process {
        ...
        if ($Vmid -and $Vmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Maxdisk"="maxdisk"; "Status"="status"; "Node"="node"; "Netout"="netout"; "Mem"="mem"; "Diskwrite"="diskwrite"; "Diskread"="diskread"; "Template"="template"; "Type"="type"; "Name"="name"; "Pool"="pool"; "Cpu"="cpu"; "Maxcpu"="maxcpu"; "Level"="level"; "Plugintype"="plugintype"; "Maxmem"="maxmem"; "Vmid"="vmid"; "Lock"="lock"; "Hastate"="hastate"; "CgroupMode"="cgroup-mode"; "Content"="content"; "Storage"="storage"; "Netin"="netin"; "Disk"="disk"; "Tags"="tags"; "Id"="id"; "Uptime"="uptime"
        }
...
function ConvertFrom-PVEJsonToClusterResourcesInner {
    ...
    Process {
        ...
        $AllProperties = ("maxdisk", "status", "node", "netout", "mem", "diskwrite", "diskread", "template", "type", "name", "pool", "cpu", "maxcpu", "level", "plugintype", "maxmem", "vmid", "lock", "hastate", "cgroup-mode", "content", "storage", "netin", "disk", "tags", "id", "uptime")
