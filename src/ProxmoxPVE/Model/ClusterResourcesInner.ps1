...
function Initialize-PVEClusterResourcesInner {
    ...
    Process {
        ...
        if ($Vmid -and $Vmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Template"="template"; "Pool"="pool"; "Maxdisk"="maxdisk"; "CgroupMode"="cgroup-mode"; "Id"="id"; "Level"="level"; "Uptime"="uptime"; "Lock"="lock"; "Type"="type"; "Hastate"="hastate"; "Maxmem"="maxmem"; "Mem"="mem"; "Node"="node"; "Plugintype"="plugintype"; "Diskread"="diskread"; "Tags"="tags"; "Content"="content"; "Maxcpu"="maxcpu"; "Netin"="netin"; "Storage"="storage"; "Disk"="disk"; "Diskwrite"="diskwrite"; "Name"="name"; "Cpu"="cpu"; "Vmid"="vmid"; "Netout"="netout"; "Status"="status"
        }
...
function ConvertFrom-PVEJsonToClusterResourcesInner {
    ...
    Process {
        ...
        $AllProperties = ("template", "pool", "maxdisk", "cgroup-mode", "id", "level", "uptime", "lock", "type", "hastate", "maxmem", "mem", "node", "plugintype", "diskread", "tags", "content", "maxcpu", "netin", "storage", "disk", "diskwrite", "name", "cpu", "vmid", "netout", "status")
