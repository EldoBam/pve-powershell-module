...
function Initialize-PVEPUTClusterJobsRealmsyncRB {
    ...
    Process {
        ...
        if (!$Comment -and $Comment.length -gt 512) {
		 ...
		 $DisplayNameMapping =@{
			"Schedule"="schedule"; "RemoveVanished"="remove-vanished"; "Delete"="delete"; "Scope"="scope"; "Enabled"="enabled"; "EnableNew"="enable-new"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToPUTClusterJobsRealmsyncRB {
    ...
    Process {
        ...
        $AllProperties = ("schedule", "remove-vanished", "delete", "scope", "enabled", "enable-new", "comment")
