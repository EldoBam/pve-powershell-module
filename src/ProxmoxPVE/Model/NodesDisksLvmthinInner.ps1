...
function Initialize-PVENodesDisksLvmthinInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"MetadataUsed"="metadata_used"; "Vg"="vg"; "Lv"="lv"; "MetadataSize"="metadata_size"; "LvSize"="lv_size"; "Used"="used"
        }
...
function ConvertFrom-PVEJsonToNodesDisksLvmthinInner {
    ...
    Process {
        ...
        $AllProperties = ("metadata_used", "vg", "lv", "metadata_size", "lv_size", "used")
