...
function Initialize-PVENodesDisksLvmthinInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"MetadataSize"="metadata_size"; "Lv"="lv"; "MetadataUsed"="metadata_used"; "LvSize"="lv_size"; "Used"="used"; "Vg"="vg"
        }
...
function ConvertFrom-PVEJsonToNodesDisksLvmthinInner {
    ...
    Process {
        ...
        $AllProperties = ("metadata_size", "lv", "metadata_used", "lv_size", "used", "vg")
