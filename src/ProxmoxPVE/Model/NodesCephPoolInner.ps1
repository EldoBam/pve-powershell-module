...
function Initialize-PVENodesCephPoolInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"AutoscaleStatus"="autoscale_status"; "BytesUsed"="bytes_used"; "Type"="type"; "PoolName"="pool_name"; "ApplicationMetadata"="application_metadata"; "CrushRule"="crush_rule"; "PgNumFinal"="pg_num_final"; "PgNum"="pg_num"; "MinSize"="min_size"; "PgNumMin"="pg_num_min"; "PgAutoscaleMode"="pg_autoscale_mode"; "TargetSizeRatio"="target_size_ratio"; "PercentUsed"="percent_used"; "CrushRuleName"="crush_rule_name"; "Size"="size"; "TargetSize"="target_size"; "Pool"="pool"
        }
...
function ConvertFrom-PVEJsonToNodesCephPoolInner {
    ...
    Process {
        ...
        $AllProperties = ("autoscale_status", "bytes_used", "type", "pool_name", "application_metadata", "crush_rule", "pg_num_final", "pg_num", "min_size", "pg_num_min", "pg_autoscale_mode", "target_size_ratio", "percent_used", "crush_rule_name", "size", "target_size", "pool")
