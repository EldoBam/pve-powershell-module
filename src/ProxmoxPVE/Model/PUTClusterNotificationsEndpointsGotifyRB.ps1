...
function Initialize-PVEPUTClusterNotificationsEndpointsGotifyRB {
    ...
    Process {
        ...
        if ($Disable -and $Disable -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Digest"="digest"; "Server"="server"; "Comment"="comment"; "Delete"="delete"; "Disable"="disable"; "Token"="token"; "Name"="name"
        }
...
function ConvertFrom-PVEJsonToPUTClusterNotificationsEndpointsGotifyRB {
    ...
    Process {
        ...
        $AllProperties = ("digest", "server", "comment", "delete", "disable", "token", "name")
