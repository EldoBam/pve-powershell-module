...
function Initialize-PVENodesCertificatesInfoInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Issuer"="issuer"; "San"="san"; "Notbefore"="notbefore"; "Filename"="filename"; "Notafter"="notafter"; "Subject"="subject"; "PublicKeyBits"="public-key-bits"; "Fingerprint"="fingerprint"; "PublicKeyType"="public-key-type"; "Pem"="pem"
        }
...
function ConvertFrom-PVEJsonToNodesCertificatesInfoInner {
    ...
    Process {
        ...
        $AllProperties = ("issuer", "san", "notbefore", "filename", "notafter", "subject", "public-key-bits", "fingerprint", "public-key-type", "pem")
