...
function Initialize-PVENodesCertificatesInfoInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"PublicKeyBits"="public-key-bits"; "Notafter"="notafter"; "Fingerprint"="fingerprint"; "PublicKeyType"="public-key-type"; "Issuer"="issuer"; "Subject"="subject"; "Pem"="pem"; "San"="san"; "Filename"="filename"; "Notbefore"="notbefore"
        }
...
function ConvertFrom-PVEJsonToNodesCertificatesInfoInner {
    ...
    Process {
        ...
        $AllProperties = ("public-key-bits", "notafter", "fingerprint", "public-key-type", "issuer", "subject", "pem", "san", "filename", "notbefore")
