...
function Initialize-PVENodesLxcInner {
    ...
    Process {
        ...
        if ($Vmid -and $Vmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Cpu"="cpu"; "Maxmem"="maxmem"; "Maxdisk"="maxdisk"; "Diskwrite"="diskwrite"; "Uptime"="uptime"; "Tags"="tags"; "Diskread"="diskread"; "Vmid"="vmid"; "Template"="template"; "Lock"="lock"; "Maxswap"="maxswap"; "Status"="status"; "Cpus"="cpus"; "Netout"="netout"; "Name"="name"; "Disk"="disk"; "Mem"="mem"; "Netin"="netin"
        }
...
function ConvertFrom-PVEJsonToNodesLxcInner {
    ...
    Process {
        ...
        $AllProperties = ("cpu", "maxmem", "maxdisk", "diskwrite", "uptime", "tags", "diskread", "vmid", "template", "lock", "maxswap", "status", "cpus", "netout", "name", "disk", "mem", "netin")
