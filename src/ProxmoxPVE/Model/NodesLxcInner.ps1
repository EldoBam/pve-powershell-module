...
function Initialize-PVENodesLxcInner {
    ...
    Process {
        ...
        if ($Vmid -and $Vmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Name"="name"; "Cpus"="cpus"; "Netin"="netin"; "Vmid"="vmid"; "Status"="status"; "Lock"="lock"; "Maxdisk"="maxdisk"; "Cpu"="cpu"; "Disk"="disk"; "Diskread"="diskread"; "Maxswap"="maxswap"; "Uptime"="uptime"; "Tags"="tags"; "Diskwrite"="diskwrite"; "Maxmem"="maxmem"; "Template"="template"; "Netout"="netout"; "Mem"="mem"
        }
...
function ConvertFrom-PVEJsonToNodesLxcInner {
    ...
    Process {
        ...
        $AllProperties = ("name", "cpus", "netin", "vmid", "status", "lock", "maxdisk", "cpu", "disk", "diskread", "maxswap", "uptime", "tags", "diskwrite", "maxmem", "template", "netout", "mem")
