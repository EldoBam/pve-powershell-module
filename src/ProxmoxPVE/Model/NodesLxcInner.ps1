...
function Initialize-PVENodesLxcInner {
    ...
    Process {
        ...
        if ($Vmid -and $Vmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Maxswap"="maxswap"; "Maxmem"="maxmem"; "Status"="status"; "Maxdisk"="maxdisk"; "Vmid"="vmid"; "Netin"="netin"; "Pressurememoryfull"="pressurememoryfull"; "Diskread"="diskread"; "Disk"="disk"; "Netout"="netout"; "Pressurememorysome"="pressurememorysome"; "Cpu"="cpu"; "Pressurecpusome"="pressurecpusome"; "Tags"="tags"; "Cpus"="cpus"; "Diskwrite"="diskwrite"; "Name"="name"; "Pressureiosome"="pressureiosome"; "Template"="template"; "Pressureiofull"="pressureiofull"; "Mem"="mem"; "Lock"="lock"; "Uptime"="uptime"
        }
...
function ConvertFrom-PVEJsonToNodesLxcInner {
    ...
    Process {
        ...
        $AllProperties = ("maxswap", "maxmem", "status", "maxdisk", "vmid", "netin", "pressurememoryfull", "diskread", "disk", "netout", "pressurememorysome", "cpu", "pressurecpusome", "tags", "cpus", "diskwrite", "name", "pressureiosome", "template", "pressureiofull", "mem", "lock", "uptime")
