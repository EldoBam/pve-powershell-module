...
function Initialize-PVEClusterAcmeMeta {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"CaaIdentities"="caaIdentities"; "ExternalAccountRequired"="externalAccountRequired"; "TermsOfService"="termsOfService"; "Website"="website"
        }
...
function ConvertFrom-PVEJsonToClusterAcmeMeta {
    ...
    Process {
        ...
        $AllProperties = ("caaIdentities", "externalAccountRequired", "termsOfService", "website")
