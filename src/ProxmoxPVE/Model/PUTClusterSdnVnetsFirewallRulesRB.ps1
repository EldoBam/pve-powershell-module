...
PUTClusterSdnVnetsFirewallRulesRB<PSCustomObject>
#>

function Initialize-PVEPUTClusterSdnVnetsFirewallRulesRB {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ProxmoxPVE => PVEPUTClusterSdnVnetsFirewallRulesRB' | Write-Debug
        ...
        if (!$Iface -and $Iface.length -lt 2) {
		 ...
		 $DisplayNameMapping =@{
			"Vnet"="vnet"; "Log"="log"; "Action"="action"; "IcmpType"="icmp-type"; "Macro"="macro"; "Comment"="comment"; "Source"="source"; "Dport"="dport"; "Proto"="proto"; "Dest"="dest"; "Delete"="delete"; "Sport"="sport"; "Moveto"="moveto"; "Type"="type"; "Enable"="enable"; "Digest"="digest"; "Pos"="pos"; "Iface"="iface"
        }
...
Convert from JSON to PUTClusterSdnVnetsFirewallRulesRB<PSCustomObject>
...
PUTClusterSdnVnetsFirewallRulesRB<PSCustomObject>
#>
function ConvertFrom-PVEJsonToPUTClusterSdnVnetsFirewallRulesRB {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ProxmoxPVE => PVEPUTClusterSdnVnetsFirewallRulesRB' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PVEPUTClusterSdnVnetsFirewallRulesRB
        $AllProperties = ("vnet", "log", "action", "icmp-type", "macro", "comment", "source", "dport", "proto", "dest", "delete", "sport", "moveto", "type", "enable", "digest", "pos", "iface")
