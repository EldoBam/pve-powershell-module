...
function Initialize-PVEAccessRoles {
    ...
    Process {
        ...
        if ($MappingAudit -and $MappingAudit -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"VMConfigMemory"="VM.Config.Memory"; "VMPowerMgmt"="VM.PowerMgmt"; "SDNUse"="SDN.Use"; "SysAccessNetwork"="Sys.AccessNetwork"; "SysSyslog"="Sys.Syslog"; "SDNAudit"="SDN.Audit"; "VMConsole"="VM.Console"; "VMConfigHWType"="VM.Config.HWType"; "PoolAudit"="Pool.Audit"; "UserModify"="User.Modify"; "VMConfigCDROM"="VM.Config.CDROM"; "VMConfigCloudinit"="VM.Config.Cloudinit"; "VMMonitor"="VM.Monitor"; "GroupAllocate"="Group.Allocate"; "MappingUse"="Mapping.Use"; "SysPowerMgmt"="Sys.PowerMgmt"; "SysIncoming"="Sys.Incoming"; "DatastoreAllocateSpace"="Datastore.AllocateSpace"; "RealmAllocate"="Realm.Allocate"; "SDNAllocate"="SDN.Allocate"; "VMSnapshot"="VM.Snapshot"; "PermissionsModify"="Permissions.Modify"; "VMBackup"="VM.Backup"; "DatastoreAllocateTemplate"="Datastore.AllocateTemplate"; "SysModify"="Sys.Modify"; "DatastoreAudit"="Datastore.Audit"; "SysConsole"="Sys.Console"; "VMConfigOptions"="VM.Config.Options"; "VMClone"="VM.Clone"; "VMConfigNetwork"="VM.Config.Network"; "VMAudit"="VM.Audit"; "VMConfigDisk"="VM.Config.Disk"; "DatastoreAllocate"="Datastore.Allocate"; "MappingModify"="Mapping.Modify"; "PoolAllocate"="Pool.Allocate"; "VMConfigCPU"="VM.Config.CPU"; "RealmAllocateUser"="Realm.AllocateUser"; "VMSnapshotRollback"="VM.Snapshot.Rollback"; "VMMigrate"="VM.Migrate"; "SysAudit"="Sys.Audit"; "VMAllocate"="VM.Allocate"; "MappingAudit"="Mapping.Audit"
        }
...
function ConvertFrom-PVEJsonToAccessRoles {
    ...
    Process {
        ...
        $AllProperties = ("VM.Config.Memory", "VM.PowerMgmt", "SDN.Use", "Sys.AccessNetwork", "Sys.Syslog", "SDN.Audit", "VM.Console", "VM.Config.HWType", "Pool.Audit", "User.Modify", "VM.Config.CDROM", "VM.Config.Cloudinit", "VM.Monitor", "Group.Allocate", "Mapping.Use", "Sys.PowerMgmt", "Sys.Incoming", "Datastore.AllocateSpace", "Realm.Allocate", "SDN.Allocate", "VM.Snapshot", "Permissions.Modify", "VM.Backup", "Datastore.AllocateTemplate", "Sys.Modify", "Datastore.Audit", "Sys.Console", "VM.Config.Options", "VM.Clone", "VM.Config.Network", "VM.Audit", "VM.Config.Disk", "Datastore.Allocate", "Mapping.Modify", "Pool.Allocate", "VM.Config.CPU", "Realm.AllocateUser", "VM.Snapshot.Rollback", "VM.Migrate", "Sys.Audit", "VM.Allocate", "Mapping.Audit")
