...
function Initialize-PVEPUTNodesCephPoolRB {
    ...
    Process {
        ...
        if ($MinSize -and $MinSize -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"PgNum"="pg_num"; "Size"="size"; "TargetSizeRatio"="target_size_ratio"; "CrushRule"="crush_rule"; "PgAutoscaleMode"="pg_autoscale_mode"; "TargetSize"="target_size"; "PgNumMin"="pg_num_min"; "MinSize"="min_size"; "Application"="application"
        }
...
function ConvertFrom-PVEJsonToPUTNodesCephPoolRB {
    ...
    Process {
        ...
        $AllProperties = ("pg_num", "size", "target_size_ratio", "crush_rule", "pg_autoscale_mode", "target_size", "pg_num_min", "min_size", "application")
