...
function Initialize-PVEPUTNodesCephPoolRB {
    ...
    Process {
        ...
        if ($MinSize -and $MinSize -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"CrushRule"="crush_rule"; "PgNum"="pg_num"; "Size"="size"; "PgNumMin"="pg_num_min"; "MinSize"="min_size"; "TargetSizeRatio"="target_size_ratio"; "PgAutoscaleMode"="pg_autoscale_mode"; "TargetSize"="target_size"; "Application"="application"
        }
...
function ConvertFrom-PVEJsonToPUTNodesCephPoolRB {
    ...
    Process {
        ...
        $AllProperties = ("crush_rule", "pg_num", "size", "pg_num_min", "min_size", "target_size_ratio", "pg_autoscale_mode", "target_size", "application")
