...
function Initialize-PVEPUTNodesCephPoolRB {
    ...
    Process {
        ...
        if ($Size -and $Size -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"PgNum"="pg_num"; "TargetSize"="target_size"; "MinSize"="min_size"; "TargetSizeRatio"="target_size_ratio"; "PgNumMin"="pg_num_min"; "PgAutoscaleMode"="pg_autoscale_mode"; "Application"="application"; "CrushRule"="crush_rule"; "Size"="size"
        }
...
function ConvertFrom-PVEJsonToPUTNodesCephPoolRB {
    ...
    Process {
        ...
        $AllProperties = ("pg_num", "target_size", "min_size", "target_size_ratio", "pg_num_min", "pg_autoscale_mode", "application", "crush_rule", "size")
