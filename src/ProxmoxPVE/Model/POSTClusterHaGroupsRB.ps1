...
function Initialize-PVEPOSTClusterHaGroupsRB {
    ...
    Process {
        ...
        if (!$Comment -and $Comment.length -gt 4096) {
		 ...
		 $DisplayNameMapping =@{
			"Restricted"="restricted"; "Type"="type"; "Group"="group"; "Comment"="comment"; "Nofailback"="nofailback"; "Nodes"="nodes"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterHaGroupsRB {
    ...
    Process {
        ...
        $AllProperties = ("restricted", "type", "group", "comment", "nofailback", "nodes")
