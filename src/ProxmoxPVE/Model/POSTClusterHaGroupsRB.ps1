...
function Initialize-PVEPOSTClusterHaGroupsRB {
    ...
    Process {
        ...
        if (!$Comment -and $Comment.length -gt 4096) {
		 ...
		 $DisplayNameMapping =@{
			"Nofailback"="nofailback"; "Group"="group"; "Type"="type"; "Restricted"="restricted"; "Nodes"="nodes"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterHaGroupsRB {
    ...
    Process {
        ...
        $AllProperties = ("nofailback", "group", "type", "restricted", "nodes", "comment")
