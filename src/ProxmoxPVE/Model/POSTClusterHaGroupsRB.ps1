...
function Initialize-PVEPOSTClusterHaGroupsRB {
    ...
    Process {
        ...
        if (!$Comment -and $Comment.length -gt 4096) {
		 ...
		 $DisplayNameMapping =@{
			"Nofailback"="nofailback"; "Type"="type"; "Restricted"="restricted"; "Nodes"="nodes"; "Comment"="comment"; "Group"="group"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterHaGroupsRB {
    ...
    Process {
        ...
        $AllProperties = ("nofailback", "type", "restricted", "nodes", "comment", "group")
