...
function ConvertFrom-PVEJsonToNodesLxcStatusCurrent {
    ...
    Process {
        ...
        $AllProperties = ("maxswap", "maxmem", "status", "maxdisk", "vmid", "netin", "pressurememoryfull", "diskread", "disk", "netout", "pressurememorysome", "cpu", "pressurecpusome", "tags", "cpus", "diskwrite", "name", "pressureiosome", "template", "ha", "pressureiofull", "mem", "lock", "uptime")
