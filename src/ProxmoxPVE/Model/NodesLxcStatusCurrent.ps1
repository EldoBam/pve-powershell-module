...
function Initialize-PVENodesLxcStatusCurrent {
    ...
    Process {
        ...
        if ($Vmid -and $Vmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Name"="name"; "Cpus"="cpus"; "Netin"="netin"; "Vmid"="vmid"; "Status"="status"; "Lock"="lock"; "Maxdisk"="maxdisk"; "Cpu"="cpu"; "Disk"="disk"; "Diskread"="diskread"; "Maxswap"="maxswap"; "Uptime"="uptime"; "Ha"="ha"; "Diskwrite"="diskwrite"; "Maxmem"="maxmem"; "Template"="template"; "Netout"="netout"; "Mem"="mem"; "Tags"="tags"
        }
...
function ConvertFrom-PVEJsonToNodesLxcStatusCurrent {
    ...
    Process {
        ...
        $AllProperties = ("name", "cpus", "netin", "vmid", "status", "lock", "maxdisk", "cpu", "disk", "diskread", "maxswap", "uptime", "ha", "diskwrite", "maxmem", "template", "netout", "mem", "tags")
