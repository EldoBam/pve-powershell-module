...
function Initialize-PVENodesLxcStatusCurrent {
    ...
    Process {
        ...
        if ($Vmid -and $Vmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Cpu"="cpu"; "Maxmem"="maxmem"; "Maxdisk"="maxdisk"; "Diskwrite"="diskwrite"; "Uptime"="uptime"; "Tags"="tags"; "Diskread"="diskread"; "Ha"="ha"; "Vmid"="vmid"; "Template"="template"; "Lock"="lock"; "Maxswap"="maxswap"; "Status"="status"; "Cpus"="cpus"; "Netout"="netout"; "Name"="name"; "Disk"="disk"; "Mem"="mem"; "Netin"="netin"
        }
...
function ConvertFrom-PVEJsonToNodesLxcStatusCurrent {
    ...
    Process {
        ...
        $AllProperties = ("cpu", "maxmem", "maxdisk", "diskwrite", "uptime", "tags", "diskread", "ha", "vmid", "template", "lock", "maxswap", "status", "cpus", "netout", "name", "disk", "mem", "netin")
