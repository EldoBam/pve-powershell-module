...
function Initialize-PVENodesLxcStatusCurrent {
    ...
    Process {
        ...
        if ($Vmid -and $Vmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Pressureiosome"="pressureiosome"; "Netout"="netout"; "Netin"="netin"; "Pressurememoryfull"="pressurememoryfull"; "Ha"="ha"; "Status"="status"; "Disk"="disk"; "Cpus"="cpus"; "Maxmem"="maxmem"; "Maxswap"="maxswap"; "Tags"="tags"; "Lock"="lock"; "Diskwrite"="diskwrite"; "Uptime"="uptime"; "Cpu"="cpu"; "Diskread"="diskread"; "Name"="name"; "Vmid"="vmid"; "Maxdisk"="maxdisk"; "Pressurecpusome"="pressurecpusome"; "Template"="template"; "Pressureiofull"="pressureiofull"; "Pressurememorysome"="pressurememorysome"; "Mem"="mem"
        }
...
function ConvertFrom-PVEJsonToNodesLxcStatusCurrent {
    ...
    Process {
        ...
        $AllProperties = ("pressureiosome", "netout", "netin", "pressurememoryfull", "ha", "status", "disk", "cpus", "maxmem", "maxswap", "tags", "lock", "diskwrite", "uptime", "cpu", "diskread", "name", "vmid", "maxdisk", "pressurecpusome", "template", "pressureiofull", "pressurememorysome", "mem")
