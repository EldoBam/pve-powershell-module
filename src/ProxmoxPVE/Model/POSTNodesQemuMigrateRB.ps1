...
function Initialize-PVEPOSTNodesQemuMigrateRB {
    ...
    Process {
        ...
        if ($WithLocalDisks -and $WithLocalDisks -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Force"="force"; "Target"="target"; "Bwlimit"="bwlimit"; "MigrationType"="migration_type"; "Vmid"="vmid"; "Online"="online"; "MigrationNetwork"="migration_network"; "Node"="node"; "Targetstorage"="targetstorage"; "WithLocalDisks"="with-local-disks"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuMigrateRB {
    ...
    Process {
        ...
        $AllProperties = ("force", "target", "bwlimit", "migration_type", "vmid", "online", "migration_network", "node", "targetstorage", "with-local-disks")
