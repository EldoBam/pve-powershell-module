...
function Initialize-PVENodesQemuMigrate {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"HasDbusVmstate"="has-dbus-vmstate"; "Running"="running"; "MappedResources"="mapped-resources"; "LocalResources"="local_resources"; "LocalDisks"="local_disks"; "MappedResourceInfo"="mapped-resource-info"; "DependentHaResources"="dependent-ha-resources"; "AllowedNodes"="allowed_nodes"; "NotAllowedNodes"="not_allowed_nodes"
        }
...
function ConvertFrom-PVEJsonToNodesQemuMigrate {
    ...
    Process {
        ...
        $AllProperties = ("has-dbus-vmstate", "running", "mapped-resources", "local_resources", "local_disks", "mapped-resource-info", "dependent-ha-resources", "allowed_nodes", "not_allowed_nodes")
