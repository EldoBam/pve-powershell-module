...
function Initialize-PVEPOSTNodesQemuRemotemigrateRB {
    ...
    Process {
        ...
        if ($TargetVmid -and $TargetVmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"TargetBridge"="target-bridge"; "Online"="online"; "TargetStorage"="target-storage"; "Delete"="delete"; "TargetVmid"="target-vmid"; "Bwlimit"="bwlimit"; "TargetEndpoint"="target-endpoint"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuRemotemigrateRB {
    ...
    Process {
        ...
        $AllProperties = ("target-bridge", "online", "target-storage", "delete", "target-vmid", "bwlimit", "target-endpoint")
