...
function Initialize-PVEPOSTNodesQemuRemotemigrateRB {
    ...
    Process {
        ...
        if ($TargetVmid -and $TargetVmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Delete"="delete"; "TargetVmid"="target-vmid"; "TargetBridge"="target-bridge"; "TargetEndpoint"="target-endpoint"; "Bwlimit"="bwlimit"; "TargetStorage"="target-storage"; "Online"="online"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuRemotemigrateRB {
    ...
    Process {
        ...
        $AllProperties = ("delete", "target-vmid", "target-bridge", "target-endpoint", "bwlimit", "target-storage", "online")
