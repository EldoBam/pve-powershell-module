...
function Initialize-PVEPOSTNodesQemuRemotemigrateRB {
    ...
    Process {
        ...
        if ($TargetVmid -and $TargetVmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"TargetBridge"="target-bridge"; "Delete"="delete"; "TargetEndpoint"="target-endpoint"; "Bwlimit"="bwlimit"; "TargetStorage"="target-storage"; "TargetVmid"="target-vmid"; "Online"="online"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuRemotemigrateRB {
    ...
    Process {
        ...
        $AllProperties = ("target-bridge", "delete", "target-endpoint", "bwlimit", "target-storage", "target-vmid", "online")
