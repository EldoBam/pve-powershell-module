...
function Initialize-PVENodesCephOsdLvinfo {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"VgName"="vg_name"; "LvUuid"="lv_uuid"; "LvName"="lv_name"; "LvSize"="lv_size"; "LvPath"="lv_path"; "CreationTime"="creation_time"
        }
...
function ConvertFrom-PVEJsonToNodesCephOsdLvinfo {
    ...
    Process {
        ...
        $AllProperties = ("vg_name", "lv_uuid", "lv_name", "lv_size", "lv_path", "creation_time")
