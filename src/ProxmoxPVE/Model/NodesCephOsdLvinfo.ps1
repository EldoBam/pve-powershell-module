...
function Initialize-PVENodesCephOsdLvinfo {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"LvName"="lv_name"; "CreationTime"="creation_time"; "LvPath"="lv_path"; "VgName"="vg_name"; "LvSize"="lv_size"; "LvUuid"="lv_uuid"
        }
...
function ConvertFrom-PVEJsonToNodesCephOsdLvinfo {
    ...
    Process {
        ...
        $AllProperties = ("lv_name", "creation_time", "lv_path", "vg_name", "lv_size", "lv_uuid")
