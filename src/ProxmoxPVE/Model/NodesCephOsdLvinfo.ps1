...
function Initialize-PVENodesCephOsdLvinfo {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"VgName"="vg_name"; "LvName"="lv_name"; "LvPath"="lv_path"; "CreationTime"="creation_time"; "LvSize"="lv_size"; "LvUuid"="lv_uuid"
        }
...
function ConvertFrom-PVEJsonToNodesCephOsdLvinfo {
    ...
    Process {
        ...
        $AllProperties = ("vg_name", "lv_name", "lv_path", "creation_time", "lv_size", "lv_uuid")
