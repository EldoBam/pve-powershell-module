...
function Initialize-PVENodesDisksZfs {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Action"="action"; "Name"="name"; "Status"="status"; "State"="state"; "Scan"="scan"; "Errors"="errors"; "Children"="children"
        }
...
function ConvertFrom-PVEJsonToNodesDisksZfs {
    ...
    Process {
        ...
        $AllProperties = ("action", "name", "status", "state", "scan", "errors", "children")
