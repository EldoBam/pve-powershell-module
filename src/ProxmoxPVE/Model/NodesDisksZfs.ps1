...
function Initialize-PVENodesDisksZfs {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Status"="status"; "Name"="name"; "State"="state"; "Action"="action"; "Children"="children"; "Scan"="scan"; "Errors"="errors"
        }
...
function ConvertFrom-PVEJsonToNodesDisksZfs {
    ...
    Process {
        ...
        $AllProperties = ("status", "name", "state", "action", "children", "scan", "errors")
