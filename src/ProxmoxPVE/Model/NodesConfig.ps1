...
function Initialize-PVENodesConfig {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 40) {
		 ...
		 $DisplayNameMapping =@{
			"Acme"="acme"; "Wakeonlan"="wakeonlan"; "AcmedomainN"="acmedomain[n]"; "BallooningTarget"="ballooning-target"; "Description"="description"; "StartallOnbootDelay"="startall-onboot-delay"; "Digest"="digest"
        }
...
function ConvertFrom-PVEJsonToNodesConfig {
    ...
    Process {
        ...
        $AllProperties = ("acme", "wakeonlan", "acmedomain[n]", "ballooning-target", "description", "startall-onboot-delay", "digest")
