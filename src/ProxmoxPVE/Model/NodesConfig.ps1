...
function Initialize-PVENodesConfig {
    ...
    Process {
        ...
        if (!$Description -and $Description.length -gt 65536) {
		 ...
		 $DisplayNameMapping =@{
			"AcmedomainN"="acmedomain[n]"; "Wakeonlan"="wakeonlan"; "StartallOnbootDelay"="startall-onboot-delay"; "Digest"="digest"; "BallooningTarget"="ballooning-target"; "Description"="description"; "Acme"="acme"
        }
...
function ConvertFrom-PVEJsonToNodesConfig {
    ...
    Process {
        ...
        $AllProperties = ("acmedomain[n]", "wakeonlan", "startall-onboot-delay", "digest", "ballooning-target", "description", "acme")
