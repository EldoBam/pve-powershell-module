...
function Initialize-PVENodesConfig {
    ...
    Process {
        ...
        if ($BallooningTarget -and $BallooningTarget -gt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Digest"="digest"; "StartallOnbootDelay"="startall-onboot-delay"; "Wakeonlan"="wakeonlan"; "Description"="description"; "BallooningTarget"="ballooning-target"; "AcmedomainN"="acmedomain[n]"; "Acme"="acme"
        }
...
function ConvertFrom-PVEJsonToNodesConfig {
    ...
    Process {
        ...
        $AllProperties = ("digest", "startall-onboot-delay", "wakeonlan", "description", "ballooning-target", "acmedomain[n]", "acme")
