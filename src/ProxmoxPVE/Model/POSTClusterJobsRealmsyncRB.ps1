...
function Initialize-PVEPOSTClusterJobsRealmsyncRB {
    ...
    Process {
        ...
        if ($EnableNew -and $EnableNew -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"RemoveVanished"="remove-vanished"; "Id"="id"; "Comment"="comment"; "Enabled"="enabled"; "Realm"="realm"; "Scope"="scope"; "Schedule"="schedule"; "EnableNew"="enable-new"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterJobsRealmsyncRB {
    ...
    Process {
        ...
        $AllProperties = ("remove-vanished", "id", "comment", "enabled", "realm", "scope", "schedule", "enable-new")
