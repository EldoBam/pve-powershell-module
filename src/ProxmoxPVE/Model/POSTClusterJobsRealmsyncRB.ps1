...
function Initialize-PVEPOSTClusterJobsRealmsyncRB {
    ...
    Process {
        ...
        if (!$Realm -and $Realm.length -gt 32) {
		 ...
		 $DisplayNameMapping =@{
			"Schedule"="schedule"; "Comment"="comment"; "EnableNew"="enable-new"; "Realm"="realm"; "Scope"="scope"; "RemoveVanished"="remove-vanished"; "Enabled"="enabled"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterJobsRealmsyncRB {
    ...
    Process {
        ...
        $AllProperties = ("schedule", "comment", "enable-new", "realm", "scope", "remove-vanished", "enabled")
