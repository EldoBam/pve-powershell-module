...
function Initialize-PVEPOSTClusterJobsRealmsyncRB {
    ...
    Process {
        ...
        if (!$Comment -and $Comment.length -gt 512) {
		 ...
		 $DisplayNameMapping =@{
			"Schedule"="schedule"; "RemoveVanished"="remove-vanished"; "Realm"="realm"; "Scope"="scope"; "Enabled"="enabled"; "EnableNew"="enable-new"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterJobsRealmsyncRB {
    ...
    Process {
        ...
        $AllProperties = ("schedule", "remove-vanished", "realm", "scope", "enabled", "enable-new", "comment")
