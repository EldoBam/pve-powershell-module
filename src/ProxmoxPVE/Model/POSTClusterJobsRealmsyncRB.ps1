...
function Initialize-PVEPOSTClusterJobsRealmsyncRB {
    ...
    Process {
        ...
        if (!$Id -and $Id.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Enabled"="enabled"; "Scope"="scope"; "Schedule"="schedule"; "RemoveVanished"="remove-vanished"; "EnableNew"="enable-new"; "Comment"="comment"; "Realm"="realm"; "Id"="id"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterJobsRealmsyncRB {
    ...
    Process {
        ...
        $AllProperties = ("enabled", "scope", "schedule", "remove-vanished", "enable-new", "comment", "realm", "id")
