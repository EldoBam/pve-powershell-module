...
POSTNodesLxcSnapshotRollbackRB<PSCustomObject>
#>

function Initialize-PVEPOSTNodesLxcSnapshotRollbackRB {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ProxmoxPVE => PVEPOSTNodesLxcSnapshotRollbackRB' | Write-Debug
...
Convert from JSON to POSTNodesLxcSnapshotRollbackRB<PSCustomObject>
...
POSTNodesLxcSnapshotRollbackRB<PSCustomObject>
#>
function ConvertFrom-PVEJsonToPOSTNodesLxcSnapshotRollbackRB {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ProxmoxPVE => PVEPOSTNodesLxcSnapshotRollbackRB' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PVEPOSTNodesLxcSnapshotRollbackRB
