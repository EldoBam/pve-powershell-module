...
function Initialize-PVEPOSTClusterBackupRB {
    ...
    Process {
        ...
        if ($Quiet -and $Quiet -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Id"="id"; "PruneBackups"="prune-backups"; "Bwlimit"="bwlimit"; "Remove"="remove"; "Fleecing"="fleecing"; "Schedule"="schedule"; "All"="all"; "Dow"="dow"; "Protected"="protected"; "ExcludePath"="exclude-path"; "PbsChangeDetectionMode"="pbs-change-detection-mode"; "Script"="script"; "RepeatMissed"="repeat-missed"; "Comment"="comment"; "Tmpdir"="tmpdir"; "Pool"="pool"; "Zstd"="zstd"; "Stopwait"="stopwait"; "Enabled"="enabled"; "Exclude"="exclude"; "Stop"="stop"; "Mailto"="mailto"; "Storage"="storage"; "NotesTemplate"="notes-template"; "Dumpdir"="dumpdir"; "Stdexcludes"="stdexcludes"; "Mailnotification"="mailnotification"; "Mode"="mode"; "Lockwait"="lockwait"; "NotificationTarget"="notification-target"; "Pigz"="pigz"; "Performance"="performance"; "Maxfiles"="maxfiles"; "Ionice"="ionice"; "NotificationPolicy"="notification-policy"; "Starttime"="starttime"; "Vmid"="vmid"; "Compress"="compress"; "Node"="node"; "Quiet"="quiet"; "NotificationMode"="notification-mode"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterBackupRB {
    ...
    Process {
        ...
        $AllProperties = ("id", "prune-backups", "bwlimit", "remove", "fleecing", "schedule", "all", "dow", "protected", "exclude-path", "pbs-change-detection-mode", "script", "repeat-missed", "comment", "tmpdir", "pool", "zstd", "stopwait", "enabled", "exclude", "stop", "mailto", "storage", "notes-template", "dumpdir", "stdexcludes", "mailnotification", "mode", "lockwait", "notification-target", "pigz", "performance", "maxfiles", "ionice", "notification-policy", "starttime", "vmid", "compress", "node", "quiet", "notification-mode")
