...
function Initialize-PVEPOSTClusterBackupRB {
    ...
    Process {
        ...
        if ($Ionice -and $Ionice -gt 8) {
		 ...
		 $DisplayNameMapping =@{
			"Maxfiles"="maxfiles"; "NotificationMode"="notification-mode"; "Mailnotification"="mailnotification"; "Schedule"="schedule"; "Tmpdir"="tmpdir"; "Id"="id"; "Mode"="mode"; "Performance"="performance"; "Compress"="compress"; "PbsChangeDetectionMode"="pbs-change-detection-mode"; "Protected"="protected"; "Vmid"="vmid"; "NotesTemplate"="notes-template"; "Dow"="dow"; "Storage"="storage"; "Node"="node"; "RepeatMissed"="repeat-missed"; "All"="all"; "Exclude"="exclude"; "Bwlimit"="bwlimit"; "Stdexcludes"="stdexcludes"; "Quiet"="quiet"; "Fleecing"="fleecing"; "Comment"="comment"; "Pool"="pool"; "Enabled"="enabled"; "Lockwait"="lockwait"; "Stop"="stop"; "Zstd"="zstd"; "ExcludePath"="exclude-path"; "Dumpdir"="dumpdir"; "PruneBackups"="prune-backups"; "Script"="script"; "Stopwait"="stopwait"; "Mailto"="mailto"; "Pigz"="pigz"; "Remove"="remove"; "Ionice"="ionice"; "Starttime"="starttime"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterBackupRB {
    ...
    Process {
        ...
        $AllProperties = ("maxfiles", "notification-mode", "mailnotification", "schedule", "tmpdir", "id", "mode", "performance", "compress", "pbs-change-detection-mode", "protected", "vmid", "notes-template", "dow", "storage", "node", "repeat-missed", "all", "exclude", "bwlimit", "stdexcludes", "quiet", "fleecing", "comment", "pool", "enabled", "lockwait", "stop", "zstd", "exclude-path", "dumpdir", "prune-backups", "script", "stopwait", "mailto", "pigz", "remove", "ionice", "starttime")
