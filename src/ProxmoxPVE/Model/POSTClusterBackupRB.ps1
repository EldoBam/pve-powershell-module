...
function ConvertFrom-PVEJsonToPOSTClusterBackupRB {
    ...
    Process {
        ...
        $AllProperties = ("all", "notification-mode", "stopwait", "pigz", "storage", "script", "enabled", "starttime", "pbs-change-detection-mode", "stdexcludes", "schedule", "ionice", "dumpdir", "node", "mode", "stop", "zstd", "compress", "mailnotification", "notes-template", "mailto", "bwlimit", "vmid", "fleecing", "exclude-path", "repeat-missed", "lockwait", "notification-policy", "id", "notification-target", "tmpdir", "protected", "exclude", "quiet", "remove", "prune-backups", "performance", "comment", "pool", "maxfiles", "dow")
