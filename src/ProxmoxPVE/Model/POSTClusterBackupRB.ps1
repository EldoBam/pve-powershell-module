...
function Initialize-PVEPOSTClusterBackupRB {
    ...
    Process {
        ...
        if ($Ionice -and $Ionice -gt 8) {
		 ...
		 $DisplayNameMapping =@{
			"Enabled"="enabled"; "Lockwait"="lockwait"; "Starttime"="starttime"; "Mode"="mode"; "Quiet"="quiet"; "Mailnotification"="mailnotification"; "ExcludePath"="exclude-path"; "Dow"="dow"; "Node"="node"; "Tmpdir"="tmpdir"; "Stdexcludes"="stdexcludes"; "Maxfiles"="maxfiles"; "Vmid"="vmid"; "NotificationMode"="notification-mode"; "Exclude"="exclude"; "Fleecing"="fleecing"; "RepeatMissed"="repeat-missed"; "Storage"="storage"; "NotesTemplate"="notes-template"; "Performance"="performance"; "NotificationTarget"="notification-target"; "Remove"="remove"; "Bwlimit"="bwlimit"; "Compress"="compress"; "Script"="script"; "Dumpdir"="dumpdir"; "Mailto"="mailto"; "Pool"="pool"; "PruneBackups"="prune-backups"; "Stopwait"="stopwait"; "Schedule"="schedule"; "Pigz"="pigz"; "Stop"="stop"; "Protected"="protected"; "Comment"="comment"; "All"="all"; "PbsChangeDetectionMode"="pbs-change-detection-mode"; "NotificationPolicy"="notification-policy"; "Zstd"="zstd"; "Id"="id"; "Ionice"="ionice"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterBackupRB {
    ...
    Process {
        ...
        $AllProperties = ("enabled", "lockwait", "starttime", "mode", "quiet", "mailnotification", "exclude-path", "dow", "node", "tmpdir", "stdexcludes", "maxfiles", "vmid", "notification-mode", "exclude", "fleecing", "repeat-missed", "storage", "notes-template", "performance", "notification-target", "remove", "bwlimit", "compress", "script", "dumpdir", "mailto", "pool", "prune-backups", "stopwait", "schedule", "pigz", "stop", "protected", "comment", "all", "pbs-change-detection-mode", "notification-policy", "zstd", "id", "ionice")
