...
function Initialize-PVEPOSTClusterBackupRB {
    ...
    Process {
        ...
        if (!$Comment -and $Comment.length -gt 512) {
		 ...
		 $DisplayNameMapping =@{
			"Maxfiles"="maxfiles"; "NotificationMode"="notification-mode"; "Pool"="pool"; "All"="all"; "NotesTemplate"="notes-template"; "Stdexcludes"="stdexcludes"; "Fleecing"="fleecing"; "Script"="script"; "Stopwait"="stopwait"; "Schedule"="schedule"; "PbsChangeDetectionMode"="pbs-change-detection-mode"; "Compress"="compress"; "Mailto"="mailto"; "Stop"="stop"; "Ionice"="ionice"; "Performance"="performance"; "Protected"="protected"; "Comment"="comment"; "Zstd"="zstd"; "Lockwait"="lockwait"; "Id"="id"; "Bwlimit"="bwlimit"; "RepeatMissed"="repeat-missed"; "Pigz"="pigz"; "Quiet"="quiet"; "Starttime"="starttime"; "Enabled"="enabled"; "Mode"="mode"; "Tmpdir"="tmpdir"; "Node"="node"; "Dumpdir"="dumpdir"; "Exclude"="exclude"; "Dow"="dow"; "Remove"="remove"; "Storage"="storage"; "Mailnotification"="mailnotification"; "PruneBackups"="prune-backups"; "Vmid"="vmid"; "ExcludePath"="exclude-path"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterBackupRB {
    ...
    Process {
        ...
        $AllProperties = ("maxfiles", "notification-mode", "pool", "all", "notes-template", "stdexcludes", "fleecing", "script", "stopwait", "schedule", "pbs-change-detection-mode", "compress", "mailto", "stop", "ionice", "performance", "protected", "comment", "zstd", "lockwait", "id", "bwlimit", "repeat-missed", "pigz", "quiet", "starttime", "enabled", "mode", "tmpdir", "node", "dumpdir", "exclude", "dow", "remove", "storage", "mailnotification", "prune-backups", "vmid", "exclude-path")
