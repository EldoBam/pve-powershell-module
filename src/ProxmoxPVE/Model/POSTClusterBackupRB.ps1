...
function Initialize-PVEPOSTClusterBackupRB {
    ...
    Process {
        ...
        if ($Ionice -and $Ionice -gt 8) {
		 ...
		 $DisplayNameMapping =@{
			"Pool"="pool"; "NotificationMode"="notification-mode"; "Comment"="comment"; "Tmpdir"="tmpdir"; "Dow"="dow"; "NotificationPolicy"="notification-policy"; "Schedule"="schedule"; "Mode"="mode"; "Pigz"="pigz"; "Quiet"="quiet"; "Storage"="storage"; "Id"="id"; "Mailto"="mailto"; "Bwlimit"="bwlimit"; "Zstd"="zstd"; "RepeatMissed"="repeat-missed"; "Compress"="compress"; "Fleecing"="fleecing"; "PbsChangeDetectionMode"="pbs-change-detection-mode"; "Lockwait"="lockwait"; "Maxfiles"="maxfiles"; "Enabled"="enabled"; "Stop"="stop"; "ExcludePath"="exclude-path"; "Performance"="performance"; "Protected"="protected"; "Dumpdir"="dumpdir"; "NotesTemplate"="notes-template"; "Stdexcludes"="stdexcludes"; "PruneBackups"="prune-backups"; "NotificationTarget"="notification-target"; "Vmid"="vmid"; "All"="all"; "Exclude"="exclude"; "Remove"="remove"; "Mailnotification"="mailnotification"; "Stopwait"="stopwait"; "Script"="script"; "Node"="node"; "Ionice"="ionice"; "Starttime"="starttime"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterBackupRB {
    ...
    Process {
        ...
        $AllProperties = ("pool", "notification-mode", "comment", "tmpdir", "dow", "notification-policy", "schedule", "mode", "pigz", "quiet", "storage", "id", "mailto", "bwlimit", "zstd", "repeat-missed", "compress", "fleecing", "pbs-change-detection-mode", "lockwait", "maxfiles", "enabled", "stop", "exclude-path", "performance", "protected", "dumpdir", "notes-template", "stdexcludes", "prune-backups", "notification-target", "vmid", "all", "exclude", "remove", "mailnotification", "stopwait", "script", "node", "ionice", "starttime")
