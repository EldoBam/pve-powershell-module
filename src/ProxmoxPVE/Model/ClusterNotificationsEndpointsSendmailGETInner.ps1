...
function Initialize-PVEClusterNotificationsEndpointsSendmailGETInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Origin"="origin"; "Name"="name"; "Mailto"="mailto"; "Disable"="disable"; "MailtoUser"="mailto-user"; "FromAddress"="from-address"; "Author"="author"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsSendmailGETInner {
    ...
    Process {
        ...
        $AllProperties = ("origin", "name", "mailto", "disable", "mailto-user", "from-address", "author", "comment")
