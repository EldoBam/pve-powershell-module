...
function Initialize-PVEClusterNotificationsEndpointsSendmailGETInner {
    ...
    Process {
        ...
        if ($Disable -and $Disable -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Author"="author"; "MailtoUser"="mailto-user"; "FromAddress"="from-address"; "Origin"="origin"; "Mailto"="mailto"; "Comment"="comment"; "Disable"="disable"; "Name"="name"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsSendmailGETInner {
    ...
    Process {
        ...
        $AllProperties = ("author", "mailto-user", "from-address", "origin", "mailto", "comment", "disable", "name")
