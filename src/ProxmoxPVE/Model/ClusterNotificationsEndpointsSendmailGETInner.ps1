...
function Initialize-PVEClusterNotificationsEndpointsSendmailGETInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Author"="author"; "Comment"="comment"; "FromAddress"="from-address"; "Disable"="disable"; "Name"="name"; "Origin"="origin"; "MailtoUser"="mailto-user"; "Mailto"="mailto"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsSendmailGETInner {
    ...
    Process {
        ...
        $AllProperties = ("author", "comment", "from-address", "disable", "name", "origin", "mailto-user", "mailto")
