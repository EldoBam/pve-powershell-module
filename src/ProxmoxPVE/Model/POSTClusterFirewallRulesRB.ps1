...
POSTClusterFirewallRulesRB<PSCustomObject>
#>

function Initialize-PVEPOSTClusterFirewallRulesRB {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ProxmoxPVE => PVEPOSTClusterFirewallRulesRB' | Write-Debug
...
Convert from JSON to POSTClusterFirewallRulesRB<PSCustomObject>
...
POSTClusterFirewallRulesRB<PSCustomObject>
#>
function ConvertFrom-PVEJsonToPOSTClusterFirewallRulesRB {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ProxmoxPVE => PVEPOSTClusterFirewallRulesRB' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PVEPOSTClusterFirewallRulesRB
