...
function Initialize-PVEPOSTClusterFirewallRulesRB {
    ...
    Process {
        ...
        if (!$Dest -and $Dest.length -gt 512) {
		 ...
		 $DisplayNameMapping =@{
			"Digest"="digest"; "Source"="source"; "Sport"="sport"; "Action"="action"; "Comment"="comment"; "Proto"="proto"; "Enable"="enable"; "IcmpType"="icmp-type"; "Macro"="macro"; "Pos"="pos"; "Type"="type"; "Iface"="iface"; "Log"="log"; "Dest"="dest"; "Dport"="dport"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterFirewallRulesRB {
    ...
    Process {
        ...
        $AllProperties = ("digest", "source", "sport", "action", "comment", "proto", "enable", "icmp-type", "macro", "pos", "type", "iface", "log", "dest", "dport")
