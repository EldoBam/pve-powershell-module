...
function Initialize-PVEPOSTClusterFirewallRulesRB {
    ...
    Process {
        ...
        if (!$Iface -and $Iface.length -lt 2) {
		 ...
		 $DisplayNameMapping =@{
			"Macro"="macro"; "Action"="action"; "Proto"="proto"; "Log"="log"; "Pos"="pos"; "Dest"="dest"; "Type"="type"; "Comment"="comment"; "Dport"="dport"; "Digest"="digest"; "Enable"="enable"; "Source"="source"; "Iface"="iface"; "IcmpType"="icmp-type"; "Sport"="sport"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterFirewallRulesRB {
    ...
    Process {
        ...
        $AllProperties = ("macro", "action", "proto", "log", "pos", "dest", "type", "comment", "dport", "digest", "enable", "source", "iface", "icmp-type", "sport")
