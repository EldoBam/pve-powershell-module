...
function Initialize-PVEPOSTClusterFirewallRulesRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Pos"="pos"; "Type"="type"; "Dest"="dest"; "Source"="source"; "Dport"="dport"; "Enable"="enable"; "Action"="action"; "Macro"="macro"; "Iface"="iface"; "Log"="log"; "Sport"="sport"; "Comment"="comment"; "Proto"="proto"; "Digest"="digest"; "IcmpType"="icmp-type"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterFirewallRulesRB {
    ...
    Process {
        ...
        $AllProperties = ("pos", "type", "dest", "source", "dport", "enable", "action", "macro", "iface", "log", "sport", "comment", "proto", "digest", "icmp-type")
