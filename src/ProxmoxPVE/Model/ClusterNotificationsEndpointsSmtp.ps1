...
function Initialize-PVEClusterNotificationsEndpointsSmtp {
    ...
    Process {
        ...
        if ($Disable -and $Disable -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Username"="username"; "Mode"="mode"; "Author"="author"; "Digest"="digest"; "FromAddress"="from-address"; "Port"="port"; "Server"="server"; "Mailto"="mailto"; "MailtoUser"="mailto-user"; "Comment"="comment"; "Disable"="disable"; "Name"="name"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsSmtp {
    ...
    Process {
        ...
        $AllProperties = ("username", "mode", "author", "digest", "from-address", "port", "server", "mailto", "mailto-user", "comment", "disable", "name")
