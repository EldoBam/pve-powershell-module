...
function Initialize-PVEClusterNotificationsEndpointsSmtp {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Mode"="mode"; "MailtoUser"="mailto-user"; "Username"="username"; "Name"="name"; "Mailto"="mailto"; "Disable"="disable"; "Port"="port"; "Digest"="digest"; "FromAddress"="from-address"; "Author"="author"; "Server"="server"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsSmtp {
    ...
    Process {
        ...
        $AllProperties = ("mode", "mailto-user", "username", "name", "mailto", "disable", "port", "digest", "from-address", "author", "server", "comment")
