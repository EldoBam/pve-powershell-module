...
function Initialize-PVEClusterNotificationsEndpointsSmtp {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Name"="name"; "Disable"="disable"; "Author"="author"; "Username"="username"; "Mode"="mode"; "Server"="server"; "Comment"="comment"; "Mailto"="mailto"; "Port"="port"; "MailtoUser"="mailto-user"; "Digest"="digest"; "FromAddress"="from-address"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsSmtp {
    ...
    Process {
        ...
        $AllProperties = ("name", "disable", "author", "username", "mode", "server", "comment", "mailto", "port", "mailto-user", "digest", "from-address")
