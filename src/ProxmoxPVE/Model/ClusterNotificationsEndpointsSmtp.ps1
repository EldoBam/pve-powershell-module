...
function Initialize-PVEClusterNotificationsEndpointsSmtp {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Username"="username"; "Port"="port"; "Author"="author"; "Comment"="comment"; "MailtoUser"="mailto-user"; "Server"="server"; "Mode"="mode"; "Disable"="disable"; "Mailto"="mailto"; "FromAddress"="from-address"; "Digest"="digest"; "Name"="name"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsSmtp {
    ...
    Process {
        ...
        $AllProperties = ("username", "port", "author", "comment", "mailto-user", "server", "mode", "disable", "mailto", "from-address", "digest", "name")
