...
function Initialize-PVEClusterNotificationsEndpointsSmtp {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Author"="author"; "Digest"="digest"; "Mode"="mode"; "Server"="server"; "FromAddress"="from-address"; "Disable"="disable"; "Name"="name"; "Username"="username"; "MailtoUser"="mailto-user"; "Comment"="comment"; "Port"="port"; "Mailto"="mailto"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsSmtp {
    ...
    Process {
        ...
        $AllProperties = ("author", "digest", "mode", "server", "from-address", "disable", "name", "username", "mailto-user", "comment", "port", "mailto")
