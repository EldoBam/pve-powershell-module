...
PUTNodesLxcResizeRB<PSCustomObject>
#>

function Initialize-PVEPUTNodesLxcResizeRB {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ProxmoxPVE => PVEPUTNodesLxcResizeRB' | Write-Debug
        ...
        if (!$Digest -and $Digest.length -gt 40) {
		 ...
		 $DisplayNameMapping =@{
			"Vmid"="vmid"; "Digest"="digest"; "Disk"="disk"; "Size"="size"; "Node"="node"
        }
...
Convert from JSON to PUTNodesLxcResizeRB<PSCustomObject>
...
PUTNodesLxcResizeRB<PSCustomObject>
#>
function ConvertFrom-PVEJsonToPUTNodesLxcResizeRB {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ProxmoxPVE => PVEPUTNodesLxcResizeRB' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PVEPUTNodesLxcResizeRB
        $AllProperties = ("vmid", "digest", "disk", "size", "node")
