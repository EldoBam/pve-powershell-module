...
function Initialize-PVEPOSTAccessTicketRB {
    ...
    Process {
        ...
        if (!$Realm -and $Realm.length -gt 32) {
		 ...
		 $DisplayNameMapping =@{
			"Password"="password"; "Path"="path"; "TfaChallenge"="tfa-challenge"; "Privs"="privs"; "Username"="username"; "NewFormat"="new-format"; "Realm"="realm"; "Otp"="otp"
        }
...
function ConvertFrom-PVEJsonToPOSTAccessTicketRB {
    ...
    Process {
        ...
        $AllProperties = ("password", "path", "tfa-challenge", "privs", "username", "new-format", "realm", "otp")
