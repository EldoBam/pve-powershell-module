...
function Initialize-PVEPOSTAccessTicketRB {
    ...
    Process {
        ...
        if (!$Privs -and $Privs.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"TfaChallenge"="tfa-challenge"; "Password"="password"; "Path"="path"; "Otp"="otp"; "NewFormat"="new-format"; "Realm"="realm"; "Username"="username"; "Privs"="privs"
        }
...
function ConvertFrom-PVEJsonToPOSTAccessTicketRB {
    ...
    Process {
        ...
        $AllProperties = ("tfa-challenge", "password", "path", "otp", "new-format", "realm", "username", "privs")
