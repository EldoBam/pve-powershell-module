...
function Initialize-PVEPOSTAccessTicketRB {
    ...
    Process {
        ...
        if (!$Realm -and $Realm.length -gt 32) {
		 ...
		 $DisplayNameMapping =@{
			"Username"="username"; "Password"="password"; "TfaChallenge"="tfa-challenge"; "Privs"="privs"; "NewFormat"="new-format"; "Path"="path"; "Realm"="realm"; "Otp"="otp"
        }
...
function ConvertFrom-PVEJsonToPOSTAccessTicketRB {
    ...
    Process {
        ...
        $AllProperties = ("username", "password", "tfa-challenge", "privs", "new-format", "path", "realm", "otp")
