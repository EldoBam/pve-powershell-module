...
function Initialize-PVEPOSTAccessTicketRB {
    ...
    Process {
        ...
        if (!$Path -and $Path.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Otp"="otp"; "Password"="password"; "Username"="username"; "Privs"="privs"; "TfaChallenge"="tfa-challenge"; "Realm"="realm"; "NewFormat"="new-format"; "Path"="path"
        }
...
function ConvertFrom-PVEJsonToPOSTAccessTicketRB {
    ...
    Process {
        ...
        $AllProperties = ("otp", "password", "username", "privs", "tfa-challenge", "realm", "new-format", "path")
