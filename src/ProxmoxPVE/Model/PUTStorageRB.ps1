...
function Initialize-PVEPUTStorageRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"IsMountpoint"="is_mountpoint"; "Blocksize"="blocksize"; "Delete"="delete"; "Subdir"="subdir"; "CreateSubdirs"="create-subdirs"; "ComstarHg"="comstar_hg"; "Mountpoint"="mountpoint"; "Content"="content"; "Sparse"="sparse"; "SaferemoveThroughput"="saferemove_throughput"; "EncryptionKey"="encryption-key"; "Nodes"="nodes"; "Preallocation"="preallocation"; "FsName"="fs-name"; "Bwlimit"="bwlimit"; "Krbd"="krbd"; "Nocow"="nocow"; "CreateBasePath"="create-base-path"; "Domain"="domain"; "Nowritecache"="nowritecache"; "TaggedOnly"="tagged_only"; "Keyring"="keyring"; "Options"="options"; "Monhost"="monhost"; "Server"="server"; "Namespace"="namespace"; "Port"="port"; "SnapshotAsVolumeChain"="snapshot-as-volume-chain"; "MaxProtectedBackups"="max-protected-backups"; "DataPool"="data-pool"; "Shared"="shared"; "Saferemove"="saferemove"; "ContentDirs"="content-dirs"; "ZfsBasePath"="zfs-base-path"; "Disable"="disable"; "SkipCertVerification"="skip-cert-verification"; "MasterPubkey"="master-pubkey"; "LioTpg"="lio_tpg"; "PruneBackups"="prune-backups"; "Fingerprint"="fingerprint"; "Mkdir"="mkdir"; "Fuse"="fuse"; "Smbversion"="smbversion"; "ComstarTg"="comstar_tg"; "Username"="username"; "Pool"="pool"; "Format"="format"; "Password"="password"; "Digest"="digest"
        }
...
function ConvertFrom-PVEJsonToPUTStorageRB {
    ...
    Process {
        ...
        $AllProperties = ("is_mountpoint", "blocksize", "delete", "subdir", "create-subdirs", "comstar_hg", "mountpoint", "content", "sparse", "saferemove_throughput", "encryption-key", "nodes", "preallocation", "fs-name", "bwlimit", "krbd", "nocow", "create-base-path", "domain", "nowritecache", "tagged_only", "keyring", "options", "monhost", "server", "namespace", "port", "snapshot-as-volume-chain", "max-protected-backups", "data-pool", "shared", "saferemove", "content-dirs", "zfs-base-path", "disable", "skip-cert-verification", "master-pubkey", "lio_tpg", "prune-backups", "fingerprint", "mkdir", "fuse", "smbversion", "comstar_tg", "username", "pool", "format", "password", "digest")
