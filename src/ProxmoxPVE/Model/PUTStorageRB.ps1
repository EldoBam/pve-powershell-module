...
function Initialize-PVEPUTStorageRB {
    ...
    Process {
        ...
        if (!$Delete -and $Delete.length -gt 4096) {
		 ...
		 $DisplayNameMapping =@{
			"CreateSubdirs"="create-subdirs"; "Monhost"="monhost"; "Digest"="digest"; "Transport"="transport"; "DataPool"="data-pool"; "Server"="server"; "IsMountpoint"="is_mountpoint"; "Nocow"="nocow"; "Port"="port"; "EncryptionKey"="encryption-key"; "SaferemoveThroughput"="saferemove_throughput"; "Fuse"="fuse"; "CreateBasePath"="create-base-path"; "Content"="content"; "Pool"="pool"; "ContentDirs"="content-dirs"; "ComstarTg"="comstar_tg"; "Maxfiles"="maxfiles"; "Shared"="shared"; "Disable"="disable"; "MaxProtectedBackups"="max-protected-backups"; "Mkdir"="mkdir"; "Bwlimit"="bwlimit"; "Smbversion"="smbversion"; "Format"="format"; "Mountpoint"="mountpoint"; "Saferemove"="saferemove"; "Domain"="domain"; "SkipCertVerification"="skip-cert-verification"; "Blocksize"="blocksize"; "Subdir"="subdir"; "Username"="username"; "Namespace"="namespace"; "Nowritecache"="nowritecache"; "Fingerprint"="fingerprint"; "Password"="password"; "Options"="options"; "Sparse"="sparse"; "MasterPubkey"="master-pubkey"; "FsName"="fs-name"; "TaggedOnly"="tagged_only"; "Nodes"="nodes"; "Preallocation"="preallocation"; "Krbd"="krbd"; "PruneBackups"="prune-backups"; "Delete"="delete"; "Keyring"="keyring"; "Server2"="server2"; "ComstarHg"="comstar_hg"; "LioTpg"="lio_tpg"
        }
...
function ConvertFrom-PVEJsonToPUTStorageRB {
    ...
    Process {
        ...
        $AllProperties = ("create-subdirs", "monhost", "digest", "transport", "data-pool", "server", "is_mountpoint", "nocow", "port", "encryption-key", "saferemove_throughput", "fuse", "create-base-path", "content", "pool", "content-dirs", "comstar_tg", "maxfiles", "shared", "disable", "max-protected-backups", "mkdir", "bwlimit", "smbversion", "format", "mountpoint", "saferemove", "domain", "skip-cert-verification", "blocksize", "subdir", "username", "namespace", "nowritecache", "fingerprint", "password", "options", "sparse", "master-pubkey", "fs-name", "tagged_only", "nodes", "preallocation", "krbd", "prune-backups", "delete", "keyring", "server2", "comstar_hg", "lio_tpg")
