...
function Initialize-PVEPUTStorageRB {
    ...
    Process {
        ...
        if ($CreateBasePath -and $CreateBasePath -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Server2"="server2"; "DataPool"="data-pool"; "Nowritecache"="nowritecache"; "Username"="username"; "EncryptionKey"="encryption-key"; "Storage"="storage"; "Sparse"="sparse"; "ComstarTg"="comstar_tg"; "SkipCertVerification"="skip-cert-verification"; "ComstarHg"="comstar_hg"; "TaggedOnly"="tagged_only"; "Disable"="disable"; "Saferemove"="saferemove"; "Smbversion"="smbversion"; "Krbd"="krbd"; "Delete"="delete"; "Fuse"="fuse"; "ContentDirs"="content-dirs"; "Port"="port"; "Mkdir"="mkdir"; "SaferemoveThroughput"="saferemove_throughput"; "Nodes"="nodes"; "Namespace"="namespace"; "Bwlimit"="bwlimit"; "Nocow"="nocow"; "Content"="content"; "IsMountpoint"="is_mountpoint"; "Fingerprint"="fingerprint"; "Domain"="domain"; "Format"="format"; "Keyring"="keyring"; "Subdir"="subdir"; "Password"="password"; "Blocksize"="blocksize"; "Shared"="shared"; "FsName"="fs-name"; "MaxProtectedBackups"="max-protected-backups"; "Options"="options"; "Transport"="transport"; "MasterPubkey"="master-pubkey"; "Pool"="pool"; "Mountpoint"="mountpoint"; "Preallocation"="preallocation"; "CreateSubdirs"="create-subdirs"; "PruneBackups"="prune-backups"; "Digest"="digest"; "Server"="server"; "LioTpg"="lio_tpg"; "Maxfiles"="maxfiles"; "Monhost"="monhost"; "CreateBasePath"="create-base-path"
        }
...
function ConvertFrom-PVEJsonToPUTStorageRB {
    ...
    Process {
        ...
        $AllProperties = ("server2", "data-pool", "nowritecache", "username", "encryption-key", "storage", "sparse", "comstar_tg", "skip-cert-verification", "comstar_hg", "tagged_only", "disable", "saferemove", "smbversion", "krbd", "delete", "fuse", "content-dirs", "port", "mkdir", "saferemove_throughput", "nodes", "namespace", "bwlimit", "nocow", "content", "is_mountpoint", "fingerprint", "domain", "format", "keyring", "subdir", "password", "blocksize", "shared", "fs-name", "max-protected-backups", "options", "transport", "master-pubkey", "pool", "mountpoint", "preallocation", "create-subdirs", "prune-backups", "digest", "server", "lio_tpg", "maxfiles", "monhost", "create-base-path")
