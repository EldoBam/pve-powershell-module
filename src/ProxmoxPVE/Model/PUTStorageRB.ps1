...
function Initialize-PVEPUTStorageRB {
    ...
    Process {
        ...
        if ($Sparse -and $Sparse -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Password"="password"; "PruneBackups"="prune-backups"; "Blocksize"="blocksize"; "Transport"="transport"; "Saferemove"="saferemove"; "SkipCertVerification"="skip-cert-verification"; "LioTpg"="lio_tpg"; "CreateBasePath"="create-base-path"; "Nodes"="nodes"; "Krbd"="krbd"; "Fuse"="fuse"; "Subdir"="subdir"; "Content"="content"; "FsName"="fs-name"; "TaggedOnly"="tagged_only"; "DataPool"="data-pool"; "Fingerprint"="fingerprint"; "Pool"="pool"; "SaferemoveThroughput"="saferemove_throughput"; "Preallocation"="preallocation"; "Delete"="delete"; "EncryptionKey"="encryption-key"; "Port"="port"; "Monhost"="monhost"; "Namespace"="namespace"; "Smbversion"="smbversion"; "MaxProtectedBackups"="max-protected-backups"; "IsMountpoint"="is_mountpoint"; "Disable"="disable"; "Username"="username"; "MasterPubkey"="master-pubkey"; "Nocow"="nocow"; "Nowritecache"="nowritecache"; "Mkdir"="mkdir"; "ComstarHg"="comstar_hg"; "Server2"="server2"; "Maxfiles"="maxfiles"; "Server"="server"; "Digest"="digest"; "Mountpoint"="mountpoint"; "Domain"="domain"; "Keyring"="keyring"; "ComstarTg"="comstar_tg"; "Bwlimit"="bwlimit"; "Options"="options"; "Format"="format"; "CreateSubdirs"="create-subdirs"; "Storage"="storage"; "Shared"="shared"; "Sparse"="sparse"; "ContentDirs"="content-dirs"
        }
...
function ConvertFrom-PVEJsonToPUTStorageRB {
    ...
    Process {
        ...
        $AllProperties = ("password", "prune-backups", "blocksize", "transport", "saferemove", "skip-cert-verification", "lio_tpg", "create-base-path", "nodes", "krbd", "fuse", "subdir", "content", "fs-name", "tagged_only", "data-pool", "fingerprint", "pool", "saferemove_throughput", "preallocation", "delete", "encryption-key", "port", "monhost", "namespace", "smbversion", "max-protected-backups", "is_mountpoint", "disable", "username", "master-pubkey", "nocow", "nowritecache", "mkdir", "comstar_hg", "server2", "maxfiles", "server", "digest", "mountpoint", "domain", "keyring", "comstar_tg", "bwlimit", "options", "format", "create-subdirs", "storage", "shared", "sparse", "content-dirs")
