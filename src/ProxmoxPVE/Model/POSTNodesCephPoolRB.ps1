...
function Initialize-PVEPOSTNodesCephPoolRB {
    ...
    Process {
        ...
        if ($MinSize -and $MinSize -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"PgNum"="pg_num"; "PgAutoscaleMode"="pg_autoscale_mode"; "TargetSizeRatio"="target_size_ratio"; "Size"="size"; "AddStorages"="add_storages"; "CrushRule"="crush_rule"; "Name"="name"; "TargetSize"="target_size"; "PgNumMin"="pg_num_min"; "MinSize"="min_size"; "Application"="application"; "ErasureCoding"="erasure-coding"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesCephPoolRB {
    ...
    Process {
        ...
        $AllProperties = ("pg_num", "pg_autoscale_mode", "target_size_ratio", "size", "add_storages", "crush_rule", "name", "target_size", "pg_num_min", "min_size", "application", "erasure-coding")
