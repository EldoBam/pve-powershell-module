...
function Initialize-PVEPOSTNodesCephPoolRB {
    ...
    Process {
        ...
        if ($MinSize -and $MinSize -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"AddStorages"="add_storages"; "PgNumMin"="pg_num_min"; "PgAutoscaleMode"="pg_autoscale_mode"; "Name"="name"; "Size"="size"; "CrushRule"="crush_rule"; "ErasureCoding"="erasure-coding"; "Application"="application"; "PgNum"="pg_num"; "TargetSize"="target_size"; "TargetSizeRatio"="target_size_ratio"; "MinSize"="min_size"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesCephPoolRB {
    ...
    Process {
        ...
        $AllProperties = ("add_storages", "pg_num_min", "pg_autoscale_mode", "name", "size", "crush_rule", "erasure-coding", "application", "pg_num", "target_size", "target_size_ratio", "min_size")
