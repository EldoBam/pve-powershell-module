...
function Initialize-PVEClusterHaResources {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"MaxRelocate"="max_relocate"; "Group"="group"; "Type"="type"; "MaxRestart"="max_restart"; "Comment"="comment"; "Sid"="sid"; "Failback"="failback"; "Digest"="digest"; "State"="state"
        }
...
function ConvertFrom-PVEJsonToClusterHaResources {
    ...
    Process {
        ...
        $AllProperties = ("max_relocate", "group", "type", "max_restart", "comment", "sid", "failback", "digest", "state")
