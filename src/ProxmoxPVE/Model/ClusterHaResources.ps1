...
function Initialize-PVEClusterHaResources {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"MaxRestart"="max_restart"; "MaxRelocate"="max_relocate"; "Comment"="comment"; "Type"="type"; "Group"="group"; "State"="state"; "Digest"="digest"; "Sid"="sid"; "Failback"="failback"
        }
...
function ConvertFrom-PVEJsonToClusterHaResources {
    ...
    Process {
        ...
        $AllProperties = ("max_restart", "max_relocate", "comment", "type", "group", "state", "digest", "sid", "failback")
