...
function Initialize-PVEClusterHaResources {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Type"="type"; "MaxRestart"="max_restart"; "State"="state"; "Group"="group"; "MaxRelocate"="max_relocate"; "Comment"="comment"; "Sid"="sid"; "Digest"="digest"
        }
...
function ConvertFrom-PVEJsonToClusterHaResources {
    ...
    Process {
        ...
        $AllProperties = ("type", "max_restart", "state", "group", "max_relocate", "comment", "sid", "digest")
