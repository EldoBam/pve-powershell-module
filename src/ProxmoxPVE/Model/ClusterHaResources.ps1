...
function Initialize-PVEClusterHaResources {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Digest"="digest"; "Type"="type"; "Group"="group"; "Sid"="sid"; "State"="state"; "MaxRelocate"="max_relocate"; "Comment"="comment"; "MaxRestart"="max_restart"
        }
...
function ConvertFrom-PVEJsonToClusterHaResources {
    ...
    Process {
        ...
        $AllProperties = ("digest", "type", "group", "sid", "state", "max_relocate", "comment", "max_restart")
