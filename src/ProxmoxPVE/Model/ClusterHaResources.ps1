...
function Initialize-PVEClusterHaResources {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"MaxRelocate"="max_relocate"; "MaxRestart"="max_restart"; "Group"="group"; "Type"="type"; "Digest"="digest"; "Sid"="sid"; "State"="state"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToClusterHaResources {
    ...
    Process {
        ...
        $AllProperties = ("max_relocate", "max_restart", "group", "type", "digest", "sid", "state", "comment")
