...
function Initialize-PVEAccessTicket {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Username"="username"; "Clustername"="clustername"; "CSRFPreventionToken"="CSRFPreventionToken"; "Ticket"="ticket"
        }
...
function ConvertFrom-PVEJsonToAccessTicket {
    ...
    Process {
        ...
        $AllProperties = ("username", "clustername", "CSRFPreventionToken", "ticket")
