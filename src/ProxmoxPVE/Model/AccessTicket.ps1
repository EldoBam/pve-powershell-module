...
function Initialize-PVEAccessTicket {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Username"="username"; "CSRFPreventionToken"="CSRFPreventionToken"; "Ticket"="ticket"; "Clustername"="clustername"
        }
...
function ConvertFrom-PVEJsonToAccessTicket {
    ...
    Process {
        ...
        $AllProperties = ("username", "CSRFPreventionToken", "ticket", "clustername")
