...
function Initialize-PVEAccessTicket {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Clustername"="clustername"; "CSRFPreventionToken"="CSRFPreventionToken"; "Username"="username"; "Ticket"="ticket"
        }
...
function ConvertFrom-PVEJsonToAccessTicket {
    ...
    Process {
        ...
        $AllProperties = ("clustername", "CSRFPreventionToken", "username", "ticket")
