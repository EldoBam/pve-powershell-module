...
ClusterReplicationGETInner<PSCustomObject>
#>

function Initialize-PVEClusterReplicationGETInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ProxmoxPVE => PVEClusterReplicationGETInner' | Write-Debug
        ...
        if ($Rate -and $Rate -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Schedule"="schedule"; "Jobnum"="jobnum"; "Id"="id"; "Comment"="comment"; "Type"="type"; "Source"="source"; "Target"="target"; "Rate"="rate"; "Guest"="guest"; "RemoveJob"="remove_job"; "Disable"="disable"
        }
...
Convert from JSON to ClusterReplicationGETInner<PSCustomObject>
...
ClusterReplicationGETInner<PSCustomObject>
#>
function ConvertFrom-PVEJsonToClusterReplicationGETInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ProxmoxPVE => PVEClusterReplicationGETInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PVEClusterReplicationGETInner
        $AllProperties = ("schedule", "jobnum", "id", "comment", "type", "source", "target", "rate", "guest", "remove_job", "disable")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "jobnum"))) { #optional property not found
            $Jobnum = $null
        } else {
            $Jobnum = $JsonParameters.PSobject.Properties["jobnum"].value
        }
