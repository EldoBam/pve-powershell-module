...
function Initialize-PVEPUTClusterMetricsServerRB {
    ...
    Process {
        ...
        if ($MaxBodySize -and $MaxBodySize -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Path"="path"; "Bucket"="bucket"; "Organization"="organization"; "Port"="port"; "Disable"="disable"; "Influxdbproto"="influxdbproto"; "Server"="server"; "Mtu"="mtu"; "VerifyCertificate"="verify-certificate"; "Delete"="delete"; "Token"="token"; "Id"="id"; "Timeout"="timeout"; "Proto"="proto"; "ApiPathPrefix"="api-path-prefix"; "Digest"="digest"; "MaxBodySize"="max-body-size"
        }
...
function ConvertFrom-PVEJsonToPUTClusterMetricsServerRB {
    ...
    Process {
        ...
        $AllProperties = ("path", "bucket", "organization", "port", "disable", "influxdbproto", "server", "mtu", "verify-certificate", "delete", "token", "id", "timeout", "proto", "api-path-prefix", "digest", "max-body-size")
