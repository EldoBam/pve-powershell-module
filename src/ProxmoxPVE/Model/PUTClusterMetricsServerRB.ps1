...
function Initialize-PVEPUTClusterMetricsServerRB {
    ...
    Process {
        ...
        if ($Mtu -and $Mtu -lt 512) {
		 ...
		 $DisplayNameMapping =@{
			"ApiPathPrefix"="api-path-prefix"; "Timeout"="timeout"; "Port"="port"; "Proto"="proto"; "Organization"="organization"; "VerifyCertificate"="verify-certificate"; "Digest"="digest"; "MaxBodySize"="max-body-size"; "Bucket"="bucket"; "Influxdbproto"="influxdbproto"; "Path"="path"; "Server"="server"; "Delete"="delete"; "Disable"="disable"; "Mtu"="mtu"; "Token"="token"
        }
...
function ConvertFrom-PVEJsonToPUTClusterMetricsServerRB {
    ...
    Process {
        ...
        $AllProperties = ("api-path-prefix", "timeout", "port", "proto", "organization", "verify-certificate", "digest", "max-body-size", "bucket", "influxdbproto", "path", "server", "delete", "disable", "mtu", "token")
