...
function Initialize-PVEPUTClusterSdnControllersRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Asn"="asn"; "Delete"="delete"; "IsisIfaces"="isis-ifaces"; "Loopback"="loopback"; "Ebgp"="ebgp"; "EbgpMultihop"="ebgp-multihop"; "Node"="node"; "IsisDomain"="isis-domain"; "Digest"="digest"; "Peers"="peers"; "BgpMultipathAsPathRelax"="bgp-multipath-as-path-relax"; "IsisNet"="isis-net"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnControllersRB {
    ...
    Process {
        ...
        $AllProperties = ("asn", "delete", "isis-ifaces", "loopback", "ebgp", "ebgp-multihop", "node", "isis-domain", "digest", "peers", "bgp-multipath-as-path-relax", "isis-net")
