...
function Initialize-PVEPUTClusterSdnControllersRB {
    ...
    Process {
        ...
        if ($Asn -and $Asn -gt 4294967296) {
		 ...
		 $DisplayNameMapping =@{
			"Digest"="digest"; "Loopback"="loopback"; "Peers"="peers"; "Ebgp"="ebgp"; "Node"="node"; "Delete"="delete"; "BgpMultipathAsPathRelax"="bgp-multipath-as-path-relax"; "EbgpMultihop"="ebgp-multihop"; "IsisNet"="isis-net"; "Asn"="asn"; "IsisIfaces"="isis-ifaces"; "IsisDomain"="isis-domain"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnControllersRB {
    ...
    Process {
        ...
        $AllProperties = ("digest", "loopback", "peers", "ebgp", "node", "delete", "bgp-multipath-as-path-relax", "ebgp-multihop", "isis-net", "asn", "isis-ifaces", "isis-domain")
