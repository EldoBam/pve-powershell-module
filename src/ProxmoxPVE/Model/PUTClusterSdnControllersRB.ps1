...
function Initialize-PVEPUTClusterSdnControllersRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"IsisIfaces"="isis-ifaces"; "EbgpMultihop"="ebgp-multihop"; "IsisDomain"="isis-domain"; "IsisNet"="isis-net"; "Peers"="peers"; "Asn"="asn"; "BgpMultipathAsPathRelax"="bgp-multipath-as-path-relax"; "Delete"="delete"; "Ebgp"="ebgp"; "Digest"="digest"; "LockToken"="lock-token"; "Node"="node"; "Loopback"="loopback"; "Fabric"="fabric"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnControllersRB {
    ...
    Process {
        ...
        $AllProperties = ("isis-ifaces", "ebgp-multihop", "isis-domain", "isis-net", "peers", "asn", "bgp-multipath-as-path-relax", "delete", "ebgp", "digest", "lock-token", "node", "loopback", "fabric")
