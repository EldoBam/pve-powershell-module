...
function Initialize-PVEPUTAccessDomainsRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"QueryUserinfo"="query-userinfo"; "ClientId"="client-id"; "Mode"="mode"; "Port"="port"; "GroupsClaim"="groups-claim"; "GroupFilter"="group_filter"; "GroupsAutocreate"="groups-autocreate"; "UserAttr"="user_attr"; "GroupDn"="group_dn"; "Cert"="cert"; "Scopes"="scopes"; "CheckConnection"="check-connection"; "BindDn"="bind_dn"; "SyncAttributes"="sync_attributes"; "Secure"="secure"; "Server1"="server1"; "Default"="default"; "Capath"="capath"; "Domain"="domain"; "Certkey"="certkey"; "Password"="password"; "VarFilter"="filter"; "ClientKey"="client-key"; "Server2"="server2"; "Autocreate"="autocreate"; "SyncDefaultsOptions"="sync-defaults-options"; "AcrValues"="acr-values"; "GroupNameAttr"="group_name_attr"; "IssuerUrl"="issuer-url"; "GroupsOverwrite"="groups-overwrite"; "UserClasses"="user_classes"; "Tfa"="tfa"; "Delete"="delete"; "GroupClasses"="group_classes"; "Verify"="verify"; "BaseDn"="base_dn"; "Sslversion"="sslversion"; "Comment"="comment"; "Digest"="digest"; "CaseSensitive"="case-sensitive"; "Prompt"="prompt"
        }
...
function ConvertFrom-PVEJsonToPUTAccessDomainsRB {
    ...
    Process {
        ...
        $AllProperties = ("query-userinfo", "client-id", "mode", "port", "groups-claim", "group_filter", "groups-autocreate", "user_attr", "group_dn", "cert", "scopes", "check-connection", "bind_dn", "sync_attributes", "secure", "server1", "default", "capath", "domain", "certkey", "password", "filter", "client-key", "server2", "autocreate", "sync-defaults-options", "acr-values", "group_name_attr", "issuer-url", "groups-overwrite", "user_classes", "tfa", "delete", "group_classes", "verify", "base_dn", "sslversion", "comment", "digest", "case-sensitive", "prompt")
