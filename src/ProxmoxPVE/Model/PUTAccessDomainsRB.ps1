...
function Initialize-PVEPUTAccessDomainsRB {
    ...
    Process {
        ...
        if (!$ClientKey -and $ClientKey.length -gt 256) {
		 ...
		 $DisplayNameMapping =@{
			"BaseDn"="base_dn"; "Digest"="digest"; "GroupClasses"="group_classes"; "AcrValues"="acr-values"; "CaseSensitive"="case-sensitive"; "Tfa"="tfa"; "VarFilter"="filter"; "SyncDefaultsOptions"="sync-defaults-options"; "UserAttr"="user_attr"; "Comment"="comment"; "CheckConnection"="check-connection"; "Port"="port"; "GroupsOverwrite"="groups-overwrite"; "Server1"="server1"; "Autocreate"="autocreate"; "Default"="default"; "GroupNameAttr"="group_name_attr"; "QueryUserinfo"="query-userinfo"; "ClientId"="client-id"; "Domain"="domain"; "GroupsAutocreate"="groups-autocreate"; "SyncAttributes"="sync_attributes"; "BindDn"="bind_dn"; "Mode"="mode"; "Capath"="capath"; "IssuerUrl"="issuer-url"; "GroupsClaim"="groups-claim"; "Password"="password"; "GroupDn"="group_dn"; "Prompt"="prompt"; "Secure"="secure"; "UserClasses"="user_classes"; "Cert"="cert"; "Scopes"="scopes"; "Verify"="verify"; "Delete"="delete"; "Certkey"="certkey"; "Server2"="server2"; "GroupFilter"="group_filter"; "ClientKey"="client-key"; "Sslversion"="sslversion"
        }
...
function ConvertFrom-PVEJsonToPUTAccessDomainsRB {
    ...
    Process {
        ...
        $AllProperties = ("base_dn", "digest", "group_classes", "acr-values", "case-sensitive", "tfa", "filter", "sync-defaults-options", "user_attr", "comment", "check-connection", "port", "groups-overwrite", "server1", "autocreate", "default", "group_name_attr", "query-userinfo", "client-id", "domain", "groups-autocreate", "sync_attributes", "bind_dn", "mode", "capath", "issuer-url", "groups-claim", "password", "group_dn", "prompt", "secure", "user_classes", "cert", "scopes", "verify", "delete", "certkey", "server2", "group_filter", "client-key", "sslversion")
