...
function Initialize-PVEPUTAccessDomainsRB {
    ...
    Process {
        ...
        if (!$Domain -and $Domain.length -gt 256) {
		 ...
		 $DisplayNameMapping =@{
			"BindDn"="bind_dn"; "SyncDefaultsOptions"="sync-defaults-options"; "ClientKey"="client-key"; "Comment"="comment"; "Mode"="mode"; "Autocreate"="autocreate"; "Password"="password"; "Digest"="digest"; "Port"="port"; "ClientId"="client-id"; "Server2"="server2"; "Sslversion"="sslversion"; "Certkey"="certkey"; "Default"="default"; "Secure"="secure"; "GroupNameAttr"="group_name_attr"; "Delete"="delete"; "GroupsClaim"="groups-claim"; "GroupsOverwrite"="groups-overwrite"; "Capath"="capath"; "Cert"="cert"; "QueryUserinfo"="query-userinfo"; "CheckConnection"="check-connection"; "IssuerUrl"="issuer-url"; "UserAttr"="user_attr"; "GroupDn"="group_dn"; "GroupFilter"="group_filter"; "UserClasses"="user_classes"; "Tfa"="tfa"; "Scopes"="scopes"; "AcrValues"="acr-values"; "Prompt"="prompt"; "VarFilter"="filter"; "SyncAttributes"="sync_attributes"; "GroupClasses"="group_classes"; "BaseDn"="base_dn"; "Server1"="server1"; "Verify"="verify"; "GroupsAutocreate"="groups-autocreate"; "Domain"="domain"; "CaseSensitive"="case-sensitive"
        }
...
function ConvertFrom-PVEJsonToPUTAccessDomainsRB {
    ...
    Process {
        ...
        $AllProperties = ("bind_dn", "sync-defaults-options", "client-key", "comment", "mode", "autocreate", "password", "digest", "port", "client-id", "server2", "sslversion", "certkey", "default", "secure", "group_name_attr", "delete", "groups-claim", "groups-overwrite", "capath", "cert", "query-userinfo", "check-connection", "issuer-url", "user_attr", "group_dn", "group_filter", "user_classes", "tfa", "scopes", "acr-values", "prompt", "filter", "sync_attributes", "group_classes", "base_dn", "server1", "verify", "groups-autocreate", "domain", "case-sensitive")
