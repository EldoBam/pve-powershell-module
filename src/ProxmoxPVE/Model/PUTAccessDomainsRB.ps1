...
function Initialize-PVEPUTAccessDomainsRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Domain"="domain"; "GroupFilter"="group_filter"; "Delete"="delete"; "GroupNameAttr"="group_name_attr"; "Certkey"="certkey"; "Prompt"="prompt"; "BaseDn"="base_dn"; "UserAttr"="user_attr"; "Autocreate"="autocreate"; "Mode"="mode"; "AcrValues"="acr-values"; "SyncAttributes"="sync_attributes"; "GroupsOverwrite"="groups-overwrite"; "QueryUserinfo"="query-userinfo"; "UserClasses"="user_classes"; "Default"="default"; "Server2"="server2"; "SyncDefaultsOptions"="sync-defaults-options"; "Sslversion"="sslversion"; "Port"="port"; "GroupClasses"="group_classes"; "Tfa"="tfa"; "Scopes"="scopes"; "Server1"="server1"; "Comment"="comment"; "CheckConnection"="check-connection"; "ClientKey"="client-key"; "VarFilter"="filter"; "GroupsAutocreate"="groups-autocreate"; "GroupDn"="group_dn"; "Cert"="cert"; "IssuerUrl"="issuer-url"; "Secure"="secure"; "GroupsClaim"="groups-claim"; "Capath"="capath"; "Verify"="verify"; "CaseSensitive"="case-sensitive"; "BindDn"="bind_dn"; "ClientId"="client-id"; "Password"="password"; "Digest"="digest"
        }
...
function ConvertFrom-PVEJsonToPUTAccessDomainsRB {
    ...
    Process {
        ...
        $AllProperties = ("domain", "group_filter", "delete", "group_name_attr", "certkey", "prompt", "base_dn", "user_attr", "autocreate", "mode", "acr-values", "sync_attributes", "groups-overwrite", "query-userinfo", "user_classes", "default", "server2", "sync-defaults-options", "sslversion", "port", "group_classes", "tfa", "scopes", "server1", "comment", "check-connection", "client-key", "filter", "groups-autocreate", "group_dn", "cert", "issuer-url", "secure", "groups-claim", "capath", "verify", "case-sensitive", "bind_dn", "client-id", "password", "digest")
