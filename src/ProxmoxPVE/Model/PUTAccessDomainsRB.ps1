...
function Initialize-PVEPUTAccessDomainsRB {
    ...
    Process {
        ...
        if (!$BindDn -and $BindDn.length -gt 256) {
		 ...
		 $DisplayNameMapping =@{
			"SyncDefaultsOptions"="sync-defaults-options"; "GroupFilter"="group_filter"; "Capath"="capath"; "VarFilter"="filter"; "ClientId"="client-id"; "Mode"="mode"; "Tfa"="tfa"; "SyncAttributes"="sync_attributes"; "Prompt"="prompt"; "Comment"="comment"; "CaseSensitive"="case-sensitive"; "GroupClasses"="group_classes"; "Server2"="server2"; "UserAttr"="user_attr"; "Delete"="delete"; "Sslversion"="sslversion"; "GroupDn"="group_dn"; "CheckConnection"="check-connection"; "Port"="port"; "Realm"="realm"; "Cert"="cert"; "Certkey"="certkey"; "IssuerUrl"="issuer-url"; "Default"="default"; "ClientKey"="client-key"; "BaseDn"="base_dn"; "GroupNameAttr"="group_name_attr"; "Secure"="secure"; "Verify"="verify"; "Autocreate"="autocreate"; "AcrValues"="acr-values"; "Digest"="digest"; "Domain"="domain"; "Password"="password"; "UserClasses"="user_classes"; "Server1"="server1"; "Scopes"="scopes"; "BindDn"="bind_dn"
        }
...
function ConvertFrom-PVEJsonToPUTAccessDomainsRB {
    ...
    Process {
        ...
        $AllProperties = ("sync-defaults-options", "group_filter", "capath", "filter", "client-id", "mode", "tfa", "sync_attributes", "prompt", "comment", "case-sensitive", "group_classes", "server2", "user_attr", "delete", "sslversion", "group_dn", "check-connection", "port", "realm", "cert", "certkey", "issuer-url", "default", "client-key", "base_dn", "group_name_attr", "secure", "verify", "autocreate", "acr-values", "digest", "domain", "password", "user_classes", "server1", "scopes", "bind_dn")
