...
function Initialize-PVEPUTAccessDomainsRB {
    ...
    Process {
        ...
        if (!$Tfa -and $Tfa.length -gt 128) {
		 ...
		 $DisplayNameMapping =@{
			"Secure"="secure"; "CheckConnection"="check-connection"; "BindDn"="bind_dn"; "Comment"="comment"; "Scopes"="scopes"; "Prompt"="prompt"; "Delete"="delete"; "Sslversion"="sslversion"; "GroupsClaim"="groups-claim"; "UserAttr"="user_attr"; "QueryUserinfo"="query-userinfo"; "GroupDn"="group_dn"; "CaseSensitive"="case-sensitive"; "GroupNameAttr"="group_name_attr"; "ClientId"="client-id"; "Verify"="verify"; "Cert"="cert"; "Certkey"="certkey"; "SyncAttributes"="sync_attributes"; "BaseDn"="base_dn"; "Domain"="domain"; "GroupClasses"="group_classes"; "GroupsOverwrite"="groups-overwrite"; "Digest"="digest"; "Mode"="mode"; "ClientKey"="client-key"; "Port"="port"; "Password"="password"; "IssuerUrl"="issuer-url"; "GroupFilter"="group_filter"; "UserClasses"="user_classes"; "Autocreate"="autocreate"; "Capath"="capath"; "VarFilter"="filter"; "SyncDefaultsOptions"="sync-defaults-options"; "Server2"="server2"; "AcrValues"="acr-values"; "Server1"="server1"; "Tfa"="tfa"; "Default"="default"; "GroupsAutocreate"="groups-autocreate"
        }
...
function ConvertFrom-PVEJsonToPUTAccessDomainsRB {
    ...
    Process {
        ...
        $AllProperties = ("secure", "check-connection", "bind_dn", "comment", "scopes", "prompt", "delete", "sslversion", "groups-claim", "user_attr", "query-userinfo", "group_dn", "case-sensitive", "group_name_attr", "client-id", "verify", "cert", "certkey", "sync_attributes", "base_dn", "domain", "group_classes", "groups-overwrite", "digest", "mode", "client-key", "port", "password", "issuer-url", "group_filter", "user_classes", "autocreate", "capath", "filter", "sync-defaults-options", "server2", "acr-values", "server1", "tfa", "default", "groups-autocreate")
