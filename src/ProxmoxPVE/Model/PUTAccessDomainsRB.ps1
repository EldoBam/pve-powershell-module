...
function Initialize-PVEPUTAccessDomainsRB {
    ...
    Process {
        ...
        if ($QueryUserinfo -and $QueryUserinfo -gt 1) {
          throw "invalid value for 'QueryUserinfo', must be smaller than or equal to 1."
        }

        if ($QueryUserinfo -and $QueryUserinfo -lt 0) {
          throw "invalid value for 'QueryUserinfo', must be greater than or equal to 0."
        }
        ...
        if ($GroupsAutocreate -and $GroupsAutocreate -gt 1) {
          throw "invalid value for 'GroupsAutocreate', must be smaller than or equal to 1."
        }

        if ($GroupsAutocreate -and $GroupsAutocreate -lt 0) {
          throw "invalid value for 'GroupsAutocreate', must be greater than or equal to 0."
        }
        ...
        if ($GroupsOverwrite -and $GroupsOverwrite -gt 1) {
          throw "invalid value for 'GroupsOverwrite', must be smaller than or equal to 1."
        }

        if ($GroupsOverwrite -and $GroupsOverwrite -lt 0) {
          throw "invalid value for 'GroupsOverwrite', must be greater than or equal to 0."
        }
        ...
        if (!$BindDn -and $BindDn.length -gt 256) {
		 ...
		 $DisplayNameMapping =@{
			"Server2"="server2"; "Cert"="cert"; "Server1"="server1"; "Realm"="realm"; "GroupNameAttr"="group_name_attr"; "Scopes"="scopes"; "Mode"="mode"; "Delete"="delete"; "Certkey"="certkey"; "AcrValues"="acr-values"; "IssuerUrl"="issuer-url"; "Default"="default"; "Prompt"="prompt"; "SyncAttributes"="sync_attributes"; "QueryUserinfo"="query-userinfo"; "CaseSensitive"="case-sensitive"; "Sslversion"="sslversion"; "ClientId"="client-id"; "GroupFilter"="group_filter"; "ClientKey"="client-key"; "Domain"="domain"; "Digest"="digest"; "BaseDn"="base_dn"; "GroupsAutocreate"="groups-autocreate"; "VarFilter"="filter"; "Autocreate"="autocreate"; "SyncDefaultsOptions"="sync-defaults-options"; "Verify"="verify"; "Secure"="secure"; "CheckConnection"="check-connection"; "UserAttr"="user_attr"; "UserClasses"="user_classes"; "GroupsClaim"="groups-claim"; "Password"="password"; "Port"="port"; "GroupClasses"="group_classes"; "Capath"="capath"; "Comment"="comment"; "GroupsOverwrite"="groups-overwrite"; "GroupDn"="group_dn"; "Tfa"="tfa"; "BindDn"="bind_dn"
        }
...
function ConvertFrom-PVEJsonToPUTAccessDomainsRB {
    ...
    Process {
        ...
        $AllProperties = ("server2", "cert", "server1", "realm", "group_name_attr", "scopes", "mode", "delete", "certkey", "acr-values", "issuer-url", "default", "prompt", "sync_attributes", "query-userinfo", "case-sensitive", "sslversion", "client-id", "group_filter", "client-key", "domain", "digest", "base_dn", "groups-autocreate", "filter", "autocreate", "sync-defaults-options", "verify", "secure", "check-connection", "user_attr", "user_classes", "groups-claim", "password", "port", "group_classes", "capath", "comment", "groups-overwrite", "group_dn", "tfa", "bind_dn")
