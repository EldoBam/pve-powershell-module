...
function Initialize-PVENodesCephMonInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"State"="state"; "VarHost"="host"; "Name"="name"; "CephVersionShort"="ceph_version_short"; "Addr"="addr"; "CephVersion"="ceph_version"; "Direxists"="direxists"; "Service"="service"; "Quorum"="quorum"; "Rank"="rank"
        }
...
function ConvertFrom-PVEJsonToNodesCephMonInner {
    ...
    Process {
        ...
        $AllProperties = ("state", "host", "name", "ceph_version_short", "addr", "ceph_version", "direxists", "service", "quorum", "rank")
