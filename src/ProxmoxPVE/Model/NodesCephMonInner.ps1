...
function Initialize-PVENodesCephMonInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Rank"="rank"; "Name"="name"; "CephVersionShort"="ceph_version_short"; "Direxists"="direxists"; "Service"="service"; "State"="state"; "VarHost"="host"; "Quorum"="quorum"; "Addr"="addr"; "CephVersion"="ceph_version"
        }
...
function ConvertFrom-PVEJsonToNodesCephMonInner {
    ...
    Process {
        ...
        $AllProperties = ("rank", "name", "ceph_version_short", "direxists", "service", "state", "host", "quorum", "addr", "ceph_version")
