...
function Initialize-PVENodesCephMonInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"CephVersionShort"="ceph_version_short"; "Direxists"="direxists"; "CephVersion"="ceph_version"; "State"="state"; "Name"="name"; "Service"="service"; "Addr"="addr"; "VarHost"="host"; "Rank"="rank"; "Quorum"="quorum"
        }
...
function ConvertFrom-PVEJsonToNodesCephMonInner {
    ...
    Process {
        ...
        $AllProperties = ("ceph_version_short", "direxists", "ceph_version", "state", "name", "service", "addr", "host", "rank", "quorum")
