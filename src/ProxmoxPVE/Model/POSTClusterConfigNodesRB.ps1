...
function Initialize-PVEPOSTClusterConfigNodesRB {
    ...
    Process {
        ...
        if ($Nodeid -and $Nodeid -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Votes"="votes"; "NewNodeIp"="new_node_ip"; "LinkN"="link[n]"; "Force"="force"; "Node"="node"; "Apiversion"="apiversion"; "Nodeid"="nodeid"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterConfigNodesRB {
    ...
    Process {
        ...
        $AllProperties = ("votes", "new_node_ip", "link[n]", "force", "node", "apiversion", "nodeid")
