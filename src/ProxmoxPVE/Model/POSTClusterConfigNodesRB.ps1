...
function Initialize-PVEPOSTClusterConfigNodesRB {
    ...
    Process {
        ...
        if ($Nodeid -and $Nodeid -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Apiversion"="apiversion"; "NewNodeIp"="new_node_ip"; "Force"="force"; "Votes"="votes"; "LinkN"="link[n]"; "Nodeid"="nodeid"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterConfigNodesRB {
    ...
    Process {
        ...
        $AllProperties = ("apiversion", "new_node_ip", "force", "votes", "link[n]", "nodeid")
