...
function Initialize-PVEPOSTClusterConfigNodesRB {
    ...
    Process {
        ...
        if ($Nodeid -and $Nodeid -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Apiversion"="apiversion"; "Nodeid"="nodeid"; "LinkN"="link[n]"; "Force"="force"; "Votes"="votes"; "NewNodeIp"="new_node_ip"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterConfigNodesRB {
    ...
    Process {
        ...
        $AllProperties = ("apiversion", "nodeid", "link[n]", "force", "votes", "new_node_ip")
