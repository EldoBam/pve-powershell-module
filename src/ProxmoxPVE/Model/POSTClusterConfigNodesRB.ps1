...
function Initialize-PVEPOSTClusterConfigNodesRB {
    ...
    Process {
        ...
        if ($Nodeid -and $Nodeid -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Apiversion"="apiversion"; "Force"="force"; "Nodeid"="nodeid"; "NewNodeIp"="new_node_ip"; "Votes"="votes"; "LinkN"="link[n]"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterConfigNodesRB {
    ...
    Process {
        ...
        $AllProperties = ("apiversion", "force", "nodeid", "new_node_ip", "votes", "link[n]")
