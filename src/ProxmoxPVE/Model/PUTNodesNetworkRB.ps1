...
function Initialize-PVEPUTNodesNetworkRB {
    ...
    Process {
        ...
        if ($Netmask6 -and $Netmask6 -gt 128) {
		 ...
		 $DisplayNameMapping =@{
			"Address6"="address6"; "BondPrimary"="bond-primary"; "Netmask"="netmask"; "Gateway"="gateway"; "Type"="type"; "OvsTag"="ovs_tag"; "Mtu"="mtu"; "OvsOptions"="ovs_options"; "Cidr6"="cidr6"; "BridgePorts"="bridge_ports"; "OvsBonds"="ovs_bonds"; "Gateway6"="gateway6"; "Comments"="comments"; "Autostart"="autostart"; "OvsPorts"="ovs_ports"; "BondXmitHashPolicy"="bond_xmit_hash_policy"; "OvsBridge"="ovs_bridge"; "BridgeVlanAware"="bridge_vlan_aware"; "Comments6"="comments6"; "VlanRawDevice"="vlan-raw-device"; "VlanId"="vlan-id"; "Netmask6"="netmask6"; "Cidr"="cidr"; "Delete"="delete"; "Slaves"="slaves"; "BridgeVids"="bridge_vids"; "Address"="address"; "BondMode"="bond_mode"
        }
...
function ConvertFrom-PVEJsonToPUTNodesNetworkRB {
    ...
    Process {
        ...
        $AllProperties = ("address6", "bond-primary", "netmask", "gateway", "type", "ovs_tag", "mtu", "ovs_options", "cidr6", "bridge_ports", "ovs_bonds", "gateway6", "comments", "autostart", "ovs_ports", "bond_xmit_hash_policy", "ovs_bridge", "bridge_vlan_aware", "comments6", "vlan-raw-device", "vlan-id", "netmask6", "cidr", "delete", "slaves", "bridge_vids", "address", "bond_mode")
