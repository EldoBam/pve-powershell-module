...
function Initialize-PVEPUTNodesNetworkRB {
    ...
    Process {
        ...
        if ($Netmask6 -and $Netmask6 -gt 128) {
		 ...
		 $DisplayNameMapping =@{
			"VlanId"="vlan-id"; "OvsBonds"="ovs_bonds"; "OvsOptions"="ovs_options"; "Delete"="delete"; "OvsBridge"="ovs_bridge"; "BridgeVids"="bridge_vids"; "Cidr"="cidr"; "OvsPorts"="ovs_ports"; "Slaves"="slaves"; "Mtu"="mtu"; "BondMode"="bond_mode"; "Netmask"="netmask"; "OvsTag"="ovs_tag"; "BridgePorts"="bridge_ports"; "Gateway"="gateway"; "Comments"="comments"; "Netmask6"="netmask6"; "VlanRawDevice"="vlan-raw-device"; "Comments6"="comments6"; "Cidr6"="cidr6"; "Address"="address"; "BondXmitHashPolicy"="bond_xmit_hash_policy"; "Autostart"="autostart"; "Gateway6"="gateway6"; "Type"="type"; "BondPrimary"="bond-primary"; "Address6"="address6"; "BridgeVlanAware"="bridge_vlan_aware"
        }
...
function ConvertFrom-PVEJsonToPUTNodesNetworkRB {
    ...
    Process {
        ...
        $AllProperties = ("vlan-id", "ovs_bonds", "ovs_options", "delete", "ovs_bridge", "bridge_vids", "cidr", "ovs_ports", "slaves", "mtu", "bond_mode", "netmask", "ovs_tag", "bridge_ports", "gateway", "comments", "netmask6", "vlan-raw-device", "comments6", "cidr6", "address", "bond_xmit_hash_policy", "autostart", "gateway6", "type", "bond-primary", "address6", "bridge_vlan_aware")
