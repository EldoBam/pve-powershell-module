...
function Initialize-PVEPUTNodesNetworkRB {
    ...
    Process {
        ...
        if ($Autostart -and $Autostart -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Mtu"="mtu"; "Address6"="address6"; "BondPrimary"="bond-primary"; "OvsBridge"="ovs_bridge"; "Node"="node"; "BondMode"="bond_mode"; "Comments6"="comments6"; "Iface"="iface"; "BridgeVids"="bridge_vids"; "Slaves"="slaves"; "Netmask"="netmask"; "Type"="type"; "OvsPorts"="ovs_ports"; "Address"="address"; "Cidr"="cidr"; "Comments"="comments"; "Cidr6"="cidr6"; "VlanRawDevice"="vlan-raw-device"; "Netmask6"="netmask6"; "Gateway"="gateway"; "BridgeVlanAware"="bridge_vlan_aware"; "OvsTag"="ovs_tag"; "OvsBonds"="ovs_bonds"; "BondXmitHashPolicy"="bond_xmit_hash_policy"; "OvsOptions"="ovs_options"; "Delete"="delete"; "BridgePorts"="bridge_ports"; "VlanId"="vlan-id"; "Gateway6"="gateway6"; "Autostart"="autostart"
        }
...
function ConvertFrom-PVEJsonToPUTNodesNetworkRB {
    ...
    Process {
        ...
        $AllProperties = ("mtu", "address6", "bond-primary", "ovs_bridge", "node", "bond_mode", "comments6", "iface", "bridge_vids", "slaves", "netmask", "type", "ovs_ports", "address", "cidr", "comments", "cidr6", "vlan-raw-device", "netmask6", "gateway", "bridge_vlan_aware", "ovs_tag", "ovs_bonds", "bond_xmit_hash_policy", "ovs_options", "delete", "bridge_ports", "vlan-id", "gateway6", "autostart")
