...
function Initialize-PVEPUTNodesNetworkRB {
    ...
    Process {
        ...
        if (!$OvsOptions -and $OvsOptions.length -gt 1024) {
		 ...
		 $DisplayNameMapping =@{
			"BridgeVlanAware"="bridge_vlan_aware"; "BondMode"="bond_mode"; "BondPrimary"="bond-primary"; "Gateway6"="gateway6"; "Address"="address"; "OvsPorts"="ovs_ports"; "Netmask"="netmask"; "Autostart"="autostart"; "Node"="node"; "Delete"="delete"; "VlanRawDevice"="vlan-raw-device"; "BridgeVids"="bridge_vids"; "Iface"="iface"; "BondXmitHashPolicy"="bond_xmit_hash_policy"; "Type"="type"; "Gateway"="gateway"; "Cidr"="cidr"; "Slaves"="slaves"; "OvsBridge"="ovs_bridge"; "OvsBonds"="ovs_bonds"; "Mtu"="mtu"; "Comments6"="comments6"; "Comments"="comments"; "OvsTag"="ovs_tag"; "Address6"="address6"; "VlanId"="vlan-id"; "Cidr6"="cidr6"; "Netmask6"="netmask6"; "BridgePorts"="bridge_ports"; "OvsOptions"="ovs_options"
        }
...
function ConvertFrom-PVEJsonToPUTNodesNetworkRB {
    ...
    Process {
        ...
        $AllProperties = ("bridge_vlan_aware", "bond_mode", "bond-primary", "gateway6", "address", "ovs_ports", "netmask", "autostart", "node", "delete", "vlan-raw-device", "bridge_vids", "iface", "bond_xmit_hash_policy", "type", "gateway", "cidr", "slaves", "ovs_bridge", "ovs_bonds", "mtu", "comments6", "comments", "ovs_tag", "address6", "vlan-id", "cidr6", "netmask6", "bridge_ports", "ovs_options")
