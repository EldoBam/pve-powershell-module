...
function ConvertFrom-PVEJsonToPUTNodesNetworkRB {
    ...
    Process {
        ...
        $AllProperties = ("iface", "ovs_tag", "bridge_ports", "netmask6", "gateway6", "ovs_ports", "vlan-raw-device", "slaves", "bridge_vlan_aware", "comments6", "mtu", "bond_xmit_hash_policy", "node", "gateway", "comments", "cidr6", "bond_mode", "vlan-id", "ovs_bridge", "bridge_vids", "netmask", "address", "bond-primary", "ovs_options", "delete", "autostart", "ovs_bonds", "cidr", "type", "address6")
