...
function Initialize-PVEPOSTAccessTfaRB {
    ...
    Process {
        ...
        if (!$Description -and $Description.length -gt 255) {
		 ...
		 $DisplayNameMapping =@{
			"Challenge"="challenge"; "Password"="password"; "Type"="type"; "Value"="value"; "Description"="description"; "Totp"="totp"
        }
...
function ConvertFrom-PVEJsonToPOSTAccessTfaRB {
    ...
    Process {
        ...
        $AllProperties = ("challenge", "password", "type", "value", "description", "totp")
