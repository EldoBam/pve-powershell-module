...
function Initialize-PVEPOSTAccessTfaRB {
    ...
    Process {
        ...
        if (!$Description -and $Description.length -gt 255) {
		 ...
		 $DisplayNameMapping =@{
			"Challenge"="challenge"; "Password"="password"; "Description"="description"; "Totp"="totp"; "Type"="type"; "Value"="value"
        }
...
function ConvertFrom-PVEJsonToPOSTAccessTfaRB {
    ...
    Process {
        ...
        $AllProperties = ("challenge", "password", "description", "totp", "type", "value")
