...
function Initialize-PVEPOSTAccessTfaRB {
    ...
    Process {
        ...
        if (!$Description -and $Description.length -gt 255) {
		 ...
		 $DisplayNameMapping =@{
			"Challenge"="challenge"; "Userid"="userid"; "Password"="password"; "Type"="type"; "Totp"="totp"; "Value"="value"; "Description"="description"
        }
...
function ConvertFrom-PVEJsonToPOSTAccessTfaRB {
    ...
    Process {
        ...
        $AllProperties = ("challenge", "userid", "password", "type", "totp", "value", "description")
