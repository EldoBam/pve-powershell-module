...
function Initialize-PVEPOSTAccessTfaRB {
    ...
    Process {
        ...
        if (!$Description -and $Description.length -gt 255) {
		 ...
		 $DisplayNameMapping =@{
			"Value"="value"; "Password"="password"; "Type"="type"; "Totp"="totp"; "Challenge"="challenge"; "Description"="description"
        }
...
function ConvertFrom-PVEJsonToPOSTAccessTfaRB {
    ...
    Process {
        ...
        $AllProperties = ("value", "password", "type", "totp", "challenge", "description")
