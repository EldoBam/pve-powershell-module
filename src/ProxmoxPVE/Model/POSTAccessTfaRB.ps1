...
function Initialize-PVEPOSTAccessTfaRB {
    ...
    Process {
        ...
        if (!$Description -and $Description.length -gt 255) {
		 ...
		 $DisplayNameMapping =@{
			"Password"="password"; "Type"="type"; "Value"="value"; "Totp"="totp"; "Description"="description"; "Challenge"="challenge"
        }
...
function ConvertFrom-PVEJsonToPOSTAccessTfaRB {
    ...
    Process {
        ...
        $AllProperties = ("password", "type", "value", "totp", "description", "challenge")
