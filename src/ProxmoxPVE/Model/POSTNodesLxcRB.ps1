...
function Initialize-PVEPOSTNodesLxcRB {
    ...
    Process {
        ...
        if ($Restore -and $Restore -gt 1) {
          throw "invalid value for 'Restore', must be smaller than or equal to 1."
        }

        if ($Restore -and $Restore -lt 0) {
        ...
        if ($Cpuunits -and $Cpuunits -gt 500000) {
		 ...
		 $DisplayNameMapping =@{
			"Startup"="startup"; "Tags"="tags"; "Restore"="restore"; "Nameserver"="nameserver"; "Timezone"="timezone"; "Swap"="swap"; "Ostype"="ostype"; "Unique"="unique"; "Debug"="debug"; "Force"="force"; "UnusedN"="unused[n]"; "IgnoreUnpackErrors"="ignore-unpack-errors"; "Cpulimit"="cpulimit"; "Tty"="tty"; "Pool"="pool"; "Cmode"="cmode"; "Template"="template"; "Hookscript"="hookscript"; "Ostemplate"="ostemplate"; "Start"="start"; "NetN"="net[n]"; "Storage"="storage"; "Description"="description"; "MpN"="mp[n]"; "Searchdomain"="searchdomain"; "Hostname"="hostname"; "Arch"="arch"; "Onboot"="onboot"; "Cores"="cores"; "Lock"="lock"; "SshPublicKeys"="ssh-public-keys"; "Vmid"="vmid"; "Memory"="memory"; "Features"="features"; "Password"="password"; "Unprivileged"="unprivileged"; "Bwlimit"="bwlimit"; "Console"="console"; "DevN"="dev[n]"; "Node"="node"; "Rootfs"="rootfs"; "Protection"="protection"; "Cpuunits"="cpuunits"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesLxcRB {
    ...
    Process {
        ...
        $AllProperties = ("startup", "tags", "restore", "nameserver", "timezone", "swap", "ostype", "unique", "debug", "force", "unused[n]", "ignore-unpack-errors", "cpulimit", "tty", "pool", "cmode", "template", "hookscript", "ostemplate", "start", "net[n]", "storage", "description", "mp[n]", "searchdomain", "hostname", "arch", "onboot", "cores", "lock", "ssh-public-keys", "vmid", "memory", "features", "password", "unprivileged", "bwlimit", "console", "dev[n]", "node", "rootfs", "protection", "cpuunits")
