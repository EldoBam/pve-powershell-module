...
function Initialize-PVEPOSTNodesLxcRB {
    ...
    Process {
        ...
        if ($Cores -and $Cores -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Cmode"="cmode"; "Lock"="lock"; "IgnoreUnpackErrors"="ignore-unpack-errors"; "Pool"="pool"; "Ostype"="ostype"; "Start"="start"; "DevN"="dev[n]"; "Swap"="swap"; "Timezone"="timezone"; "Unique"="unique"; "Env"="env"; "NetN"="net[n]"; "Vmid"="vmid"; "Hookscript"="hookscript"; "MpN"="mp[n]"; "Onboot"="onboot"; "Protection"="protection"; "Tty"="tty"; "Memory"="memory"; "SshPublicKeys"="ssh-public-keys"; "Cpuunits"="cpuunits"; "Nameserver"="nameserver"; "Template"="template"; "Startup"="startup"; "Restore"="restore"; "Description"="description"; "Bwlimit"="bwlimit"; "Features"="features"; "Searchdomain"="searchdomain"; "Rootfs"="rootfs"; "Unprivileged"="unprivileged"; "Arch"="arch"; "Tags"="tags"; "Cpulimit"="cpulimit"; "Password"="password"; "Force"="force"; "UnusedN"="unused[n]"; "Hostname"="hostname"; "Storage"="storage"; "Console"="console"; "Entrypoint"="entrypoint"; "Ostemplate"="ostemplate"; "Debug"="debug"; "Cores"="cores"; "HaManaged"="ha-managed"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesLxcRB {
    ...
    Process {
        ...
        $AllProperties = ("cmode", "lock", "ignore-unpack-errors", "pool", "ostype", "start", "dev[n]", "swap", "timezone", "unique", "env", "net[n]", "vmid", "hookscript", "mp[n]", "onboot", "protection", "tty", "memory", "ssh-public-keys", "cpuunits", "nameserver", "template", "startup", "restore", "description", "bwlimit", "features", "searchdomain", "rootfs", "unprivileged", "arch", "tags", "cpulimit", "password", "force", "unused[n]", "hostname", "storage", "console", "entrypoint", "ostemplate", "debug", "cores", "ha-managed")
