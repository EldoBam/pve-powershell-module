...
function Initialize-PVEPOSTNodesLxcRB {
    ...
    Process {
        ...
        if (!$Hostname -and $Hostname.length -gt 255) {
		 ...
		 $DisplayNameMapping =@{
			"SshPublicKeys"="ssh-public-keys"; "Features"="features"; "Storage"="storage"; "Ostemplate"="ostemplate"; "DevN"="dev[n]"; "Template"="template"; "Cmode"="cmode"; "Vmid"="vmid"; "Timezone"="timezone"; "Arch"="arch"; "Memory"="memory"; "Debug"="debug"; "MpN"="mp[n]"; "Bwlimit"="bwlimit"; "Protection"="protection"; "IgnoreUnpackErrors"="ignore-unpack-errors"; "Hookscript"="hookscript"; "Onboot"="onboot"; "Force"="force"; "Cpuunits"="cpuunits"; "Cpulimit"="cpulimit"; "Swap"="swap"; "Unique"="unique"; "Lock"="lock"; "Nameserver"="nameserver"; "Pool"="pool"; "Start"="start"; "Startup"="startup"; "Restore"="restore"; "Tty"="tty"; "Console"="console"; "Searchdomain"="searchdomain"; "NetN"="net[n]"; "Description"="description"; "Tags"="tags"; "Ostype"="ostype"; "Cores"="cores"; "UnusedN"="unused[n]"; "Password"="password"; "Rootfs"="rootfs"; "Hostname"="hostname"; "Unprivileged"="unprivileged"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesLxcRB {
    ...
    Process {
        ...
        $AllProperties = ("ssh-public-keys", "features", "storage", "ostemplate", "dev[n]", "template", "cmode", "vmid", "timezone", "arch", "memory", "debug", "mp[n]", "bwlimit", "protection", "ignore-unpack-errors", "hookscript", "onboot", "force", "cpuunits", "cpulimit", "swap", "unique", "lock", "nameserver", "pool", "start", "startup", "restore", "tty", "console", "searchdomain", "net[n]", "description", "tags", "ostype", "cores", "unused[n]", "password", "rootfs", "hostname", "unprivileged")
