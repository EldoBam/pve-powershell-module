...
function Initialize-PVEPOSTClusterNotificationsEndpointsWebhookRB {
    ...
    Process {
        ...
        if ($Disable -and $Disable -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Secret"="secret"; "Name"="name"; "Disable"="disable"; "Comment"="comment"; "Header"="header"; "Url"="url"; "Body"="body"; "Method"="method"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterNotificationsEndpointsWebhookRB {
    ...
    Process {
        ...
        $AllProperties = ("secret", "name", "disable", "comment", "header", "url", "body", "method")
