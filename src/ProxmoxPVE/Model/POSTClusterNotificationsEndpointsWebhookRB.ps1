...
function Initialize-PVEPOSTClusterNotificationsEndpointsWebhookRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Url"="url"; "Method"="method"; "Name"="name"; "Disable"="disable"; "Header"="header"; "Body"="body"; "Secret"="secret"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterNotificationsEndpointsWebhookRB {
    ...
    Process {
        ...
        $AllProperties = ("url", "method", "name", "disable", "header", "body", "secret", "comment")
