...
POSTAccessUsersTokenRB<PSCustomObject>
#>

function Initialize-PVEPOSTAccessUsersTokenRB {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ProxmoxPVE => PVEPOSTAccessUsersTokenRB' | Write-Debug
        ...
        if ($Privsep -and $Privsep -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Comment"="comment"; "Expire"="expire"; "Userid"="userid"; "Privsep"="privsep"; "Tokenid"="tokenid"
        }
...
Convert from JSON to POSTAccessUsersTokenRB<PSCustomObject>
...
POSTAccessUsersTokenRB<PSCustomObject>
#>
function ConvertFrom-PVEJsonToPOSTAccessUsersTokenRB {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ProxmoxPVE => PVEPOSTAccessUsersTokenRB' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PVEPOSTAccessUsersTokenRB
        $AllProperties = ("comment", "expire", "userid", "privsep", "tokenid")
