...
function Initialize-PVEPOSTNodesLxcFirewallRulesRB {
    ...
    Process {
        ...
        if (!$Macro -and $Macro.length -gt 128) {
		 ...
		 $DisplayNameMapping =@{
			"IcmpType"="icmp-type"; "Action"="action"; "Type"="type"; "Dest"="dest"; "Source"="source"; "Digest"="digest"; "Dport"="dport"; "Enable"="enable"; "Log"="log"; "Pos"="pos"; "Iface"="iface"; "Comment"="comment"; "Proto"="proto"; "Sport"="sport"; "Macro"="macro"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesLxcFirewallRulesRB {
    ...
    Process {
        ...
        $AllProperties = ("icmp-type", "action", "type", "dest", "source", "digest", "dport", "enable", "log", "pos", "iface", "comment", "proto", "sport", "macro")
