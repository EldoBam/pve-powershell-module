...
function Initialize-PVEPOSTNodesLxcFirewallRulesRB {
    ...
    Process {
        ...
        if (!$Dest -and $Dest.length -gt 512) {
		 ...
		 $DisplayNameMapping =@{
			"Macro"="macro"; "Action"="action"; "Iface"="iface"; "Proto"="proto"; "Comment"="comment"; "IcmpType"="icmp-type"; "Digest"="digest"; "Type"="type"; "Source"="source"; "Dest"="dest"; "Enable"="enable"; "Log"="log"; "Dport"="dport"; "Pos"="pos"; "Sport"="sport"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesLxcFirewallRulesRB {
    ...
    Process {
        ...
        $AllProperties = ("macro", "action", "iface", "proto", "comment", "icmp-type", "digest", "type", "source", "dest", "enable", "log", "dport", "pos", "sport")
