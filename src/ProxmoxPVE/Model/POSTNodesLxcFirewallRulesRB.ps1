...
function Initialize-PVEPOSTNodesLxcFirewallRulesRB {
    ...
    Process {
        ...
        if (!$Iface -and $Iface.length -lt 2) {
		 ...
		 $DisplayNameMapping =@{
			"Enable"="enable"; "Dport"="dport"; "Comment"="comment"; "IcmpType"="icmp-type"; "Sport"="sport"; "Digest"="digest"; "Pos"="pos"; "Dest"="dest"; "Log"="log"; "Macro"="macro"; "Source"="source"; "Action"="action"; "Proto"="proto"; "Iface"="iface"; "Type"="type"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesLxcFirewallRulesRB {
    ...
    Process {
        ...
        $AllProperties = ("enable", "dport", "comment", "icmp-type", "sport", "digest", "pos", "dest", "log", "macro", "source", "action", "proto", "iface", "type")
