...
function Initialize-PVEPUTClusterNotificationsEndpointsSendmailRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Delete"="delete"; "Mailto"="mailto"; "Comment"="comment"; "MailtoUser"="mailto-user"; "FromAddress"="from-address"; "Author"="author"; "Disable"="disable"; "Digest"="digest"
        }
...
function ConvertFrom-PVEJsonToPUTClusterNotificationsEndpointsSendmailRB {
    ...
    Process {
        ...
        $AllProperties = ("delete", "mailto", "comment", "mailto-user", "from-address", "author", "disable", "digest")
