...
function Initialize-PVEPUTClusterNotificationsEndpointsSendmailRB {
    ...
    Process {
        ...
        if ($Disable -and $Disable -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Author"="author"; "Digest"="digest"; "FromAddress"="from-address"; "Mailto"="mailto"; "MailtoUser"="mailto-user"; "Comment"="comment"; "Delete"="delete"; "Disable"="disable"; "Name"="name"
        }
...
function ConvertFrom-PVEJsonToPUTClusterNotificationsEndpointsSendmailRB {
    ...
    Process {
        ...
        $AllProperties = ("author", "digest", "from-address", "mailto", "mailto-user", "comment", "delete", "disable", "name")
