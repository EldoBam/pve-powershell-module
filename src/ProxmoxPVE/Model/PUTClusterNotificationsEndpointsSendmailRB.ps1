...
function Initialize-PVEPUTClusterNotificationsEndpointsSendmailRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Disable"="disable"; "Author"="author"; "Delete"="delete"; "Comment"="comment"; "Mailto"="mailto"; "MailtoUser"="mailto-user"; "Digest"="digest"; "FromAddress"="from-address"
        }
...
function ConvertFrom-PVEJsonToPUTClusterNotificationsEndpointsSendmailRB {
    ...
    Process {
        ...
        $AllProperties = ("disable", "author", "delete", "comment", "mailto", "mailto-user", "digest", "from-address")
