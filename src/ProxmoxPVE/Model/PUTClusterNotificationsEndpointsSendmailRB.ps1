...
function Initialize-PVEPUTClusterNotificationsEndpointsSendmailRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"FromAddress"="from-address"; "MailtoUser"="mailto-user"; "Delete"="delete"; "Comment"="comment"; "Mailto"="mailto"; "Digest"="digest"; "Author"="author"; "Disable"="disable"
        }
...
function ConvertFrom-PVEJsonToPUTClusterNotificationsEndpointsSendmailRB {
    ...
    Process {
        ...
        $AllProperties = ("from-address", "mailto-user", "delete", "comment", "mailto", "digest", "author", "disable")
