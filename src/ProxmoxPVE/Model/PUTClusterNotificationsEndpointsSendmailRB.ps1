...
function Initialize-PVEPUTClusterNotificationsEndpointsSendmailRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Mailto"="mailto"; "MailtoUser"="mailto-user"; "Comment"="comment"; "Author"="author"; "Disable"="disable"; "FromAddress"="from-address"; "Delete"="delete"; "Digest"="digest"; "Name"="name"
        }
...
function ConvertFrom-PVEJsonToPUTClusterNotificationsEndpointsSendmailRB {
    ...
    Process {
        ...
        $AllProperties = ("mailto", "mailto-user", "comment", "author", "disable", "from-address", "delete", "digest", "name")
