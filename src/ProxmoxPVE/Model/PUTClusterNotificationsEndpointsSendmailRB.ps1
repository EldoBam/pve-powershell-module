...
function Initialize-PVEPUTClusterNotificationsEndpointsSendmailRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"MailtoUser"="mailto-user"; "Name"="name"; "Delete"="delete"; "Disable"="disable"; "Comment"="comment"; "Author"="author"; "Digest"="digest"; "Mailto"="mailto"; "FromAddress"="from-address"
        }
...
function ConvertFrom-PVEJsonToPUTClusterNotificationsEndpointsSendmailRB {
    ...
    Process {
        ...
        $AllProperties = ("mailto-user", "name", "delete", "disable", "comment", "author", "digest", "mailto", "from-address")
