...
function Initialize-PVEPUTNodesLxcFirewallOptionsRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Enable"="enable"; "Dhcp"="dhcp"; "PolicyOut"="policy_out"; "Delete"="delete"; "PolicyIn"="policy_in"; "LogLevelIn"="log_level_in"; "LogLevelOut"="log_level_out"; "Macfilter"="macfilter"; "Ipfilter"="ipfilter"; "Radv"="radv"; "Ndp"="ndp"; "Digest"="digest"
        }
...
function ConvertFrom-PVEJsonToPUTNodesLxcFirewallOptionsRB {
    ...
    Process {
        ...
        $AllProperties = ("enable", "dhcp", "policy_out", "delete", "policy_in", "log_level_in", "log_level_out", "macfilter", "ipfilter", "radv", "ndp", "digest")
