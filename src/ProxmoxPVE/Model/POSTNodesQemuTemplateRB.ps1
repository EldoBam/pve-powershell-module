...
POSTNodesQemuTemplateRB<PSCustomObject>
#>

function Initialize-PVEPOSTNodesQemuTemplateRB {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ProxmoxPVE => PVEPOSTNodesQemuTemplateRB' | Write-Debug
...
Convert from JSON to POSTNodesQemuTemplateRB<PSCustomObject>
...
POSTNodesQemuTemplateRB<PSCustomObject>
#>
function ConvertFrom-PVEJsonToPOSTNodesQemuTemplateRB {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ProxmoxPVE => PVEPOSTNodesQemuTemplateRB' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PVEPOSTNodesQemuTemplateRB
        $AllProperties = ("disk", "vmid", "node")
