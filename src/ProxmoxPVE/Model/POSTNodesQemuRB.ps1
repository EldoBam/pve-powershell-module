...
function Initialize-PVEPOSTNodesQemuRB {
    ...
    Process {
        ...
        if ($Shares -and $Shares -gt 50000) {
		 ...
		 $DisplayNameMapping =@{
			"SpiceEnhancements"="spice_enhancements"; "Lock"="lock"; "Pool"="pool"; "Onboot"="onboot"; "Vmid"="vmid"; "Cdrom"="cdrom"; "Template"="template"; "Ciupgrade"="ciupgrade"; "Hookscript"="hookscript"; "Keephugepages"="keephugepages"; "Cpu"="cpu"; "Rng0"="rng0"; "Agent"="agent"; "Cpulimit"="cpulimit"; "Scsihw"="scsihw"; "Boot"="boot"; "Vmgenid"="vmgenid"; "ParallelN"="parallel[n]"; "NetN"="net[n]"; "Smbios1"="smbios1"; "SerialN"="serial[n]"; "Tpmstate0"="tpmstate0"; "Archive"="archive"; "Name"="name"; "Bios"="bios"; "Vga"="vga"; "Sshkeys"="sshkeys"; "Nameserver"="nameserver"; "Memory"="memory"; "IdeN"="ide[n]"; "Kvm"="kvm"; "Efidisk0"="efidisk0"; "Startdate"="startdate"; "Arch"="arch"; "Cpuunits"="cpuunits"; "Autostart"="autostart"; "Localtime"="localtime"; "Startup"="startup"; "Vcpus"="vcpus"; "MigrateSpeed"="migrate_speed"; "Hotplug"="hotplug"; "Cipassword"="cipassword"; "Bootdisk"="bootdisk"; "Description"="description"; "Vmstatestorage"="vmstatestorage"; "Cicustom"="cicustom"; "Machine"="machine"; "Affinity"="affinity"; "Sockets"="sockets"; "Smp"="smp"; "Bwlimit"="bwlimit"; "Tablet"="tablet"; "IpconfigN"="ipconfig[n]"; "Numa"="numa"; "Unique"="unique"; "AmdSev"="amd-sev"; "HostpciN"="hostpci[n]"; "Cores"="cores"; "Ostype"="ostype"; "Tags"="tags"; "Shares"="shares"; "Start"="start"; "VirtioN"="virtio[n]"; "Freeze"="freeze"; "ScsiN"="scsi[n]"; "Force"="force"; "SataN"="sata[n]"; "Ivshmem"="ivshmem"; "Watchdog"="watchdog"; "UnusedN"="unused[n]"; "Protection"="protection"; "MigrateDowntime"="migrate_downtime"; "Balloon"="balloon"; "Storage"="storage"; "Hugepages"="hugepages"; "VarArgs"="args"; "Keyboard"="keyboard"; "Acpi"="acpi"; "NumaN"="numa[n]"; "Searchdomain"="searchdomain"; "Tdf"="tdf"; "Ciuser"="ciuser"; "VirtiofsN"="virtiofs[n]"; "ImportWorkingStorage"="import-working-storage"; "UsbN"="usb[n]"; "Reboot"="reboot"; "Audio0"="audio0"; "LiveRestore"="live-restore"; "Citype"="citype"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuRB {
    ...
    Process {
        ...
        $AllProperties = ("spice_enhancements", "lock", "pool", "onboot", "vmid", "cdrom", "template", "ciupgrade", "hookscript", "keephugepages", "cpu", "rng0", "agent", "cpulimit", "scsihw", "boot", "vmgenid", "parallel[n]", "net[n]", "smbios1", "serial[n]", "tpmstate0", "archive", "name", "bios", "vga", "sshkeys", "nameserver", "memory", "ide[n]", "kvm", "efidisk0", "startdate", "arch", "cpuunits", "autostart", "localtime", "startup", "vcpus", "migrate_speed", "hotplug", "cipassword", "bootdisk", "description", "vmstatestorage", "cicustom", "machine", "affinity", "sockets", "smp", "bwlimit", "tablet", "ipconfig[n]", "numa", "unique", "amd-sev", "hostpci[n]", "cores", "ostype", "tags", "shares", "start", "virtio[n]", "freeze", "scsi[n]", "force", "sata[n]", "ivshmem", "watchdog", "unused[n]", "protection", "migrate_downtime", "balloon", "storage", "hugepages", "args", "keyboard", "acpi", "numa[n]", "searchdomain", "tdf", "ciuser", "virtiofs[n]", "import-working-storage", "usb[n]", "reboot", "audio0", "live-restore", "citype")
