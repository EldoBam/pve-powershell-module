...
function Initialize-PVEPOSTNodesQemuRB {
    ...
    Process {
        ...
        if ($Kvm -and $Kvm -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Protection"="protection"; "Watchdog"="watchdog"; "VarArgs"="args"; "Cdrom"="cdrom"; "Bwlimit"="bwlimit"; "Machine"="machine"; "IpconfigN"="ipconfig[n]"; "Cpuunits"="cpuunits"; "Force"="force"; "ScsiN"="scsi[n]"; "Cores"="cores"; "Citype"="citype"; "ImportWorkingStorage"="import-working-storage"; "Vga"="vga"; "ParallelN"="parallel[n]"; "UsbN"="usb[n]"; "Bootdisk"="bootdisk"; "Sshkeys"="sshkeys"; "Ciupgrade"="ciupgrade"; "Vcpus"="vcpus"; "Scsihw"="scsihw"; "SpiceEnhancements"="spice_enhancements"; "MigrateSpeed"="migrate_speed"; "Hotplug"="hotplug"; "Freeze"="freeze"; "Pool"="pool"; "SerialN"="serial[n]"; "Startup"="startup"; "Efidisk0"="efidisk0"; "Startdate"="startdate"; "Nameserver"="nameserver"; "AmdSev"="amd-sev"; "LiveRestore"="live-restore"; "Hookscript"="hookscript"; "SataN"="sata[n]"; "Unique"="unique"; "Storage"="storage"; "Onboot"="onboot"; "Vmgenid"="vmgenid"; "Cicustom"="cicustom"; "NumaN"="numa[n]"; "Lock"="lock"; "IdeN"="ide[n]"; "NetN"="net[n]"; "Vmid"="vmid"; "Acpi"="acpi"; "Arch"="arch"; "Audio0"="audio0"; "Localtime"="localtime"; "Sockets"="sockets"; "Tags"="tags"; "Searchdomain"="searchdomain"; "HostpciN"="hostpci[n]"; "Bios"="bios"; "Template"="template"; "MigrateDowntime"="migrate_downtime"; "Vmstatestorage"="vmstatestorage"; "Tablet"="tablet"; "Cpulimit"="cpulimit"; "Ivshmem"="ivshmem"; "Start"="start"; "Memory"="memory"; "Tdf"="tdf"; "Rng0"="rng0"; "Node"="node"; "Shares"="shares"; "Cipassword"="cipassword"; "Reboot"="reboot"; "Archive"="archive"; "Name"="name"; "Hugepages"="hugepages"; "Boot"="boot"; "Numa"="numa"; "Affinity"="affinity"; "Keephugepages"="keephugepages"; "Ostype"="ostype"; "Description"="description"; "Tpmstate0"="tpmstate0"; "VirtioN"="virtio[n]"; "Ciuser"="ciuser"; "Smbios1"="smbios1"; "Agent"="agent"; "Balloon"="balloon"; "Smp"="smp"; "Keyboard"="keyboard"; "Autostart"="autostart"; "UnusedN"="unused[n]"; "Kvm"="kvm"; "Cpu"="cpu"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuRB {
    ...
    Process {
        ...
        $AllProperties = ("protection", "watchdog", "args", "cdrom", "bwlimit", "machine", "ipconfig[n]", "cpuunits", "force", "scsi[n]", "cores", "citype", "import-working-storage", "vga", "parallel[n]", "usb[n]", "bootdisk", "sshkeys", "ciupgrade", "vcpus", "scsihw", "spice_enhancements", "migrate_speed", "hotplug", "freeze", "pool", "serial[n]", "startup", "efidisk0", "startdate", "nameserver", "amd-sev", "live-restore", "hookscript", "sata[n]", "unique", "storage", "onboot", "vmgenid", "cicustom", "numa[n]", "lock", "ide[n]", "net[n]", "vmid", "acpi", "arch", "audio0", "localtime", "sockets", "tags", "searchdomain", "hostpci[n]", "bios", "template", "migrate_downtime", "vmstatestorage", "tablet", "cpulimit", "ivshmem", "start", "memory", "tdf", "rng0", "node", "shares", "cipassword", "reboot", "archive", "name", "hugepages", "boot", "numa", "affinity", "keephugepages", "ostype", "description", "tpmstate0", "virtio[n]", "ciuser", "smbios1", "agent", "balloon", "smp", "keyboard", "autostart", "unused[n]", "kvm", "cpu")
