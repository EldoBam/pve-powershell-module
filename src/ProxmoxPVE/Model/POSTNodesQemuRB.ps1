...
function Initialize-PVEPOSTNodesQemuRB {
    ...
    Process {
        ...
        if ($Vmid -and $Vmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Balloon"="balloon"; "Bwlimit"="bwlimit"; "Tdf"="tdf"; "Tags"="tags"; "SpiceEnhancements"="spice_enhancements"; "NetN"="net[n]"; "Archive"="archive"; "Protection"="protection"; "Onboot"="onboot"; "Audio0"="audio0"; "Bios"="bios"; "Keyboard"="keyboard"; "NumaN"="numa[n]"; "Machine"="machine"; "ScsiN"="scsi[n]"; "HostpciN"="hostpci[n]"; "SerialN"="serial[n]"; "Efidisk0"="efidisk0"; "Lock"="lock"; "Start"="start"; "ImportWorkingStorage"="import-working-storage"; "VirtiofsN"="virtiofs[n]"; "Ostype"="ostype"; "Smp"="smp"; "Startdate"="startdate"; "Hugepages"="hugepages"; "Vcpus"="vcpus"; "Boot"="boot"; "IdeN"="ide[n]"; "SataN"="sata[n]"; "Freeze"="freeze"; "Ciuser"="ciuser"; "Force"="force"; "VirtioN"="virtio[n]"; "Watchdog"="watchdog"; "Node"="node"; "AmdSev"="amd-sev"; "MigrateSpeed"="migrate_speed"; "Bootdisk"="bootdisk"; "Cpulimit"="cpulimit"; "UsbN"="usb[n]"; "Shares"="shares"; "Arch"="arch"; "Searchdomain"="searchdomain"; "Pool"="pool"; "Reboot"="reboot"; "Acpi"="acpi"; "Cpu"="cpu"; "IpconfigN"="ipconfig[n]"; "Memory"="memory"; "Localtime"="localtime"; "VarArgs"="args"; "Keephugepages"="keephugepages"; "ParallelN"="parallel[n]"; "Affinity"="affinity"; "Vmstatestorage"="vmstatestorage"; "Autostart"="autostart"; "Startup"="startup"; "Cipassword"="cipassword"; "Kvm"="kvm"; "Description"="description"; "Tablet"="tablet"; "Hotplug"="hotplug"; "Scsihw"="scsihw"; "Vmgenid"="vmgenid"; "Name"="name"; "Numa"="numa"; "Cpuunits"="cpuunits"; "Sockets"="sockets"; "Agent"="agent"; "Ciupgrade"="ciupgrade"; "Tpmstate0"="tpmstate0"; "Sshkeys"="sshkeys"; "Cdrom"="cdrom"; "LiveRestore"="live-restore"; "Smbios1"="smbios1"; "Cores"="cores"; "Cicustom"="cicustom"; "Hookscript"="hookscript"; "Vga"="vga"; "Storage"="storage"; "Template"="template"; "Unique"="unique"; "UnusedN"="unused[n]"; "Citype"="citype"; "Ivshmem"="ivshmem"; "MigrateDowntime"="migrate_downtime"; "Vmid"="vmid"; "Rng0"="rng0"; "Nameserver"="nameserver"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuRB {
    ...
    Process {
        ...
        $AllProperties = ("balloon", "bwlimit", "tdf", "tags", "spice_enhancements", "net[n]", "archive", "protection", "onboot", "audio0", "bios", "keyboard", "numa[n]", "machine", "scsi[n]", "hostpci[n]", "serial[n]", "efidisk0", "lock", "start", "import-working-storage", "virtiofs[n]", "ostype", "smp", "startdate", "hugepages", "vcpus", "boot", "ide[n]", "sata[n]", "freeze", "ciuser", "force", "virtio[n]", "watchdog", "node", "amd-sev", "migrate_speed", "bootdisk", "cpulimit", "usb[n]", "shares", "arch", "searchdomain", "pool", "reboot", "acpi", "cpu", "ipconfig[n]", "memory", "localtime", "args", "keephugepages", "parallel[n]", "affinity", "vmstatestorage", "autostart", "startup", "cipassword", "kvm", "description", "tablet", "hotplug", "scsihw", "vmgenid", "name", "numa", "cpuunits", "sockets", "agent", "ciupgrade", "tpmstate0", "sshkeys", "cdrom", "live-restore", "smbios1", "cores", "cicustom", "hookscript", "vga", "storage", "template", "unique", "unused[n]", "citype", "ivshmem", "migrate_downtime", "vmid", "rng0", "nameserver")
