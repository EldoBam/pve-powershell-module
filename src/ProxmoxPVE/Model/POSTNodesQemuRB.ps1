...
function Initialize-PVEPOSTNodesQemuRB {
    ...
    Process {
        ...
        if ($Vmid -and $Vmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"UnusedN"="unused[n]"; "HostpciN"="hostpci[n]"; "Autostart"="autostart"; "Unique"="unique"; "Protection"="protection"; "Bwlimit"="bwlimit"; "Vmstatestorage"="vmstatestorage"; "Balloon"="balloon"; "Ostype"="ostype"; "Kvm"="kvm"; "Sockets"="sockets"; "Affinity"="affinity"; "VirtiofsN"="virtiofs[n]"; "IpconfigN"="ipconfig[n]"; "Description"="description"; "Tdf"="tdf"; "Keyboard"="keyboard"; "Cpulimit"="cpulimit"; "Memory"="memory"; "Agent"="agent"; "SataN"="sata[n]"; "Vcpus"="vcpus"; "Watchdog"="watchdog"; "MigrateSpeed"="migrate_speed"; "NumaN"="numa[n]"; "Template"="template"; "VarArgs"="args"; "MigrateDowntime"="migrate_downtime"; "Rng0"="rng0"; "Onboot"="onboot"; "Pool"="pool"; "Force"="force"; "Audio0"="audio0"; "Hookscript"="hookscript"; "Tags"="tags"; "Boot"="boot"; "Storage"="storage"; "Name"="name"; "Bootdisk"="bootdisk"; "Numa"="numa"; "Localtime"="localtime"; "Efidisk0"="efidisk0"; "Hotplug"="hotplug"; "Tablet"="tablet"; "ScsiN"="scsi[n]"; "Machine"="machine"; "Ciupgrade"="ciupgrade"; "Startup"="startup"; "Acpi"="acpi"; "Freeze"="freeze"; "SerialN"="serial[n]"; "Cores"="cores"; "ImportWorkingStorage"="import-working-storage"; "ParallelN"="parallel[n]"; "Cpu"="cpu"; "Keephugepages"="keephugepages"; "Ciuser"="ciuser"; "Bios"="bios"; "Start"="start"; "Cpuunits"="cpuunits"; "Ivshmem"="ivshmem"; "Cicustom"="cicustom"; "Smbios1"="smbios1"; "AmdSev"="amd-sev"; "NetN"="net[n]"; "Vmgenid"="vmgenid"; "Archive"="archive"; "Sshkeys"="sshkeys"; "Searchdomain"="searchdomain"; "Nameserver"="nameserver"; "SpiceEnhancements"="spice_enhancements"; "Shares"="shares"; "LiveRestore"="live-restore"; "Arch"="arch"; "Smp"="smp"; "Citype"="citype"; "Scsihw"="scsihw"; "VirtioN"="virtio[n]"; "IdeN"="ide[n]"; "Startdate"="startdate"; "Reboot"="reboot"; "Vga"="vga"; "Tpmstate0"="tpmstate0"; "UsbN"="usb[n]"; "Hugepages"="hugepages"; "Cipassword"="cipassword"; "Vmid"="vmid"; "Lock"="lock"; "Cdrom"="cdrom"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuRB {
    ...
    Process {
        ...
        $AllProperties = ("unused[n]", "hostpci[n]", "autostart", "unique", "protection", "bwlimit", "vmstatestorage", "balloon", "ostype", "kvm", "sockets", "affinity", "virtiofs[n]", "ipconfig[n]", "description", "tdf", "keyboard", "cpulimit", "memory", "agent", "sata[n]", "vcpus", "watchdog", "migrate_speed", "numa[n]", "template", "args", "migrate_downtime", "rng0", "onboot", "pool", "force", "audio0", "hookscript", "tags", "boot", "storage", "name", "bootdisk", "numa", "localtime", "efidisk0", "hotplug", "tablet", "scsi[n]", "machine", "ciupgrade", "startup", "acpi", "freeze", "serial[n]", "cores", "import-working-storage", "parallel[n]", "cpu", "keephugepages", "ciuser", "bios", "start", "cpuunits", "ivshmem", "cicustom", "smbios1", "amd-sev", "net[n]", "vmgenid", "archive", "sshkeys", "searchdomain", "nameserver", "spice_enhancements", "shares", "live-restore", "arch", "smp", "citype", "scsihw", "virtio[n]", "ide[n]", "startdate", "reboot", "vga", "tpmstate0", "usb[n]", "hugepages", "cipassword", "vmid", "lock", "cdrom")
