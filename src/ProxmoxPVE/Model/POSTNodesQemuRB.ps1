...
function Initialize-PVEPOSTNodesQemuRB {
    ...
    Process {
        ...
        if ($Vcpus -and $Vcpus -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Reboot"="reboot"; "Onboot"="onboot"; "VarArgs"="args"; "Audio0"="audio0"; "Efidisk0"="efidisk0"; "LiveRestore"="live-restore"; "Machine"="machine"; "Tdf"="tdf"; "ParallelN"="parallel[n]"; "Agent"="agent"; "Balloon"="balloon"; "HaManaged"="ha-managed"; "Boot"="boot"; "Ciupgrade"="ciupgrade"; "Arch"="arch"; "AllowKsm"="allow-ksm"; "IdeN"="ide[n]"; "Vmstatestorage"="vmstatestorage"; "Searchdomain"="searchdomain"; "SpiceEnhancements"="spice_enhancements"; "Cicustom"="cicustom"; "MigrateSpeed"="migrate_speed"; "Freeze"="freeze"; "Cores"="cores"; "Cdrom"="cdrom"; "Bwlimit"="bwlimit"; "SerialN"="serial[n]"; "Vga"="vga"; "Bios"="bios"; "UnusedN"="unused[n]"; "Archive"="archive"; "Startdate"="startdate"; "HostpciN"="hostpci[n]"; "NetN"="net[n]"; "Description"="description"; "Kvm"="kvm"; "Sshkeys"="sshkeys"; "VirtiofsN"="virtiofs[n]"; "Tags"="tags"; "Cpu"="cpu"; "AmdSev"="amd-sev"; "Numa"="numa"; "Shares"="shares"; "Keephugepages"="keephugepages"; "NumaN"="numa[n]"; "Localtime"="localtime"; "Citype"="citype"; "Tablet"="tablet"; "Scsihw"="scsihw"; "Affinity"="affinity"; "Storage"="storage"; "Cpuunits"="cpuunits"; "Lock"="lock"; "Ciuser"="ciuser"; "Nameserver"="nameserver"; "Start"="start"; "Sockets"="sockets"; "Ivshmem"="ivshmem"; "Vmid"="vmid"; "Protection"="protection"; "Template"="template"; "Memory"="memory"; "SataN"="sata[n]"; "IpconfigN"="ipconfig[n]"; "Smp"="smp"; "Keyboard"="keyboard"; "Startup"="startup"; "Bootdisk"="bootdisk"; "UsbN"="usb[n]"; "ImportWorkingStorage"="import-working-storage"; "Tpmstate0"="tpmstate0"; "Hotplug"="hotplug"; "Rng0"="rng0"; "MigrateDowntime"="migrate_downtime"; "Watchdog"="watchdog"; "Vmgenid"="vmgenid"; "Cipassword"="cipassword"; "VirtioN"="virtio[n]"; "Unique"="unique"; "Hugepages"="hugepages"; "Hookscript"="hookscript"; "Force"="force"; "Acpi"="acpi"; "Smbios1"="smbios1"; "Cpulimit"="cpulimit"; "ScsiN"="scsi[n]"; "Autostart"="autostart"; "Vcpus"="vcpus"; "Pool"="pool"; "Name"="name"; "Ostype"="ostype"; "IntelTdx"="intel-tdx"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuRB {
    ...
    Process {
        ...
        $AllProperties = ("reboot", "onboot", "args", "audio0", "efidisk0", "live-restore", "machine", "tdf", "parallel[n]", "agent", "balloon", "ha-managed", "boot", "ciupgrade", "arch", "allow-ksm", "ide[n]", "vmstatestorage", "searchdomain", "spice_enhancements", "cicustom", "migrate_speed", "freeze", "cores", "cdrom", "bwlimit", "serial[n]", "vga", "bios", "unused[n]", "archive", "startdate", "hostpci[n]", "net[n]", "description", "kvm", "sshkeys", "virtiofs[n]", "tags", "cpu", "amd-sev", "numa", "shares", "keephugepages", "numa[n]", "localtime", "citype", "tablet", "scsihw", "affinity", "storage", "cpuunits", "lock", "ciuser", "nameserver", "start", "sockets", "ivshmem", "vmid", "protection", "template", "memory", "sata[n]", "ipconfig[n]", "smp", "keyboard", "startup", "bootdisk", "usb[n]", "import-working-storage", "tpmstate0", "hotplug", "rng0", "migrate_downtime", "watchdog", "vmgenid", "cipassword", "virtio[n]", "unique", "hugepages", "hookscript", "force", "acpi", "smbios1", "cpulimit", "scsi[n]", "autostart", "vcpus", "pool", "name", "ostype", "intel-tdx")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ha-managed"))) { #optional property not found
            $HaManaged = $null
        } else {
            $HaManaged = $JsonParameters.PSobject.Properties["ha-managed"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "allow-ksm"))) { #optional property not found
            $AllowKsm = $null
        } else {
            $AllowKsm = $JsonParameters.PSobject.Properties["allow-ksm"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "intel-tdx"))) { #optional property not found
            $IntelTdx = $null
        } else {
            $IntelTdx = $JsonParameters.PSobject.Properties["intel-tdx"].value
        }
