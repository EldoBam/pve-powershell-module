...
function Initialize-PVEPOSTNodesQemuRB {
    ...
    Process {
        ...
        if ($Acpi -and $Acpi -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Keyboard"="keyboard"; "Efidisk0"="efidisk0"; "NetN"="net[n]"; "Vcpus"="vcpus"; "Pool"="pool"; "Cores"="cores"; "Start"="start"; "Ciuser"="ciuser"; "Startup"="startup"; "Cdrom"="cdrom"; "UsbN"="usb[n]"; "Cicustom"="cicustom"; "Ciupgrade"="ciupgrade"; "Cpulimit"="cpulimit"; "SpiceEnhancements"="spice_enhancements"; "Unique"="unique"; "Name"="name"; "Freeze"="freeze"; "LiveRestore"="live-restore"; "Tpmstate0"="tpmstate0"; "IpconfigN"="ipconfig[n]"; "VarArgs"="args"; "Localtime"="localtime"; "Rng0"="rng0"; "MigrateSpeed"="migrate_speed"; "Balloon"="balloon"; "ImportWorkingStorage"="import-working-storage"; "Hookscript"="hookscript"; "Tdf"="tdf"; "Lock"="lock"; "Smp"="smp"; "Numa"="numa"; "Vmid"="vmid"; "Vmstatestorage"="vmstatestorage"; "Bwlimit"="bwlimit"; "Shares"="shares"; "Onboot"="onboot"; "Cpu"="cpu"; "Reboot"="reboot"; "Cpuunits"="cpuunits"; "Autostart"="autostart"; "Scsihw"="scsihw"; "Description"="description"; "Storage"="storage"; "Cipassword"="cipassword"; "Hotplug"="hotplug"; "Force"="force"; "Citype"="citype"; "Kvm"="kvm"; "Memory"="memory"; "Bios"="bios"; "Ivshmem"="ivshmem"; "Vga"="vga"; "Agent"="agent"; "Audio0"="audio0"; "ParallelN"="parallel[n]"; "ScsiN"="scsi[n]"; "Archive"="archive"; "UnusedN"="unused[n]"; "IdeN"="ide[n]"; "Boot"="boot"; "Smbios1"="smbios1"; "Keephugepages"="keephugepages"; "Node"="node"; "Tablet"="tablet"; "Startdate"="startdate"; "Protection"="protection"; "NumaN"="numa[n]"; "Template"="template"; "SataN"="sata[n]"; "Nameserver"="nameserver"; "Machine"="machine"; "Arch"="arch"; "Ostype"="ostype"; "SerialN"="serial[n]"; "Affinity"="affinity"; "Sockets"="sockets"; "Bootdisk"="bootdisk"; "Searchdomain"="searchdomain"; "Tags"="tags"; "Acpi"="acpi"; "VirtioN"="virtio[n]"; "Watchdog"="watchdog"; "Sshkeys"="sshkeys"; "AmdSev"="amd-sev"; "Hugepages"="hugepages"; "Vmgenid"="vmgenid"; "HostpciN"="hostpci[n]"; "MigrateDowntime"="migrate_downtime"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuRB {
    ...
    Process {
        ...
        $AllProperties = ("keyboard", "efidisk0", "net[n]", "vcpus", "pool", "cores", "start", "ciuser", "startup", "cdrom", "usb[n]", "cicustom", "ciupgrade", "cpulimit", "spice_enhancements", "unique", "name", "freeze", "live-restore", "tpmstate0", "ipconfig[n]", "args", "localtime", "rng0", "migrate_speed", "balloon", "import-working-storage", "hookscript", "tdf", "lock", "smp", "numa", "vmid", "vmstatestorage", "bwlimit", "shares", "onboot", "cpu", "reboot", "cpuunits", "autostart", "scsihw", "description", "storage", "cipassword", "hotplug", "force", "citype", "kvm", "memory", "bios", "ivshmem", "vga", "agent", "audio0", "parallel[n]", "scsi[n]", "archive", "unused[n]", "ide[n]", "boot", "smbios1", "keephugepages", "node", "tablet", "startdate", "protection", "numa[n]", "template", "sata[n]", "nameserver", "machine", "arch", "ostype", "serial[n]", "affinity", "sockets", "bootdisk", "searchdomain", "tags", "acpi", "virtio[n]", "watchdog", "sshkeys", "amd-sev", "hugepages", "vmgenid", "hostpci[n]", "migrate_downtime")
