...
function Initialize-PVEPOSTNodesQemuRB {
    ...
    Param (
        ...
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidatePattern("net\d+=\d+(,net\d+=\d+)*")]
        [String]
        ${RunningNetsHostMtu},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
    ...
    Process {
        ...
        if ($Vmid -and $Vmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Watchdog"="watchdog"; "Bootdisk"="bootdisk"; "Cdrom"="cdrom"; "MigrateDowntime"="migrate_downtime"; "Vga"="vga"; "Numa"="numa"; "Template"="template"; "Sshkeys"="sshkeys"; "Tablet"="tablet"; "IpconfigN"="ipconfig[n]"; "Scsihw"="scsihw"; "Agent"="agent"; "ScsiN"="scsi[n]"; "Cicustom"="cicustom"; "Bios"="bios"; "Cpuunits"="cpuunits"; "Archive"="archive"; "SataN"="sata[n]"; "Startdate"="startdate"; "Name"="name"; "Unique"="unique"; "Acpi"="acpi"; "Citype"="citype"; "Cpu"="cpu"; "Localtime"="localtime"; "Storage"="storage"; "VarArgs"="args"; "Nameserver"="nameserver"; "Machine"="machine"; "Ivshmem"="ivshmem"; "HostpciN"="hostpci[n]"; "Kvm"="kvm"; "Lock"="lock"; "AmdSev"="amd-sev"; "Startup"="startup"; "Cpulimit"="cpulimit"; "Ciupgrade"="ciupgrade"; "MigrateSpeed"="migrate_speed"; "Smbios1"="smbios1"; "Shares"="shares"; "Protection"="protection"; "Vcpus"="vcpus"; "Description"="description"; "Boot"="boot"; "Freeze"="freeze"; "Arch"="arch"; "NumaN"="numa[n]"; "Cipassword"="cipassword"; "Tags"="tags"; "Keyboard"="keyboard"; "Searchdomain"="searchdomain"; "Cores"="cores"; "Efidisk0"="efidisk0"; "Keephugepages"="keephugepages"; "Ciuser"="ciuser"; "Affinity"="affinity"; "VirtioN"="virtio[n]"; "Sockets"="sockets"; "Vmgenid"="vmgenid"; "ParallelN"="parallel[n]"; "Force"="force"; "Smp"="smp"; "NetN"="net[n]"; "Onboot"="onboot"; "UsbN"="usb[n]"; "Pool"="pool"; "Balloon"="balloon"; "ImportWorkingStorage"="import-working-storage"; "RunningNetsHostMtu"="running-nets-host-mtu"; "Hotplug"="hotplug"; "Vmstatestorage"="vmstatestorage"; "Hugepages"="hugepages"; "Start"="start"; "Reboot"="reboot"; "Tpmstate0"="tpmstate0"; "Memory"="memory"; "LiveRestore"="live-restore"; "SerialN"="serial[n]"; "Autostart"="autostart"; "Hookscript"="hookscript"; "Vmid"="vmid"; "VirtiofsN"="virtiofs[n]"; "Rng0"="rng0"; "Tdf"="tdf"; "UnusedN"="unused[n]"; "Ostype"="ostype"; "SpiceEnhancements"="spice_enhancements"; "Audio0"="audio0"; "IdeN"="ide[n]"; "Bwlimit"="bwlimit"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuRB {
    ...
    Process {
        ...
        $AllProperties = ("watchdog", "bootdisk", "cdrom", "migrate_downtime", "vga", "numa", "template", "sshkeys", "tablet", "ipconfig[n]", "scsihw", "agent", "scsi[n]", "cicustom", "bios", "cpuunits", "archive", "sata[n]", "startdate", "name", "unique", "acpi", "citype", "cpu", "localtime", "storage", "args", "nameserver", "machine", "ivshmem", "hostpci[n]", "kvm", "lock", "amd-sev", "startup", "cpulimit", "ciupgrade", "migrate_speed", "smbios1", "shares", "protection", "vcpus", "description", "boot", "freeze", "arch", "numa[n]", "cipassword", "tags", "keyboard", "searchdomain", "cores", "efidisk0", "keephugepages", "ciuser", "affinity", "virtio[n]", "sockets", "vmgenid", "parallel[n]", "force", "smp", "net[n]", "onboot", "usb[n]", "pool", "balloon", "import-working-storage", "running-nets-host-mtu", "hotplug", "vmstatestorage", "hugepages", "start", "reboot", "tpmstate0", "memory", "live-restore", "serial[n]", "autostart", "hookscript", "vmid", "virtiofs[n]", "rng0", "tdf", "unused[n]", "ostype", "spice_enhancements", "audio0", "ide[n]", "bwlimit")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "running-nets-host-mtu"))) { #optional property not found
            $RunningNetsHostMtu = $null
        } else {
            $RunningNetsHostMtu = $JsonParameters.PSobject.Properties["running-nets-host-mtu"].value
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "running-nets-host-mtu" = ${RunningNetsHostMtu}
            "hotplug" = ${Hotplug}
