...
DELETENodesQemuFirewallAliasesRB<PSCustomObject>
#>

function Initialize-PVEDELETENodesQemuFirewallAliasesRB {
    [CmdletBinding()]
    Param (
...
Convert from JSON to DELETENodesQemuFirewallAliasesRB<PSCustomObject>
...
DELETENodesQemuFirewallAliasesRB<PSCustomObject>
#>
function ConvertFrom-PVEJsonToDELETENodesQemuFirewallAliasesRB {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ProxmoxPVE => PVEDELETENodesQemuFirewallAliasesRB' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
