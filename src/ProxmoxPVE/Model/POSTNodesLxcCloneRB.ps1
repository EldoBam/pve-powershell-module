...
function Initialize-PVEPOSTNodesLxcCloneRB {
    ...
    Process {
        ...
        if (!$Snapname -and $Snapname.length -gt 40) {
		 ...
		 $DisplayNameMapping =@{
			"Target"="target"; "Hostname"="hostname"; "Full"="full"; "Newid"="newid"; "Snapname"="snapname"; "Bwlimit"="bwlimit"; "Pool"="pool"; "Storage"="storage"; "Description"="description"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesLxcCloneRB {
    ...
    Process {
        ...
        $AllProperties = ("target", "hostname", "full", "newid", "snapname", "bwlimit", "pool", "storage", "description")
