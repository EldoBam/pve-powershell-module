...
function Initialize-PVEPOSTNodesLxcCloneRB {
    ...
    Process {
        ...
        if ($Newid -and $Newid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Snapname"="snapname"; "Storage"="storage"; "Description"="description"; "Newid"="newid"; "Target"="target"; "Full"="full"; "Bwlimit"="bwlimit"; "Pool"="pool"; "Hostname"="hostname"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesLxcCloneRB {
    ...
    Process {
        ...
        $AllProperties = ("snapname", "storage", "description", "newid", "target", "full", "bwlimit", "pool", "hostname")
