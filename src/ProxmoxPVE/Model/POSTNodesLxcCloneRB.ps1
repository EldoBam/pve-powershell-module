...
function Initialize-PVEPOSTNodesLxcCloneRB {
    ...
    Process {
        ...
        if ($Newid -and $Newid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Target"="target"; "Full"="full"; "Snapname"="snapname"; "Vmid"="vmid"; "Bwlimit"="bwlimit"; "Newid"="newid"; "Node"="node"; "Storage"="storage"; "Hostname"="hostname"; "Pool"="pool"; "Description"="description"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesLxcCloneRB {
    ...
    Process {
        ...
        $AllProperties = ("target", "full", "snapname", "vmid", "bwlimit", "newid", "node", "storage", "hostname", "pool", "description")
