...
function Initialize-PVEPUTClusterSdnVnetsRB {
    ...
    Process {
        ...
        if (!$Alias -and $Alias.length -gt 256) {
		 ...
		 $DisplayNameMapping =@{
			"Delete"="delete"; "Zone"="zone"; "IsolatePorts"="isolate-ports"; "Tag"="tag"; "Digest"="digest"; "Alias"="alias"; "Vlanaware"="vlanaware"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnVnetsRB {
    ...
    Process {
        ...
        $AllProperties = ("delete", "zone", "isolate-ports", "tag", "digest", "alias", "vlanaware")
