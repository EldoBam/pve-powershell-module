...
function Initialize-PVEPUTClusterSdnVnetsRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Zone"="zone"; "Vlanaware"="vlanaware"; "LockToken"="lock-token"; "Alias"="alias"; "IsolatePorts"="isolate-ports"; "Delete"="delete"; "Tag"="tag"; "Digest"="digest"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnVnetsRB {
    ...
    Process {
        ...
        $AllProperties = ("zone", "vlanaware", "lock-token", "alias", "isolate-ports", "delete", "tag", "digest")
