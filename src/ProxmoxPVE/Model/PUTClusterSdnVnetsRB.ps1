...
function Initialize-PVEPUTClusterSdnVnetsRB {
    ...
    Process {
        ...
        if (!$Alias -and $Alias.length -gt 256) {
		 ...
		 $DisplayNameMapping =@{
			"Tag"="tag"; "Delete"="delete"; "IsolatePorts"="isolate-ports"; "Vlanaware"="vlanaware"; "Zone"="zone"; "Digest"="digest"; "LockToken"="lock-token"; "Alias"="alias"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnVnetsRB {
    ...
    Process {
        ...
        $AllProperties = ("tag", "delete", "isolate-ports", "vlanaware", "zone", "digest", "lock-token", "alias")
