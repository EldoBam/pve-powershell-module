...
function Initialize-PVEPOSTNodesQemuStatusStopRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"KeepActive"="keepActive"; "Migratedfrom"="migratedfrom"; "Skiplock"="skiplock"; "OverruleShutdown"="overrule-shutdown"; "Timeout"="timeout"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuStatusStopRB {
    ...
    Process {
        ...
        $AllProperties = ("keepActive", "migratedfrom", "skiplock", "overrule-shutdown", "timeout")
