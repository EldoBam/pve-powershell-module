...
function Initialize-PVEPOSTNodesQemuStatusStopRB {
    ...
    Process {
        ...
        if ($Skiplock -and $Skiplock -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Migratedfrom"="migratedfrom"; "OverruleShutdown"="overrule-shutdown"; "Timeout"="timeout"; "KeepActive"="keepActive"; "Node"="node"; "Vmid"="vmid"; "Skiplock"="skiplock"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuStatusStopRB {
    ...
    Process {
        ...
        $AllProperties = ("migratedfrom", "overrule-shutdown", "timeout", "keepActive", "node", "vmid", "skiplock")
