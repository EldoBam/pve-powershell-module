...
function Initialize-PVEPUTNodesConfigRB {
    ...
    Process {
        ...
        if (!$Description -and $Description.length -gt 65536) {
		 ...
		 $DisplayNameMapping =@{
			"Digest"="digest"; "StartallOnbootDelay"="startall-onboot-delay"; "Wakeonlan"="wakeonlan"; "BallooningTarget"="ballooning-target"; "Delete"="delete"; "Acme"="acme"; "AcmedomainN"="acmedomain[n]"; "Description"="description"
        }
...
function ConvertFrom-PVEJsonToPUTNodesConfigRB {
    ...
    Process {
        ...
        $AllProperties = ("digest", "startall-onboot-delay", "wakeonlan", "ballooning-target", "delete", "acme", "acmedomain[n]", "description")
