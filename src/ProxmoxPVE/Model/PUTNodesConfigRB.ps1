...
function Initialize-PVEPUTNodesConfigRB {
    ...
    Process {
        ...
        if ($BallooningTarget -and $BallooningTarget -gt 100) {
		 ...
		 $DisplayNameMapping =@{
			"StartallOnbootDelay"="startall-onboot-delay"; "Delete"="delete"; "Description"="description"; "Wakeonlan"="wakeonlan"; "AcmedomainN"="acmedomain[n]"; "Digest"="digest"; "BallooningTarget"="ballooning-target"; "Acme"="acme"
        }
...
function ConvertFrom-PVEJsonToPUTNodesConfigRB {
    ...
    Process {
        ...
        $AllProperties = ("startall-onboot-delay", "delete", "description", "wakeonlan", "acmedomain[n]", "digest", "ballooning-target", "acme")
