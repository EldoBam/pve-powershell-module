...
function Initialize-PVEPUTNodesConfigRB {
    ...
    Process {
        ...
        if (!$Description -and $Description.length -gt 65536) {
		 ...
		 $DisplayNameMapping =@{
			"AcmedomainN"="acmedomain[n]"; "Wakeonlan"="wakeonlan"; "Delete"="delete"; "StartallOnbootDelay"="startall-onboot-delay"; "BallooningTarget"="ballooning-target"; "Digest"="digest"; "Description"="description"; "Acme"="acme"
        }
...
function ConvertFrom-PVEJsonToPUTNodesConfigRB {
    ...
    Process {
        ...
        $AllProperties = ("acmedomain[n]", "wakeonlan", "delete", "startall-onboot-delay", "ballooning-target", "digest", "description", "acme")
