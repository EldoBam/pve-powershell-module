...
function Initialize-PVENodesFirewallRules {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Enable"="enable"; "Dport"="dport"; "Comment"="comment"; "IcmpType"="icmp-type"; "Sport"="sport"; "Pos"="pos"; "Ipversion"="ipversion"; "Dest"="dest"; "Log"="log"; "Macro"="macro"; "Source"="source"; "Action"="action"; "Proto"="proto"; "Iface"="iface"; "Type"="type"
        }
...
function ConvertFrom-PVEJsonToNodesFirewallRules {
    ...
    Process {
        ...
        $AllProperties = ("enable", "dport", "comment", "icmp-type", "sport", "pos", "ipversion", "dest", "log", "macro", "source", "action", "proto", "iface", "type")
