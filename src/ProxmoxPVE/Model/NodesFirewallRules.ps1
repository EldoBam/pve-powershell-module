...
function Initialize-PVENodesFirewallRules {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Macro"="macro"; "Action"="action"; "Iface"="iface"; "Proto"="proto"; "IcmpType"="icmp-type"; "Ipversion"="ipversion"; "Comment"="comment"; "Type"="type"; "Source"="source"; "Dest"="dest"; "Enable"="enable"; "Log"="log"; "Dport"="dport"; "Pos"="pos"; "Sport"="sport"
        }
...
function ConvertFrom-PVEJsonToNodesFirewallRules {
    ...
    Process {
        ...
        $AllProperties = ("macro", "action", "iface", "proto", "icmp-type", "ipversion", "comment", "type", "source", "dest", "enable", "log", "dport", "pos", "sport")
