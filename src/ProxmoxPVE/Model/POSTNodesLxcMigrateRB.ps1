...
function Initialize-PVEPOSTNodesLxcMigrateRB {
    ...
    Process {
        ...
        if ($Vmid -and $Vmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Restart"="restart"; "TargetStorage"="target-storage"; "Online"="online"; "Bwlimit"="bwlimit"; "Vmid"="vmid"; "Timeout"="timeout"; "Target"="target"; "Node"="node"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesLxcMigrateRB {
    ...
    Process {
        ...
        $AllProperties = ("restart", "target-storage", "online", "bwlimit", "vmid", "timeout", "target", "node")
