...
function Initialize-PVEClusterStatusInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Level"="level"; "Nodeid"="nodeid"; "Ip"="ip"; "Quorate"="quorate"; "Name"="name"; "Id"="id"; "Type"="type"; "Nodes"="nodes"; "Online"="online"; "VarLocal"="local"; "Version"="version"
        }
...
function ConvertFrom-PVEJsonToClusterStatusInner {
    ...
    Process {
        ...
        $AllProperties = ("level", "nodeid", "ip", "quorate", "name", "id", "type", "nodes", "online", "local", "version")
