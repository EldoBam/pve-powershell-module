...
function Initialize-PVEClusterNotificationsMatchersGETInner {
    ...
    Process {
        ...
        if ($Disable -and $Disable -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"InvertMatch"="invert-match"; "Mode"="mode"; "MatchSeverity"="match-severity"; "Origin"="origin"; "MatchCalendar"="match-calendar"; "Target"="target"; "Comment"="comment"; "MatchField"="match-field"; "Disable"="disable"; "Name"="name"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsMatchersGETInner {
    ...
    Process {
        ...
        $AllProperties = ("invert-match", "mode", "match-severity", "origin", "match-calendar", "target", "comment", "match-field", "disable", "name")
