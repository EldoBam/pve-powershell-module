...
function Initialize-PVEClusterNotificationsMatchersGETInner {
    ...
    Process {
        ...
        if ($Disable -and $Disable -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Comment"="comment"; "Name"="name"; "MatchField"="match-field"; "MatchCalendar"="match-calendar"; "MatchSeverity"="match-severity"; "Target"="target"; "InvertMatch"="invert-match"; "Mode"="mode"; "Disable"="disable"; "Origin"="origin"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsMatchersGETInner {
    ...
    Process {
        ...
        $AllProperties = ("comment", "name", "match-field", "match-calendar", "match-severity", "target", "invert-match", "mode", "disable", "origin")
