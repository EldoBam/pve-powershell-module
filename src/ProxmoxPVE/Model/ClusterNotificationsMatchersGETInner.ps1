...
function Initialize-PVEClusterNotificationsMatchersGETInner {
    ...
    Process {
        ...
        if ($InvertMatch -and $InvertMatch -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"MatchSeverity"="match-severity"; "Comment"="comment"; "Disable"="disable"; "MatchCalendar"="match-calendar"; "Origin"="origin"; "MatchField"="match-field"; "InvertMatch"="invert-match"; "Target"="target"; "Name"="name"; "Mode"="mode"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsMatchersGETInner {
    ...
    Process {
        ...
        $AllProperties = ("match-severity", "comment", "disable", "match-calendar", "origin", "match-field", "invert-match", "target", "name", "mode")
