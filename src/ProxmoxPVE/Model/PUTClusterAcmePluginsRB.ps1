...
function Initialize-PVEPUTClusterAcmePluginsRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"VarData"="data"; "Delete"="delete"; "Api"="api"; "Nodes"="nodes"; "ValidationDelay"="validation-delay"; "Digest"="digest"; "Disable"="disable"
        }
...
function ConvertFrom-PVEJsonToPUTClusterAcmePluginsRB {
    ...
    Process {
        ...
        $AllProperties = ("data", "delete", "api", "nodes", "validation-delay", "digest", "disable")
