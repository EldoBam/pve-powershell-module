...
function Initialize-PVEPUTClusterAcmePluginsRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"ValidationDelay"="validation-delay"; "Delete"="delete"; "VarData"="data"; "Disable"="disable"; "Api"="api"; "Digest"="digest"; "Nodes"="nodes"
        }
...
function ConvertFrom-PVEJsonToPUTClusterAcmePluginsRB {
    ...
    Process {
        ...
        $AllProperties = ("validation-delay", "delete", "data", "disable", "api", "digest", "nodes")
