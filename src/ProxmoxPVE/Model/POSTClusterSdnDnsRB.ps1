...
function Initialize-PVEPOSTClusterSdnDnsRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Key"="key"; "Ttl"="ttl"; "Url"="url"; "Type"="type"; "Reversemaskv6"="reversemaskv6"; "Dns"="dns"; "Reversev6mask"="reversev6mask"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterSdnDnsRB {
    ...
    Process {
        ...
        $AllProperties = ("key", "ttl", "url", "type", "reversemaskv6", "dns", "reversev6mask")
