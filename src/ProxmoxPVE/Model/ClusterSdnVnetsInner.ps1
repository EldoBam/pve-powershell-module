...
function Initialize-PVEClusterSdnVnetsInner {
    ...
    Process {
        ...
        if ($Tag -and $Tag -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Zone"="zone"; "Pending"="pending"; "Vnet"="vnet"; "Alias"="alias"; "Type"="type"; "IsolatePorts"="isolate-ports"; "Vlanaware"="vlanaware"; "Tag"="tag"; "Digest"="digest"; "State"="state"
        }
...
function ConvertFrom-PVEJsonToClusterSdnVnetsInner {
    ...
    Process {
        ...
        $AllProperties = ("zone", "pending", "vnet", "alias", "type", "isolate-ports", "vlanaware", "tag", "digest", "state")
