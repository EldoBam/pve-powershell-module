...
function Initialize-PVEGETNodesJournalRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Endcursor"="endcursor"; "VarUntil"="until"; "Startcursor"="startcursor"; "Node"="node"; "Since"="since"; "Lastentries"="lastentries"
        }
...
function ConvertFrom-PVEJsonToGETNodesJournalRB {
    ...
    Process {
        ...
        $AllProperties = ("endcursor", "until", "startcursor", "node", "since", "lastentries")
