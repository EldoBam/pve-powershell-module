...
function Initialize-PVEGETNodesJournalRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"VarUntil"="until"; "Lastentries"="lastentries"; "Startcursor"="startcursor"; "Since"="since"; "Endcursor"="endcursor"
        }
...
function ConvertFrom-PVEJsonToGETNodesJournalRB {
    ...
    Process {
        ...
        $AllProperties = ("until", "lastentries", "startcursor", "since", "endcursor")
