...
function Initialize-PVEGETNodesJournalRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"VarUntil"="until"; "Lastentries"="lastentries"; "Endcursor"="endcursor"; "Since"="since"; "Startcursor"="startcursor"
        }
...
function ConvertFrom-PVEJsonToGETNodesJournalRB {
    ...
    Process {
        ...
        $AllProperties = ("until", "lastentries", "endcursor", "since", "startcursor")
