...
function Initialize-PVEPOSTNodesCephInitRB {
    ...
    Process {
        ...
        if ($Size -and $Size -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"PgBits"="pg_bits"; "Network"="network"; "DisableCephx"="disable_cephx"; "Node"="node"; "ClusterNetwork"="cluster-network"; "MinSize"="min_size"; "Size"="size"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesCephInitRB {
    ...
    Process {
        ...
        $AllProperties = ("pg_bits", "network", "disable_cephx", "node", "cluster-network", "min_size", "size")
