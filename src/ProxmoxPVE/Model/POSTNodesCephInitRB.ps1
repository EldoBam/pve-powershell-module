...
function Initialize-PVEPOSTNodesCephInitRB {
    ...
    Process {
        ...
        if (!$ClusterNetwork -and $ClusterNetwork.length -gt 128) {
		 ...
		 $DisplayNameMapping =@{
			"Size"="size"; "DisableCephx"="disable_cephx"; "Network"="network"; "MinSize"="min_size"; "PgBits"="pg_bits"; "ClusterNetwork"="cluster-network"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesCephInitRB {
    ...
    Process {
        ...
        $AllProperties = ("size", "disable_cephx", "network", "min_size", "pg_bits", "cluster-network")
