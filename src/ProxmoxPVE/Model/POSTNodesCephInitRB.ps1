...
function Initialize-PVEPOSTNodesCephInitRB {
    ...
    Process {
        ...
        if ($PgBits -and $PgBits -lt 6) {
		 ...
		 $DisplayNameMapping =@{
			"DisableCephx"="disable_cephx"; "Size"="size"; "Network"="network"; "MinSize"="min_size"; "ClusterNetwork"="cluster-network"; "PgBits"="pg_bits"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesCephInitRB {
    ...
    Process {
        ...
        $AllProperties = ("disable_cephx", "size", "network", "min_size", "cluster-network", "pg_bits")
