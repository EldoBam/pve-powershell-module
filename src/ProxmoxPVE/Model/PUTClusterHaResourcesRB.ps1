...
function Initialize-PVEPUTClusterHaResourcesRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"MaxRelocate"="max_relocate"; "Group"="group"; "Delete"="delete"; "MaxRestart"="max_restart"; "Comment"="comment"; "Failback"="failback"; "Digest"="digest"; "State"="state"
        }
...
function ConvertFrom-PVEJsonToPUTClusterHaResourcesRB {
    ...
    Process {
        ...
        $AllProperties = ("max_relocate", "group", "delete", "max_restart", "comment", "failback", "digest", "state")
