...
function Initialize-PVEPUTClusterHaResourcesRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Delete"="delete"; "Group"="group"; "Comment"="comment"; "MaxRelocate"="max_relocate"; "State"="state"; "MaxRestart"="max_restart"; "Digest"="digest"; "Failback"="failback"
        }
...
function ConvertFrom-PVEJsonToPUTClusterHaResourcesRB {
    ...
    Process {
        ...
        $AllProperties = ("delete", "group", "comment", "max_relocate", "state", "max_restart", "digest", "failback")
