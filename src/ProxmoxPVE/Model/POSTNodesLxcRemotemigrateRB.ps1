...
function Initialize-PVEPOSTNodesLxcRemotemigrateRB {
    ...
    Process {
        ...
        if ($TargetVmid -and $TargetVmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"TargetBridge"="target-bridge"; "Restart"="restart"; "Delete"="delete"; "TargetEndpoint"="target-endpoint"; "Bwlimit"="bwlimit"; "TargetStorage"="target-storage"; "Timeout"="timeout"; "TargetVmid"="target-vmid"; "Online"="online"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesLxcRemotemigrateRB {
    ...
    Process {
        ...
        $AllProperties = ("target-bridge", "restart", "delete", "target-endpoint", "bwlimit", "target-storage", "timeout", "target-vmid", "online")
