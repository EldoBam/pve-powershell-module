...
function Initialize-PVEPOSTNodesLxcRemotemigrateRB {
    ...
    Process {
        ...
        if ($TargetVmid -and $TargetVmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Online"="online"; "Timeout"="timeout"; "Delete"="delete"; "TargetBridge"="target-bridge"; "TargetStorage"="target-storage"; "Bwlimit"="bwlimit"; "TargetEndpoint"="target-endpoint"; "TargetVmid"="target-vmid"; "Restart"="restart"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesLxcRemotemigrateRB {
    ...
    Process {
        ...
        $AllProperties = ("online", "timeout", "delete", "target-bridge", "target-storage", "bwlimit", "target-endpoint", "target-vmid", "restart")
