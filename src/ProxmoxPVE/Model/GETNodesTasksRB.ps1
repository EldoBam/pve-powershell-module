...
function Initialize-PVEGETNodesTasksRB {
    ...
    Process {
        ...
        if ($Vmid -and $Vmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Since"="since"; "Source"="source"; "Errors"="errors"; "Statusfilter"="statusfilter"; "Limit"="limit"; "VarUntil"="until"; "Vmid"="vmid"; "Typefilter"="typefilter"; "Start"="start"; "Userfilter"="userfilter"
        }
...
function ConvertFrom-PVEJsonToGETNodesTasksRB {
    ...
    Process {
        ...
        $AllProperties = ("since", "source", "errors", "statusfilter", "limit", "until", "vmid", "typefilter", "start", "userfilter")
