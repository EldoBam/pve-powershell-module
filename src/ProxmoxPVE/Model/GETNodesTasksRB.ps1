...
function Initialize-PVEGETNodesTasksRB {
    ...
    Process {
        ...
        if ($Vmid -and $Vmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Userfilter"="userfilter"; "Statusfilter"="statusfilter"; "Typefilter"="typefilter"; "Vmid"="vmid"; "Limit"="limit"; "Source"="source"; "Since"="since"; "Errors"="errors"; "VarUntil"="until"; "Start"="start"
        }
...
function ConvertFrom-PVEJsonToGETNodesTasksRB {
    ...
    Process {
        ...
        $AllProperties = ("userfilter", "statusfilter", "typefilter", "vmid", "limit", "source", "since", "errors", "until", "start")
