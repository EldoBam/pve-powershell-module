...
function Initialize-PVEGETNodesTasksRB {
    ...
    Process {
        ...
        if ($Errors -and $Errors -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Typefilter"="typefilter"; "Source"="source"; "Limit"="limit"; "Userfilter"="userfilter"; "Statusfilter"="statusfilter"; "Node"="node"; "Vmid"="vmid"; "Errors"="errors"; "Since"="since"; "Start"="start"; "VarUntil"="until"
        }
...
function ConvertFrom-PVEJsonToGETNodesTasksRB {
    ...
    Process {
        ...
        $AllProperties = ("typefilter", "source", "limit", "userfilter", "statusfilter", "node", "vmid", "errors", "since", "start", "until")
