...
function Initialize-PVEGETNodesTasksRB {
    ...
    Process {
        ...
        if ($Vmid -and $Vmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Vmid"="vmid"; "Limit"="limit"; "VarUntil"="until"; "Start"="start"; "Source"="source"; "Userfilter"="userfilter"; "Statusfilter"="statusfilter"; "Typefilter"="typefilter"; "Since"="since"; "Errors"="errors"
        }
...
function ConvertFrom-PVEJsonToGETNodesTasksRB {
    ...
    Process {
        ...
        $AllProperties = ("vmid", "limit", "until", "start", "source", "userfilter", "statusfilter", "typefilter", "since", "errors")
