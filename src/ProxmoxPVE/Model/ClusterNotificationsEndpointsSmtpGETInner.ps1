...
function Initialize-PVEClusterNotificationsEndpointsSmtpGETInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Author"="author"; "Comment"="comment"; "Mode"="mode"; "Server"="server"; "FromAddress"="from-address"; "Disable"="disable"; "Name"="name"; "Origin"="origin"; "MailtoUser"="mailto-user"; "Username"="username"; "Mailto"="mailto"; "Port"="port"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsSmtpGETInner {
    ...
    Process {
        ...
        $AllProperties = ("author", "comment", "mode", "server", "from-address", "disable", "name", "origin", "mailto-user", "username", "mailto", "port")
