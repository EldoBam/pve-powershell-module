...
function Initialize-PVEClusterNotificationsEndpointsSmtpGETInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Mode"="mode"; "Origin"="origin"; "Username"="username"; "Name"="name"; "Mailto"="mailto"; "Disable"="disable"; "Port"="port"; "MailtoUser"="mailto-user"; "FromAddress"="from-address"; "Author"="author"; "Server"="server"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsSmtpGETInner {
    ...
    Process {
        ...
        $AllProperties = ("mode", "origin", "username", "name", "mailto", "disable", "port", "mailto-user", "from-address", "author", "server", "comment")
