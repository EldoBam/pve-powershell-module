...
function Initialize-PVEClusterNotificationsEndpointsSmtpGETInner {
    ...
    Process {
        ...
        if ($Disable -and $Disable -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Mailto"="mailto"; "Origin"="origin"; "MailtoUser"="mailto-user"; "Comment"="comment"; "Author"="author"; "Disable"="disable"; "Server"="server"; "FromAddress"="from-address"; "Username"="username"; "Port"="port"; "Name"="name"; "Mode"="mode"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsSmtpGETInner {
    ...
    Process {
        ...
        $AllProperties = ("mailto", "origin", "mailto-user", "comment", "author", "disable", "server", "from-address", "username", "port", "name", "mode")
