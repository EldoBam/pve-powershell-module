...
function Initialize-PVEClusterNotificationsEndpointsSmtpGETInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Disable"="disable"; "Author"="author"; "Origin"="origin"; "Username"="username"; "Mode"="mode"; "Server"="server"; "Comment"="comment"; "Mailto"="mailto"; "Port"="port"; "MailtoUser"="mailto-user"; "Name"="name"; "FromAddress"="from-address"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsSmtpGETInner {
    ...
    Process {
        ...
        $AllProperties = ("disable", "author", "origin", "username", "mode", "server", "comment", "mailto", "port", "mailto-user", "name", "from-address")
