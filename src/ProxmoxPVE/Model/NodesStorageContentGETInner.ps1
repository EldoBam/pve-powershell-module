...
function Initialize-PVENodesStorageContentGETInner {
    ...
    Process {
        ...
        if ($Protected -and $Protected -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Notes"="notes"; "Volid"="volid"; "Encrypted"="encrypted"; "Format"="format"; "Protected"="protected"; "Vmid"="vmid"; "Verification"="verification"; "Used"="used"; "Parent"="parent"; "Ctime"="ctime"; "Size"="size"
        }
...
function ConvertFrom-PVEJsonToNodesStorageContentGETInner {
    ...
    Process {
        ...
        $AllProperties = ("notes", "volid", "encrypted", "format", "protected", "vmid", "verification", "used", "parent", "ctime", "size")
