...
function Initialize-PVEPOSTClusterReplicationRB {
    ...
    Process {
        ...
        if ($Rate -and $Rate -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Disable"="disable"; "Target"="target"; "Type"="type"; "Schedule"="schedule"; "Id"="id"; "Source"="source"; "RemoveJob"="remove_job"; "Comment"="comment"; "Rate"="rate"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterReplicationRB {
    ...
    Process {
        ...
        $AllProperties = ("disable", "target", "type", "schedule", "id", "source", "remove_job", "comment", "rate")
