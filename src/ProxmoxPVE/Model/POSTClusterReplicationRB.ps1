...
function Initialize-PVEPOSTClusterReplicationRB {
    ...
    Process {
        ...
        if (!$Comment -and $Comment.length -gt 4096) {
		 ...
		 $DisplayNameMapping =@{
			"Schedule"="schedule"; "Target"="target"; "RemoveJob"="remove_job"; "Disable"="disable"; "Type"="type"; "Rate"="rate"; "Id"="id"; "Source"="source"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterReplicationRB {
    ...
    Process {
        ...
        $AllProperties = ("schedule", "target", "remove_job", "disable", "type", "rate", "id", "source", "comment")
