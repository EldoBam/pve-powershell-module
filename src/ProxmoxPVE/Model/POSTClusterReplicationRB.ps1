...
function Initialize-PVEPOSTClusterReplicationRB {
    ...
    Process {
        ...
        if (!$Comment -and $Comment.length -gt 4096) {
		 ...
		 $DisplayNameMapping =@{
			"Type"="type"; "RemoveJob"="remove_job"; "Schedule"="schedule"; "Disable"="disable"; "Id"="id"; "Target"="target"; "Source"="source"; "Rate"="rate"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterReplicationRB {
    ...
    Process {
        ...
        $AllProperties = ("type", "remove_job", "schedule", "disable", "id", "target", "source", "rate", "comment")
