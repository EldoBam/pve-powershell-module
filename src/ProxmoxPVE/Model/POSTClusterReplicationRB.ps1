...
function Initialize-PVEPOSTClusterReplicationRB {
    ...
    Process {
        ...
        if ($Rate -and $Rate -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Schedule"="schedule"; "RemoveJob"="remove_job"; "Id"="id"; "Comment"="comment"; "Type"="type"; "Source"="source"; "Target"="target"; "Rate"="rate"; "Disable"="disable"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterReplicationRB {
    ...
    Process {
        ...
        $AllProperties = ("schedule", "remove_job", "id", "comment", "type", "source", "target", "rate", "disable")
