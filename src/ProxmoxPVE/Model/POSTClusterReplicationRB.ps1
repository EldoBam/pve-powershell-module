...
function Initialize-PVEPOSTClusterReplicationRB {
    ...
    Process {
        ...
        if ($Disable -and $Disable -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Source"="source"; "Schedule"="schedule"; "Target"="target"; "Type"="type"; "Rate"="rate"; "Comment"="comment"; "Disable"="disable"; "RemoveJob"="remove_job"; "Id"="id"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterReplicationRB {
    ...
    Process {
        ...
        $AllProperties = ("source", "schedule", "target", "type", "rate", "comment", "disable", "remove_job", "id")
