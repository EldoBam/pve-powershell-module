...
function Initialize-PVEPUTClusterSdnFabricsNodeRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Protocol"="protocol"; "Ip6"="ip6"; "Ip"="ip"; "Delete"="delete"; "LockToken"="lock-token"; "NodeId"="node_id"; "FabricId"="fabric_id"; "Digest"="digest"; "Interfaces"="interfaces"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnFabricsNodeRB {
    ...
    Process {
        ...
        $AllProperties = ("protocol", "ip6", "ip", "delete", "lock-token", "node_id", "fabric_id", "digest", "interfaces")
