...
PUTClusterSdnFabricsNodeRB<PSCustomObject>
#>

function Initialize-PVEPUTClusterSdnFabricsNodeRB {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ProxmoxPVE => PVEPUTClusterSdnFabricsNodeRB' | Write-Debug
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Ip"="ip"; "Delete"="delete"; "NodeId"="node_id"; "FabricId"="fabric_id"; "Interfaces"="interfaces"; "Digest"="digest"; "LockToken"="lock-token"; "Ip6"="ip6"; "Protocol"="protocol"
        }
...
Convert from JSON to PUTClusterSdnFabricsNodeRB<PSCustomObject>
...
PUTClusterSdnFabricsNodeRB<PSCustomObject>
#>
function ConvertFrom-PVEJsonToPUTClusterSdnFabricsNodeRB {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ProxmoxPVE => PVEPUTClusterSdnFabricsNodeRB' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PVEPUTClusterSdnFabricsNodeRB
        $AllProperties = ("ip", "delete", "node_id", "fabric_id", "interfaces", "digest", "lock-token", "ip6", "protocol")
