...
function Initialize-PVEPOSTClusterMetricsServerRB {
    ...
    Process {
        ...
        if ($MaxBodySize -and $MaxBodySize -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"VerifyCertificate"="verify-certificate"; "Type"="type"; "Bucket"="bucket"; "Organization"="organization"; "ApiPathPrefix"="api-path-prefix"; "Timeout"="timeout"; "Token"="token"; "Port"="port"; "Mtu"="mtu"; "Influxdbproto"="influxdbproto"; "Disable"="disable"; "Server"="server"; "Proto"="proto"; "MaxBodySize"="max-body-size"; "Path"="path"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterMetricsServerRB {
    ...
    Process {
        ...
        $AllProperties = ("verify-certificate", "type", "bucket", "organization", "api-path-prefix", "timeout", "token", "port", "mtu", "influxdbproto", "disable", "server", "proto", "max-body-size", "path")
