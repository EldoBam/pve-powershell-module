...
function Initialize-PVEPOSTClusterMetricsServerRB {
    ...
    Process {
        ...
        if ($Mtu -and $Mtu -lt 512) {
		 ...
		 $DisplayNameMapping =@{
			"ApiPathPrefix"="api-path-prefix"; "Timeout"="timeout"; "Port"="port"; "Proto"="proto"; "Organization"="organization"; "Type"="type"; "Server"="server"; "Bucket"="bucket"; "Influxdbproto"="influxdbproto"; "Path"="path"; "VerifyCertificate"="verify-certificate"; "MaxBodySize"="max-body-size"; "Disable"="disable"; "Mtu"="mtu"; "Token"="token"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterMetricsServerRB {
    ...
    Process {
        ...
        $AllProperties = ("api-path-prefix", "timeout", "port", "proto", "organization", "type", "server", "bucket", "influxdbproto", "path", "verify-certificate", "max-body-size", "disable", "mtu", "token")
