...
function Initialize-PVEPUTClusterFirewallOptionsRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"PolicyOut"="policy_out"; "Delete"="delete"; "Enable"="enable"; "Ebtables"="ebtables"; "LogRatelimit"="log_ratelimit"; "Digest"="digest"; "PolicyForward"="policy_forward"; "PolicyIn"="policy_in"
        }
...
function ConvertFrom-PVEJsonToPUTClusterFirewallOptionsRB {
    ...
    Process {
        ...
        $AllProperties = ("policy_out", "delete", "enable", "ebtables", "log_ratelimit", "digest", "policy_forward", "policy_in")
