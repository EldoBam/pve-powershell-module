...
function Initialize-PVEPUTClusterFirewallOptionsRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"LogRatelimit"="log_ratelimit"; "Digest"="digest"; "PolicyOut"="policy_out"; "Delete"="delete"; "Enable"="enable"; "Ebtables"="ebtables"; "PolicyIn"="policy_in"; "PolicyForward"="policy_forward"
        }
...
function ConvertFrom-PVEJsonToPUTClusterFirewallOptionsRB {
    ...
    Process {
        ...
        $AllProperties = ("log_ratelimit", "digest", "policy_out", "delete", "enable", "ebtables", "policy_in", "policy_forward")
