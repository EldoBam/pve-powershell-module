...
function Initialize-PVEPUTClusterBackupRB {
    ...
    Process {
        ...
        if ($Ionice -and $Ionice -gt 8) {
		 ...
		 $DisplayNameMapping =@{
			"Stop"="stop"; "Starttime"="starttime"; "Mailnotification"="mailnotification"; "ExcludePath"="exclude-path"; "Protected"="protected"; "Dow"="dow"; "PruneBackups"="prune-backups"; "Comment"="comment"; "Exclude"="exclude"; "Node"="node"; "Dumpdir"="dumpdir"; "Zstd"="zstd"; "NotificationTarget"="notification-target"; "Quiet"="quiet"; "Performance"="performance"; "Maxfiles"="maxfiles"; "Mailto"="mailto"; "NotesTemplate"="notes-template"; "Enabled"="enabled"; "Bwlimit"="bwlimit"; "Fleecing"="fleecing"; "All"="all"; "NotificationPolicy"="notification-policy"; "Schedule"="schedule"; "Compress"="compress"; "Pigz"="pigz"; "NotificationMode"="notification-mode"; "Mode"="mode"; "Vmid"="vmid"; "Remove"="remove"; "Stdexcludes"="stdexcludes"; "Ionice"="ionice"; "Lockwait"="lockwait"; "Storage"="storage"; "Tmpdir"="tmpdir"; "Pool"="pool"; "Delete"="delete"; "Script"="script"; "RepeatMissed"="repeat-missed"; "Stopwait"="stopwait"; "PbsChangeDetectionMode"="pbs-change-detection-mode"
        }
...
function ConvertFrom-PVEJsonToPUTClusterBackupRB {
    ...
    Process {
        ...
        $AllProperties = ("stop", "starttime", "mailnotification", "exclude-path", "protected", "dow", "prune-backups", "comment", "exclude", "node", "dumpdir", "zstd", "notification-target", "quiet", "performance", "maxfiles", "mailto", "notes-template", "enabled", "bwlimit", "fleecing", "all", "notification-policy", "schedule", "compress", "pigz", "notification-mode", "mode", "vmid", "remove", "stdexcludes", "ionice", "lockwait", "storage", "tmpdir", "pool", "delete", "script", "repeat-missed", "stopwait", "pbs-change-detection-mode")
