...
function Initialize-PVEPUTClusterBackupRB {
    ...
    Process {
        ...
        if ($Ionice -and $Ionice -gt 8) {
		 ...
		 $DisplayNameMapping =@{
			"Pool"="pool"; "Comment"="comment"; "Tmpdir"="tmpdir"; "Dow"="dow"; "NotificationPolicy"="notification-policy"; "Schedule"="schedule"; "Mode"="mode"; "Pigz"="pigz"; "Quiet"="quiet"; "Storage"="storage"; "Vmid"="vmid"; "Mailto"="mailto"; "Bwlimit"="bwlimit"; "Zstd"="zstd"; "Delete"="delete"; "NotificationMode"="notification-mode"; "Fleecing"="fleecing"; "RepeatMissed"="repeat-missed"; "PbsChangeDetectionMode"="pbs-change-detection-mode"; "Lockwait"="lockwait"; "Maxfiles"="maxfiles"; "Enabled"="enabled"; "Stop"="stop"; "ExcludePath"="exclude-path"; "Performance"="performance"; "Protected"="protected"; "Dumpdir"="dumpdir"; "NotesTemplate"="notes-template"; "Stdexcludes"="stdexcludes"; "PruneBackups"="prune-backups"; "NotificationTarget"="notification-target"; "Compress"="compress"; "All"="all"; "Exclude"="exclude"; "Remove"="remove"; "Mailnotification"="mailnotification"; "Stopwait"="stopwait"; "Script"="script"; "Node"="node"; "Ionice"="ionice"; "Starttime"="starttime"
        }
...
function ConvertFrom-PVEJsonToPUTClusterBackupRB {
    ...
    Process {
        ...
        $AllProperties = ("pool", "comment", "tmpdir", "dow", "notification-policy", "schedule", "mode", "pigz", "quiet", "storage", "vmid", "mailto", "bwlimit", "zstd", "delete", "notification-mode", "fleecing", "repeat-missed", "pbs-change-detection-mode", "lockwait", "maxfiles", "enabled", "stop", "exclude-path", "performance", "protected", "dumpdir", "notes-template", "stdexcludes", "prune-backups", "notification-target", "compress", "all", "exclude", "remove", "mailnotification", "stopwait", "script", "node", "ionice", "starttime")
