...
function Initialize-PVEPUTClusterBackupRB {
    ...
    Process {
        ...
        if ($Quiet -and $Quiet -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Id"="id"; "PruneBackups"="prune-backups"; "Bwlimit"="bwlimit"; "Remove"="remove"; "Fleecing"="fleecing"; "Schedule"="schedule"; "All"="all"; "Dow"="dow"; "Protected"="protected"; "ExcludePath"="exclude-path"; "PbsChangeDetectionMode"="pbs-change-detection-mode"; "Script"="script"; "RepeatMissed"="repeat-missed"; "Comment"="comment"; "Tmpdir"="tmpdir"; "Pool"="pool"; "Dumpdir"="dumpdir"; "Delete"="delete"; "Stopwait"="stopwait"; "Enabled"="enabled"; "Exclude"="exclude"; "Stop"="stop"; "Mailto"="mailto"; "Storage"="storage"; "NotesTemplate"="notes-template"; "NotificationTarget"="notification-target"; "Stdexcludes"="stdexcludes"; "Mailnotification"="mailnotification"; "Mode"="mode"; "Lockwait"="lockwait"; "Ionice"="ionice"; "Zstd"="zstd"; "Pigz"="pigz"; "Performance"="performance"; "Maxfiles"="maxfiles"; "NotificationPolicy"="notification-policy"; "Starttime"="starttime"; "Vmid"="vmid"; "Compress"="compress"; "Node"="node"; "Quiet"="quiet"; "NotificationMode"="notification-mode"
        }
...
function ConvertFrom-PVEJsonToPUTClusterBackupRB {
    ...
    Process {
        ...
        $AllProperties = ("id", "prune-backups", "bwlimit", "remove", "fleecing", "schedule", "all", "dow", "protected", "exclude-path", "pbs-change-detection-mode", "script", "repeat-missed", "comment", "tmpdir", "pool", "dumpdir", "delete", "stopwait", "enabled", "exclude", "stop", "mailto", "storage", "notes-template", "notification-target", "stdexcludes", "mailnotification", "mode", "lockwait", "ionice", "zstd", "pigz", "performance", "maxfiles", "notification-policy", "starttime", "vmid", "compress", "node", "quiet", "notification-mode")
