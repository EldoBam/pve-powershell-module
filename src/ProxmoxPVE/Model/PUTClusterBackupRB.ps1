...
function Initialize-PVEPUTClusterBackupRB {
    ...
    Process {
        ...
        if ($Maxfiles -and $Maxfiles -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"All"="all"; "NotificationMode"="notification-mode"; "Stopwait"="stopwait"; "Pigz"="pigz"; "Storage"="storage"; "Script"="script"; "Enabled"="enabled"; "Starttime"="starttime"; "PbsChangeDetectionMode"="pbs-change-detection-mode"; "Stdexcludes"="stdexcludes"; "Schedule"="schedule"; "Ionice"="ionice"; "Dumpdir"="dumpdir"; "Node"="node"; "Delete"="delete"; "Mode"="mode"; "Stop"="stop"; "Zstd"="zstd"; "Compress"="compress"; "Mailnotification"="mailnotification"; "NotesTemplate"="notes-template"; "Mailto"="mailto"; "Bwlimit"="bwlimit"; "Vmid"="vmid"; "Fleecing"="fleecing"; "ExcludePath"="exclude-path"; "RepeatMissed"="repeat-missed"; "Lockwait"="lockwait"; "NotificationPolicy"="notification-policy"; "Id"="id"; "NotificationTarget"="notification-target"; "Tmpdir"="tmpdir"; "Protected"="protected"; "Exclude"="exclude"; "Quiet"="quiet"; "Remove"="remove"; "PruneBackups"="prune-backups"; "Performance"="performance"; "Comment"="comment"; "Pool"="pool"; "Maxfiles"="maxfiles"; "Dow"="dow"
        }
...
function ConvertFrom-PVEJsonToPUTClusterBackupRB {
    ...
    Process {
        ...
        $AllProperties = ("all", "notification-mode", "stopwait", "pigz", "storage", "script", "enabled", "starttime", "pbs-change-detection-mode", "stdexcludes", "schedule", "ionice", "dumpdir", "node", "delete", "mode", "stop", "zstd", "compress", "mailnotification", "notes-template", "mailto", "bwlimit", "vmid", "fleecing", "exclude-path", "repeat-missed", "lockwait", "notification-policy", "id", "notification-target", "tmpdir", "protected", "exclude", "quiet", "remove", "prune-backups", "performance", "comment", "pool", "maxfiles", "dow")
