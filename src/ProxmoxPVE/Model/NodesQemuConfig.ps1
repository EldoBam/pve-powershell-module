...
function Initialize-PVENodesQemuConfig {
    ...
    Process {
        ...
        if ($Cpuunits -and $Cpuunits -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"MigrateDowntime"="migrate_downtime"; "Scsihw"="scsihw"; "Tpmstate0"="tpmstate0"; "Name"="name"; "Localtime"="localtime"; "Digest"="digest"; "VirtioN"="virtio[n]"; "Acpi"="acpi"; "SerialN"="serial[n]"; "IpconfigN"="ipconfig[n]"; "Arch"="arch"; "Hotplug"="hotplug"; "NetN"="net[n]"; "Ciuser"="ciuser"; "Vmstatestorage"="vmstatestorage"; "Bios"="bios"; "Ostype"="ostype"; "Cpu"="cpu"; "UnusedN"="unused[n]"; "Searchdomain"="searchdomain"; "HostpciN"="hostpci[n]"; "Freeze"="freeze"; "SataN"="sata[n]"; "AmdSev"="amd-sev"; "Cicustom"="cicustom"; "MigrateSpeed"="migrate_speed"; "Citype"="citype"; "Description"="description"; "Hugepages"="hugepages"; "Startup"="startup"; "ParallelN"="parallel[n]"; "Watchdog"="watchdog"; "IdeN"="ide[n]"; "UsbN"="usb[n]"; "Nameserver"="nameserver"; "Tablet"="tablet"; "ScsiN"="scsi[n]"; "Autostart"="autostart"; "Ivshmem"="ivshmem"; "Sockets"="sockets"; "Machine"="machine"; "Efidisk0"="efidisk0"; "Audio0"="audio0"; "Cpulimit"="cpulimit"; "Vmgenid"="vmgenid"; "Tdf"="tdf"; "Agent"="agent"; "Lock"="lock"; "Vga"="vga"; "Shares"="shares"; "Protection"="protection"; "Memory"="memory"; "Onboot"="onboot"; "Smp"="smp"; "Cores"="cores"; "Affinity"="affinity"; "SpiceEnhancements"="spice_enhancements"; "Startdate"="startdate"; "Cipassword"="cipassword"; "Template"="template"; "Kvm"="kvm"; "Boot"="boot"; "Ciupgrade"="ciupgrade"; "Rng0"="rng0"; "Hookscript"="hookscript"; "Tags"="tags"; "Numa"="numa"; "Cdrom"="cdrom"; "VarArgs"="args"; "Bootdisk"="bootdisk"; "Reboot"="reboot"; "Vcpus"="vcpus"; "Smbios1"="smbios1"; "Sshkeys"="sshkeys"; "NumaN"="numa[n]"; "Keyboard"="keyboard"; "Balloon"="balloon"; "Keephugepages"="keephugepages"; "Cpuunits"="cpuunits"
        }
...
function ConvertFrom-PVEJsonToNodesQemuConfig {
    ...
    Process {
        ...
        $AllProperties = ("migrate_downtime", "scsihw", "tpmstate0", "name", "localtime", "digest", "virtio[n]", "acpi", "serial[n]", "ipconfig[n]", "arch", "hotplug", "net[n]", "ciuser", "vmstatestorage", "bios", "ostype", "cpu", "unused[n]", "searchdomain", "hostpci[n]", "freeze", "sata[n]", "amd-sev", "cicustom", "migrate_speed", "citype", "description", "hugepages", "startup", "parallel[n]", "watchdog", "ide[n]", "usb[n]", "nameserver", "tablet", "scsi[n]", "autostart", "ivshmem", "sockets", "machine", "efidisk0", "audio0", "cpulimit", "vmgenid", "tdf", "agent", "lock", "vga", "shares", "protection", "memory", "onboot", "smp", "cores", "affinity", "spice_enhancements", "startdate", "cipassword", "template", "kvm", "boot", "ciupgrade", "rng0", "hookscript", "tags", "numa", "cdrom", "args", "bootdisk", "reboot", "vcpus", "smbios1", "sshkeys", "numa[n]", "keyboard", "balloon", "keephugepages", "cpuunits")
