...
function Initialize-PVENodesQemuConfig {
    ...
    Process {
        ...
        if (!$Parent -and $Parent.length -gt 40) {
            throw "invalid value for 'Parent', the character length must be smaller than or equal to 40."
        }
        ...
        if ($Vcpus -and $Vcpus -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Reboot"="reboot"; "Onboot"="onboot"; "VarArgs"="args"; "Audio0"="audio0"; "Efidisk0"="efidisk0"; "Machine"="machine"; "Tdf"="tdf"; "ParallelN"="parallel[n]"; "Agent"="agent"; "Balloon"="balloon"; "Cicustom"="cicustom"; "VirtiofsN"="virtiofs[n]"; "Boot"="boot"; "Ciupgrade"="ciupgrade"; "Arch"="arch"; "AllowKsm"="allow-ksm"; "IdeN"="ide[n]"; "Vmstatestorage"="vmstatestorage"; "Searchdomain"="searchdomain"; "SpiceEnhancements"="spice_enhancements"; "MigrateSpeed"="migrate_speed"; "Freeze"="freeze"; "Cores"="cores"; "Cdrom"="cdrom"; "SerialN"="serial[n]"; "Vga"="vga"; "Snaptime"="snaptime"; "Bios"="bios"; "Startdate"="startdate"; "HostpciN"="hostpci[n]"; "NetN"="net[n]"; "Description"="description"; "Kvm"="kvm"; "Sshkeys"="sshkeys"; "Digest"="digest"; "Tags"="tags"; "Cpu"="cpu"; "AmdSev"="amd-sev"; "Numa"="numa"; "Shares"="shares"; "Keephugepages"="keephugepages"; "NumaN"="numa[n]"; "Localtime"="localtime"; "Citype"="citype"; "Tablet"="tablet"; "Scsihw"="scsihw"; "Affinity"="affinity"; "UnusedN"="unused[n]"; "Cpuunits"="cpuunits"; "Lock"="lock"; "Ciuser"="ciuser"; "Nameserver"="nameserver"; "Sockets"="sockets"; "Ivshmem"="ivshmem"; "Protection"="protection"; "Template"="template"; "Memory"="memory"; "Rng0"="rng0"; "IpconfigN"="ipconfig[n]"; "Smp"="smp"; "Keyboard"="keyboard"; "Startup"="startup"; "Bootdisk"="bootdisk"; "Meta"="meta"; "UsbN"="usb[n]"; "Runningcpu"="runningcpu"; "Tpmstate0"="tpmstate0"; "Hotplug"="hotplug"; "Parent"="parent"; "MigrateDowntime"="migrate_downtime"; "Watchdog"="watchdog"; "Vmgenid"="vmgenid"; "Cipassword"="cipassword"; "RunningNetsHostMtu"="running-nets-host-mtu"; "VirtioN"="virtio[n]"; "Hugepages"="hugepages"; "Vmstate"="vmstate"; "Hookscript"="hookscript"; "Acpi"="acpi"; "Smbios1"="smbios1"; "Cpulimit"="cpulimit"; "ScsiN"="scsi[n]"; "Autostart"="autostart"; "Vcpus"="vcpus"; "Runningmachine"="runningmachine"; "SataN"="sata[n]"; "Name"="name"; "Ostype"="ostype"; "IntelTdx"="intel-tdx"
        }
...
function ConvertFrom-PVEJsonToNodesQemuConfig {
    ...
    Process {
        ...
        $AllProperties = ("reboot", "onboot", "args", "audio0", "efidisk0", "machine", "tdf", "parallel[n]", "agent", "balloon", "cicustom", "virtiofs[n]", "boot", "ciupgrade", "arch", "allow-ksm", "ide[n]", "vmstatestorage", "searchdomain", "spice_enhancements", "migrate_speed", "freeze", "cores", "cdrom", "serial[n]", "vga", "snaptime", "bios", "startdate", "hostpci[n]", "net[n]", "description", "kvm", "sshkeys", "digest", "tags", "cpu", "amd-sev", "numa", "shares", "keephugepages", "numa[n]", "localtime", "citype", "tablet", "scsihw", "affinity", "unused[n]", "cpuunits", "lock", "ciuser", "nameserver", "sockets", "ivshmem", "protection", "template", "memory", "rng0", "ipconfig[n]", "smp", "keyboard", "startup", "bootdisk", "meta", "usb[n]", "runningcpu", "tpmstate0", "hotplug", "parent", "migrate_downtime", "watchdog", "vmgenid", "cipassword", "running-nets-host-mtu", "virtio[n]", "hugepages", "vmstate", "hookscript", "acpi", "smbios1", "cpulimit", "scsi[n]", "autostart", "vcpus", "runningmachine", "sata[n]", "name", "ostype", "intel-tdx")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "runningcpu"))) { #optional property not found
            $Runningcpu = $null
        } else {
            $Runningcpu = $JsonParameters.PSobject.Properties["runningcpu"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "runningmachine"))) { #optional property not found
            $Runningmachine = $null
        } else {
            $Runningmachine = $JsonParameters.PSobject.Properties["runningmachine"].value
        }
