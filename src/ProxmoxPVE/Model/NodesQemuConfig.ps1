...
function ConvertFrom-PVEJsonToNodesQemuConfig {
    ...
    Process {
        ...
        $AllProperties = ("watchdog", "bootdisk", "cdrom", "migrate_downtime", "vga", "numa", "template", "sshkeys", "digest", "tablet", "ipconfig[n]", "scsihw", "agent", "scsi[n]", "cicustom", "bios", "cpuunits", "protection", "sata[n]", "startdate", "name", "acpi", "citype", "cpu", "localtime", "nameserver", "machine", "ivshmem", "hostpci[n]", "kvm", "lock", "amd-sev", "startup", "cpulimit", "ciupgrade", "migrate_speed", "smbios1", "shares", "vcpus", "description", "boot", "freeze", "arch", "numa[n]", "cipassword", "tags", "keyboard", "searchdomain", "cores", "efidisk0", "keephugepages", "ciuser", "affinity", "virtio[n]", "sockets", "vmgenid", "parallel[n]", "smp", "net[n]", "onboot", "usb[n]", "balloon", "args", "spice_enhancements", "hotplug", "vmstatestorage", "hugepages", "running-nets-host-mtu", "reboot", "memory", "serial[n]", "autostart", "hookscript", "virtiofs[n]", "rng0", "tdf", "unused[n]", "ostype", "audio0", "ide[n]", "tpmstate0")
