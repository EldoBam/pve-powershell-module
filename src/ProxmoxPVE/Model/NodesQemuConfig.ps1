...
function Initialize-PVENodesQemuConfig {
    ...
    Process {
        ...
        if ($Keephugepages -and $Keephugepages -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Ivshmem"="ivshmem"; "NetN"="net[n]"; "Vcpus"="vcpus"; "Ostype"="ostype"; "Rng0"="rng0"; "Autostart"="autostart"; "Acpi"="acpi"; "AmdSev"="amd-sev"; "Boot"="boot"; "ScsiN"="scsi[n]"; "Agent"="agent"; "IpconfigN"="ipconfig[n]"; "VarArgs"="args"; "MigrateSpeed"="migrate_speed"; "Vmstatestorage"="vmstatestorage"; "Keyboard"="keyboard"; "Memory"="memory"; "Tpmstate0"="tpmstate0"; "Description"="description"; "SpiceEnhancements"="spice_enhancements"; "Freeze"="freeze"; "Reboot"="reboot"; "Smbios1"="smbios1"; "Cipassword"="cipassword"; "Bootdisk"="bootdisk"; "Citype"="citype"; "Smp"="smp"; "Hookscript"="hookscript"; "Hotplug"="hotplug"; "Balloon"="balloon"; "Tags"="tags"; "ParallelN"="parallel[n]"; "Sshkeys"="sshkeys"; "Efidisk0"="efidisk0"; "Arch"="arch"; "UnusedN"="unused[n]"; "IdeN"="ide[n]"; "VirtioN"="virtio[n]"; "Vga"="vga"; "Tdf"="tdf"; "Name"="name"; "Watchdog"="watchdog"; "MigrateDowntime"="migrate_downtime"; "Vmgenid"="vmgenid"; "Hugepages"="hugepages"; "SerialN"="serial[n]"; "Cpuunits"="cpuunits"; "Shares"="shares"; "Cpulimit"="cpulimit"; "Cpu"="cpu"; "Affinity"="affinity"; "Onboot"="onboot"; "Cicustom"="cicustom"; "Sockets"="sockets"; "Ciuser"="ciuser"; "Protection"="protection"; "Digest"="digest"; "Lock"="lock"; "Numa"="numa"; "Cores"="cores"; "HostpciN"="hostpci[n]"; "Cdrom"="cdrom"; "SataN"="sata[n]"; "Tablet"="tablet"; "Bios"="bios"; "Localtime"="localtime"; "Template"="template"; "Nameserver"="nameserver"; "Kvm"="kvm"; "Startdate"="startdate"; "UsbN"="usb[n]"; "Startup"="startup"; "Scsihw"="scsihw"; "Ciupgrade"="ciupgrade"; "Keephugepages"="keephugepages"; "Audio0"="audio0"; "NumaN"="numa[n]"; "Searchdomain"="searchdomain"; "Machine"="machine"
        }
...
function ConvertFrom-PVEJsonToNodesQemuConfig {
    ...
    Process {
        ...
        $AllProperties = ("ivshmem", "net[n]", "vcpus", "ostype", "rng0", "autostart", "acpi", "amd-sev", "boot", "scsi[n]", "agent", "ipconfig[n]", "args", "migrate_speed", "vmstatestorage", "keyboard", "memory", "tpmstate0", "description", "spice_enhancements", "freeze", "reboot", "smbios1", "cipassword", "bootdisk", "citype", "smp", "hookscript", "hotplug", "balloon", "tags", "parallel[n]", "sshkeys", "efidisk0", "arch", "unused[n]", "ide[n]", "virtio[n]", "vga", "tdf", "name", "watchdog", "migrate_downtime", "vmgenid", "hugepages", "serial[n]", "cpuunits", "shares", "cpulimit", "cpu", "affinity", "onboot", "cicustom", "sockets", "ciuser", "protection", "digest", "lock", "numa", "cores", "hostpci[n]", "cdrom", "sata[n]", "tablet", "bios", "localtime", "template", "nameserver", "kvm", "startdate", "usb[n]", "startup", "scsihw", "ciupgrade", "keephugepages", "audio0", "numa[n]", "searchdomain", "machine")
