...
function Initialize-PVENodesQemuConfig {
    ...
    Process {
        ...
        if ($Acpi -and $Acpi -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Keyboard"="keyboard"; "Efidisk0"="efidisk0"; "NetN"="net[n]"; "Vcpus"="vcpus"; "Cores"="cores"; "Ciuser"="ciuser"; "Startup"="startup"; "Cdrom"="cdrom"; "UsbN"="usb[n]"; "Cicustom"="cicustom"; "Ciupgrade"="ciupgrade"; "Cpulimit"="cpulimit"; "SpiceEnhancements"="spice_enhancements"; "Name"="name"; "Freeze"="freeze"; "Tpmstate0"="tpmstate0"; "IpconfigN"="ipconfig[n]"; "VarArgs"="args"; "Localtime"="localtime"; "Rng0"="rng0"; "MigrateSpeed"="migrate_speed"; "Balloon"="balloon"; "Hookscript"="hookscript"; "Tdf"="tdf"; "Lock"="lock"; "Smp"="smp"; "Numa"="numa"; "Vmstatestorage"="vmstatestorage"; "Scsihw"="scsihw"; "Shares"="shares"; "Onboot"="onboot"; "Cpu"="cpu"; "Reboot"="reboot"; "Cpuunits"="cpuunits"; "Autostart"="autostart"; "Description"="description"; "Cipassword"="cipassword"; "Hotplug"="hotplug"; "Tablet"="tablet"; "Citype"="citype"; "Kvm"="kvm"; "Memory"="memory"; "Bios"="bios"; "Ivshmem"="ivshmem"; "Vga"="vga"; "Agent"="agent"; "Audio0"="audio0"; "ParallelN"="parallel[n]"; "ScsiN"="scsi[n]"; "Digest"="digest"; "UnusedN"="unused[n]"; "IdeN"="ide[n]"; "Boot"="boot"; "Smbios1"="smbios1"; "Keephugepages"="keephugepages"; "Startdate"="startdate"; "Protection"="protection"; "NumaN"="numa[n]"; "Template"="template"; "SataN"="sata[n]"; "Nameserver"="nameserver"; "Machine"="machine"; "Arch"="arch"; "Ostype"="ostype"; "SerialN"="serial[n]"; "Affinity"="affinity"; "Sockets"="sockets"; "Bootdisk"="bootdisk"; "Searchdomain"="searchdomain"; "Tags"="tags"; "Acpi"="acpi"; "VirtioN"="virtio[n]"; "Watchdog"="watchdog"; "Sshkeys"="sshkeys"; "AmdSev"="amd-sev"; "Hugepages"="hugepages"; "Vmgenid"="vmgenid"; "HostpciN"="hostpci[n]"; "MigrateDowntime"="migrate_downtime"
        }
...
function ConvertFrom-PVEJsonToNodesQemuConfig {
    ...
    Process {
        ...
        $AllProperties = ("keyboard", "efidisk0", "net[n]", "vcpus", "cores", "ciuser", "startup", "cdrom", "usb[n]", "cicustom", "ciupgrade", "cpulimit", "spice_enhancements", "name", "freeze", "tpmstate0", "ipconfig[n]", "args", "localtime", "rng0", "migrate_speed", "balloon", "hookscript", "tdf", "lock", "smp", "numa", "vmstatestorage", "scsihw", "shares", "onboot", "cpu", "reboot", "cpuunits", "autostart", "description", "cipassword", "hotplug", "tablet", "citype", "kvm", "memory", "bios", "ivshmem", "vga", "agent", "audio0", "parallel[n]", "scsi[n]", "digest", "unused[n]", "ide[n]", "boot", "smbios1", "keephugepages", "startdate", "protection", "numa[n]", "template", "sata[n]", "nameserver", "machine", "arch", "ostype", "serial[n]", "affinity", "sockets", "bootdisk", "searchdomain", "tags", "acpi", "virtio[n]", "watchdog", "sshkeys", "amd-sev", "hugepages", "vmgenid", "hostpci[n]", "migrate_downtime")
