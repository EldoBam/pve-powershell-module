...
function Initialize-PVENodesQemuConfig {
    ...
    Process {
        ...
        if ($Smp -and $Smp -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"UnusedN"="unused[n]"; "HostpciN"="hostpci[n]"; "Autostart"="autostart"; "Protection"="protection"; "Vmstatestorage"="vmstatestorage"; "Balloon"="balloon"; "Ostype"="ostype"; "Kvm"="kvm"; "Affinity"="affinity"; "VirtiofsN"="virtiofs[n]"; "IpconfigN"="ipconfig[n]"; "Description"="description"; "Tdf"="tdf"; "Keyboard"="keyboard"; "Cpulimit"="cpulimit"; "Memory"="memory"; "Agent"="agent"; "SataN"="sata[n]"; "Vcpus"="vcpus"; "Watchdog"="watchdog"; "MigrateSpeed"="migrate_speed"; "NumaN"="numa[n]"; "Template"="template"; "VarArgs"="args"; "MigrateDowntime"="migrate_downtime"; "Sshkeys"="sshkeys"; "Onboot"="onboot"; "Audio0"="audio0"; "Hookscript"="hookscript"; "Tags"="tags"; "Boot"="boot"; "Sockets"="sockets"; "Bootdisk"="bootdisk"; "Numa"="numa"; "Localtime"="localtime"; "Efidisk0"="efidisk0"; "Hotplug"="hotplug"; "Tablet"="tablet"; "ScsiN"="scsi[n]"; "Machine"="machine"; "Ciupgrade"="ciupgrade"; "Startup"="startup"; "Acpi"="acpi"; "Freeze"="freeze"; "SerialN"="serial[n]"; "Cores"="cores"; "ParallelN"="parallel[n]"; "Cpu"="cpu"; "Keephugepages"="keephugepages"; "Ciuser"="ciuser"; "Bios"="bios"; "Cpuunits"="cpuunits"; "Ivshmem"="ivshmem"; "Cicustom"="cicustom"; "Smbios1"="smbios1"; "AmdSev"="amd-sev"; "Hugepages"="hugepages"; "NetN"="net[n]"; "Vmgenid"="vmgenid"; "Searchdomain"="searchdomain"; "Nameserver"="nameserver"; "Digest"="digest"; "SpiceEnhancements"="spice_enhancements"; "Shares"="shares"; "Name"="name"; "Arch"="arch"; "Smp"="smp"; "Citype"="citype"; "Scsihw"="scsihw"; "VirtioN"="virtio[n]"; "IdeN"="ide[n]"; "Startdate"="startdate"; "Reboot"="reboot"; "Vga"="vga"; "Tpmstate0"="tpmstate0"; "UsbN"="usb[n]"; "Rng0"="rng0"; "Cipassword"="cipassword"; "Lock"="lock"; "Cdrom"="cdrom"
        }
...
function ConvertFrom-PVEJsonToNodesQemuConfig {
    ...
    Process {
        ...
        $AllProperties = ("unused[n]", "hostpci[n]", "autostart", "protection", "vmstatestorage", "balloon", "ostype", "kvm", "affinity", "virtiofs[n]", "ipconfig[n]", "description", "tdf", "keyboard", "cpulimit", "memory", "agent", "sata[n]", "vcpus", "watchdog", "migrate_speed", "numa[n]", "template", "args", "migrate_downtime", "sshkeys", "onboot", "audio0", "hookscript", "tags", "boot", "sockets", "bootdisk", "numa", "localtime", "efidisk0", "hotplug", "tablet", "scsi[n]", "machine", "ciupgrade", "startup", "acpi", "freeze", "serial[n]", "cores", "parallel[n]", "cpu", "keephugepages", "ciuser", "bios", "cpuunits", "ivshmem", "cicustom", "smbios1", "amd-sev", "hugepages", "net[n]", "vmgenid", "searchdomain", "nameserver", "digest", "spice_enhancements", "shares", "name", "arch", "smp", "citype", "scsihw", "virtio[n]", "ide[n]", "startdate", "reboot", "vga", "tpmstate0", "usb[n]", "rng0", "cipassword", "lock", "cdrom")
