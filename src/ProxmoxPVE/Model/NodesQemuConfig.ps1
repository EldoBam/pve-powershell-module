...
function Initialize-PVENodesQemuConfig {
    ...
    Process {
        ...
        if ($Vcpus -and $Vcpus -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"SpiceEnhancements"="spice_enhancements"; "Lock"="lock"; "Onboot"="onboot"; "Cdrom"="cdrom"; "Template"="template"; "Ciupgrade"="ciupgrade"; "Hookscript"="hookscript"; "Digest"="digest"; "Cpu"="cpu"; "Rng0"="rng0"; "Agent"="agent"; "Cpulimit"="cpulimit"; "Scsihw"="scsihw"; "Boot"="boot"; "Vmgenid"="vmgenid"; "ParallelN"="parallel[n]"; "NetN"="net[n]"; "Smbios1"="smbios1"; "SerialN"="serial[n]"; "Tpmstate0"="tpmstate0"; "Name"="name"; "Bios"="bios"; "Vga"="vga"; "Sshkeys"="sshkeys"; "Nameserver"="nameserver"; "Memory"="memory"; "IdeN"="ide[n]"; "Kvm"="kvm"; "Efidisk0"="efidisk0"; "Startdate"="startdate"; "Smp"="smp"; "Cpuunits"="cpuunits"; "Autostart"="autostart"; "Localtime"="localtime"; "Startup"="startup"; "Keephugepages"="keephugepages"; "MigrateSpeed"="migrate_speed"; "Hotplug"="hotplug"; "Cipassword"="cipassword"; "Bootdisk"="bootdisk"; "Description"="description"; "Vmstatestorage"="vmstatestorage"; "Cicustom"="cicustom"; "Arch"="arch"; "Affinity"="affinity"; "Sockets"="sockets"; "VirtiofsN"="virtiofs[n]"; "Tablet"="tablet"; "IpconfigN"="ipconfig[n]"; "Numa"="numa"; "AmdSev"="amd-sev"; "HostpciN"="hostpci[n]"; "Cores"="cores"; "Ostype"="ostype"; "Tags"="tags"; "Shares"="shares"; "Vcpus"="vcpus"; "VirtioN"="virtio[n]"; "Freeze"="freeze"; "ScsiN"="scsi[n]"; "SataN"="sata[n]"; "Ivshmem"="ivshmem"; "Watchdog"="watchdog"; "UnusedN"="unused[n]"; "Protection"="protection"; "MigrateDowntime"="migrate_downtime"; "Balloon"="balloon"; "Hugepages"="hugepages"; "Machine"="machine"; "VarArgs"="args"; "Keyboard"="keyboard"; "Acpi"="acpi"; "NumaN"="numa[n]"; "Searchdomain"="searchdomain"; "Tdf"="tdf"; "Ciuser"="ciuser"; "UsbN"="usb[n]"; "Reboot"="reboot"; "Audio0"="audio0"; "Citype"="citype"
        }
...
function ConvertFrom-PVEJsonToNodesQemuConfig {
    ...
    Process {
        ...
        $AllProperties = ("spice_enhancements", "lock", "onboot", "cdrom", "template", "ciupgrade", "hookscript", "digest", "cpu", "rng0", "agent", "cpulimit", "scsihw", "boot", "vmgenid", "parallel[n]", "net[n]", "smbios1", "serial[n]", "tpmstate0", "name", "bios", "vga", "sshkeys", "nameserver", "memory", "ide[n]", "kvm", "efidisk0", "startdate", "smp", "cpuunits", "autostart", "localtime", "startup", "keephugepages", "migrate_speed", "hotplug", "cipassword", "bootdisk", "description", "vmstatestorage", "cicustom", "arch", "affinity", "sockets", "virtiofs[n]", "tablet", "ipconfig[n]", "numa", "amd-sev", "hostpci[n]", "cores", "ostype", "tags", "shares", "vcpus", "virtio[n]", "freeze", "scsi[n]", "sata[n]", "ivshmem", "watchdog", "unused[n]", "protection", "migrate_downtime", "balloon", "hugepages", "machine", "args", "keyboard", "acpi", "numa[n]", "searchdomain", "tdf", "ciuser", "usb[n]", "reboot", "audio0", "citype")
