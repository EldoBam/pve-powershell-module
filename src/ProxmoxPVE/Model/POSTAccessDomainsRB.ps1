...
function Initialize-PVEPOSTAccessDomainsRB {
    ...
    Process {
        ...
        if (!$UserAttr -and $UserAttr.length -gt 256) {
		 ...
		 $DisplayNameMapping =@{
			"Domain"="domain"; "GroupFilter"="group_filter"; "Server1"="server1"; "GroupNameAttr"="group_name_attr"; "Certkey"="certkey"; "Prompt"="prompt"; "BaseDn"="base_dn"; "Autocreate"="autocreate"; "Mode"="mode"; "AcrValues"="acr-values"; "SyncAttributes"="sync_attributes"; "GroupsOverwrite"="groups-overwrite"; "QueryUserinfo"="query-userinfo"; "UserClasses"="user_classes"; "Default"="default"; "Server2"="server2"; "Type"="type"; "SyncDefaultsOptions"="sync-defaults-options"; "Sslversion"="sslversion"; "Port"="port"; "GroupClasses"="group_classes"; "Tfa"="tfa"; "Scopes"="scopes"; "Comment"="comment"; "CheckConnection"="check-connection"; "ClientKey"="client-key"; "VarFilter"="filter"; "GroupsAutocreate"="groups-autocreate"; "Realm"="realm"; "GroupDn"="group_dn"; "Cert"="cert"; "UsernameClaim"="username-claim"; "IssuerUrl"="issuer-url"; "Secure"="secure"; "GroupsClaim"="groups-claim"; "Capath"="capath"; "Verify"="verify"; "CaseSensitive"="case-sensitive"; "BindDn"="bind_dn"; "ClientId"="client-id"; "Password"="password"; "UserAttr"="user_attr"
        }
...
function ConvertFrom-PVEJsonToPOSTAccessDomainsRB {
    ...
    Process {
        ...
        $AllProperties = ("domain", "group_filter", "server1", "group_name_attr", "certkey", "prompt", "base_dn", "autocreate", "mode", "acr-values", "sync_attributes", "groups-overwrite", "query-userinfo", "user_classes", "default", "server2", "type", "sync-defaults-options", "sslversion", "port", "group_classes", "tfa", "scopes", "comment", "check-connection", "client-key", "filter", "groups-autocreate", "realm", "group_dn", "cert", "username-claim", "issuer-url", "secure", "groups-claim", "capath", "verify", "case-sensitive", "bind_dn", "client-id", "password", "user_attr")
