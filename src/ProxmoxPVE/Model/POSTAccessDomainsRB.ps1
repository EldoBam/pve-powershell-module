...
function Initialize-PVEPOSTAccessDomainsRB {
    ...
    Process {
        ...
        if (!$Server1 -and $Server1.length -gt 256) {
		 ...
		 $DisplayNameMapping =@{
			"Secure"="secure"; "CheckConnection"="check-connection"; "UsernameClaim"="username-claim"; "BindDn"="bind_dn"; "Comment"="comment"; "Scopes"="scopes"; "Prompt"="prompt"; "Sslversion"="sslversion"; "GroupsClaim"="groups-claim"; "UserAttr"="user_attr"; "QueryUserinfo"="query-userinfo"; "GroupDn"="group_dn"; "CaseSensitive"="case-sensitive"; "GroupNameAttr"="group_name_attr"; "ClientId"="client-id"; "Verify"="verify"; "Cert"="cert"; "Certkey"="certkey"; "SyncAttributes"="sync_attributes"; "BaseDn"="base_dn"; "Domain"="domain"; "GroupClasses"="group_classes"; "GroupsOverwrite"="groups-overwrite"; "SyncDefaultsOptions"="sync-defaults-options"; "Mode"="mode"; "ClientKey"="client-key"; "Port"="port"; "Realm"="realm"; "Password"="password"; "IssuerUrl"="issuer-url"; "GroupFilter"="group_filter"; "UserClasses"="user_classes"; "Autocreate"="autocreate"; "Capath"="capath"; "Type"="type"; "VarFilter"="filter"; "Tfa"="tfa"; "Server2"="server2"; "AcrValues"="acr-values"; "Server1"="server1"; "Default"="default"; "GroupsAutocreate"="groups-autocreate"
        }
...
function ConvertFrom-PVEJsonToPOSTAccessDomainsRB {
    ...
    Process {
        ...
        $AllProperties = ("secure", "check-connection", "username-claim", "bind_dn", "comment", "scopes", "prompt", "sslversion", "groups-claim", "user_attr", "query-userinfo", "group_dn", "case-sensitive", "group_name_attr", "client-id", "verify", "cert", "certkey", "sync_attributes", "base_dn", "domain", "group_classes", "groups-overwrite", "sync-defaults-options", "mode", "client-key", "port", "realm", "password", "issuer-url", "group_filter", "user_classes", "autocreate", "capath", "type", "filter", "tfa", "server2", "acr-values", "server1", "default", "groups-autocreate")
