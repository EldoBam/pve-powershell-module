...
function Initialize-PVENodesTasksStatus {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"VarPid"="pid"; "Node"="node"; "Id"="id"; "Upid"="upid"; "Type"="type"; "Status"="status"; "Starttime"="starttime"; "Exitstatus"="exitstatus"; "Pstart"="pstart"; "User"="user"
        }
...
function ConvertFrom-PVEJsonToNodesTasksStatus {
    ...
    Process {
        ...
        $AllProperties = ("pid", "node", "id", "upid", "type", "status", "starttime", "exitstatus", "pstart", "user")
