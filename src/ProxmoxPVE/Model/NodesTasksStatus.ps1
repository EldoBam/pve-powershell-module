...
function Initialize-PVENodesTasksStatus {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"VarPid"="pid"; "Pstart"="pstart"; "Node"="node"; "Upid"="upid"; "Type"="type"; "Id"="id"; "Status"="status"; "Starttime"="starttime"; "User"="user"; "Exitstatus"="exitstatus"
        }
...
function ConvertFrom-PVEJsonToNodesTasksStatus {
    ...
    Process {
        ...
        $AllProperties = ("pid", "pstart", "node", "upid", "type", "id", "status", "starttime", "user", "exitstatus")
