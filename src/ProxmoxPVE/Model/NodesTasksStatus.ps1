...
function Initialize-PVENodesTasksStatus {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Starttime"="starttime"; "User"="user"; "Node"="node"; "VarPid"="pid"; "Id"="id"; "Upid"="upid"; "Type"="type"; "Exitstatus"="exitstatus"; "Pstart"="pstart"; "Status"="status"
        }
...
function ConvertFrom-PVEJsonToNodesTasksStatus {
    ...
    Process {
        ...
        $AllProperties = ("starttime", "user", "node", "pid", "id", "upid", "type", "exitstatus", "pstart", "status")
