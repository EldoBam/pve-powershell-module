...
function Initialize-PVENodesTasksStatus {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Exitstatus"="exitstatus"; "Upid"="upid"; "Status"="status"; "Node"="node"; "Id"="id"; "Starttime"="starttime"; "User"="user"; "Type"="type"; "VarPid"="pid"; "Pstart"="pstart"
        }
...
function ConvertFrom-PVEJsonToNodesTasksStatus {
    ...
    Process {
        ...
        $AllProperties = ("exitstatus", "upid", "status", "node", "id", "starttime", "user", "type", "pid", "pstart")
