...
function Initialize-PVEPUTClusterFirewallRulesRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Pos"="pos"; "Moveto"="moveto"; "Type"="type"; "Dest"="dest"; "Source"="source"; "Comment"="comment"; "Enable"="enable"; "Macro"="macro"; "Action"="action"; "Dport"="dport"; "Log"="log"; "Sport"="sport"; "Iface"="iface"; "Delete"="delete"; "Proto"="proto"; "Digest"="digest"; "IcmpType"="icmp-type"
        }
...
function ConvertFrom-PVEJsonToPUTClusterFirewallRulesRB {
    ...
    Process {
        ...
        $AllProperties = ("pos", "moveto", "type", "dest", "source", "comment", "enable", "macro", "action", "dport", "log", "sport", "iface", "delete", "proto", "digest", "icmp-type")
