...
function Initialize-PVEPUTClusterFirewallRulesRB {
    ...
    Process {
        ...
        if (!$Iface -and $Iface.length -lt 2) {
		 ...
		 $DisplayNameMapping =@{
			"Digest"="digest"; "Source"="source"; "Sport"="sport"; "Action"="action"; "Log"="log"; "Comment"="comment"; "Dest"="dest"; "Proto"="proto"; "Enable"="enable"; "IcmpType"="icmp-type"; "Macro"="macro"; "Pos"="pos"; "Type"="type"; "Iface"="iface"; "Moveto"="moveto"; "Delete"="delete"; "Dport"="dport"
        }
...
function ConvertFrom-PVEJsonToPUTClusterFirewallRulesRB {
    ...
    Process {
        ...
        $AllProperties = ("digest", "source", "sport", "action", "log", "comment", "dest", "proto", "enable", "icmp-type", "macro", "pos", "type", "iface", "moveto", "delete", "dport")
