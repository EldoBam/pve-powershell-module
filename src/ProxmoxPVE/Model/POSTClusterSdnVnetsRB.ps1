...
function Initialize-PVEPOSTClusterSdnVnetsRB {
    ...
    Process {
        ...
        if (!$Alias -and $Alias.length -gt 256) {
		 ...
		 $DisplayNameMapping =@{
			"Tag"="tag"; "Vlanaware"="vlanaware"; "Type"="type"; "Zone"="zone"; "Alias"="alias"; "IsolatePorts"="isolate-ports"; "Vnet"="vnet"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterSdnVnetsRB {
    ...
    Process {
        ...
        $AllProperties = ("tag", "vlanaware", "type", "zone", "alias", "isolate-ports", "vnet")
