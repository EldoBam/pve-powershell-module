...
function Initialize-PVEPOSTClusterSdnVnetsRB {
    ...
    Process {
        ...
        if ($Tag -and $Tag -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Zone"="zone"; "LockToken"="lock-token"; "Vnet"="vnet"; "Alias"="alias"; "Type"="type"; "IsolatePorts"="isolate-ports"; "Vlanaware"="vlanaware"; "Tag"="tag"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterSdnVnetsRB {
    ...
    Process {
        ...
        $AllProperties = ("zone", "lock-token", "vnet", "alias", "type", "isolate-ports", "vlanaware", "tag")
