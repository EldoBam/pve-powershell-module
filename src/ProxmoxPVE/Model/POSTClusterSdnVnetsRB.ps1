...
function Initialize-PVEPOSTClusterSdnVnetsRB {
    ...
    Process {
        ...
        if ($Vlanaware -and $Vlanaware -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"IsolatePorts"="isolate-ports"; "Alias"="alias"; "Type"="type"; "Vnet"="vnet"; "Vlanaware"="vlanaware"; "Zone"="zone"; "Tag"="tag"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterSdnVnetsRB {
    ...
    Process {
        ...
        $AllProperties = ("isolate-ports", "alias", "type", "vnet", "vlanaware", "zone", "tag")
