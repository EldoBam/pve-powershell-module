...
function Initialize-PVEPOSTClusterSdnVnetsRB {
    ...
    Process {
        ...
        if (!$Alias -and $Alias.length -gt 256) {
		 ...
		 $DisplayNameMapping =@{
			"Zone"="zone"; "Vnet"="vnet"; "IsolatePorts"="isolate-ports"; "Tag"="tag"; "Type"="type"; "Alias"="alias"; "Vlanaware"="vlanaware"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterSdnVnetsRB {
    ...
    Process {
        ...
        $AllProperties = ("zone", "vnet", "isolate-ports", "tag", "type", "alias", "vlanaware")
