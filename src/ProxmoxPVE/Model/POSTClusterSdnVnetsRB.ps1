...
function Initialize-PVEPOSTClusterSdnVnetsRB {
    ...
    Process {
        ...
        if (!$Alias -and $Alias.length -gt 256) {
		 ...
		 $DisplayNameMapping =@{
			"Tag"="tag"; "IsolatePorts"="isolate-ports"; "Type"="type"; "Zone"="zone"; "LockToken"="lock-token"; "Vnet"="vnet"; "Alias"="alias"; "Vlanaware"="vlanaware"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterSdnVnetsRB {
    ...
    Process {
        ...
        $AllProperties = ("tag", "isolate-ports", "type", "zone", "lock-token", "vnet", "alias", "vlanaware")
