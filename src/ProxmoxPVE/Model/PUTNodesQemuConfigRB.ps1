...
function Initialize-PVEPUTNodesQemuConfigRB {
    ...
    Process {
        ...
        if ($Acpi -and $Acpi -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Keyboard"="keyboard"; "Skiplock"="skiplock"; "NetN"="net[n]"; "Delete"="delete"; "Vcpus"="vcpus"; "Cores"="cores"; "Ciuser"="ciuser"; "Startup"="startup"; "Cdrom"="cdrom"; "UsbN"="usb[n]"; "Cicustom"="cicustom"; "Ciupgrade"="ciupgrade"; "Cpulimit"="cpulimit"; "SpiceEnhancements"="spice_enhancements"; "Name"="name"; "Freeze"="freeze"; "Tpmstate0"="tpmstate0"; "IpconfigN"="ipconfig[n]"; "VarArgs"="args"; "Localtime"="localtime"; "Rng0"="rng0"; "MigrateSpeed"="migrate_speed"; "Efidisk0"="efidisk0"; "Hookscript"="hookscript"; "Tdf"="tdf"; "Lock"="lock"; "Smp"="smp"; "Numa"="numa"; "Vmid"="vmid"; "Balloon"="balloon"; "Vmstatestorage"="vmstatestorage"; "Scsihw"="scsihw"; "Shares"="shares"; "Onboot"="onboot"; "Cpu"="cpu"; "Reboot"="reboot"; "Cpuunits"="cpuunits"; "Autostart"="autostart"; "Description"="description"; "Cipassword"="cipassword"; "Hotplug"="hotplug"; "Force"="force"; "Citype"="citype"; "Kvm"="kvm"; "Memory"="memory"; "Bios"="bios"; "Ivshmem"="ivshmem"; "Vga"="vga"; "Agent"="agent"; "Audio0"="audio0"; "ParallelN"="parallel[n]"; "ScsiN"="scsi[n]"; "Digest"="digest"; "UnusedN"="unused[n]"; "IdeN"="ide[n]"; "Boot"="boot"; "Smbios1"="smbios1"; "Keephugepages"="keephugepages"; "Node"="node"; "Tablet"="tablet"; "Startdate"="startdate"; "Protection"="protection"; "NumaN"="numa[n]"; "Template"="template"; "SataN"="sata[n]"; "Nameserver"="nameserver"; "Revert"="revert"; "Machine"="machine"; "Arch"="arch"; "Ostype"="ostype"; "SerialN"="serial[n]"; "Affinity"="affinity"; "Sockets"="sockets"; "Bootdisk"="bootdisk"; "Searchdomain"="searchdomain"; "Tags"="tags"; "Acpi"="acpi"; "VirtioN"="virtio[n]"; "Watchdog"="watchdog"; "Sshkeys"="sshkeys"; "AmdSev"="amd-sev"; "Hugepages"="hugepages"; "Vmgenid"="vmgenid"; "HostpciN"="hostpci[n]"; "MigrateDowntime"="migrate_downtime"
        }
...
function ConvertFrom-PVEJsonToPUTNodesQemuConfigRB {
    ...
    Process {
        ...
        $AllProperties = ("keyboard", "skiplock", "net[n]", "delete", "vcpus", "cores", "ciuser", "startup", "cdrom", "usb[n]", "cicustom", "ciupgrade", "cpulimit", "spice_enhancements", "name", "freeze", "tpmstate0", "ipconfig[n]", "args", "localtime", "rng0", "migrate_speed", "efidisk0", "hookscript", "tdf", "lock", "smp", "numa", "vmid", "balloon", "vmstatestorage", "scsihw", "shares", "onboot", "cpu", "reboot", "cpuunits", "autostart", "description", "cipassword", "hotplug", "force", "citype", "kvm", "memory", "bios", "ivshmem", "vga", "agent", "audio0", "parallel[n]", "scsi[n]", "digest", "unused[n]", "ide[n]", "boot", "smbios1", "keephugepages", "node", "tablet", "startdate", "protection", "numa[n]", "template", "sata[n]", "nameserver", "revert", "machine", "arch", "ostype", "serial[n]", "affinity", "sockets", "bootdisk", "searchdomain", "tags", "acpi", "virtio[n]", "watchdog", "sshkeys", "amd-sev", "hugepages", "vmgenid", "hostpci[n]", "migrate_downtime")
