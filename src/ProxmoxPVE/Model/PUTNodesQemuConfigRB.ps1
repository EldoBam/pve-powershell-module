...
function Initialize-PVEPUTNodesQemuConfigRB {
    ...
    Process {
        ...
        if ($Smp -and $Smp -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Watchdog"="watchdog"; "Bootdisk"="bootdisk"; "Cdrom"="cdrom"; "MigrateDowntime"="migrate_downtime"; "Vga"="vga"; "Numa"="numa"; "Template"="template"; "Skiplock"="skiplock"; "Digest"="digest"; "Tablet"="tablet"; "IpconfigN"="ipconfig[n]"; "Scsihw"="scsihw"; "Agent"="agent"; "ScsiN"="scsi[n]"; "Cicustom"="cicustom"; "Bios"="bios"; "Cpuunits"="cpuunits"; "Protection"="protection"; "SataN"="sata[n]"; "Startdate"="startdate"; "Name"="name"; "Acpi"="acpi"; "Citype"="citype"; "Cpu"="cpu"; "Localtime"="localtime"; "Nameserver"="nameserver"; "Machine"="machine"; "Ivshmem"="ivshmem"; "HostpciN"="hostpci[n]"; "Delete"="delete"; "Kvm"="kvm"; "Lock"="lock"; "AmdSev"="amd-sev"; "Startup"="startup"; "Cpulimit"="cpulimit"; "Ciupgrade"="ciupgrade"; "MigrateSpeed"="migrate_speed"; "Smbios1"="smbios1"; "Shares"="shares"; "Vcpus"="vcpus"; "Description"="description"; "Boot"="boot"; "Freeze"="freeze"; "Arch"="arch"; "NumaN"="numa[n]"; "Cipassword"="cipassword"; "Tags"="tags"; "Keyboard"="keyboard"; "Searchdomain"="searchdomain"; "Cores"="cores"; "Efidisk0"="efidisk0"; "Keephugepages"="keephugepages"; "Ciuser"="ciuser"; "Sshkeys"="sshkeys"; "Affinity"="affinity"; "VirtioN"="virtio[n]"; "Sockets"="sockets"; "Vmgenid"="vmgenid"; "ParallelN"="parallel[n]"; "Force"="force"; "Smp"="smp"; "NetN"="net[n]"; "Onboot"="onboot"; "UsbN"="usb[n]"; "Balloon"="balloon"; "VarArgs"="args"; "RunningNetsHostMtu"="running-nets-host-mtu"; "Hotplug"="hotplug"; "Vmstatestorage"="vmstatestorage"; "Hugepages"="hugepages"; "Reboot"="reboot"; "Memory"="memory"; "SerialN"="serial[n]"; "Autostart"="autostart"; "Hookscript"="hookscript"; "VirtiofsN"="virtiofs[n]"; "Rng0"="rng0"; "Tdf"="tdf"; "UnusedN"="unused[n]"; "Ostype"="ostype"; "SpiceEnhancements"="spice_enhancements"; "Audio0"="audio0"; "IdeN"="ide[n]"; "Tpmstate0"="tpmstate0"; "Revert"="revert"
        }
...
function ConvertFrom-PVEJsonToPUTNodesQemuConfigRB {
    ...
    Process {
        ...
        $AllProperties = ("watchdog", "bootdisk", "cdrom", "migrate_downtime", "vga", "numa", "template", "skiplock", "digest", "tablet", "ipconfig[n]", "scsihw", "agent", "scsi[n]", "cicustom", "bios", "cpuunits", "protection", "sata[n]", "startdate", "name", "acpi", "citype", "cpu", "localtime", "nameserver", "machine", "ivshmem", "hostpci[n]", "delete", "kvm", "lock", "amd-sev", "startup", "cpulimit", "ciupgrade", "migrate_speed", "smbios1", "shares", "vcpus", "description", "boot", "freeze", "arch", "numa[n]", "cipassword", "tags", "keyboard", "searchdomain", "cores", "efidisk0", "keephugepages", "ciuser", "sshkeys", "affinity", "virtio[n]", "sockets", "vmgenid", "parallel[n]", "force", "smp", "net[n]", "onboot", "usb[n]", "balloon", "args", "running-nets-host-mtu", "hotplug", "vmstatestorage", "hugepages", "reboot", "memory", "serial[n]", "autostart", "hookscript", "virtiofs[n]", "rng0", "tdf", "unused[n]", "ostype", "spice_enhancements", "audio0", "ide[n]", "tpmstate0", "revert")
