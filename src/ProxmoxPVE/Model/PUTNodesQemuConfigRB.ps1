...
function Initialize-PVEPUTNodesQemuConfigRB {
    ...
    Process {
        ...
        if (!$Smbios1 -and $Smbios1.length -gt 512) {
		 ...
		 $DisplayNameMapping =@{
			"Localtime"="localtime"; "Hugepages"="hugepages"; "Cipassword"="cipassword"; "Vmstatestorage"="vmstatestorage"; "Tablet"="tablet"; "Watchdog"="watchdog"; "UsbN"="usb[n]"; "Bios"="bios"; "Reboot"="reboot"; "Digest"="digest"; "SpiceEnhancements"="spice_enhancements"; "Tags"="tags"; "NumaN"="numa[n]"; "IdeN"="ide[n]"; "Audio0"="audio0"; "Tpmstate0"="tpmstate0"; "Searchdomain"="searchdomain"; "Machine"="machine"; "Cicustom"="cicustom"; "Cpuunits"="cpuunits"; "Efidisk0"="efidisk0"; "ScsiN"="scsi[n]"; "Vcpus"="vcpus"; "MigrateDowntime"="migrate_downtime"; "Revert"="revert"; "Cpu"="cpu"; "Onboot"="onboot"; "IpconfigN"="ipconfig[n]"; "Cdrom"="cdrom"; "Tdf"="tdf"; "Autostart"="autostart"; "UnusedN"="unused[n]"; "Agent"="agent"; "Rng0"="rng0"; "Freeze"="freeze"; "Cpulimit"="cpulimit"; "Name"="name"; "Template"="template"; "Protection"="protection"; "Sshkeys"="sshkeys"; "Affinity"="affinity"; "NetN"="net[n]"; "SataN"="sata[n]"; "Sockets"="sockets"; "Nameserver"="nameserver"; "VarArgs"="args"; "Vmgenid"="vmgenid"; "Kvm"="kvm"; "Citype"="citype"; "Keephugepages"="keephugepages"; "Numa"="numa"; "Force"="force"; "Cores"="cores"; "HostpciN"="hostpci[n]"; "Acpi"="acpi"; "Ostype"="ostype"; "Hotplug"="hotplug"; "VirtioN"="virtio[n]"; "Delete"="delete"; "Vga"="vga"; "Boot"="boot"; "Bootdisk"="bootdisk"; "Smp"="smp"; "Hookscript"="hookscript"; "Lock"="lock"; "AmdSev"="amd-sev"; "Startup"="startup"; "Description"="description"; "Balloon"="balloon"; "Ciupgrade"="ciupgrade"; "MigrateSpeed"="migrate_speed"; "Shares"="shares"; "Ivshmem"="ivshmem"; "SerialN"="serial[n]"; "Keyboard"="keyboard"; "VirtiofsN"="virtiofs[n]"; "Arch"="arch"; "Skiplock"="skiplock"; "Ciuser"="ciuser"; "Smbios1"="smbios1"; "Scsihw"="scsihw"; "ParallelN"="parallel[n]"; "Memory"="memory"; "Startdate"="startdate"
        }
...
function ConvertFrom-PVEJsonToPUTNodesQemuConfigRB {
    ...
    Process {
        ...
        $AllProperties = ("localtime", "hugepages", "cipassword", "vmstatestorage", "tablet", "watchdog", "usb[n]", "bios", "reboot", "digest", "spice_enhancements", "tags", "numa[n]", "ide[n]", "audio0", "tpmstate0", "searchdomain", "machine", "cicustom", "cpuunits", "efidisk0", "scsi[n]", "vcpus", "migrate_downtime", "revert", "cpu", "onboot", "ipconfig[n]", "cdrom", "tdf", "autostart", "unused[n]", "agent", "rng0", "freeze", "cpulimit", "name", "template", "protection", "sshkeys", "affinity", "net[n]", "sata[n]", "sockets", "nameserver", "args", "vmgenid", "kvm", "citype", "keephugepages", "numa", "force", "cores", "hostpci[n]", "acpi", "ostype", "hotplug", "virtio[n]", "delete", "vga", "boot", "bootdisk", "smp", "hookscript", "lock", "amd-sev", "startup", "description", "balloon", "ciupgrade", "migrate_speed", "shares", "ivshmem", "serial[n]", "keyboard", "virtiofs[n]", "arch", "skiplock", "ciuser", "smbios1", "scsihw", "parallel[n]", "memory", "startdate")
