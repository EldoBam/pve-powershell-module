...
PUTNodesQemuConfigRB<PSCustomObject>
#>

function Initialize-PVEPUTNodesQemuConfigRB {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ProxmoxPVE => PVEPUTNodesQemuConfigRB' | Write-Debug
        ...
        if ($Vcpus -and $Vcpus -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Reboot"="reboot"; "Onboot"="onboot"; "VarArgs"="args"; "Audio0"="audio0"; "Efidisk0"="efidisk0"; "Machine"="machine"; "Revert"="revert"; "ParallelN"="parallel[n]"; "Agent"="agent"; "Balloon"="balloon"; "Cicustom"="cicustom"; "VirtiofsN"="virtiofs[n]"; "Boot"="boot"; "Ciupgrade"="ciupgrade"; "Arch"="arch"; "IdeN"="ide[n]"; "Vmstatestorage"="vmstatestorage"; "Searchdomain"="searchdomain"; "SpiceEnhancements"="spice_enhancements"; "MigrateSpeed"="migrate_speed"; "Freeze"="freeze"; "Cores"="cores"; "Cdrom"="cdrom"; "SerialN"="serial[n]"; "Vga"="vga"; "Bios"="bios"; "Startdate"="startdate"; "Delete"="delete"; "HostpciN"="hostpci[n]"; "NetN"="net[n]"; "Description"="description"; "Kvm"="kvm"; "Sshkeys"="sshkeys"; "Digest"="digest"; "Tags"="tags"; "Cpu"="cpu"; "AmdSev"="amd-sev"; "Numa"="numa"; "Shares"="shares"; "Keephugepages"="keephugepages"; "NumaN"="numa[n]"; "Localtime"="localtime"; "Citype"="citype"; "Tablet"="tablet"; "Scsihw"="scsihw"; "Affinity"="affinity"; "UnusedN"="unused[n]"; "Cpuunits"="cpuunits"; "Lock"="lock"; "Ciuser"="ciuser"; "Skiplock"="skiplock"; "Nameserver"="nameserver"; "Sockets"="sockets"; "Ivshmem"="ivshmem"; "Protection"="protection"; "Template"="template"; "Memory"="memory"; "SataN"="sata[n]"; "IpconfigN"="ipconfig[n]"; "Smp"="smp"; "Keyboard"="keyboard"; "Startup"="startup"; "Bootdisk"="bootdisk"; "UsbN"="usb[n]"; "AllowKsm"="allow-ksm"; "Tpmstate0"="tpmstate0"; "Hotplug"="hotplug"; "Rng0"="rng0"; "MigrateDowntime"="migrate_downtime"; "Watchdog"="watchdog"; "Vmgenid"="vmgenid"; "Cipassword"="cipassword"; "VirtioN"="virtio[n]"; "Hugepages"="hugepages"; "Hookscript"="hookscript"; "Force"="force"; "Acpi"="acpi"; "Smbios1"="smbios1"; "Cpulimit"="cpulimit"; "ScsiN"="scsi[n]"; "Autostart"="autostart"; "Vcpus"="vcpus"; "Tdf"="tdf"; "Name"="name"; "Ostype"="ostype"; "IntelTdx"="intel-tdx"
        }
...
Convert from JSON to PUTNodesQemuConfigRB<PSCustomObject>
...
PUTNodesQemuConfigRB<PSCustomObject>
#>
function ConvertFrom-PVEJsonToPUTNodesQemuConfigRB {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ProxmoxPVE => PVEPUTNodesQemuConfigRB' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PVEPUTNodesQemuConfigRB
        $AllProperties = ("reboot", "onboot", "args", "audio0", "efidisk0", "machine", "revert", "parallel[n]", "agent", "balloon", "cicustom", "virtiofs[n]", "boot", "ciupgrade", "arch", "ide[n]", "vmstatestorage", "searchdomain", "spice_enhancements", "migrate_speed", "freeze", "cores", "cdrom", "serial[n]", "vga", "bios", "startdate", "delete", "hostpci[n]", "net[n]", "description", "kvm", "sshkeys", "digest", "tags", "cpu", "amd-sev", "numa", "shares", "keephugepages", "numa[n]", "localtime", "citype", "tablet", "scsihw", "affinity", "unused[n]", "cpuunits", "lock", "ciuser", "skiplock", "nameserver", "sockets", "ivshmem", "protection", "template", "memory", "sata[n]", "ipconfig[n]", "smp", "keyboard", "startup", "bootdisk", "usb[n]", "allow-ksm", "tpmstate0", "hotplug", "rng0", "migrate_downtime", "watchdog", "vmgenid", "cipassword", "virtio[n]", "hugepages", "hookscript", "force", "acpi", "smbios1", "cpulimit", "scsi[n]", "autostart", "vcpus", "tdf", "name", "ostype", "intel-tdx")
