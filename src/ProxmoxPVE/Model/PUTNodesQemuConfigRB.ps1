...
function Initialize-PVEPUTNodesQemuConfigRB {
    ...
    Process {
        ...
        if ($Kvm -and $Kvm -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Protection"="protection"; "Watchdog"="watchdog"; "VarArgs"="args"; "Cdrom"="cdrom"; "Ostype"="ostype"; "Machine"="machine"; "Skiplock"="skiplock"; "IpconfigN"="ipconfig[n]"; "Cpuunits"="cpuunits"; "Force"="force"; "ScsiN"="scsi[n]"; "Hookscript"="hookscript"; "Cores"="cores"; "Citype"="citype"; "Vga"="vga"; "ParallelN"="parallel[n]"; "UsbN"="usb[n]"; "Bootdisk"="bootdisk"; "Sshkeys"="sshkeys"; "Ciupgrade"="ciupgrade"; "Vcpus"="vcpus"; "Scsihw"="scsihw"; "SpiceEnhancements"="spice_enhancements"; "MigrateSpeed"="migrate_speed"; "Hotplug"="hotplug"; "Freeze"="freeze"; "SerialN"="serial[n]"; "Startup"="startup"; "Efidisk0"="efidisk0"; "Startdate"="startdate"; "Nameserver"="nameserver"; "AmdSev"="amd-sev"; "Revert"="revert"; "SataN"="sata[n]"; "Onboot"="onboot"; "Vmgenid"="vmgenid"; "Cicustom"="cicustom"; "NumaN"="numa[n]"; "Lock"="lock"; "IdeN"="ide[n]"; "NetN"="net[n]"; "Vmid"="vmid"; "Acpi"="acpi"; "Arch"="arch"; "Audio0"="audio0"; "Localtime"="localtime"; "Sockets"="sockets"; "Tags"="tags"; "Searchdomain"="searchdomain"; "HostpciN"="hostpci[n]"; "Bios"="bios"; "Template"="template"; "MigrateDowntime"="migrate_downtime"; "Vmstatestorage"="vmstatestorage"; "Cpulimit"="cpulimit"; "Tablet"="tablet"; "Digest"="digest"; "Ivshmem"="ivshmem"; "Memory"="memory"; "Tdf"="tdf"; "Rng0"="rng0"; "Delete"="delete"; "Node"="node"; "Shares"="shares"; "Cipassword"="cipassword"; "Reboot"="reboot"; "Name"="name"; "Hugepages"="hugepages"; "Boot"="boot"; "Numa"="numa"; "Affinity"="affinity"; "Keephugepages"="keephugepages"; "Description"="description"; "Tpmstate0"="tpmstate0"; "VirtioN"="virtio[n]"; "Ciuser"="ciuser"; "Smbios1"="smbios1"; "Agent"="agent"; "Balloon"="balloon"; "Smp"="smp"; "Keyboard"="keyboard"; "Autostart"="autostart"; "UnusedN"="unused[n]"; "Kvm"="kvm"; "Cpu"="cpu"
        }
...
function ConvertFrom-PVEJsonToPUTNodesQemuConfigRB {
    ...
    Process {
        ...
        $AllProperties = ("protection", "watchdog", "args", "cdrom", "ostype", "machine", "skiplock", "ipconfig[n]", "cpuunits", "force", "scsi[n]", "hookscript", "cores", "citype", "vga", "parallel[n]", "usb[n]", "bootdisk", "sshkeys", "ciupgrade", "vcpus", "scsihw", "spice_enhancements", "migrate_speed", "hotplug", "freeze", "serial[n]", "startup", "efidisk0", "startdate", "nameserver", "amd-sev", "revert", "sata[n]", "onboot", "vmgenid", "cicustom", "numa[n]", "lock", "ide[n]", "net[n]", "vmid", "acpi", "arch", "audio0", "localtime", "sockets", "tags", "searchdomain", "hostpci[n]", "bios", "template", "migrate_downtime", "vmstatestorage", "cpulimit", "tablet", "digest", "ivshmem", "memory", "tdf", "rng0", "delete", "node", "shares", "cipassword", "reboot", "name", "hugepages", "boot", "numa", "affinity", "keephugepages", "description", "tpmstate0", "virtio[n]", "ciuser", "smbios1", "agent", "balloon", "smp", "keyboard", "autostart", "unused[n]", "kvm", "cpu")
