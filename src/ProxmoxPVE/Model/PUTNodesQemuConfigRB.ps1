...
function Initialize-PVEPUTNodesQemuConfigRB {
    ...
    Process {
        ...
        if ($Smp -and $Smp -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"UnusedN"="unused[n]"; "HostpciN"="hostpci[n]"; "Autostart"="autostart"; "Protection"="protection"; "Vmstatestorage"="vmstatestorage"; "Balloon"="balloon"; "Ostype"="ostype"; "Kvm"="kvm"; "Sockets"="sockets"; "Affinity"="affinity"; "VirtiofsN"="virtiofs[n]"; "IpconfigN"="ipconfig[n]"; "Description"="description"; "Tdf"="tdf"; "Keyboard"="keyboard"; "Cpulimit"="cpulimit"; "Memory"="memory"; "Agent"="agent"; "SataN"="sata[n]"; "Vcpus"="vcpus"; "Watchdog"="watchdog"; "MigrateSpeed"="migrate_speed"; "NumaN"="numa[n]"; "Revert"="revert"; "Template"="template"; "VarArgs"="args"; "MigrateDowntime"="migrate_downtime"; "Rng0"="rng0"; "Onboot"="onboot"; "Force"="force"; "Audio0"="audio0"; "Hookscript"="hookscript"; "Tags"="tags"; "Boot"="boot"; "Name"="name"; "Bootdisk"="bootdisk"; "Numa"="numa"; "Localtime"="localtime"; "Efidisk0"="efidisk0"; "Hotplug"="hotplug"; "Tablet"="tablet"; "ScsiN"="scsi[n]"; "Machine"="machine"; "Ciupgrade"="ciupgrade"; "Startup"="startup"; "Acpi"="acpi"; "Freeze"="freeze"; "SerialN"="serial[n]"; "Cores"="cores"; "ParallelN"="parallel[n]"; "Cpu"="cpu"; "Keephugepages"="keephugepages"; "Ciuser"="ciuser"; "Bios"="bios"; "Cpuunits"="cpuunits"; "Ivshmem"="ivshmem"; "Cicustom"="cicustom"; "Smbios1"="smbios1"; "AmdSev"="amd-sev"; "NetN"="net[n]"; "Vmgenid"="vmgenid"; "Sshkeys"="sshkeys"; "Searchdomain"="searchdomain"; "Nameserver"="nameserver"; "Digest"="digest"; "SpiceEnhancements"="spice_enhancements"; "Shares"="shares"; "Delete"="delete"; "Arch"="arch"; "Smp"="smp"; "Citype"="citype"; "Scsihw"="scsihw"; "Skiplock"="skiplock"; "VirtioN"="virtio[n]"; "IdeN"="ide[n]"; "Startdate"="startdate"; "Reboot"="reboot"; "Vga"="vga"; "Tpmstate0"="tpmstate0"; "UsbN"="usb[n]"; "Hugepages"="hugepages"; "Cipassword"="cipassword"; "Lock"="lock"; "Cdrom"="cdrom"
        }
...
function ConvertFrom-PVEJsonToPUTNodesQemuConfigRB {
    ...
    Process {
        ...
        $AllProperties = ("unused[n]", "hostpci[n]", "autostart", "protection", "vmstatestorage", "balloon", "ostype", "kvm", "sockets", "affinity", "virtiofs[n]", "ipconfig[n]", "description", "tdf", "keyboard", "cpulimit", "memory", "agent", "sata[n]", "vcpus", "watchdog", "migrate_speed", "numa[n]", "revert", "template", "args", "migrate_downtime", "rng0", "onboot", "force", "audio0", "hookscript", "tags", "boot", "name", "bootdisk", "numa", "localtime", "efidisk0", "hotplug", "tablet", "scsi[n]", "machine", "ciupgrade", "startup", "acpi", "freeze", "serial[n]", "cores", "parallel[n]", "cpu", "keephugepages", "ciuser", "bios", "cpuunits", "ivshmem", "cicustom", "smbios1", "amd-sev", "net[n]", "vmgenid", "sshkeys", "searchdomain", "nameserver", "digest", "spice_enhancements", "shares", "delete", "arch", "smp", "citype", "scsihw", "skiplock", "virtio[n]", "ide[n]", "startdate", "reboot", "vga", "tpmstate0", "usb[n]", "hugepages", "cipassword", "lock", "cdrom")
