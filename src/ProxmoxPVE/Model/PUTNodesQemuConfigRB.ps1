...
function Initialize-PVEPUTNodesQemuConfigRB {
    ...
    Process {
        ...
        if ($Vmid -and $Vmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Balloon"="balloon"; "Tdf"="tdf"; "Tags"="tags"; "SpiceEnhancements"="spice_enhancements"; "NetN"="net[n]"; "Protection"="protection"; "Onboot"="onboot"; "Audio0"="audio0"; "Bios"="bios"; "Keyboard"="keyboard"; "NumaN"="numa[n]"; "Machine"="machine"; "ScsiN"="scsi[n]"; "HostpciN"="hostpci[n]"; "SerialN"="serial[n]"; "Efidisk0"="efidisk0"; "Lock"="lock"; "Smbios1"="smbios1"; "Ostype"="ostype"; "Smp"="smp"; "Startdate"="startdate"; "Hugepages"="hugepages"; "Vcpus"="vcpus"; "Cpulimit"="cpulimit"; "VirtiofsN"="virtiofs[n]"; "SataN"="sata[n]"; "Freeze"="freeze"; "Digest"="digest"; "Ciuser"="ciuser"; "Force"="force"; "VirtioN"="virtio[n]"; "Watchdog"="watchdog"; "Node"="node"; "AmdSev"="amd-sev"; "Boot"="boot"; "MigrateSpeed"="migrate_speed"; "Bootdisk"="bootdisk"; "UsbN"="usb[n]"; "Revert"="revert"; "Arch"="arch"; "Searchdomain"="searchdomain"; "Reboot"="reboot"; "Acpi"="acpi"; "Cpu"="cpu"; "IpconfigN"="ipconfig[n]"; "Memory"="memory"; "Localtime"="localtime"; "Rng0"="rng0"; "Shares"="shares"; "Keephugepages"="keephugepages"; "ParallelN"="parallel[n]"; "Affinity"="affinity"; "Vmstatestorage"="vmstatestorage"; "Autostart"="autostart"; "Startup"="startup"; "Hookscript"="hookscript"; "Cipassword"="cipassword"; "Kvm"="kvm"; "Description"="description"; "Tablet"="tablet"; "Hotplug"="hotplug"; "Scsihw"="scsihw"; "Vmgenid"="vmgenid"; "Name"="name"; "Numa"="numa"; "Sockets"="sockets"; "Agent"="agent"; "Ciupgrade"="ciupgrade"; "Tpmstate0"="tpmstate0"; "Sshkeys"="sshkeys"; "Cdrom"="cdrom"; "MigrateDowntime"="migrate_downtime"; "VarArgs"="args"; "Cores"="cores"; "Cicustom"="cicustom"; "IdeN"="ide[n]"; "Vga"="vga"; "Skiplock"="skiplock"; "Template"="template"; "UnusedN"="unused[n]"; "Citype"="citype"; "Ivshmem"="ivshmem"; "Cpuunits"="cpuunits"; "Vmid"="vmid"; "Delete"="delete"; "Nameserver"="nameserver"
        }
...
function ConvertFrom-PVEJsonToPUTNodesQemuConfigRB {
    ...
    Process {
        ...
        $AllProperties = ("balloon", "tdf", "tags", "spice_enhancements", "net[n]", "protection", "onboot", "audio0", "bios", "keyboard", "numa[n]", "machine", "scsi[n]", "hostpci[n]", "serial[n]", "efidisk0", "lock", "smbios1", "ostype", "smp", "startdate", "hugepages", "vcpus", "cpulimit", "virtiofs[n]", "sata[n]", "freeze", "digest", "ciuser", "force", "virtio[n]", "watchdog", "node", "amd-sev", "boot", "migrate_speed", "bootdisk", "usb[n]", "revert", "arch", "searchdomain", "reboot", "acpi", "cpu", "ipconfig[n]", "memory", "localtime", "rng0", "shares", "keephugepages", "parallel[n]", "affinity", "vmstatestorage", "autostart", "startup", "hookscript", "cipassword", "kvm", "description", "tablet", "hotplug", "scsihw", "vmgenid", "name", "numa", "sockets", "agent", "ciupgrade", "tpmstate0", "sshkeys", "cdrom", "migrate_downtime", "args", "cores", "cicustom", "ide[n]", "vga", "skiplock", "template", "unused[n]", "citype", "ivshmem", "cpuunits", "vmid", "delete", "nameserver")
