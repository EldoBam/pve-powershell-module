...
function Initialize-PVEPUTNodesFirewallRulesRB {
    ...
    Process {
        ...
        if (!$Source -and $Source.length -gt 512) {
		 ...
		 $DisplayNameMapping =@{
			"Node"="node"; "Macro"="macro"; "Moveto"="moveto"; "Proto"="proto"; "Log"="log"; "Pos"="pos"; "Dest"="dest"; "Action"="action"; "Type"="type"; "Comment"="comment"; "Dport"="dport"; "Digest"="digest"; "Enable"="enable"; "Delete"="delete"; "Iface"="iface"; "IcmpType"="icmp-type"; "Source"="source"; "Sport"="sport"
        }
...
function ConvertFrom-PVEJsonToPUTNodesFirewallRulesRB {
    ...
    Process {
        ...
        $AllProperties = ("node", "macro", "moveto", "proto", "log", "pos", "dest", "action", "type", "comment", "dport", "digest", "enable", "delete", "iface", "icmp-type", "source", "sport")
