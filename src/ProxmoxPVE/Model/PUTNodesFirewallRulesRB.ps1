...
PUTNodesFirewallRulesRB<PSCustomObject>
#>

function Initialize-PVEPUTNodesFirewallRulesRB {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ProxmoxPVE => PVEPUTNodesFirewallRulesRB' | Write-Debug
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Pos"="pos"; "Moveto"="moveto"; "Type"="type"; "Dest"="dest"; "Source"="source"; "Comment"="comment"; "Enable"="enable"; "Macro"="macro"; "Node"="node"; "Action"="action"; "Dport"="dport"; "Log"="log"; "Sport"="sport"; "Iface"="iface"; "Delete"="delete"; "Proto"="proto"; "Digest"="digest"; "IcmpType"="icmp-type"
        }
...
Convert from JSON to PUTNodesFirewallRulesRB<PSCustomObject>
...
PUTNodesFirewallRulesRB<PSCustomObject>
#>
function ConvertFrom-PVEJsonToPUTNodesFirewallRulesRB {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ProxmoxPVE => PVEPUTNodesFirewallRulesRB' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PVEPUTNodesFirewallRulesRB
        $AllProperties = ("pos", "moveto", "type", "dest", "source", "comment", "enable", "macro", "node", "action", "dport", "log", "sport", "iface", "delete", "proto", "digest", "icmp-type")
