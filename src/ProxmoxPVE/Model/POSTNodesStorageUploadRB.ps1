...
function Initialize-PVEPOSTNodesStorageUploadRB {
    ...
    Process {
        ...
        if (!$Filename -and $Filename.length -gt 255) {
		 ...
		 $DisplayNameMapping =@{
			"Checksum"="checksum"; "ChecksumAlgorithm"="checksum-algorithm"; "Filename"="filename"; "Content"="content"; "Tmpfilename"="tmpfilename"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesStorageUploadRB {
    ...
    Process {
        ...
        $AllProperties = ("checksum", "checksum-algorithm", "filename", "content", "tmpfilename")
