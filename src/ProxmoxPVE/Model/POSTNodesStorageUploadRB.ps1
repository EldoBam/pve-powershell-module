...
function Initialize-PVEPOSTNodesStorageUploadRB {
    ...
    Process {
        ...
        if (!$Filename -and $Filename.length -gt 255) {
		 ...
		 $DisplayNameMapping =@{
			"Tmpfilename"="tmpfilename"; "ChecksumAlgorithm"="checksum-algorithm"; "Filename"="filename"; "Content"="content"; "Checksum"="checksum"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesStorageUploadRB {
    ...
    Process {
        ...
        $AllProperties = ("tmpfilename", "checksum-algorithm", "filename", "content", "checksum")
