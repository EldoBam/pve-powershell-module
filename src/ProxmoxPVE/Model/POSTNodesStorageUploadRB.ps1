...
function Initialize-PVEPOSTNodesStorageUploadRB {
    ...
    Process {
        ...
        if (!$Filename -and $Filename.length -gt 255) {
		 ...
		 $DisplayNameMapping =@{
			"Tmpfilename"="tmpfilename"; "Content"="content"; "Filename"="filename"; "Checksum"="checksum"; "ChecksumAlgorithm"="checksum-algorithm"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesStorageUploadRB {
    ...
    Process {
        ...
        $AllProperties = ("tmpfilename", "content", "filename", "checksum", "checksum-algorithm")
