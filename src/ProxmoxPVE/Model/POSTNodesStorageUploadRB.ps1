...
function Initialize-PVEPOSTNodesStorageUploadRB {
    ...
    Process {
        ...
        if (!$Filename -and $Filename.length -gt 255) {
		 ...
		 $DisplayNameMapping =@{
			"Tmpfilename"="tmpfilename"; "Content"="content"; "ChecksumAlgorithm"="checksum-algorithm"; "Checksum"="checksum"; "Filename"="filename"; "Node"="node"; "Storage"="storage"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesStorageUploadRB {
    ...
    Process {
        ...
        $AllProperties = ("tmpfilename", "content", "checksum-algorithm", "checksum", "filename", "node", "storage")
