...
function Initialize-PVEPOSTNodesStorageUploadRB {
    ...
    Process {
        ...
        if (!$Filename -and $Filename.length -gt 255) {
		 ...
		 $DisplayNameMapping =@{
			"Checksum"="checksum"; "Content"="content"; "ChecksumAlgorithm"="checksum-algorithm"; "Tmpfilename"="tmpfilename"; "Filename"="filename"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesStorageUploadRB {
    ...
    Process {
        ...
        $AllProperties = ("checksum", "content", "checksum-algorithm", "tmpfilename", "filename")
