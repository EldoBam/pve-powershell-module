...
function Initialize-PVEPUTNodesLxcConfigRB {
    ...
    Process {
        ...
        if ($Cpuunits -and $Cpuunits -gt 500000) {
		 ...
		 $DisplayNameMapping =@{
			"Startup"="startup"; "Tags"="tags"; "Swap"="swap"; "Nameserver"="nameserver"; "Timezone"="timezone"; "Ostype"="ostype"; "Debug"="debug"; "UnusedN"="unused[n]"; "Revert"="revert"; "Cpulimit"="cpulimit"; "Tty"="tty"; "Cmode"="cmode"; "Template"="template"; "Delete"="delete"; "Hookscript"="hookscript"; "Onboot"="onboot"; "NetN"="net[n]"; "Lock"="lock"; "MpN"="mp[n]"; "Hostname"="hostname"; "Arch"="arch"; "Description"="description"; "Cores"="cores"; "Vmid"="vmid"; "Memory"="memory"; "Digest"="digest"; "Features"="features"; "Unprivileged"="unprivileged"; "Console"="console"; "DevN"="dev[n]"; "Protection"="protection"; "Node"="node"; "Rootfs"="rootfs"; "Searchdomain"="searchdomain"; "Cpuunits"="cpuunits"
        }
...
function ConvertFrom-PVEJsonToPUTNodesLxcConfigRB {
    ...
    Process {
        ...
        $AllProperties = ("startup", "tags", "swap", "nameserver", "timezone", "ostype", "debug", "unused[n]", "revert", "cpulimit", "tty", "cmode", "template", "delete", "hookscript", "onboot", "net[n]", "lock", "mp[n]", "hostname", "arch", "description", "cores", "vmid", "memory", "digest", "features", "unprivileged", "console", "dev[n]", "protection", "node", "rootfs", "searchdomain", "cpuunits")
