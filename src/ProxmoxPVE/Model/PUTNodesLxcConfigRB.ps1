...
function Initialize-PVEPUTNodesLxcConfigRB {
    ...
    Process {
        ...
        if ($Tty -and $Tty -gt 6) {
		 ...
		 $DisplayNameMapping =@{
			"Template"="template"; "Onboot"="onboot"; "Console"="console"; "Protection"="protection"; "Memory"="memory"; "Digest"="digest"; "Startup"="startup"; "Lock"="lock"; "Swap"="swap"; "Features"="features"; "Delete"="delete"; "Description"="description"; "Hostname"="hostname"; "Arch"="arch"; "Cmode"="cmode"; "Timezone"="timezone"; "DevN"="dev[n]"; "Tags"="tags"; "Rootfs"="rootfs"; "Unprivileged"="unprivileged"; "Cores"="cores"; "Cpulimit"="cpulimit"; "Debug"="debug"; "MpN"="mp[n]"; "UnusedN"="unused[n]"; "Hookscript"="hookscript"; "Cpuunits"="cpuunits"; "NetN"="net[n]"; "Ostype"="ostype"; "Tty"="tty"; "Searchdomain"="searchdomain"; "Revert"="revert"; "Nameserver"="nameserver"
        }
...
function ConvertFrom-PVEJsonToPUTNodesLxcConfigRB {
    ...
    Process {
        ...
        $AllProperties = ("template", "onboot", "console", "protection", "memory", "digest", "startup", "lock", "swap", "features", "delete", "description", "hostname", "arch", "cmode", "timezone", "dev[n]", "tags", "rootfs", "unprivileged", "cores", "cpulimit", "debug", "mp[n]", "unused[n]", "hookscript", "cpuunits", "net[n]", "ostype", "tty", "searchdomain", "revert", "nameserver")
