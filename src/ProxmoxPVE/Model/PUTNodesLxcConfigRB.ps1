...
function Initialize-PVEPUTNodesLxcConfigRB {
    ...
    Process {
        ...
        if ($Cpuunits -and $Cpuunits -gt 500000) {
		 ...
		 $DisplayNameMapping =@{
			"Cores"="cores"; "Digest"="digest"; "Lock"="lock"; "Description"="description"; "Memory"="memory"; "Cmode"="cmode"; "DevN"="dev[n]"; "Template"="template"; "Hookscript"="hookscript"; "Onboot"="onboot"; "Tags"="tags"; "Revert"="revert"; "Tty"="tty"; "NetN"="net[n]"; "Cpulimit"="cpulimit"; "Hostname"="hostname"; "Console"="console"; "Ostype"="ostype"; "Cpuunits"="cpuunits"; "Features"="features"; "Startup"="startup"; "UnusedN"="unused[n]"; "Unprivileged"="unprivileged"; "Protection"="protection"; "Timezone"="timezone"; "Swap"="swap"; "Searchdomain"="searchdomain"; "Debug"="debug"; "Delete"="delete"; "Rootfs"="rootfs"; "Nameserver"="nameserver"; "MpN"="mp[n]"; "Arch"="arch"
        }
...
function ConvertFrom-PVEJsonToPUTNodesLxcConfigRB {
    ...
    Process {
        ...
        $AllProperties = ("cores", "digest", "lock", "description", "memory", "cmode", "dev[n]", "template", "hookscript", "onboot", "tags", "revert", "tty", "net[n]", "cpulimit", "hostname", "console", "ostype", "cpuunits", "features", "startup", "unused[n]", "unprivileged", "protection", "timezone", "swap", "searchdomain", "debug", "delete", "rootfs", "nameserver", "mp[n]", "arch")
