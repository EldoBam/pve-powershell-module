...
function Initialize-PVEPUTNodesLxcConfigRB {
    ...
    Process {
        ...
        if ($Cpuunits -and $Cpuunits -gt 500000) {
		 ...
		 $DisplayNameMapping =@{
			"MpN"="mp[n]"; "Nameserver"="nameserver"; "Hookscript"="hookscript"; "Searchdomain"="searchdomain"; "NetN"="net[n]"; "Console"="console"; "Rootfs"="rootfs"; "Ostype"="ostype"; "Node"="node"; "Protection"="protection"; "Tty"="tty"; "Cpulimit"="cpulimit"; "Revert"="revert"; "Arch"="arch"; "Template"="template"; "Delete"="delete"; "Swap"="swap"; "Features"="features"; "Debug"="debug"; "Vmid"="vmid"; "Lock"="lock"; "Unprivileged"="unprivileged"; "Hostname"="hostname"; "Startup"="startup"; "Cores"="cores"; "DevN"="dev[n]"; "Digest"="digest"; "Description"="description"; "Memory"="memory"; "UnusedN"="unused[n]"; "Onboot"="onboot"; "Tags"="tags"; "Timezone"="timezone"; "Cpuunits"="cpuunits"; "Cmode"="cmode"
        }
...
function ConvertFrom-PVEJsonToPUTNodesLxcConfigRB {
    ...
    Process {
        ...
        $AllProperties = ("mp[n]", "nameserver", "hookscript", "searchdomain", "net[n]", "console", "rootfs", "ostype", "node", "protection", "tty", "cpulimit", "revert", "arch", "template", "delete", "swap", "features", "debug", "vmid", "lock", "unprivileged", "hostname", "startup", "cores", "dev[n]", "digest", "description", "memory", "unused[n]", "onboot", "tags", "timezone", "cpuunits", "cmode")
