...
function Initialize-PVEPUTNodesLxcConfigRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 40) {
		 ...
		 $DisplayNameMapping =@{
			"Delete"="delete"; "Features"="features"; "DevN"="dev[n]"; "Template"="template"; "Cmode"="cmode"; "Timezone"="timezone"; "Arch"="arch"; "Memory"="memory"; "Debug"="debug"; "MpN"="mp[n]"; "Protection"="protection"; "Startup"="startup"; "Hookscript"="hookscript"; "Onboot"="onboot"; "Revert"="revert"; "Cpuunits"="cpuunits"; "Cpulimit"="cpulimit"; "NetN"="net[n]"; "Swap"="swap"; "Lock"="lock"; "Nameserver"="nameserver"; "Tty"="tty"; "Console"="console"; "Ostype"="ostype"; "Hostname"="hostname"; "Description"="description"; "Tags"="tags"; "Searchdomain"="searchdomain"; "Cores"="cores"; "UnusedN"="unused[n]"; "Rootfs"="rootfs"; "Digest"="digest"; "Unprivileged"="unprivileged"
        }
...
function ConvertFrom-PVEJsonToPUTNodesLxcConfigRB {
    ...
    Process {
        ...
        $AllProperties = ("delete", "features", "dev[n]", "template", "cmode", "timezone", "arch", "memory", "debug", "mp[n]", "protection", "startup", "hookscript", "onboot", "revert", "cpuunits", "cpulimit", "net[n]", "swap", "lock", "nameserver", "tty", "console", "ostype", "hostname", "description", "tags", "searchdomain", "cores", "unused[n]", "rootfs", "digest", "unprivileged")
