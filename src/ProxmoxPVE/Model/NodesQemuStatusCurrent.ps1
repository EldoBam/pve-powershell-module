...
function Initialize-PVENodesQemuStatusCurrent {
    ...
    Process {
        ...
        if ($Agent -and $Agent -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Status"="status"; "Template"="template"; "RunningMachine"="running-machine"; "Netin"="netin"; "Qmpstatus"="qmpstatus"; "Name"="name"; "Spice"="spice"; "Diskread"="diskread"; "Ha"="ha"; "Diskwrite"="diskwrite"; "Tags"="tags"; "Uptime"="uptime"; "Cpus"="cpus"; "VarPid"="pid"; "Clipboard"="clipboard"; "RunningQemu"="running-qemu"; "Vmid"="vmid"; "Maxmem"="maxmem"; "Agent"="agent"; "Maxdisk"="maxdisk"; "Lock"="lock"; "Netout"="netout"
        }
...
function ConvertFrom-PVEJsonToNodesQemuStatusCurrent {
    ...
    Process {
        ...
        $AllProperties = ("status", "template", "running-machine", "netin", "qmpstatus", "name", "spice", "diskread", "ha", "diskwrite", "tags", "uptime", "cpus", "pid", "clipboard", "running-qemu", "vmid", "maxmem", "agent", "maxdisk", "lock", "netout")
