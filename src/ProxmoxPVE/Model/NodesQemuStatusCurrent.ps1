...
function Initialize-PVENodesQemuStatusCurrent {
    ...
    Process {
        ...
        if ($Vmid -and $Vmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Cpu"="cpu"; "Pressurememorysome"="pressurememorysome"; "Agent"="agent"; "VarPid"="pid"; "Maxdisk"="maxdisk"; "Pressurememoryfull"="pressurememoryfull"; "Maxmem"="maxmem"; "Template"="template"; "RunningMachine"="running-machine"; "Pressurecpufull"="pressurecpufull"; "Pressurecpusome"="pressurecpusome"; "Vmid"="vmid"; "Qmpstatus"="qmpstatus"; "Status"="status"; "Diskread"="diskread"; "Cpus"="cpus"; "Ha"="ha"; "Mem"="mem"; "Lock"="lock"; "Uptime"="uptime"; "Pressureiofull"="pressureiofull"; "Name"="name"; "Spice"="spice"; "RunningQemu"="running-qemu"; "Clipboard"="clipboard"; "Memhost"="memhost"; "Tags"="tags"; "Netout"="netout"; "Pressureiosome"="pressureiosome"; "Netin"="netin"; "Serial"="serial"; "Diskwrite"="diskwrite"
        }
...
function ConvertFrom-PVEJsonToNodesQemuStatusCurrent {
    ...
    Process {
        ...
        $AllProperties = ("cpu", "pressurememorysome", "agent", "pid", "maxdisk", "pressurememoryfull", "maxmem", "template", "running-machine", "pressurecpufull", "pressurecpusome", "vmid", "qmpstatus", "status", "diskread", "cpus", "ha", "mem", "lock", "uptime", "pressureiofull", "name", "spice", "running-qemu", "clipboard", "memhost", "tags", "netout", "pressureiosome", "netin", "serial", "diskwrite")
