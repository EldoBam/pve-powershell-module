...
function Initialize-PVENodesQemuStatusCurrent {
    ...
    Process {
        ...
        if ($Vmid -and $Vmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Template"="template"; "Cpu"="cpu"; "Maxmem"="maxmem"; "Maxdisk"="maxdisk"; "Diskwrite"="diskwrite"; "Uptime"="uptime"; "Qmpstatus"="qmpstatus"; "Tags"="tags"; "Diskread"="diskread"; "Ha"="ha"; "RunningMachine"="running-machine"; "Serial"="serial"; "Status"="status"; "Agent"="agent"; "Vmid"="vmid"; "Spice"="spice"; "Lock"="lock"; "Netout"="netout"; "VarPid"="pid"; "Cpus"="cpus"; "Name"="name"; "Clipboard"="clipboard"; "RunningQemu"="running-qemu"; "Mem"="mem"; "Netin"="netin"
        }
...
function ConvertFrom-PVEJsonToNodesQemuStatusCurrent {
    ...
    Process {
        ...
        $AllProperties = ("template", "cpu", "maxmem", "maxdisk", "diskwrite", "uptime", "qmpstatus", "tags", "diskread", "ha", "running-machine", "serial", "status", "agent", "vmid", "spice", "lock", "netout", "pid", "cpus", "name", "clipboard", "running-qemu", "mem", "netin")
