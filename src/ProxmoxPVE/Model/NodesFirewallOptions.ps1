...
function Initialize-PVENodesFirewallOptions {
    ...
    Process {
        ...
        if ($NfConntrackTcpTimeoutSynRecv -and $NfConntrackTcpTimeoutSynRecv -lt 30) {
		 ...
		 $DisplayNameMapping =@{
			"ProtectionSynfloodRate"="protection_synflood_rate"; "LogLevelForward"="log_level_forward"; "Tcpflags"="tcpflags"; "ProtectionSynflood"="protection_synflood"; "LogLevelIn"="log_level_in"; "NfConntrackHelpers"="nf_conntrack_helpers"; "Nftables"="nftables"; "SmurfLogLevel"="smurf_log_level"; "LogLevelOut"="log_level_out"; "ProtectionSynfloodBurst"="protection_synflood_burst"; "TcpFlagsLogLevel"="tcp_flags_log_level"; "Nosmurfs"="nosmurfs"; "LogNfConntrack"="log_nf_conntrack"; "Ndp"="ndp"; "NfConntrackTcpTimeoutEstablished"="nf_conntrack_tcp_timeout_established"; "Enable"="enable"; "NfConntrackMax"="nf_conntrack_max"; "NfConntrackAllowInvalid"="nf_conntrack_allow_invalid"; "NfConntrackTcpTimeoutSynRecv"="nf_conntrack_tcp_timeout_syn_recv"
        }
...
function ConvertFrom-PVEJsonToNodesFirewallOptions {
    ...
    Process {
        ...
        $AllProperties = ("protection_synflood_rate", "log_level_forward", "tcpflags", "protection_synflood", "log_level_in", "nf_conntrack_helpers", "nftables", "smurf_log_level", "log_level_out", "protection_synflood_burst", "tcp_flags_log_level", "nosmurfs", "log_nf_conntrack", "ndp", "nf_conntrack_tcp_timeout_established", "enable", "nf_conntrack_max", "nf_conntrack_allow_invalid", "nf_conntrack_tcp_timeout_syn_recv")
