...
function Initialize-PVENodesFirewallOptions {
    ...
    Process {
        ...
        if ($NfConntrackTcpTimeoutSynRecv -and $NfConntrackTcpTimeoutSynRecv -lt 30) {
		 ...
		 $DisplayNameMapping =@{
			"ProtectionSynfloodRate"="protection_synflood_rate"; "ProtectionSynflood"="protection_synflood"; "NfConntrackTcpTimeoutEstablished"="nf_conntrack_tcp_timeout_established"; "Tcpflags"="tcpflags"; "TcpFlagsLogLevel"="tcp_flags_log_level"; "Nosmurfs"="nosmurfs"; "Nftables"="nftables"; "LogLevelForward"="log_level_forward"; "NfConntrackHelpers"="nf_conntrack_helpers"; "NfConntrackMax"="nf_conntrack_max"; "ProtectionSynfloodBurst"="protection_synflood_burst"; "Enable"="enable"; "LogLevelIn"="log_level_in"; "LogNfConntrack"="log_nf_conntrack"; "Ndp"="ndp"; "SmurfLogLevel"="smurf_log_level"; "LogLevelOut"="log_level_out"; "NfConntrackAllowInvalid"="nf_conntrack_allow_invalid"; "NfConntrackTcpTimeoutSynRecv"="nf_conntrack_tcp_timeout_syn_recv"
        }
...
function ConvertFrom-PVEJsonToNodesFirewallOptions {
    ...
    Process {
        ...
        $AllProperties = ("protection_synflood_rate", "protection_synflood", "nf_conntrack_tcp_timeout_established", "tcpflags", "tcp_flags_log_level", "nosmurfs", "nftables", "log_level_forward", "nf_conntrack_helpers", "nf_conntrack_max", "protection_synflood_burst", "enable", "log_level_in", "log_nf_conntrack", "ndp", "smurf_log_level", "log_level_out", "nf_conntrack_allow_invalid", "nf_conntrack_tcp_timeout_syn_recv")
