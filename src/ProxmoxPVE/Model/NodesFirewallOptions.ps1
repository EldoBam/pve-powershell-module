...
function Initialize-PVENodesFirewallOptions {
    ...
    Process {
        ...
        if ($NfConntrackMax -and $NfConntrackMax -lt 32768) {
		 ...
		 $DisplayNameMapping =@{
			"Nosmurfs"="nosmurfs"; "Enable"="enable"; "TcpFlagsLogLevel"="tcp_flags_log_level"; "NfConntrackTcpTimeoutSynRecv"="nf_conntrack_tcp_timeout_syn_recv"; "ProtectionSynfloodBurst"="protection_synflood_burst"; "ProtectionSynflood"="protection_synflood"; "LogLevelOut"="log_level_out"; "NfConntrackHelpers"="nf_conntrack_helpers"; "NfConntrackTcpTimeoutEstablished"="nf_conntrack_tcp_timeout_established"; "Ndp"="ndp"; "Tcpflags"="tcpflags"; "LogLevelForward"="log_level_forward"; "NfConntrackMax"="nf_conntrack_max"; "Nftables"="nftables"; "LogLevelIn"="log_level_in"; "NfConntrackAllowInvalid"="nf_conntrack_allow_invalid"; "SmurfLogLevel"="smurf_log_level"; "LogNfConntrack"="log_nf_conntrack"; "ProtectionSynfloodRate"="protection_synflood_rate"
        }
...
function ConvertFrom-PVEJsonToNodesFirewallOptions {
    ...
    Process {
        ...
        $AllProperties = ("nosmurfs", "enable", "tcp_flags_log_level", "nf_conntrack_tcp_timeout_syn_recv", "protection_synflood_burst", "protection_synflood", "log_level_out", "nf_conntrack_helpers", "nf_conntrack_tcp_timeout_established", "ndp", "tcpflags", "log_level_forward", "nf_conntrack_max", "nftables", "log_level_in", "nf_conntrack_allow_invalid", "smurf_log_level", "log_nf_conntrack", "protection_synflood_rate")
