...
function Initialize-PVENodesFirewallOptions {
    ...
    Process {
        ...
        if ($NfConntrackMax -and $NfConntrackMax -lt 32768) {
		 ...
		 $DisplayNameMapping =@{
			"NfConntrackTcpTimeoutEstablished"="nf_conntrack_tcp_timeout_established"; "NfConntrackTcpTimeoutSynRecv"="nf_conntrack_tcp_timeout_syn_recv"; "Nosmurfs"="nosmurfs"; "LogLevelOut"="log_level_out"; "ProtectionSynfloodRate"="protection_synflood_rate"; "SmurfLogLevel"="smurf_log_level"; "NfConntrackMax"="nf_conntrack_max"; "Tcpflags"="tcpflags"; "Nftables"="nftables"; "NfConntrackHelpers"="nf_conntrack_helpers"; "ProtectionSynflood"="protection_synflood"; "Enable"="enable"; "TcpFlagsLogLevel"="tcp_flags_log_level"; "Ndp"="ndp"; "ProtectionSynfloodBurst"="protection_synflood_burst"; "LogLevelForward"="log_level_forward"; "LogLevelIn"="log_level_in"; "NfConntrackAllowInvalid"="nf_conntrack_allow_invalid"; "LogNfConntrack"="log_nf_conntrack"
        }
...
function ConvertFrom-PVEJsonToNodesFirewallOptions {
    ...
    Process {
        ...
        $AllProperties = ("nf_conntrack_tcp_timeout_established", "nf_conntrack_tcp_timeout_syn_recv", "nosmurfs", "log_level_out", "protection_synflood_rate", "smurf_log_level", "nf_conntrack_max", "tcpflags", "nftables", "nf_conntrack_helpers", "protection_synflood", "enable", "tcp_flags_log_level", "ndp", "protection_synflood_burst", "log_level_forward", "log_level_in", "nf_conntrack_allow_invalid", "log_nf_conntrack")
