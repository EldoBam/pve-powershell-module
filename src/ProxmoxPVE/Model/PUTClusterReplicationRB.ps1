...
function Initialize-PVEPUTClusterReplicationRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Schedule"="schedule"; "RemoveJob"="remove_job"; "Delete"="delete"; "Comment"="comment"; "Source"="source"; "Rate"="rate"; "Digest"="digest"; "Disable"="disable"
        }
...
function ConvertFrom-PVEJsonToPUTClusterReplicationRB {
    ...
    Process {
        ...
        $AllProperties = ("schedule", "remove_job", "delete", "comment", "source", "rate", "digest", "disable")
