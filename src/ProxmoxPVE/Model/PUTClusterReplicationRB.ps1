...
function Initialize-PVEPUTClusterReplicationRB {
    ...
    Process {
        ...
        if ($Rate -and $Rate -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Source"="source"; "RemoveJob"="remove_job"; "Comment"="comment"; "Disable"="disable"; "Id"="id"; "Delete"="delete"; "Digest"="digest"; "Schedule"="schedule"; "Rate"="rate"
        }
...
function ConvertFrom-PVEJsonToPUTClusterReplicationRB {
    ...
    Process {
        ...
        $AllProperties = ("source", "remove_job", "comment", "disable", "id", "delete", "digest", "schedule", "rate")
