...
function Initialize-PVEPUTClusterReplicationRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Disable"="disable"; "Delete"="delete"; "Schedule"="schedule"; "Rate"="rate"; "Source"="source"; "RemoveJob"="remove_job"; "Comment"="comment"; "Digest"="digest"
        }
...
function ConvertFrom-PVEJsonToPUTClusterReplicationRB {
    ...
    Process {
        ...
        $AllProperties = ("disable", "delete", "schedule", "rate", "source", "remove_job", "comment", "digest")
