...
ClusterSdnFabricsNodeGETInner<PSCustomObject>
#>

function Initialize-PVEClusterSdnFabricsNodeGETInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ProxmoxPVE => PVEClusterSdnFabricsNodeGETInner' | Write-Debug
...
Convert from JSON to ClusterSdnFabricsNodeGETInner<PSCustomObject>
...
ClusterSdnFabricsNodeGETInner<PSCustomObject>
#>
function ConvertFrom-PVEJsonToClusterSdnFabricsNodeGETInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ProxmoxPVE => PVEClusterSdnFabricsNodeGETInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PVEClusterSdnFabricsNodeGETInner
