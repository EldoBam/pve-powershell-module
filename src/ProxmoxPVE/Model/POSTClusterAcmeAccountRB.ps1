...
function Initialize-PVEPOSTClusterAcmeAccountRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"EabHmacKey"="eab-hmac-key"; "Contact"="contact"; "Name"="name"; "EabKid"="eab-kid"; "TosUrl"="tos_url"; "Directory"="directory"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterAcmeAccountRB {
    ...
    Process {
        ...
        $AllProperties = ("eab-hmac-key", "contact", "name", "eab-kid", "tos_url", "directory")
