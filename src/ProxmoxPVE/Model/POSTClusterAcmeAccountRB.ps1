...
function Initialize-PVEPOSTClusterAcmeAccountRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"EabHmacKey"="eab-hmac-key"; "Directory"="directory"; "Contact"="contact"; "TosUrl"="tos_url"; "Name"="name"; "EabKid"="eab-kid"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterAcmeAccountRB {
    ...
    Process {
        ...
        $AllProperties = ("eab-hmac-key", "directory", "contact", "tos_url", "name", "eab-kid")
