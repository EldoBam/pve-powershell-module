...
ClusterSdnFabricsNodeInner<PSCustomObject>
#>

function Initialize-PVEClusterSdnFabricsNodeInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ProxmoxPVE => PVEClusterSdnFabricsNodeInner' | Write-Debug
...
Convert from JSON to ClusterSdnFabricsNodeInner<PSCustomObject>
...
ClusterSdnFabricsNodeInner<PSCustomObject>
#>
function ConvertFrom-PVEJsonToClusterSdnFabricsNodeInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ProxmoxPVE => PVEClusterSdnFabricsNodeInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PVEClusterSdnFabricsNodeInner
