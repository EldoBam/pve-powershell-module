...
function Initialize-PVEPUTClusterSdnVnetsFirewallOptionsRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Delete"="delete"; "Digest"="digest"; "LogLevelForward"="log_level_forward"; "Enable"="enable"; "PolicyForward"="policy_forward"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnVnetsFirewallOptionsRB {
    ...
    Process {
        ...
        $AllProperties = ("delete", "digest", "log_level_forward", "enable", "policy_forward")
