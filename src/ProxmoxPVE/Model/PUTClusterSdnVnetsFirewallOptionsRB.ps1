...
function Initialize-PVEPUTClusterSdnVnetsFirewallOptionsRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Delete"="delete"; "LogLevelForward"="log_level_forward"; "PolicyForward"="policy_forward"; "Enable"="enable"; "Digest"="digest"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnVnetsFirewallOptionsRB {
    ...
    Process {
        ...
        $AllProperties = ("delete", "log_level_forward", "policy_forward", "enable", "digest")
