...
function Initialize-PVEPUTClusterSdnVnetsFirewallOptionsRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"LogLevelForward"="log_level_forward"; "Digest"="digest"; "Enable"="enable"; "PolicyForward"="policy_forward"; "Delete"="delete"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnVnetsFirewallOptionsRB {
    ...
    Process {
        ...
        $AllProperties = ("log_level_forward", "digest", "enable", "policy_forward", "delete")
