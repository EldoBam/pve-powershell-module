...
function Initialize-PVEPUTClusterSdnVnetsFirewallOptionsRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Delete"="delete"; "Enable"="enable"; "LogLevelForward"="log_level_forward"; "PolicyForward"="policy_forward"; "Digest"="digest"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnVnetsFirewallOptionsRB {
    ...
    Process {
        ...
        $AllProperties = ("delete", "enable", "log_level_forward", "policy_forward", "digest")
