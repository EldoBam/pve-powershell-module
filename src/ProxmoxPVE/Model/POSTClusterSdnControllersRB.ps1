...
function Initialize-PVEPOSTClusterSdnControllersRB {
    ...
    Process {
        ...
        if ($Asn -and $Asn -gt 4294967296) {
		 ...
		 $DisplayNameMapping =@{
			"Controller"="controller"; "Node"="node"; "Loopback"="loopback"; "Peers"="peers"; "Type"="type"; "Ebgp"="ebgp"; "BgpMultipathAsPathRelax"="bgp-multipath-as-path-relax"; "EbgpMultihop"="ebgp-multihop"; "IsisNet"="isis-net"; "Asn"="asn"; "IsisIfaces"="isis-ifaces"; "IsisDomain"="isis-domain"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterSdnControllersRB {
    ...
    Process {
        ...
        $AllProperties = ("controller", "node", "loopback", "peers", "type", "ebgp", "bgp-multipath-as-path-relax", "ebgp-multihop", "isis-net", "asn", "isis-ifaces", "isis-domain")
