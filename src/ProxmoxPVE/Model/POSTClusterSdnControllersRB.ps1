...
function Initialize-PVEPOSTClusterSdnControllersRB {
    ...
    Process {
        ...
        if ($Asn -and $Asn -gt 4294967295) {
		 ...
		 $DisplayNameMapping =@{
			"IsisIfaces"="isis-ifaces"; "EbgpMultihop"="ebgp-multihop"; "IsisDomain"="isis-domain"; "IsisNet"="isis-net"; "Peers"="peers"; "Asn"="asn"; "BgpMultipathAsPathRelax"="bgp-multipath-as-path-relax"; "Ebgp"="ebgp"; "Type"="type"; "LockToken"="lock-token"; "Node"="node"; "Controller"="controller"; "Loopback"="loopback"; "Fabric"="fabric"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterSdnControllersRB {
    ...
    Process {
        ...
        $AllProperties = ("isis-ifaces", "ebgp-multihop", "isis-domain", "isis-net", "peers", "asn", "bgp-multipath-as-path-relax", "ebgp", "type", "lock-token", "node", "controller", "loopback", "fabric")
