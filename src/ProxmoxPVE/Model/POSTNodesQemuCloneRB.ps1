...
function Initialize-PVEPOSTNodesQemuCloneRB {
    ...
    Process {
        ...
        if (!$Snapname -and $Snapname.length -gt 40) {
		 ...
		 $DisplayNameMapping =@{
			"Target"="target"; "Full"="full"; "Name"="name"; "Newid"="newid"; "Snapname"="snapname"; "Bwlimit"="bwlimit"; "Pool"="pool"; "Format"="format"; "Storage"="storage"; "Description"="description"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuCloneRB {
    ...
    Process {
        ...
        $AllProperties = ("target", "full", "name", "newid", "snapname", "bwlimit", "pool", "format", "storage", "description")
