...
function Initialize-PVEPOSTNodesQemuCloneRB {
    ...
    Process {
        ...
        if ($Newid -and $Newid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Snapname"="snapname"; "Target"="target"; "Bwlimit"="bwlimit"; "Newid"="newid"; "Storage"="storage"; "Pool"="pool"; "Format"="format"; "Full"="full"; "Description"="description"; "Name"="name"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuCloneRB {
    ...
    Process {
        ...
        $AllProperties = ("snapname", "target", "bwlimit", "newid", "storage", "pool", "format", "full", "description", "name")
