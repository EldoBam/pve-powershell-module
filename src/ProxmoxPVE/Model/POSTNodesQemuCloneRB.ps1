...
function Initialize-PVEPOSTNodesQemuCloneRB {
    ...
    Process {
        ...
        if (!$Snapname -and $Snapname.length -gt 40) {
		 ...
		 $DisplayNameMapping =@{
			"Newid"="newid"; "Target"="target"; "Snapname"="snapname"; "Description"="description"; "Name"="name"; "Format"="format"; "Full"="full"; "Bwlimit"="bwlimit"; "Pool"="pool"; "Storage"="storage"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuCloneRB {
    ...
    Process {
        ...
        $AllProperties = ("newid", "target", "snapname", "description", "name", "format", "full", "bwlimit", "pool", "storage")
