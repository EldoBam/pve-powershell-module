...
function Initialize-PVEPOSTNodesQemuCloneRB {
    ...
    Process {
        ...
        if (!$Snapname -and $Snapname.length -gt 40) {
		 ...
		 $DisplayNameMapping =@{
			"Pool"="pool"; "Target"="target"; "Newid"="newid"; "Name"="name"; "Storage"="storage"; "Description"="description"; "Full"="full"; "Bwlimit"="bwlimit"; "Snapname"="snapname"; "Format"="format"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuCloneRB {
    ...
    Process {
        ...
        $AllProperties = ("pool", "target", "newid", "name", "storage", "description", "full", "bwlimit", "snapname", "format")
