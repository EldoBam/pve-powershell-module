...
function Initialize-PVEPUTClusterNotificationsEndpointsWebhookRB {
    ...
    Process {
        ...
        if ($Disable -and $Disable -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Secret"="secret"; "Header"="header"; "Digest"="digest"; "Method"="method"; "Body"="body"; "Url"="url"; "Comment"="comment"; "Delete"="delete"; "Disable"="disable"; "Name"="name"
        }
...
function ConvertFrom-PVEJsonToPUTClusterNotificationsEndpointsWebhookRB {
    ...
    Process {
        ...
        $AllProperties = ("secret", "header", "digest", "method", "body", "url", "comment", "delete", "disable", "name")
