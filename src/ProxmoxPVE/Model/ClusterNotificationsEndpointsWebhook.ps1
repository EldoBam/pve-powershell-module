...
function Initialize-PVEClusterNotificationsEndpointsWebhook {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Body"="body"; "Url"="url"; "Comment"="comment"; "Name"="name"; "Disable"="disable"; "Method"="method"; "Digest"="digest"; "Secret"="secret"; "Header"="header"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsWebhook {
    ...
    Process {
        ...
        $AllProperties = ("body", "url", "comment", "name", "disable", "method", "digest", "secret", "header")
