...
function Initialize-PVEClusterNotificationsEndpointsWebhook {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Url"="url"; "Disable"="disable"; "Header"="header"; "Comment"="comment"; "Body"="body"; "Secret"="secret"; "Name"="name"; "Method"="method"; "Digest"="digest"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsWebhook {
    ...
    Process {
        ...
        $AllProperties = ("url", "disable", "header", "comment", "body", "secret", "name", "method", "digest")
