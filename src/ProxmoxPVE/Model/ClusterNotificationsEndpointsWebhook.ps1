...
function Initialize-PVEClusterNotificationsEndpointsWebhook {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Digest"="digest"; "Method"="method"; "Url"="url"; "Disable"="disable"; "Header"="header"; "Secret"="secret"; "Comment"="comment"; "Body"="body"; "Name"="name"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsWebhook {
    ...
    Process {
        ...
        $AllProperties = ("digest", "method", "url", "disable", "header", "secret", "comment", "body", "name")
