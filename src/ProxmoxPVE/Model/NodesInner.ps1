...
function Initialize-PVENodesInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Node"="node"; "Maxcpu"="maxcpu"; "Status"="status"; "Cpu"="cpu"; "Uptime"="uptime"; "Level"="level"; "Mem"="mem"; "Maxmem"="maxmem"; "SslFingerprint"="ssl_fingerprint"
        }
...
function ConvertFrom-PVEJsonToNodesInner {
    ...
    Process {
        ...
        $AllProperties = ("node", "maxcpu", "status", "cpu", "uptime", "level", "mem", "maxmem", "ssl_fingerprint")
