...
function Initialize-PVENodesInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Maxmem"="maxmem"; "Node"="node"; "Level"="level"; "Cpu"="cpu"; "SslFingerprint"="ssl_fingerprint"; "Maxcpu"="maxcpu"; "Mem"="mem"; "Uptime"="uptime"; "Status"="status"
        }
...
function ConvertFrom-PVEJsonToNodesInner {
    ...
    Process {
        ...
        $AllProperties = ("maxmem", "node", "level", "cpu", "ssl_fingerprint", "maxcpu", "mem", "uptime", "status")
