...
function Initialize-PVENodesInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Uptime"="uptime"; "Mem"="mem"; "Cpu"="cpu"; "Maxmem"="maxmem"; "Node"="node"; "SslFingerprint"="ssl_fingerprint"; "Level"="level"; "Maxcpu"="maxcpu"; "Status"="status"
        }
...
function ConvertFrom-PVEJsonToNodesInner {
    ...
    Process {
        ...
        $AllProperties = ("uptime", "mem", "cpu", "maxmem", "node", "ssl_fingerprint", "level", "maxcpu", "status")
