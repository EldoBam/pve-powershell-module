...
function Initialize-PVEPOSTNodesDisksZfsRB {
    ...
    Process {
        ...
        if ($Ashift -and $Ashift -lt 9) {
		 ...
		 $DisplayNameMapping =@{
			"Compression"="compression"; "Raidlevel"="raidlevel"; "Devices"="devices"; "DraidConfig"="draid-config"; "AddStorage"="add_storage"; "Name"="name"; "Ashift"="ashift"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesDisksZfsRB {
    ...
    Process {
        ...
        $AllProperties = ("compression", "raidlevel", "devices", "draid-config", "add_storage", "name", "ashift")
