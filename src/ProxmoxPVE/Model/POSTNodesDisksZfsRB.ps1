...
function Initialize-PVEPOSTNodesDisksZfsRB {
    ...
    Process {
        ...
        if ($Ashift -and $Ashift -lt 9) {
		 ...
		 $DisplayNameMapping =@{
			"Raidlevel"="raidlevel"; "Devices"="devices"; "AddStorage"="add_storage"; "Compression"="compression"; "Name"="name"; "DraidConfig"="draid-config"; "Ashift"="ashift"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesDisksZfsRB {
    ...
    Process {
        ...
        $AllProperties = ("raidlevel", "devices", "add_storage", "compression", "name", "draid-config", "ashift")
