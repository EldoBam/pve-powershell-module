...
function Initialize-PVEPUTAccessAclRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Path"="path"; "Roles"="roles"; "Delete"="delete"; "Users"="users"; "Propagate"="propagate"; "Groups"="groups"; "Tokens"="tokens"
        }
...
function ConvertFrom-PVEJsonToPUTAccessAclRB {
    ...
    Process {
        ...
        $AllProperties = ("path", "roles", "delete", "users", "propagate", "groups", "tokens")
