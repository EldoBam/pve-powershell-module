...
function Initialize-PVEPUTAccessAclRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Delete"="delete"; "Groups"="groups"; "Roles"="roles"; "Users"="users"; "Tokens"="tokens"; "Propagate"="propagate"; "Path"="path"
        }
...
function ConvertFrom-PVEJsonToPUTAccessAclRB {
    ...
    Process {
        ...
        $AllProperties = ("delete", "groups", "roles", "users", "tokens", "propagate", "path")
