...
function Initialize-PVEPUTAccessAclRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Roles"="roles"; "Propagate"="propagate"; "Tokens"="tokens"; "Groups"="groups"; "Users"="users"; "Path"="path"; "Delete"="delete"
        }
...
function ConvertFrom-PVEJsonToPUTAccessAclRB {
    ...
    Process {
        ...
        $AllProperties = ("roles", "propagate", "tokens", "groups", "users", "path", "delete")
