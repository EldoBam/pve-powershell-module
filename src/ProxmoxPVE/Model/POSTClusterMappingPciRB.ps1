...
function Initialize-PVEPOSTClusterMappingPciRB {
    ...
    Process {
        ...
        if (!$Description -and $Description.length -gt 4096) {
		 ...
		 $DisplayNameMapping =@{
			"Map"="map"; "LiveMigrationCapable"="live-migration-capable"; "Id"="id"; "Description"="description"; "Mdev"="mdev"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterMappingPciRB {
    ...
    Process {
        ...
        $AllProperties = ("map", "live-migration-capable", "id", "description", "mdev")
