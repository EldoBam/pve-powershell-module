...
function Initialize-PVEPOSTClusterMappingPciRB {
    ...
    Process {
        ...
        if (!$Description -and $Description.length -gt 4096) {
		 ...
		 $DisplayNameMapping =@{
			"Mdev"="mdev"; "LiveMigrationCapable"="live-migration-capable"; "Id"="id"; "Description"="description"; "Map"="map"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterMappingPciRB {
    ...
    Process {
        ...
        $AllProperties = ("mdev", "live-migration-capable", "id", "description", "map")
