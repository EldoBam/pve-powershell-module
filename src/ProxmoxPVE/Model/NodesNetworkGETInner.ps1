...
function Initialize-PVENodesNetworkGETInner {
    ...
    Process {
        ...
        if ($Mtu -and $Mtu -lt 1280) {
		 ...
		 $DisplayNameMapping =@{
			"BridgeUnicastFlood"="bridge-unicast-flood"; "VxlanId"="vxlan-id"; "Families"="families"; "LinkType"="link-type"; "Gateway"="gateway"; "UplinkId"="uplink-id"; "Cidr6"="cidr6"; "Type"="type"; "BridgePorts"="bridge_ports"; "Address"="address"; "Options"="options"; "VlanId"="vlan-id"; "Active"="active"; "BridgeLearning"="bridge-learning"; "BondXmitHashPolicy"="bond_xmit_hash_policy"; "BondPrimary"="bond-primary"; "Priority"="priority"; "Comments"="comments"; "Options6"="options6"; "Address6"="address6"; "Comments6"="comments6"; "VxlanSvcnodeip"="vxlan-svcnodeip"; "Autostart"="autostart"; "VxlanLocalTunnelip"="vxlan-local-tunnelip"; "Gateway6"="gateway6"; "VlanProtocol"="vlan-protocol"; "Method6"="method6"; "BondMode"="bond_mode"; "BridgeArpNdSuppress"="bridge-arp-nd-suppress"; "VlanRawDevice"="vlan-raw-device"; "Netmask"="netmask"; "Netmask6"="netmask6"; "BridgeMulticastFlood"="bridge-multicast-flood"; "BridgeVids"="bridge_vids"; "Exists"="exists"; "Method"="method"; "Iface"="iface"; "OvsBridge"="ovs_bridge"; "BridgeVlanAware"="bridge_vlan_aware"; "Cidr"="cidr"; "OvsBonds"="ovs_bonds"; "OvsOptions"="ovs_options"; "BridgeAccess"="bridge-access"; "Slaves"="slaves"; "OvsPorts"="ovs_ports"; "OvsTag"="ovs_tag"; "Mtu"="mtu"; "VxlanPhysdev"="vxlan-physdev"
        }
...
function ConvertFrom-PVEJsonToNodesNetworkGETInner {
    ...
    Process {
        ...
        $AllProperties = ("bridge-unicast-flood", "vxlan-id", "families", "link-type", "gateway", "uplink-id", "cidr6", "type", "bridge_ports", "address", "options", "vlan-id", "active", "bridge-learning", "bond_xmit_hash_policy", "bond-primary", "priority", "comments", "options6", "address6", "comments6", "vxlan-svcnodeip", "autostart", "vxlan-local-tunnelip", "gateway6", "vlan-protocol", "method6", "bond_mode", "bridge-arp-nd-suppress", "vlan-raw-device", "netmask", "netmask6", "bridge-multicast-flood", "bridge_vids", "exists", "method", "iface", "ovs_bridge", "bridge_vlan_aware", "cidr", "ovs_bonds", "ovs_options", "bridge-access", "slaves", "ovs_ports", "ovs_tag", "mtu", "vxlan-physdev")
