...
function Initialize-PVEPOSTClusterAcmePluginsRB {
    ...
    Process {
        ...
        if ($Disable -and $Disable -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Api"="api"; "ValidationDelay"="validation-delay"; "VarData"="data"; "Type"="type"; "Nodes"="nodes"; "Disable"="disable"; "Id"="id"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterAcmePluginsRB {
    ...
    Process {
        ...
        $AllProperties = ("api", "validation-delay", "data", "type", "nodes", "disable", "id")
