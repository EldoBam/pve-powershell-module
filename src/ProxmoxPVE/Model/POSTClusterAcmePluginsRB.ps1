...
function Initialize-PVEPOSTClusterAcmePluginsRB {
    ...
    Process {
        ...
        if ($ValidationDelay -and $ValidationDelay -gt 172800) {
		 ...
		 $DisplayNameMapping =@{
			"Type"="type"; "Api"="api"; "Disable"="disable"; "Id"="id"; "ValidationDelay"="validation-delay"; "VarData"="data"; "Nodes"="nodes"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterAcmePluginsRB {
    ...
    Process {
        ...
        $AllProperties = ("type", "api", "disable", "id", "validation-delay", "data", "nodes")
