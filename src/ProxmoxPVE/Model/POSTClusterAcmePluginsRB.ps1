...
function Initialize-PVEPOSTClusterAcmePluginsRB {
    ...
    Process {
        ...
        if ($ValidationDelay -and $ValidationDelay -gt 172800) {
		 ...
		 $DisplayNameMapping =@{
			"Disable"="disable"; "Type"="type"; "ValidationDelay"="validation-delay"; "Id"="id"; "Nodes"="nodes"; "VarData"="data"; "Api"="api"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterAcmePluginsRB {
    ...
    Process {
        ...
        $AllProperties = ("disable", "type", "validation-delay", "id", "nodes", "data", "api")
