...
function Initialize-PVEPUTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Mode"="mode"; "Delete"="delete"; "Target"="target"; "MatchField"="match-field"; "Disable"="disable"; "MatchSeverity"="match-severity"; "Digest"="digest"; "MatchCalendar"="match-calendar"; "Comment"="comment"; "InvertMatch"="invert-match"
        }
...
function ConvertFrom-PVEJsonToPUTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        $AllProperties = ("mode", "delete", "target", "match-field", "disable", "match-severity", "digest", "match-calendar", "comment", "invert-match")
