...
function Initialize-PVEPUTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"MatchSeverity"="match-severity"; "InvertMatch"="invert-match"; "Comment"="comment"; "Disable"="disable"; "MatchCalendar"="match-calendar"; "Delete"="delete"; "MatchField"="match-field"; "Digest"="digest"; "Target"="target"; "Name"="name"; "Mode"="mode"
        }
...
function ConvertFrom-PVEJsonToPUTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        $AllProperties = ("match-severity", "invert-match", "comment", "disable", "match-calendar", "delete", "match-field", "digest", "target", "name", "mode")
