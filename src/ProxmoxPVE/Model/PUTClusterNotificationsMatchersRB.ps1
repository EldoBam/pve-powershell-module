...
function Initialize-PVEPUTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Mode"="mode"; "Delete"="delete"; "MatchField"="match-field"; "Target"="target"; "Comment"="comment"; "InvertMatch"="invert-match"; "Disable"="disable"; "MatchCalendar"="match-calendar"; "Digest"="digest"; "MatchSeverity"="match-severity"
        }
...
function ConvertFrom-PVEJsonToPUTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        $AllProperties = ("mode", "delete", "match-field", "target", "comment", "invert-match", "disable", "match-calendar", "digest", "match-severity")
