...
function Initialize-PVEPUTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Digest"="digest"; "Mode"="mode"; "MatchCalendar"="match-calendar"; "InvertMatch"="invert-match"; "MatchSeverity"="match-severity"; "Disable"="disable"; "Delete"="delete"; "Target"="target"; "Comment"="comment"; "MatchField"="match-field"
        }
...
function ConvertFrom-PVEJsonToPUTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        $AllProperties = ("digest", "mode", "match-calendar", "invert-match", "match-severity", "disable", "delete", "target", "comment", "match-field")
