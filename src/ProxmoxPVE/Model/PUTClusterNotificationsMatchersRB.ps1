...
function Initialize-PVEPUTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Target"="target"; "MatchField"="match-field"; "Mode"="mode"; "Delete"="delete"; "Comment"="comment"; "MatchCalendar"="match-calendar"; "Digest"="digest"; "MatchSeverity"="match-severity"; "InvertMatch"="invert-match"; "Disable"="disable"
        }
...
function ConvertFrom-PVEJsonToPUTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        $AllProperties = ("target", "match-field", "mode", "delete", "comment", "match-calendar", "digest", "match-severity", "invert-match", "disable")
