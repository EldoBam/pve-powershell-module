...
function Initialize-PVEPUTNodesQemuFirewallRulesRB {
    ...
    Process {
        ...
        if (!$Dest -and $Dest.length -gt 512) {
		 ...
		 $DisplayNameMapping =@{
			"Macro"="macro"; "Action"="action"; "Iface"="iface"; "Proto"="proto"; "Sport"="sport"; "Comment"="comment"; "IcmpType"="icmp-type"; "Delete"="delete"; "Digest"="digest"; "Type"="type"; "Source"="source"; "Dest"="dest"; "Enable"="enable"; "Log"="log"; "Dport"="dport"; "Moveto"="moveto"
        }
...
function ConvertFrom-PVEJsonToPUTNodesQemuFirewallRulesRB {
    ...
    Process {
        ...
        $AllProperties = ("macro", "action", "iface", "proto", "sport", "comment", "icmp-type", "delete", "digest", "type", "source", "dest", "enable", "log", "dport", "moveto")
