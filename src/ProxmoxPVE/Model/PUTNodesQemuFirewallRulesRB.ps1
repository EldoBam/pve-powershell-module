...
function Initialize-PVEPUTNodesQemuFirewallRulesRB {
    ...
    Process {
        ...
        if (!$Macro -and $Macro.length -gt 128) {
		 ...
		 $DisplayNameMapping =@{
			"IcmpType"="icmp-type"; "Action"="action"; "Type"="type"; "Dest"="dest"; "Source"="source"; "Digest"="digest"; "Dport"="dport"; "Enable"="enable"; "Log"="log"; "Iface"="iface"; "Delete"="delete"; "Moveto"="moveto"; "Comment"="comment"; "Proto"="proto"; "Sport"="sport"; "Macro"="macro"
        }
...
function ConvertFrom-PVEJsonToPUTNodesQemuFirewallRulesRB {
    ...
    Process {
        ...
        $AllProperties = ("icmp-type", "action", "type", "dest", "source", "digest", "dport", "enable", "log", "iface", "delete", "moveto", "comment", "proto", "sport", "macro")
