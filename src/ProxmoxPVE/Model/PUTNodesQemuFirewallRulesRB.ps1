...
function Initialize-PVEPUTNodesQemuFirewallRulesRB {
    ...
    Process {
        ...
        if (!$Iface -and $Iface.length -lt 2) {
		 ...
		 $DisplayNameMapping =@{
			"Digest"="digest"; "Source"="source"; "Sport"="sport"; "Action"="action"; "Log"="log"; "Comment"="comment"; "Dest"="dest"; "Proto"="proto"; "Enable"="enable"; "IcmpType"="icmp-type"; "Macro"="macro"; "Vmid"="vmid"; "Pos"="pos"; "Type"="type"; "Node"="node"; "Iface"="iface"; "Moveto"="moveto"; "Delete"="delete"; "Dport"="dport"
        }
...
function ConvertFrom-PVEJsonToPUTNodesQemuFirewallRulesRB {
    ...
    Process {
        ...
        $AllProperties = ("digest", "source", "sport", "action", "log", "comment", "dest", "proto", "enable", "icmp-type", "macro", "vmid", "pos", "type", "node", "iface", "moveto", "delete", "dport")
