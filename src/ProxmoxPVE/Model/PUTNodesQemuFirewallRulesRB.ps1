...
function Initialize-PVEPUTNodesQemuFirewallRulesRB {
    ...
    Process {
        ...
        if (!$Iface -and $Iface.length -lt 2) {
		 ...
		 $DisplayNameMapping =@{
			"Delete"="delete"; "Enable"="enable"; "Macro"="macro"; "Comment"="comment"; "Moveto"="moveto"; "Sport"="sport"; "Digest"="digest"; "Dest"="dest"; "Log"="log"; "IcmpType"="icmp-type"; "Source"="source"; "Action"="action"; "Proto"="proto"; "Iface"="iface"; "Dport"="dport"; "Type"="type"
        }
...
function ConvertFrom-PVEJsonToPUTNodesQemuFirewallRulesRB {
    ...
    Process {
        ...
        $AllProperties = ("delete", "enable", "macro", "comment", "moveto", "sport", "digest", "dest", "log", "icmp-type", "source", "action", "proto", "iface", "dport", "type")
