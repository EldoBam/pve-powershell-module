...
function Initialize-PVEPUTNodesQemuFirewallRulesRB {
    ...
    Process {
        ...
        if (!$Iface -and $Iface.length -lt 2) {
		 ...
		 $DisplayNameMapping =@{
			"Log"="log"; "Action"="action"; "IcmpType"="icmp-type"; "Macro"="macro"; "Comment"="comment"; "Source"="source"; "Dport"="dport"; "Vmid"="vmid"; "Proto"="proto"; "Dest"="dest"; "Delete"="delete"; "Node"="node"; "Sport"="sport"; "Moveto"="moveto"; "Type"="type"; "Enable"="enable"; "Digest"="digest"; "Pos"="pos"; "Iface"="iface"
        }
...
function ConvertFrom-PVEJsonToPUTNodesQemuFirewallRulesRB {
    ...
    Process {
        ...
        $AllProperties = ("log", "action", "icmp-type", "macro", "comment", "source", "dport", "vmid", "proto", "dest", "delete", "node", "sport", "moveto", "type", "enable", "digest", "pos", "iface")
