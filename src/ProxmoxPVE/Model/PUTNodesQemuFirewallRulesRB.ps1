...
function Initialize-PVEPUTNodesQemuFirewallRulesRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Vmid"="vmid"; "Pos"="pos"; "Moveto"="moveto"; "Type"="type"; "Dest"="dest"; "Source"="source"; "Comment"="comment"; "Enable"="enable"; "Macro"="macro"; "Node"="node"; "Action"="action"; "Dport"="dport"; "Log"="log"; "Sport"="sport"; "Iface"="iface"; "Delete"="delete"; "Proto"="proto"; "Digest"="digest"; "IcmpType"="icmp-type"
        }
...
function ConvertFrom-PVEJsonToPUTNodesQemuFirewallRulesRB {
    ...
    Process {
        ...
        $AllProperties = ("vmid", "pos", "moveto", "type", "dest", "source", "comment", "enable", "macro", "node", "action", "dport", "log", "sport", "iface", "delete", "proto", "digest", "icmp-type")
