...
function Initialize-PVEPUTNodesQemuFirewallRulesRB {
    ...
    Process {
        ...
        if (!$Iface -and $Iface.length -lt 2) {
		 ...
		 $DisplayNameMapping =@{
			"IcmpType"="icmp-type"; "Dest"="dest"; "Enable"="enable"; "Action"="action"; "Sport"="sport"; "Proto"="proto"; "Macro"="macro"; "Moveto"="moveto"; "Comment"="comment"; "Delete"="delete"; "Type"="type"; "Digest"="digest"; "Dport"="dport"; "Source"="source"; "Log"="log"; "Iface"="iface"
        }
...
function ConvertFrom-PVEJsonToPUTNodesQemuFirewallRulesRB {
    ...
    Process {
        ...
        $AllProperties = ("icmp-type", "dest", "enable", "action", "sport", "proto", "macro", "moveto", "comment", "delete", "type", "digest", "dport", "source", "log", "iface")
