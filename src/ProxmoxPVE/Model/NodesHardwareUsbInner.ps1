...
function Initialize-PVENodesHardwareUsbInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Vendid"="vendid"; "Class"="class"; "Speed"="speed"; "Product"="product"; "Usbpath"="usbpath"; "Port"="port"; "Level"="level"; "Devnum"="devnum"; "Serial"="serial"; "Prodid"="prodid"; "Manufacturer"="manufacturer"; "Busnum"="busnum"
        }
...
function ConvertFrom-PVEJsonToNodesHardwareUsbInner {
    ...
    Process {
        ...
        $AllProperties = ("vendid", "class", "speed", "product", "usbpath", "port", "level", "devnum", "serial", "prodid", "manufacturer", "busnum")
