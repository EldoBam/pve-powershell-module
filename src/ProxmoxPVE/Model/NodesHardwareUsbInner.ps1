...
function Initialize-PVENodesHardwareUsbInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Usbpath"="usbpath"; "Vendid"="vendid"; "Devnum"="devnum"; "Serial"="serial"; "Product"="product"; "Speed"="speed"; "Level"="level"; "Class"="class"; "Manufacturer"="manufacturer"; "Prodid"="prodid"; "Port"="port"; "Busnum"="busnum"
        }
...
function ConvertFrom-PVEJsonToNodesHardwareUsbInner {
    ...
    Process {
        ...
        $AllProperties = ("usbpath", "vendid", "devnum", "serial", "product", "speed", "level", "class", "manufacturer", "prodid", "port", "busnum")
