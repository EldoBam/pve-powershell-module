...
function Initialize-PVENodesHardwareUsbInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Level"="level"; "Port"="port"; "Speed"="speed"; "Manufacturer"="manufacturer"; "Devnum"="devnum"; "Usbpath"="usbpath"; "Vendid"="vendid"; "Product"="product"; "Class"="class"; "Prodid"="prodid"; "Busnum"="busnum"; "Serial"="serial"
        }
...
function ConvertFrom-PVEJsonToNodesHardwareUsbInner {
    ...
    Process {
        ...
        $AllProperties = ("level", "port", "speed", "manufacturer", "devnum", "usbpath", "vendid", "product", "class", "prodid", "busnum", "serial")
