...
function Initialize-PVENodesStatus {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"BootInfo"="boot-info"; "CurrentKernel"="current-kernel"; "Rootfs"="rootfs"; "Cpuinfo"="cpuinfo"; "Loadavg"="loadavg"; "Cpu"="cpu"; "Pveversion"="pveversion"; "Memory"="memory"
        }
...
function ConvertFrom-PVEJsonToNodesStatus {
    ...
    Process {
        ...
        $AllProperties = ("boot-info", "current-kernel", "rootfs", "cpuinfo", "loadavg", "cpu", "pveversion", "memory")
