...
function Initialize-PVENodesStatus {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"CurrentKernel"="current-kernel"; "Cpu"="cpu"; "Loadavg"="loadavg"; "Memory"="memory"; "BootInfo"="boot-info"; "Cpuinfo"="cpuinfo"; "Pveversion"="pveversion"; "Rootfs"="rootfs"
        }
...
function ConvertFrom-PVEJsonToNodesStatus {
    ...
    Process {
        ...
        $AllProperties = ("current-kernel", "cpu", "loadavg", "memory", "boot-info", "cpuinfo", "pveversion", "rootfs")
