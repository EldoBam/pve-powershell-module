...
function Initialize-PVENodesStatus {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Rootfs"="rootfs"; "CurrentKernel"="current-kernel"; "Pveversion"="pveversion"; "Cpuinfo"="cpuinfo"; "BootInfo"="boot-info"; "Cpu"="cpu"; "Loadavg"="loadavg"; "Memory"="memory"
        }
...
function ConvertFrom-PVEJsonToNodesStatus {
    ...
    Process {
        ...
        $AllProperties = ("rootfs", "current-kernel", "pveversion", "cpuinfo", "boot-info", "cpu", "loadavg", "memory")
