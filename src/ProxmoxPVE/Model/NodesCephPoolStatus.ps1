...
function Initialize-PVENodesCephPoolStatus {
    ...
    Process {
        ...
        if ($Size -and $Size -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Name"="name"; "Statistics"="statistics"; "AutoscaleStatus"="autoscale_status"; "Nodelete"="nodelete"; "UseGmtHitset"="use_gmt_hitset"; "WriteFadviseDontneed"="write_fadvise_dontneed"; "Nopgchange"="nopgchange"; "Application"="application"; "Hashpspool"="hashpspool"; "NodeepScrub"="nodeep-scrub"; "Nosizechange"="nosizechange"; "CrushRule"="crush_rule"; "Id"="id"; "PgNum"="pg_num"; "MinSize"="min_size"; "PgNumMin"="pg_num_min"; "ApplicationList"="application_list"; "FastRead"="fast_read"; "PgAutoscaleMode"="pg_autoscale_mode"; "TargetSizeRatio"="target_size_ratio"; "Size"="size"; "TargetSize"="target_size"; "Noscrub"="noscrub"; "PgpNum"="pgp_num"
        }
...
function ConvertFrom-PVEJsonToNodesCephPoolStatus {
    ...
    Process {
        ...
        $AllProperties = ("name", "statistics", "autoscale_status", "nodelete", "use_gmt_hitset", "write_fadvise_dontneed", "nopgchange", "application", "hashpspool", "nodeep-scrub", "nosizechange", "crush_rule", "id", "pg_num", "min_size", "pg_num_min", "application_list", "fast_read", "pg_autoscale_mode", "target_size_ratio", "size", "target_size", "noscrub", "pgp_num")
