...
function Initialize-PVENodesCephPoolStatus {
    ...
    Process {
        ...
        if ($Size -and $Size -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"WriteFadviseDontneed"="write_fadvise_dontneed"; "PgNum"="pg_num"; "ApplicationList"="application_list"; "Hashpspool"="hashpspool"; "NodeepScrub"="nodeep-scrub"; "Nodelete"="nodelete"; "MinSize"="min_size"; "Id"="id"; "Nopgchange"="nopgchange"; "Nosizechange"="nosizechange"; "FastRead"="fast_read"; "Statistics"="statistics"; "PgNumMin"="pg_num_min"; "TargetSizeRatio"="target_size_ratio"; "PgAutoscaleMode"="pg_autoscale_mode"; "Noscrub"="noscrub"; "Name"="name"; "UseGmtHitset"="use_gmt_hitset"; "TargetSize"="target_size"; "AutoscaleStatus"="autoscale_status"; "Application"="application"; "CrushRule"="crush_rule"; "PgpNum"="pgp_num"; "Size"="size"
        }
...
function ConvertFrom-PVEJsonToNodesCephPoolStatus {
    ...
    Process {
        ...
        $AllProperties = ("write_fadvise_dontneed", "pg_num", "application_list", "hashpspool", "nodeep-scrub", "nodelete", "min_size", "id", "nopgchange", "nosizechange", "fast_read", "statistics", "pg_num_min", "target_size_ratio", "pg_autoscale_mode", "noscrub", "name", "use_gmt_hitset", "target_size", "autoscale_status", "application", "crush_rule", "pgp_num", "size")
