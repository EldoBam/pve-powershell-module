...
function Initialize-PVEPUTClusterHaGroupsRB {
    ...
    Process {
        ...
        if (!$Comment -and $Comment.length -gt 4096) {
		 ...
		 $DisplayNameMapping =@{
			"Restricted"="restricted"; "Delete"="delete"; "Nodes"="nodes"; "Digest"="digest"; "Nofailback"="nofailback"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToPUTClusterHaGroupsRB {
    ...
    Process {
        ...
        $AllProperties = ("restricted", "delete", "nodes", "digest", "nofailback", "comment")
