...
function Initialize-PVEPUTClusterHaGroupsRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Nofailback"="nofailback"; "Delete"="delete"; "Restricted"="restricted"; "Nodes"="nodes"; "Comment"="comment"; "Digest"="digest"
        }
...
function ConvertFrom-PVEJsonToPUTClusterHaGroupsRB {
    ...
    Process {
        ...
        $AllProperties = ("nofailback", "delete", "restricted", "nodes", "comment", "digest")
