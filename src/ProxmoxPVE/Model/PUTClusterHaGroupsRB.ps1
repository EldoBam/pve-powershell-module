...
function Initialize-PVEPUTClusterHaGroupsRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Delete"="delete"; "Comment"="comment"; "Nofailback"="nofailback"; "Nodes"="nodes"; "Digest"="digest"; "Restricted"="restricted"
        }
...
function ConvertFrom-PVEJsonToPUTClusterHaGroupsRB {
    ...
    Process {
        ...
        $AllProperties = ("delete", "comment", "nofailback", "nodes", "digest", "restricted")
