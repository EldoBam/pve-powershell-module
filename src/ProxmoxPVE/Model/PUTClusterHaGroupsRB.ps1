...
function Initialize-PVEPUTClusterHaGroupsRB {
    ...
    Process {
        ...
        if (!$Comment -and $Comment.length -gt 4096) {
		 ...
		 $DisplayNameMapping =@{
			"Digest"="digest"; "Nofailback"="nofailback"; "Restricted"="restricted"; "Nodes"="nodes"; "Delete"="delete"; "Comment"="comment"; "Group"="group"
        }
...
function ConvertFrom-PVEJsonToPUTClusterHaGroupsRB {
    ...
    Process {
        ...
        $AllProperties = ("digest", "nofailback", "restricted", "nodes", "delete", "comment", "group")
