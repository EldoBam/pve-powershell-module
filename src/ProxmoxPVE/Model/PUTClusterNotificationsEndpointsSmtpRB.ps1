...
function Initialize-PVEPUTClusterNotificationsEndpointsSmtpRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Delete"="delete"; "Mailto"="mailto"; "Author"="author"; "Comment"="comment"; "Username"="username"; "FromAddress"="from-address"; "Disable"="disable"; "Mode"="mode"; "Digest"="digest"; "Port"="port"; "MailtoUser"="mailto-user"; "Server"="server"; "Password"="password"
        }
...
function ConvertFrom-PVEJsonToPUTClusterNotificationsEndpointsSmtpRB {
    ...
    Process {
        ...
        $AllProperties = ("delete", "mailto", "author", "comment", "username", "from-address", "disable", "mode", "digest", "port", "mailto-user", "server", "password")
