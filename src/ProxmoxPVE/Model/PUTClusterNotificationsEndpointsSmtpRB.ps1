...
function Initialize-PVEPUTClusterNotificationsEndpointsSmtpRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Disable"="disable"; "Password"="password"; "Mode"="mode"; "Port"="port"; "FromAddress"="from-address"; "Comment"="comment"; "MailtoUser"="mailto-user"; "Username"="username"; "Digest"="digest"; "Server"="server"; "Delete"="delete"; "Author"="author"; "Mailto"="mailto"
        }
...
function ConvertFrom-PVEJsonToPUTClusterNotificationsEndpointsSmtpRB {
    ...
    Process {
        ...
        $AllProperties = ("disable", "password", "mode", "port", "from-address", "comment", "mailto-user", "username", "digest", "server", "delete", "author", "mailto")
