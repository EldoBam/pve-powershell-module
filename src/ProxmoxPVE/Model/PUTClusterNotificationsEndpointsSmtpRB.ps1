...
function Initialize-PVEPUTClusterNotificationsEndpointsSmtpRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Server"="server"; "Comment"="comment"; "Disable"="disable"; "FromAddress"="from-address"; "Author"="author"; "Port"="port"; "Mode"="mode"; "Digest"="digest"; "Mailto"="mailto"; "MailtoUser"="mailto-user"; "Username"="username"; "Delete"="delete"; "Password"="password"
        }
...
function ConvertFrom-PVEJsonToPUTClusterNotificationsEndpointsSmtpRB {
    ...
    Process {
        ...
        $AllProperties = ("server", "comment", "disable", "from-address", "author", "port", "mode", "digest", "mailto", "mailto-user", "username", "delete", "password")
