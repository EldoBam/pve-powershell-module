...
function Initialize-PVEPUTClusterNotificationsEndpointsSmtpRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"MailtoUser"="mailto-user"; "Password"="password"; "FromAddress"="from-address"; "Name"="name"; "Comment"="comment"; "Port"="port"; "Disable"="disable"; "Server"="server"; "Mode"="mode"; "Author"="author"; "Delete"="delete"; "Mailto"="mailto"; "Username"="username"; "Digest"="digest"
        }
...
function ConvertFrom-PVEJsonToPUTClusterNotificationsEndpointsSmtpRB {
    ...
    Process {
        ...
        $AllProperties = ("mailto-user", "password", "from-address", "name", "comment", "port", "disable", "server", "mode", "author", "delete", "mailto", "username", "digest")
