...
function Initialize-PVEPUTAccessUsersRB {
    ...
    Process {
        ...
        if (!$Firstname -and $Firstname.length -gt 1024) {
		 ...
		 $DisplayNameMapping =@{
			"Expire"="expire"; "Lastname"="lastname"; "Email"="email"; "Keys"="keys"; "Enable"="enable"; "Groups"="groups"; "Comment"="comment"; "Append"="append"; "Firstname"="firstname"
        }
...
function ConvertFrom-PVEJsonToPUTAccessUsersRB {
    ...
    Process {
        ...
        $AllProperties = ("expire", "lastname", "email", "keys", "enable", "groups", "comment", "append", "firstname")
