...
function Initialize-PVEPUTAccessUsersRB {
    ...
    Process {
        ...
        if (!$Comment -and $Comment.length -gt 2048) {
		 ...
		 $DisplayNameMapping =@{
			"Groups"="groups"; "Enable"="enable"; "Firstname"="firstname"; "Expire"="expire"; "Lastname"="lastname"; "Email"="email"; "Keys"="keys"; "Append"="append"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToPUTAccessUsersRB {
    ...
    Process {
        ...
        $AllProperties = ("groups", "enable", "firstname", "expire", "lastname", "email", "keys", "append", "comment")
