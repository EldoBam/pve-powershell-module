...
function Initialize-PVEPUTAccessUsersRB {
    ...
    Process {
        ...
        if (!$Firstname -and $Firstname.length -gt 1024) {
		 ...
		 $DisplayNameMapping =@{
			"Expire"="expire"; "Userid"="userid"; "Lastname"="lastname"; "Groups"="groups"; "Append"="append"; "Keys"="keys"; "Email"="email"; "Enable"="enable"; "Comment"="comment"; "Firstname"="firstname"
        }
...
function ConvertFrom-PVEJsonToPUTAccessUsersRB {
    ...
    Process {
        ...
        $AllProperties = ("expire", "userid", "lastname", "groups", "append", "keys", "email", "enable", "comment", "firstname")
