...
function Initialize-PVEPUTAccessUsersRB {
    ...
    Process {
        ...
        if (!$Firstname -and $Firstname.length -gt 1024) {
		 ...
		 $DisplayNameMapping =@{
			"Enable"="enable"; "Keys"="keys"; "Groups"="groups"; "Lastname"="lastname"; "Email"="email"; "Comment"="comment"; "Firstname"="firstname"; "Expire"="expire"; "Append"="append"
        }
...
function ConvertFrom-PVEJsonToPUTAccessUsersRB {
    ...
    Process {
        ...
        $AllProperties = ("enable", "keys", "groups", "lastname", "email", "comment", "firstname", "expire", "append")
