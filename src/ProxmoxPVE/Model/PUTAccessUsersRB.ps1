...
function Initialize-PVEPUTAccessUsersRB {
    ...
    Process {
        ...
        if (!$Email -and $Email.length -gt 254) {
		 ...
		 $DisplayNameMapping =@{
			"Keys"="keys"; "Groups"="groups"; "Expire"="expire"; "Comment"="comment"; "Lastname"="lastname"; "Append"="append"; "Firstname"="firstname"; "Email"="email"; "Enable"="enable"
        }
...
function ConvertFrom-PVEJsonToPUTAccessUsersRB {
    ...
    Process {
        ...
        $AllProperties = ("keys", "groups", "expire", "comment", "lastname", "append", "firstname", "email", "enable")
