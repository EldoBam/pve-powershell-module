...
function Initialize-PVEPOSTClusterSdnZonesRB {
    ...
    Process {
        ...
        if ($ExitnodesLocalRouting -and $ExitnodesLocalRouting -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Reversedns"="reversedns"; "Zone"="zone"; "Ipam"="ipam"; "Type"="type"; "Mac"="mac"; "VrfVxlan"="vrf-vxlan"; "Nodes"="nodes"; "Controller"="controller"; "VlanProtocol"="vlan-protocol"; "Dns"="dns"; "Bridge"="bridge"; "Dhcp"="dhcp"; "ExitnodesPrimary"="exitnodes-primary"; "VxlanPort"="vxlan-port"; "DpId"="dp-id"; "DisableArpNdSuppression"="disable-arp-nd-suppression"; "Peers"="peers"; "Tag"="tag"; "AdvertiseSubnets"="advertise-subnets"; "RtImport"="rt-import"; "BridgeDisableMacLearning"="bridge-disable-mac-learning"; "Exitnodes"="exitnodes"; "Mtu"="mtu"; "ExitnodesLocalRouting"="exitnodes-local-routing"; "Dnszone"="dnszone"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterSdnZonesRB {
    ...
    Process {
        ...
        $AllProperties = ("reversedns", "zone", "ipam", "type", "mac", "vrf-vxlan", "nodes", "controller", "vlan-protocol", "dns", "bridge", "dhcp", "exitnodes-primary", "vxlan-port", "dp-id", "disable-arp-nd-suppression", "peers", "tag", "advertise-subnets", "rt-import", "bridge-disable-mac-learning", "exitnodes", "mtu", "exitnodes-local-routing", "dnszone")
