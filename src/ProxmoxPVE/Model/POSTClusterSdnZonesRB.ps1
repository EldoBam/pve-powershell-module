...
function Initialize-PVEPOSTClusterSdnZonesRB {
    ...
    Process {
        ...
        if ($VxlanPort -and $VxlanPort -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Mtu"="mtu"; "Nodes"="nodes"; "Tag"="tag"; "VrfVxlan"="vrf-vxlan"; "Controller"="controller"; "VxlanPort"="vxlan-port"; "RtImport"="rt-import"; "Exitnodes"="exitnodes"; "Type"="type"; "Reversedns"="reversedns"; "DisableArpNdSuppression"="disable-arp-nd-suppression"; "Dhcp"="dhcp"; "Mac"="mac"; "LockToken"="lock-token"; "AdvertiseSubnets"="advertise-subnets"; "BridgeDisableMacLearning"="bridge-disable-mac-learning"; "Dnszone"="dnszone"; "Zone"="zone"; "Ipam"="ipam"; "Bridge"="bridge"; "Dns"="dns"; "ExitnodesLocalRouting"="exitnodes-local-routing"; "Peers"="peers"; "ExitnodesPrimary"="exitnodes-primary"; "Fabric"="fabric"; "DpId"="dp-id"; "VlanProtocol"="vlan-protocol"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterSdnZonesRB {
    ...
    Process {
        ...
        $AllProperties = ("mtu", "nodes", "tag", "vrf-vxlan", "controller", "vxlan-port", "rt-import", "exitnodes", "type", "reversedns", "disable-arp-nd-suppression", "dhcp", "mac", "lock-token", "advertise-subnets", "bridge-disable-mac-learning", "dnszone", "zone", "ipam", "bridge", "dns", "exitnodes-local-routing", "peers", "exitnodes-primary", "fabric", "dp-id", "vlan-protocol")
