...
function Initialize-PVEPOSTNodesNetworkRB {
    ...
    Process {
        ...
        if ($Mtu -and $Mtu -lt 1280) {
		 ...
		 $DisplayNameMapping =@{
			"BridgePorts"="bridge_ports"; "Gateway"="gateway"; "Cidr6"="cidr6"; "Type"="type"; "Address"="address"; "OvsPorts"="ovs_ports"; "Autostart"="autostart"; "VlanId"="vlan-id"; "BondXmitHashPolicy"="bond_xmit_hash_policy"; "BondPrimary"="bond-primary"; "Comments"="comments"; "Address6"="address6"; "Comments6"="comments6"; "Netmask6"="netmask6"; "Gateway6"="gateway6"; "BondMode"="bond_mode"; "VlanRawDevice"="vlan-raw-device"; "Netmask"="netmask"; "BridgeVids"="bridge_vids"; "Iface"="iface"; "OvsBridge"="ovs_bridge"; "BridgeVlanAware"="bridge_vlan_aware"; "Cidr"="cidr"; "OvsBonds"="ovs_bonds"; "OvsOptions"="ovs_options"; "Slaves"="slaves"; "OvsTag"="ovs_tag"; "Mtu"="mtu"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesNetworkRB {
    ...
    Process {
        ...
        $AllProperties = ("bridge_ports", "gateway", "cidr6", "type", "address", "ovs_ports", "autostart", "vlan-id", "bond_xmit_hash_policy", "bond-primary", "comments", "address6", "comments6", "netmask6", "gateway6", "bond_mode", "vlan-raw-device", "netmask", "bridge_vids", "iface", "ovs_bridge", "bridge_vlan_aware", "cidr", "ovs_bonds", "ovs_options", "slaves", "ovs_tag", "mtu")
