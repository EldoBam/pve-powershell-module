...
function Initialize-PVEPOSTNodesNetworkRB {
    ...
    Process {
        ...
        if ($Mtu -and $Mtu -lt 1280) {
		 ...
		 $DisplayNameMapping =@{
			"OvsBridge"="ovs_bridge"; "BondPrimary"="bond-primary"; "Comments"="comments"; "OvsBonds"="ovs_bonds"; "OvsTag"="ovs_tag"; "Gateway"="gateway"; "OvsPorts"="ovs_ports"; "VlanRawDevice"="vlan-raw-device"; "BridgeVlanAware"="bridge_vlan_aware"; "Netmask6"="netmask6"; "Gateway6"="gateway6"; "BridgeVids"="bridge_vids"; "Netmask"="netmask"; "BondMode"="bond_mode"; "BondXmitHashPolicy"="bond_xmit_hash_policy"; "Slaves"="slaves"; "BridgePorts"="bridge_ports"; "Address6"="address6"; "Address"="address"; "Autostart"="autostart"; "Comments6"="comments6"; "Iface"="iface"; "VlanId"="vlan-id"; "Cidr6"="cidr6"; "OvsOptions"="ovs_options"; "Cidr"="cidr"; "Node"="node"; "Mtu"="mtu"; "Type"="type"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesNetworkRB {
    ...
    Process {
        ...
        $AllProperties = ("ovs_bridge", "bond-primary", "comments", "ovs_bonds", "ovs_tag", "gateway", "ovs_ports", "vlan-raw-device", "bridge_vlan_aware", "netmask6", "gateway6", "bridge_vids", "netmask", "bond_mode", "bond_xmit_hash_policy", "slaves", "bridge_ports", "address6", "address", "autostart", "comments6", "iface", "vlan-id", "cidr6", "ovs_options", "cidr", "node", "mtu", "type")
