...
function Initialize-PVEPOSTNodesNetworkRB {
    ...
    Process {
        ...
        if ($OvsTag -and $OvsTag -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"BondPrimary"="bond-primary"; "Mtu"="mtu"; "Comments6"="comments6"; "Slaves"="slaves"; "OvsPorts"="ovs_ports"; "OvsOptions"="ovs_options"; "VlanId"="vlan-id"; "Address6"="address6"; "BridgeVids"="bridge_vids"; "Gateway"="gateway"; "BondXmitHashPolicy"="bond_xmit_hash_policy"; "Type"="type"; "OvsBonds"="ovs_bonds"; "Gateway6"="gateway6"; "BondMode"="bond_mode"; "BridgePorts"="bridge_ports"; "OvsBridge"="ovs_bridge"; "VlanRawDevice"="vlan-raw-device"; "Cidr"="cidr"; "Iface"="iface"; "BridgeVlanAware"="bridge_vlan_aware"; "Netmask6"="netmask6"; "Netmask"="netmask"; "OvsTag"="ovs_tag"; "Address"="address"; "Autostart"="autostart"; "Comments"="comments"; "Cidr6"="cidr6"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesNetworkRB {
    ...
    Process {
        ...
        $AllProperties = ("bond-primary", "mtu", "comments6", "slaves", "ovs_ports", "ovs_options", "vlan-id", "address6", "bridge_vids", "gateway", "bond_xmit_hash_policy", "type", "ovs_bonds", "gateway6", "bond_mode", "bridge_ports", "ovs_bridge", "vlan-raw-device", "cidr", "iface", "bridge_vlan_aware", "netmask6", "netmask", "ovs_tag", "address", "autostart", "comments", "cidr6")
