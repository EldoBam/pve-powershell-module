...
function ConvertFrom-PVEJsonToPOSTNodesNetworkRB {
    ...
    Process {
        ...
        $AllProperties = ("address6", "bond-primary", "netmask", "gateway", "type", "ovs_tag", "mtu", "ovs_options", "cidr6", "bridge_ports", "ovs_bonds", "gateway6", "comments", "autostart", "ovs_ports", "bond_xmit_hash_policy", "ovs_bridge", "bridge_vlan_aware", "comments6", "vlan-raw-device", "vlan-id", "netmask6", "cidr", "iface", "slaves", "bridge_vids", "address", "bond_mode")
