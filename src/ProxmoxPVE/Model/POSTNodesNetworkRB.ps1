...
function Initialize-PVEPOSTNodesNetworkRB {
    ...
    Process {
        ...
        if (!$OvsOptions -and $OvsOptions.length -gt 1024) {
		 ...
		 $DisplayNameMapping =@{
			"BridgeVlanAware"="bridge_vlan_aware"; "BondMode"="bond_mode"; "BondPrimary"="bond-primary"; "Gateway6"="gateway6"; "Address"="address"; "OvsPorts"="ovs_ports"; "OvsBridge"="ovs_bridge"; "Netmask"="netmask"; "Autostart"="autostart"; "Node"="node"; "VlanRawDevice"="vlan-raw-device"; "BridgeVids"="bridge_vids"; "Iface"="iface"; "BondXmitHashPolicy"="bond_xmit_hash_policy"; "Type"="type"; "Gateway"="gateway"; "Cidr"="cidr"; "Slaves"="slaves"; "OvsBonds"="ovs_bonds"; "Mtu"="mtu"; "Comments6"="comments6"; "Comments"="comments"; "OvsTag"="ovs_tag"; "Address6"="address6"; "VlanId"="vlan-id"; "Cidr6"="cidr6"; "Netmask6"="netmask6"; "BridgePorts"="bridge_ports"; "OvsOptions"="ovs_options"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesNetworkRB {
    ...
    Process {
        ...
        $AllProperties = ("bridge_vlan_aware", "bond_mode", "bond-primary", "gateway6", "address", "ovs_ports", "ovs_bridge", "netmask", "autostart", "node", "vlan-raw-device", "bridge_vids", "iface", "bond_xmit_hash_policy", "type", "gateway", "cidr", "slaves", "ovs_bonds", "mtu", "comments6", "comments", "ovs_tag", "address6", "vlan-id", "cidr6", "netmask6", "bridge_ports", "ovs_options")
