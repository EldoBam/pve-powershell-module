...
function Initialize-PVEPOSTNodesNetworkRB {
    ...
    Process {
        ...
        if ($VlanId -and $VlanId -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Gateway6"="gateway6"; "Comments6"="comments6"; "Iface"="iface"; "Cidr"="cidr"; "Cidr6"="cidr6"; "Autostart"="autostart"; "Mtu"="mtu"; "BondMode"="bond_mode"; "Slaves"="slaves"; "BridgeVids"="bridge_vids"; "BridgePorts"="bridge_ports"; "Netmask6"="netmask6"; "OvsOptions"="ovs_options"; "Type"="type"; "OvsTag"="ovs_tag"; "Gateway"="gateway"; "Netmask"="netmask"; "OvsPorts"="ovs_ports"; "Comments"="comments"; "BondXmitHashPolicy"="bond_xmit_hash_policy"; "Address"="address"; "BridgeVlanAware"="bridge_vlan_aware"; "VlanRawDevice"="vlan-raw-device"; "BondPrimary"="bond-primary"; "Address6"="address6"; "VlanId"="vlan-id"; "OvsBonds"="ovs_bonds"; "OvsBridge"="ovs_bridge"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesNetworkRB {
    ...
    Process {
        ...
        $AllProperties = ("gateway6", "comments6", "iface", "cidr", "cidr6", "autostart", "mtu", "bond_mode", "slaves", "bridge_vids", "bridge_ports", "netmask6", "ovs_options", "type", "ovs_tag", "gateway", "netmask", "ovs_ports", "comments", "bond_xmit_hash_policy", "address", "bridge_vlan_aware", "vlan-raw-device", "bond-primary", "address6", "vlan-id", "ovs_bonds", "ovs_bridge")
