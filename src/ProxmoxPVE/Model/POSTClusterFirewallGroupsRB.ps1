...
function Initialize-PVEPOSTClusterFirewallGroupsRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Pos"="pos"; "Type"="type"; "Dest"="dest"; "Source"="source"; "Dport"="dport"; "Enable"="enable"; "Macro"="macro"; "Action"="action"; "Log"="log"; "Sport"="sport"; "Iface"="iface"; "Comment"="comment"; "Proto"="proto"; "Group"="group"; "Digest"="digest"; "IcmpType"="icmp-type"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterFirewallGroupsRB {
    ...
    Process {
        ...
        $AllProperties = ("pos", "type", "dest", "source", "dport", "enable", "macro", "action", "log", "sport", "iface", "comment", "proto", "group", "digest", "icmp-type")
