...
function Initialize-PVEPOSTClusterSdnVnetsSubnetsRB {
    ...
    Process {
        ...
        if ($Snat -and $Snat -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"DhcpRange"="dhcp-range"; "Snat"="snat"; "Subnet"="subnet"; "Type"="type"; "Vnet"="vnet"; "Dnszoneprefix"="dnszoneprefix"; "DhcpDnsServer"="dhcp-dns-server"; "Gateway"="gateway"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterSdnVnetsSubnetsRB {
    ...
    Process {
        ...
        $AllProperties = ("dhcp-range", "snat", "subnet", "type", "vnet", "dnszoneprefix", "dhcp-dns-server", "gateway")
