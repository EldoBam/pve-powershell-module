...
function Initialize-PVEPOSTClusterSdnVnetsSubnetsRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Type"="type"; "Snat"="snat"; "Subnet"="subnet"; "Dnszoneprefix"="dnszoneprefix"; "Gateway"="gateway"; "DhcpRange"="dhcp-range"; "DhcpDnsServer"="dhcp-dns-server"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterSdnVnetsSubnetsRB {
    ...
    Process {
        ...
        $AllProperties = ("type", "snat", "subnet", "dnszoneprefix", "gateway", "dhcp-range", "dhcp-dns-server")
