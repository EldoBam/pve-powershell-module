...
function Initialize-PVENodesDisksListInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"OsdidList"="osdid-list"; "Osdid"="osdid"; "Gpt"="gpt"; "Model"="model"; "Health"="health"; "Parent"="parent"; "Mounted"="mounted"; "Vendor"="vendor"; "Wwn"="wwn"; "Serial"="serial"; "Devpath"="devpath"; "Used"="used"; "Size"="size"
        }
...
function ConvertFrom-PVEJsonToNodesDisksListInner {
    ...
    Process {
        ...
        $AllProperties = ("osdid-list", "osdid", "gpt", "model", "health", "parent", "mounted", "vendor", "wwn", "serial", "devpath", "used", "size")
