...
function Initialize-PVEClusterJobsRealmsyncInner {
    ...
    Process {
        ...
        if (!$Realm -and $Realm.length -gt 32) {
		 ...
		 $DisplayNameMapping =@{
			"Schedule"="schedule"; "Id"="id"; "Comment"="comment"; "LastRun"="last-run"; "Realm"="realm"; "Scope"="scope"; "RemoveVanished"="remove-vanished"; "Enabled"="enabled"; "NextRun"="next-run"
        }
...
function ConvertFrom-PVEJsonToClusterJobsRealmsyncInner {
    ...
    Process {
        ...
        $AllProperties = ("schedule", "id", "comment", "last-run", "realm", "scope", "remove-vanished", "enabled", "next-run")
