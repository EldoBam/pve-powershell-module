...
function Initialize-PVEClusterJobsRealmsyncInner {
    ...
    Process {
        ...
        if (!$Realm -and $Realm.length -gt 32) {
		 ...
		 $DisplayNameMapping =@{
			"Schedule"="schedule"; "Scope"="scope"; "LastRun"="last-run"; "Enabled"="enabled"; "Comment"="comment"; "NextRun"="next-run"; "RemoveVanished"="remove-vanished"; "Id"="id"; "Realm"="realm"
        }
...
function ConvertFrom-PVEJsonToClusterJobsRealmsyncInner {
    ...
    Process {
        ...
        $AllProperties = ("schedule", "scope", "last-run", "enabled", "comment", "next-run", "remove-vanished", "id", "realm")
