...
function Initialize-PVENodesLxcInterfacesInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"HardwareAddress"="hardware-address"; "IpAddresses"="ip-addresses"; "Inet"="inet"; "Name"="name"; "Inet6"="inet6"; "Hwaddr"="hwaddr"
        }
...
function ConvertFrom-PVEJsonToNodesLxcInterfacesInner {
    ...
    Process {
        ...
        $AllProperties = ("hardware-address", "ip-addresses", "inet", "name", "inet6", "hwaddr")
