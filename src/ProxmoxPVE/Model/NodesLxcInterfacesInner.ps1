...
function Initialize-PVENodesLxcInterfacesInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Hwaddr"="hwaddr"; "IpAddresses"="ip-addresses"; "Inet6"="inet6"; "HardwareAddress"="hardware-address"; "Name"="name"; "Inet"="inet"
        }
...
function ConvertFrom-PVEJsonToNodesLxcInterfacesInner {
    ...
    Process {
        ...
        $AllProperties = ("hwaddr", "ip-addresses", "inet6", "hardware-address", "name", "inet")
