...
function Initialize-PVENodesLxcInterfacesInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"IpAddresses"="ip-addresses"; "Hwaddr"="hwaddr"; "Inet6"="inet6"; "HardwareAddress"="hardware-address"; "Name"="name"; "Inet"="inet"
        }
...
function ConvertFrom-PVEJsonToNodesLxcInterfacesInner {
    ...
    Process {
        ...
        $AllProperties = ("ip-addresses", "hwaddr", "inet6", "hardware-address", "name", "inet")
