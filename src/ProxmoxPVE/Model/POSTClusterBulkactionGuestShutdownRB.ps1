...
POSTClusterBulkactionGuestShutdownRB<PSCustomObject>
#>

function Initialize-PVEPOSTClusterBulkactionGuestShutdownRB {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ProxmoxPVE => PVEPOSTClusterBulkactionGuestShutdownRB' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug


		 $DisplayNameMapping =@{
			"Vms"="vms"; "Maxworkers"="maxworkers"; "Timeout"="timeout"; "ForceStop"="force-stop"
        }
...
Convert from JSON to POSTClusterBulkactionGuestShutdownRB<PSCustomObject>
...
POSTClusterBulkactionGuestShutdownRB<PSCustomObject>
#>
function ConvertFrom-PVEJsonToPOSTClusterBulkactionGuestShutdownRB {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ProxmoxPVE => PVEPOSTClusterBulkactionGuestShutdownRB' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PVEPOSTClusterBulkactionGuestShutdownRB
        $AllProperties = ("vms", "maxworkers", "timeout", "force-stop")
