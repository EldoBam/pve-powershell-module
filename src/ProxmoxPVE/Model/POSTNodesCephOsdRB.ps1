...
function Initialize-PVEPOSTNodesCephOsdRB {
    ...
    Process {
        ...
        if ($WalDevSize -and $WalDevSize -lt 0.5) {
		 ...
		 $DisplayNameMapping =@{
			"CrushDeviceClass"="crush-device-class"; "Dev"="dev"; "DbDevSize"="db_dev_size"; "OsdsPerDevice"="osds-per-device"; "Encrypted"="encrypted"; "WalDevSize"="wal_dev_size"; "DbDev"="db_dev"; "WalDev"="wal_dev"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesCephOsdRB {
    ...
    Process {
        ...
        $AllProperties = ("crush-device-class", "dev", "db_dev_size", "osds-per-device", "encrypted", "wal_dev_size", "db_dev", "wal_dev")
