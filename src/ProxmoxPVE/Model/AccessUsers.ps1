...
function Initialize-PVEAccessUsers {
    ...
    Process {
        ...
        if (!$Comment -and $Comment.length -gt 2048) {
		 ...
		 $DisplayNameMapping =@{
			"Firstname"="firstname"; "Enable"="enable"; "Lastname"="lastname"; "Tokens"="tokens"; "Email"="email"; "Comment"="comment"; "Groups"="groups"; "Keys"="keys"; "Expire"="expire"
        }
...
function ConvertFrom-PVEJsonToAccessUsers {
    ...
    Process {
        ...
        $AllProperties = ("firstname", "enable", "lastname", "tokens", "email", "comment", "groups", "keys", "expire")
