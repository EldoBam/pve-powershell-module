...
function Initialize-PVEAccessUsers {
    ...
    Process {
        ...
        if (!$Comment -and $Comment.length -gt 2048) {
		 ...
		 $DisplayNameMapping =@{
			"Groups"="groups"; "Enable"="enable"; "Firstname"="firstname"; "Expire"="expire"; "Tokens"="tokens"; "Lastname"="lastname"; "Email"="email"; "Keys"="keys"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToAccessUsers {
    ...
    Process {
        ...
        $AllProperties = ("groups", "enable", "firstname", "expire", "tokens", "lastname", "email", "keys", "comment")
