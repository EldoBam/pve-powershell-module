...
function Initialize-PVEAccessUsers {
    ...
    Process {
        ...
        if (!$Email -and $Email.length -gt 254) {
		 ...
		 $DisplayNameMapping =@{
			"Keys"="keys"; "Groups"="groups"; "Expire"="expire"; "Comment"="comment"; "Lastname"="lastname"; "Firstname"="firstname"; "Email"="email"; "Tokens"="tokens"; "Enable"="enable"
        }
...
function ConvertFrom-PVEJsonToAccessUsers {
    ...
    Process {
        ...
        $AllProperties = ("keys", "groups", "expire", "comment", "lastname", "firstname", "email", "tokens", "enable")
