...
function Initialize-PVEPUTClusterSdnDnsRB {
    ...
    Process {
        ...
        if (!$Delete -and $Delete.length -gt 4096) {
		 ...
		 $DisplayNameMapping =@{
			"Digest"="digest"; "Key"="key"; "Url"="url"; "Delete"="delete"; "Fingerprint"="fingerprint"; "Ttl"="ttl"; "Reversemaskv6"="reversemaskv6"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnDnsRB {
    ...
    Process {
        ...
        $AllProperties = ("digest", "key", "url", "delete", "fingerprint", "ttl", "reversemaskv6")
