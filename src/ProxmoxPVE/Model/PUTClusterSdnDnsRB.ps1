...
function Initialize-PVEPUTClusterSdnDnsRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Url"="url"; "LockToken"="lock-token"; "Reversemaskv6"="reversemaskv6"; "Delete"="delete"; "Fingerprint"="fingerprint"; "Ttl"="ttl"; "Digest"="digest"; "Key"="key"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnDnsRB {
    ...
    Process {
        ...
        $AllProperties = ("url", "lock-token", "reversemaskv6", "delete", "fingerprint", "ttl", "digest", "key")
