...
function Initialize-PVEClusterNotificationsEndpointsWebhookGETInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Body"="body"; "Origin"="origin"; "Comment"="comment"; "Name"="name"; "Disable"="disable"; "Method"="method"; "Secret"="secret"; "Url"="url"; "Header"="header"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsWebhookGETInner {
    ...
    Process {
        ...
        $AllProperties = ("body", "origin", "comment", "name", "disable", "method", "secret", "url", "header")
