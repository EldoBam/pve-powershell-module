...
function Initialize-PVEClusterNotificationsEndpointsWebhookGETInner {
    ...
    Process {
        ...
        if ($Disable -and $Disable -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Secret"="secret"; "Name"="name"; "Disable"="disable"; "Comment"="comment"; "Url"="url"; "Header"="header"; "Origin"="origin"; "Body"="body"; "Method"="method"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsWebhookGETInner {
    ...
    Process {
        ...
        $AllProperties = ("secret", "name", "disable", "comment", "url", "header", "origin", "body", "method")
