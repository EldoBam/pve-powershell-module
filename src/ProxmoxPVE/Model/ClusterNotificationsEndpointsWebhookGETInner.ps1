...
function Initialize-PVEClusterNotificationsEndpointsWebhookGETInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Url"="url"; "Disable"="disable"; "Origin"="origin"; "Header"="header"; "Comment"="comment"; "Body"="body"; "Secret"="secret"; "Name"="name"; "Method"="method"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsWebhookGETInner {
    ...
    Process {
        ...
        $AllProperties = ("url", "disable", "origin", "header", "comment", "body", "secret", "name", "method")
