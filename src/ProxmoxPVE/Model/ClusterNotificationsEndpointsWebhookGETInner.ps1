...
function Initialize-PVEClusterNotificationsEndpointsWebhookGETInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Comment"="comment"; "Origin"="origin"; "Url"="url"; "Disable"="disable"; "Header"="header"; "Secret"="secret"; "Method"="method"; "Body"="body"; "Name"="name"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsWebhookGETInner {
    ...
    Process {
        ...
        $AllProperties = ("comment", "origin", "url", "disable", "header", "secret", "method", "body", "name")
