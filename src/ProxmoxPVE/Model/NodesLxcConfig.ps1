...
function ConvertFrom-PVEJsonToNodesLxcConfig {
    ...
    Process {
        ...
        $AllProperties = ("features", "dev[n]", "template", "cmode", "timezone", "arch", "memory", "debug", "mp[n]", "lxc", "protection", "startup", "hookscript", "onboot", "cpuunits", "cpulimit", "net[n]", "swap", "lock", "nameserver", "tty", "console", "ostype", "hostname", "description", "tags", "searchdomain", "cores", "unused[n]", "rootfs", "digest", "unprivileged")
