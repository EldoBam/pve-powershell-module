...
function Initialize-PVENodesLxcConfig {
    ...
    Process {
        ...
        if ($Tty -and $Tty -gt 6) {
		 ...
		 $DisplayNameMapping =@{
			"Template"="template"; "Onboot"="onboot"; "Console"="console"; "Protection"="protection"; "Memory"="memory"; "Digest"="digest"; "Startup"="startup"; "Lock"="lock"; "Swap"="swap"; "Features"="features"; "Description"="description"; "Hostname"="hostname"; "Arch"="arch"; "Cmode"="cmode"; "Timezone"="timezone"; "DevN"="dev[n]"; "Tags"="tags"; "Rootfs"="rootfs"; "Lxc"="lxc"; "Unprivileged"="unprivileged"; "Cores"="cores"; "Cpulimit"="cpulimit"; "MpN"="mp[n]"; "UnusedN"="unused[n]"; "Hookscript"="hookscript"; "Cpuunits"="cpuunits"; "NetN"="net[n]"; "Ostype"="ostype"; "Tty"="tty"; "Searchdomain"="searchdomain"; "Debug"="debug"; "Nameserver"="nameserver"
        }
...
function ConvertFrom-PVEJsonToNodesLxcConfig {
    ...
    Process {
        ...
        $AllProperties = ("template", "onboot", "console", "protection", "memory", "digest", "startup", "lock", "swap", "features", "description", "hostname", "arch", "cmode", "timezone", "dev[n]", "tags", "rootfs", "lxc", "unprivileged", "cores", "cpulimit", "mp[n]", "unused[n]", "hookscript", "cpuunits", "net[n]", "ostype", "tty", "searchdomain", "debug", "nameserver")
