...
function Initialize-PVENodesLxcConfig {
    ...
    Process {
        ...
        if ($Debug -and $Debug -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"NetN"="net[n]"; "Tty"="tty"; "Tags"="tags"; "Unprivileged"="unprivileged"; "Template"="template"; "Startup"="startup"; "Digest"="digest"; "Cmode"="cmode"; "Lock"="lock"; "Hostname"="hostname"; "Timezone"="timezone"; "Description"="description"; "Arch"="arch"; "Searchdomain"="searchdomain"; "Console"="console"; "Hookscript"="hookscript"; "Protection"="protection"; "Cpulimit"="cpulimit"; "Lxc"="lxc"; "MpN"="mp[n]"; "Onboot"="onboot"; "Cores"="cores"; "Nameserver"="nameserver"; "Swap"="swap"; "Rootfs"="rootfs"; "DevN"="dev[n]"; "Cpuunits"="cpuunits"; "Memory"="memory"; "UnusedN"="unused[n]"; "Ostype"="ostype"; "Features"="features"; "Debug"="debug"
        }
...
function ConvertFrom-PVEJsonToNodesLxcConfig {
    ...
    Process {
        ...
        $AllProperties = ("net[n]", "tty", "tags", "unprivileged", "template", "startup", "digest", "cmode", "lock", "hostname", "timezone", "description", "arch", "searchdomain", "console", "hookscript", "protection", "cpulimit", "lxc", "mp[n]", "onboot", "cores", "nameserver", "swap", "rootfs", "dev[n]", "cpuunits", "memory", "unused[n]", "ostype", "features", "debug")
