...
function Initialize-PVENodesLxcConfig {
    ...
    Process {
        ...
        if ($Cpuunits -and $Cpuunits -gt 500000) {
		 ...
		 $DisplayNameMapping =@{
			"Cores"="cores"; "Digest"="digest"; "Lock"="lock"; "Description"="description"; "Memory"="memory"; "Cmode"="cmode"; "DevN"="dev[n]"; "Template"="template"; "Hookscript"="hookscript"; "Onboot"="onboot"; "Tags"="tags"; "Tty"="tty"; "NetN"="net[n]"; "Cpulimit"="cpulimit"; "Hostname"="hostname"; "Console"="console"; "Ostype"="ostype"; "Cpuunits"="cpuunits"; "Features"="features"; "Startup"="startup"; "UnusedN"="unused[n]"; "Unprivileged"="unprivileged"; "Lxc"="lxc"; "Protection"="protection"; "Timezone"="timezone"; "Swap"="swap"; "Searchdomain"="searchdomain"; "Debug"="debug"; "Rootfs"="rootfs"; "Nameserver"="nameserver"; "MpN"="mp[n]"; "Arch"="arch"
        }
...
function ConvertFrom-PVEJsonToNodesLxcConfig {
    ...
    Process {
        ...
        $AllProperties = ("cores", "digest", "lock", "description", "memory", "cmode", "dev[n]", "template", "hookscript", "onboot", "tags", "tty", "net[n]", "cpulimit", "hostname", "console", "ostype", "cpuunits", "features", "startup", "unused[n]", "unprivileged", "lxc", "protection", "timezone", "swap", "searchdomain", "debug", "rootfs", "nameserver", "mp[n]", "arch")
