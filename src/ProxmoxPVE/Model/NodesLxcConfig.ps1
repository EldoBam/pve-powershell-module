...
function Initialize-PVENodesLxcConfig {
    ...
    Process {
        ...
        if ($Cores -and $Cores -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Cmode"="cmode"; "Lock"="lock"; "Digest"="digest"; "DevN"="dev[n]"; "Swap"="swap"; "Timezone"="timezone"; "Env"="env"; "NetN"="net[n]"; "Hookscript"="hookscript"; "MpN"="mp[n]"; "Onboot"="onboot"; "Protection"="protection"; "Memory"="memory"; "Cpuunits"="cpuunits"; "Nameserver"="nameserver"; "Lxc"="lxc"; "Startup"="startup"; "Description"="description"; "Ostype"="ostype"; "Searchdomain"="searchdomain"; "Rootfs"="rootfs"; "Unprivileged"="unprivileged"; "Arch"="arch"; "Tty"="tty"; "Cpulimit"="cpulimit"; "Tags"="tags"; "Hostname"="hostname"; "UnusedN"="unused[n]"; "Console"="console"; "Entrypoint"="entrypoint"; "Template"="template"; "Debug"="debug"; "Cores"="cores"; "Features"="features"
        }
...
function ConvertFrom-PVEJsonToNodesLxcConfig {
    ...
    Process {
        ...
        $AllProperties = ("cmode", "lock", "digest", "dev[n]", "swap", "timezone", "env", "net[n]", "hookscript", "mp[n]", "onboot", "protection", "memory", "cpuunits", "nameserver", "lxc", "startup", "description", "ostype", "searchdomain", "rootfs", "unprivileged", "arch", "tty", "cpulimit", "tags", "hostname", "unused[n]", "console", "entrypoint", "template", "debug", "cores", "features")
