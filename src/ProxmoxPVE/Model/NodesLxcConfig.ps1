...
function Initialize-PVENodesLxcConfig {
    ...
    Process {
        ...
        if ($Cpuunits -and $Cpuunits -gt 500000) {
		 ...
		 $DisplayNameMapping =@{
			"Nameserver"="nameserver"; "Lxc"="lxc"; "Hookscript"="hookscript"; "Searchdomain"="searchdomain"; "NetN"="net[n]"; "Console"="console"; "Rootfs"="rootfs"; "Ostype"="ostype"; "MpN"="mp[n]"; "Protection"="protection"; "Tty"="tty"; "Cpulimit"="cpulimit"; "UnusedN"="unused[n]"; "Arch"="arch"; "Template"="template"; "Swap"="swap"; "Features"="features"; "Debug"="debug"; "Lock"="lock"; "Unprivileged"="unprivileged"; "Hostname"="hostname"; "Startup"="startup"; "Cores"="cores"; "DevN"="dev[n]"; "Digest"="digest"; "Description"="description"; "Memory"="memory"; "Onboot"="onboot"; "Tags"="tags"; "Timezone"="timezone"; "Cpuunits"="cpuunits"; "Cmode"="cmode"
        }
...
function ConvertFrom-PVEJsonToNodesLxcConfig {
    ...
    Process {
        ...
        $AllProperties = ("nameserver", "lxc", "hookscript", "searchdomain", "net[n]", "console", "rootfs", "ostype", "mp[n]", "protection", "tty", "cpulimit", "unused[n]", "arch", "template", "swap", "features", "debug", "lock", "unprivileged", "hostname", "startup", "cores", "dev[n]", "digest", "description", "memory", "onboot", "tags", "timezone", "cpuunits", "cmode")
