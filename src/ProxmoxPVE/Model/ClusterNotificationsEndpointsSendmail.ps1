...
function Initialize-PVEClusterNotificationsEndpointsSendmail {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Name"="name"; "Disable"="disable"; "Author"="author"; "Comment"="comment"; "Mailto"="mailto"; "MailtoUser"="mailto-user"; "Digest"="digest"; "FromAddress"="from-address"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsSendmail {
    ...
    Process {
        ...
        $AllProperties = ("name", "disable", "author", "comment", "mailto", "mailto-user", "digest", "from-address")
