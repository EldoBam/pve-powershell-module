...
function Initialize-PVEClusterNotificationsEndpointsSendmail {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Mailto"="mailto"; "MailtoUser"="mailto-user"; "Comment"="comment"; "Author"="author"; "Disable"="disable"; "FromAddress"="from-address"; "Digest"="digest"; "Name"="name"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsSendmail {
    ...
    Process {
        ...
        $AllProperties = ("mailto", "mailto-user", "comment", "author", "disable", "from-address", "digest", "name")
