...
function Initialize-PVEClusterNotificationsEndpointsSendmail {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"MailtoUser"="mailto-user"; "Name"="name"; "Mailto"="mailto"; "Disable"="disable"; "Digest"="digest"; "FromAddress"="from-address"; "Author"="author"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsSendmail {
    ...
    Process {
        ...
        $AllProperties = ("mailto-user", "name", "mailto", "disable", "digest", "from-address", "author", "comment")
