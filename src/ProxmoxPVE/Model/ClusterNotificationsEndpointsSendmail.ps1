...
function Initialize-PVEClusterNotificationsEndpointsSendmail {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Author"="author"; "Digest"="digest"; "FromAddress"="from-address"; "Disable"="disable"; "Name"="name"; "MailtoUser"="mailto-user"; "Comment"="comment"; "Mailto"="mailto"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsEndpointsSendmail {
    ...
    Process {
        ...
        $AllProperties = ("author", "digest", "from-address", "disable", "name", "mailto-user", "comment", "mailto")
