...
function Initialize-PVEPOSTNodesFirewallRulesRB {
    ...
    Process {
        ...
        if (!$Dest -and $Dest.length -gt 512) {
		 ...
		 $DisplayNameMapping =@{
			"Digest"="digest"; "Source"="source"; "Sport"="sport"; "Action"="action"; "Comment"="comment"; "Proto"="proto"; "Enable"="enable"; "IcmpType"="icmp-type"; "Macro"="macro"; "Pos"="pos"; "Type"="type"; "Node"="node"; "Iface"="iface"; "Log"="log"; "Dest"="dest"; "Dport"="dport"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesFirewallRulesRB {
    ...
    Process {
        ...
        $AllProperties = ("digest", "source", "sport", "action", "comment", "proto", "enable", "icmp-type", "macro", "pos", "type", "node", "iface", "log", "dest", "dport")
