...
function Initialize-PVEPOSTNodesFirewallRulesRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Pos"="pos"; "Type"="type"; "Dest"="dest"; "Source"="source"; "Dport"="dport"; "Enable"="enable"; "Action"="action"; "Macro"="macro"; "Node"="node"; "Iface"="iface"; "Log"="log"; "Sport"="sport"; "Comment"="comment"; "Proto"="proto"; "Digest"="digest"; "IcmpType"="icmp-type"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesFirewallRulesRB {
    ...
    Process {
        ...
        $AllProperties = ("pos", "type", "dest", "source", "dport", "enable", "action", "macro", "node", "iface", "log", "sport", "comment", "proto", "digest", "icmp-type")
