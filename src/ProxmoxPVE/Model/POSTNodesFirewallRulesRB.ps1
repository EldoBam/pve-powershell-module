...
function Initialize-PVEPOSTNodesFirewallRulesRB {
    ...
    Process {
        ...
        if (!$Iface -and $Iface.length -lt 2) {
		 ...
		 $DisplayNameMapping =@{
			"Log"="log"; "Action"="action"; "IcmpType"="icmp-type"; "Macro"="macro"; "Comment"="comment"; "Source"="source"; "Dport"="dport"; "Proto"="proto"; "Dest"="dest"; "Node"="node"; "Sport"="sport"; "Type"="type"; "Enable"="enable"; "Digest"="digest"; "Pos"="pos"; "Iface"="iface"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesFirewallRulesRB {
    ...
    Process {
        ...
        $AllProperties = ("log", "action", "icmp-type", "macro", "comment", "source", "dport", "proto", "dest", "node", "sport", "type", "enable", "digest", "pos", "iface")
