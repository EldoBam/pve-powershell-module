...
function Initialize-PVEPOSTStorageRB {
    ...
    Process {
        ...
        if (!$Password -and $Password.length -gt 256) {
		 ...
		 $DisplayNameMapping =@{
			"Smbversion"="smbversion"; "CreateSubdirs"="create-subdirs"; "Monhost"="monhost"; "Transport"="transport"; "DataPool"="data-pool"; "Server"="server"; "Base"="base"; "IsMountpoint"="is_mountpoint"; "Datastore"="datastore"; "Nocow"="nocow"; "Port"="port"; "SkipCertVerification"="skip-cert-verification"; "EncryptionKey"="encryption-key"; "SaferemoveThroughput"="saferemove_throughput"; "Fuse"="fuse"; "Type"="type"; "CreateBasePath"="create-base-path"; "Content"="content"; "Pool"="pool"; "ContentDirs"="content-dirs"; "Thinpool"="thinpool"; "ComstarTg"="comstar_tg"; "Maxfiles"="maxfiles"; "Shared"="shared"; "Nowritecache"="nowritecache"; "Disable"="disable"; "Target"="target"; "MaxProtectedBackups"="max-protected-backups"; "Mkdir"="mkdir"; "Bwlimit"="bwlimit"; "Path"="path"; "Format"="format"; "Mountpoint"="mountpoint"; "Preallocation"="preallocation"; "Domain"="domain"; "Volume"="volume"; "Iscsiprovider"="iscsiprovider"; "Blocksize"="blocksize"; "Subdir"="subdir"; "Username"="username"; "Share"="share"; "Namespace"="namespace"; "Export"="export"; "Fingerprint"="fingerprint"; "Password"="password"; "Options"="options"; "Sparse"="sparse"; "MasterPubkey"="master-pubkey"; "FsName"="fs-name"; "TaggedOnly"="tagged_only"; "Nodes"="nodes"; "Authsupported"="authsupported"; "Krbd"="krbd"; "PruneBackups"="prune-backups"; "Vgname"="vgname"; "Keyring"="keyring"; "Server2"="server2"; "Saferemove"="saferemove"; "Storage"="storage"; "ComstarHg"="comstar_hg"; "Portal"="portal"; "LioTpg"="lio_tpg"
        }
...
function ConvertFrom-PVEJsonToPOSTStorageRB {
    ...
    Process {
        ...
        $AllProperties = ("smbversion", "create-subdirs", "monhost", "transport", "data-pool", "server", "base", "is_mountpoint", "datastore", "nocow", "port", "skip-cert-verification", "encryption-key", "saferemove_throughput", "fuse", "type", "create-base-path", "content", "pool", "content-dirs", "thinpool", "comstar_tg", "maxfiles", "shared", "nowritecache", "disable", "target", "max-protected-backups", "mkdir", "bwlimit", "path", "format", "mountpoint", "preallocation", "domain", "volume", "iscsiprovider", "blocksize", "subdir", "username", "share", "namespace", "export", "fingerprint", "password", "options", "sparse", "master-pubkey", "fs-name", "tagged_only", "nodes", "authsupported", "krbd", "prune-backups", "vgname", "keyring", "server2", "saferemove", "storage", "comstar_hg", "portal", "lio_tpg")
