...
function Initialize-PVEPOSTStorageRB {
    ...
    Process {
        ...
        if ($Shared -and $Shared -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Password"="password"; "PruneBackups"="prune-backups"; "Blocksize"="blocksize"; "Bwlimit"="bwlimit"; "Transport"="transport"; "Datastore"="datastore"; "Server"="server"; "Saferemove"="saferemove"; "SkipCertVerification"="skip-cert-verification"; "LioTpg"="lio_tpg"; "CreateBasePath"="create-base-path"; "Nodes"="nodes"; "Krbd"="krbd"; "Fuse"="fuse"; "Type"="type"; "Subdir"="subdir"; "Target"="target"; "Content"="content"; "Iscsiprovider"="iscsiprovider"; "FsName"="fs-name"; "Thinpool"="thinpool"; "DataPool"="data-pool"; "Fingerprint"="fingerprint"; "Vgname"="vgname"; "Pool"="pool"; "SaferemoveThroughput"="saferemove_throughput"; "Preallocation"="preallocation"; "IsMountpoint"="is_mountpoint"; "Monhost"="monhost"; "Port"="port"; "Smbversion"="smbversion"; "Path"="path"; "Namespace"="namespace"; "TaggedOnly"="tagged_only"; "MaxProtectedBackups"="max-protected-backups"; "Base"="base"; "Disable"="disable"; "Username"="username"; "MasterPubkey"="master-pubkey"; "Nocow"="nocow"; "Volume"="volume"; "Nowritecache"="nowritecache"; "Mkdir"="mkdir"; "Export"="export"; "ComstarHg"="comstar_hg"; "Server2"="server2"; "Maxfiles"="maxfiles"; "Portal"="portal"; "Format"="format"; "Mountpoint"="mountpoint"; "Domain"="domain"; "Keyring"="keyring"; "Share"="share"; "ComstarTg"="comstar_tg"; "EncryptionKey"="encryption-key"; "Options"="options"; "Sparse"="sparse"; "Authsupported"="authsupported"; "CreateSubdirs"="create-subdirs"; "Storage"="storage"; "Shared"="shared"; "ContentDirs"="content-dirs"
        }
...
function ConvertFrom-PVEJsonToPOSTStorageRB {
    ...
    Process {
        ...
        $AllProperties = ("password", "prune-backups", "blocksize", "bwlimit", "transport", "datastore", "server", "saferemove", "skip-cert-verification", "lio_tpg", "create-base-path", "nodes", "krbd", "fuse", "type", "subdir", "target", "content", "iscsiprovider", "fs-name", "thinpool", "data-pool", "fingerprint", "vgname", "pool", "saferemove_throughput", "preallocation", "is_mountpoint", "monhost", "port", "smbversion", "path", "namespace", "tagged_only", "max-protected-backups", "base", "disable", "username", "master-pubkey", "nocow", "volume", "nowritecache", "mkdir", "export", "comstar_hg", "server2", "maxfiles", "portal", "format", "mountpoint", "domain", "keyring", "share", "comstar_tg", "encryption-key", "options", "sparse", "authsupported", "create-subdirs", "storage", "shared", "content-dirs")
