...
function Initialize-PVEClusterFirewallOptions {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"PolicyOut"="policy_out"; "PolicyForward"="policy_forward"; "Enable"="enable"; "Ebtables"="ebtables"; "LogRatelimit"="log_ratelimit"; "PolicyIn"="policy_in"
        }
...
function ConvertFrom-PVEJsonToClusterFirewallOptions {
    ...
    Process {
        ...
        $AllProperties = ("policy_out", "policy_forward", "enable", "ebtables", "log_ratelimit", "policy_in")
