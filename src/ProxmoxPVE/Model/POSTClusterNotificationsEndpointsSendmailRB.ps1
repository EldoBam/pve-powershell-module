...
function Initialize-PVEPOSTClusterNotificationsEndpointsSendmailRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Name"="name"; "Mailto"="mailto"; "Disable"="disable"; "MailtoUser"="mailto-user"; "FromAddress"="from-address"; "Author"="author"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterNotificationsEndpointsSendmailRB {
    ...
    Process {
        ...
        $AllProperties = ("name", "mailto", "disable", "mailto-user", "from-address", "author", "comment")
