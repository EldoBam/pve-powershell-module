...
function Initialize-PVEPOSTClusterNotificationsEndpointsSendmailRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"FromAddress"="from-address"; "Comment"="comment"; "Name"="name"; "MailtoUser"="mailto-user"; "Author"="author"; "Mailto"="mailto"; "Disable"="disable"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterNotificationsEndpointsSendmailRB {
    ...
    Process {
        ...
        $AllProperties = ("from-address", "comment", "name", "mailto-user", "author", "mailto", "disable")
