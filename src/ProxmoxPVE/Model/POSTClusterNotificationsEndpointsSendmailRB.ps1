...
function Initialize-PVEPOSTClusterNotificationsEndpointsSendmailRB {
    ...
    Process {
        ...
        if ($Disable -and $Disable -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Author"="author"; "MailtoUser"="mailto-user"; "FromAddress"="from-address"; "Mailto"="mailto"; "Comment"="comment"; "Disable"="disable"; "Name"="name"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterNotificationsEndpointsSendmailRB {
    ...
    Process {
        ...
        $AllProperties = ("author", "mailto-user", "from-address", "mailto", "comment", "disable", "name")
