...
function Initialize-PVEPOSTClusterNotificationsEndpointsSendmailRB {
    ...
    Process {
        ...
        if ($Disable -and $Disable -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"MailtoUser"="mailto-user"; "Name"="name"; "Disable"="disable"; "Comment"="comment"; "Author"="author"; "Mailto"="mailto"; "FromAddress"="from-address"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterNotificationsEndpointsSendmailRB {
    ...
    Process {
        ...
        $AllProperties = ("mailto-user", "name", "disable", "comment", "author", "mailto", "from-address")
