...
function Initialize-PVEPUTClusterMappingPciRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Mdev"="mdev"; "Delete"="delete"; "Map"="map"; "LiveMigrationCapable"="live-migration-capable"; "Description"="description"; "Digest"="digest"
        }
...
function ConvertFrom-PVEJsonToPUTClusterMappingPciRB {
    ...
    Process {
        ...
        $AllProperties = ("mdev", "delete", "map", "live-migration-capable", "description", "digest")
