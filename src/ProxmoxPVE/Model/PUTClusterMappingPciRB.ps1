...
function Initialize-PVEPUTClusterMappingPciRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Delete"="delete"; "LiveMigrationCapable"="live-migration-capable"; "Description"="description"; "Map"="map"; "Digest"="digest"; "Mdev"="mdev"
        }
...
function ConvertFrom-PVEJsonToPUTClusterMappingPciRB {
    ...
    Process {
        ...
        $AllProperties = ("delete", "live-migration-capable", "description", "map", "digest", "mdev")
