...
function Initialize-PVEPUTClusterMappingPciRB {
    ...
    Process {
        ...
        if (!$Description -and $Description.length -gt 4096) {
		 ...
		 $DisplayNameMapping =@{
			"Digest"="digest"; "Map"="map"; "LiveMigrationCapable"="live-migration-capable"; "Delete"="delete"; "Mdev"="mdev"; "Description"="description"
        }
...
function ConvertFrom-PVEJsonToPUTClusterMappingPciRB {
    ...
    Process {
        ...
        $AllProperties = ("digest", "map", "live-migration-capable", "delete", "mdev", "description")
