...
function Initialize-PVEClusterSdnZonesInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Mtu"="mtu"; "Dnszone"="dnszone"; "Ipam"="ipam"; "Dhcp"="dhcp"; "Nodes"="nodes"; "Reversedns"="reversedns"; "State"="state"; "Zone"="zone"; "Type"="type"; "Pending"="pending"; "Dns"="dns"
        }
...
function ConvertFrom-PVEJsonToClusterSdnZonesInner {
    ...
    Process {
        ...
        $AllProperties = ("mtu", "dnszone", "ipam", "dhcp", "nodes", "reversedns", "state", "zone", "type", "pending", "dns")
