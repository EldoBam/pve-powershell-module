...
function Initialize-PVEClusterSdnZonesInner {
    ...
    Process {
        ...
        if ($VxlanPort -and $VxlanPort -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"VlanProtocol"="vlan-protocol"; "ExitnodesLocalRouting"="exitnodes-local-routing"; "Digest"="digest"; "VrfVxlan"="vrf-vxlan"; "Peers"="peers"; "Dnszone"="dnszone"; "State"="state"; "Mtu"="mtu"; "AdvertiseSubnets"="advertise-subnets"; "DisableArpNdSuppression"="disable-arp-nd-suppression"; "Pending"="pending"; "Reversedns"="reversedns"; "Dhcp"="dhcp"; "Dns"="dns"; "Bridge"="bridge"; "RtImport"="rt-import"; "VxlanPort"="vxlan-port"; "Controller"="controller"; "Zone"="zone"; "BridgeDisableMacLearning"="bridge-disable-mac-learning"; "Exitnodes"="exitnodes"; "Nodes"="nodes"; "Ipam"="ipam"; "Type"="type"; "Mac"="mac"; "ExitnodesPrimary"="exitnodes-primary"; "Tag"="tag"
        }
...
function ConvertFrom-PVEJsonToClusterSdnZonesInner {
    ...
    Process {
        ...
        $AllProperties = ("vlan-protocol", "exitnodes-local-routing", "digest", "vrf-vxlan", "peers", "dnszone", "state", "mtu", "advertise-subnets", "disable-arp-nd-suppression", "pending", "reversedns", "dhcp", "dns", "bridge", "rt-import", "vxlan-port", "controller", "zone", "bridge-disable-mac-learning", "exitnodes", "nodes", "ipam", "type", "mac", "exitnodes-primary", "tag")
