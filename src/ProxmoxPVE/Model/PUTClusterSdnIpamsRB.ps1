...
function Initialize-PVEPUTClusterSdnIpamsRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Url"="url"; "Token"="token"; "LockToken"="lock-token"; "Delete"="delete"; "Section"="section"; "Fingerprint"="fingerprint"; "Digest"="digest"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnIpamsRB {
    ...
    Process {
        ...
        $AllProperties = ("url", "token", "lock-token", "delete", "section", "fingerprint", "digest")
