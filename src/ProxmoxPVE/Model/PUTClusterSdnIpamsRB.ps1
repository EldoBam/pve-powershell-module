...
function Initialize-PVEPUTClusterSdnIpamsRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Delete"="delete"; "Section"="section"; "Token"="token"; "Digest"="digest"; "LockToken"="lock-token"; "Fingerprint"="fingerprint"; "Url"="url"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnIpamsRB {
    ...
    Process {
        ...
        $AllProperties = ("delete", "section", "token", "digest", "lock-token", "fingerprint", "url")
