...
function Initialize-PVEClusterNotificationsMatchers {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Name"="name"; "MatchField"="match-field"; "Disable"="disable"; "MatchSeverity"="match-severity"; "Mode"="mode"; "Target"="target"; "Comment"="comment"; "MatchCalendar"="match-calendar"; "InvertMatch"="invert-match"; "Digest"="digest"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsMatchers {
    ...
    Process {
        ...
        $AllProperties = ("name", "match-field", "disable", "match-severity", "mode", "target", "comment", "match-calendar", "invert-match", "digest")
