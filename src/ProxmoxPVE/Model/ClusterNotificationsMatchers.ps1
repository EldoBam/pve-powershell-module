...
function Initialize-PVEClusterNotificationsMatchers {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Target"="target"; "MatchField"="match-field"; "Mode"="mode"; "Comment"="comment"; "MatchCalendar"="match-calendar"; "Name"="name"; "Digest"="digest"; "MatchSeverity"="match-severity"; "InvertMatch"="invert-match"; "Disable"="disable"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsMatchers {
    ...
    Process {
        ...
        $AllProperties = ("target", "match-field", "mode", "comment", "match-calendar", "name", "digest", "match-severity", "invert-match", "disable")
