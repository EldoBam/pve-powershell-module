...
function Initialize-PVEClusterNotificationsMatchers {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"MatchSeverity"="match-severity"; "InvertMatch"="invert-match"; "Comment"="comment"; "Disable"="disable"; "MatchCalendar"="match-calendar"; "MatchField"="match-field"; "Digest"="digest"; "Target"="target"; "Name"="name"; "Mode"="mode"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsMatchers {
    ...
    Process {
        ...
        $AllProperties = ("match-severity", "invert-match", "comment", "disable", "match-calendar", "match-field", "digest", "target", "name", "mode")
