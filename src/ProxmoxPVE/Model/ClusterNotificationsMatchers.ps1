...
function Initialize-PVEClusterNotificationsMatchers {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Mode"="mode"; "Target"="target"; "Name"="name"; "MatchField"="match-field"; "Disable"="disable"; "MatchSeverity"="match-severity"; "Digest"="digest"; "MatchCalendar"="match-calendar"; "Comment"="comment"; "InvertMatch"="invert-match"
        }
...
function ConvertFrom-PVEJsonToClusterNotificationsMatchers {
    ...
    Process {
        ...
        $AllProperties = ("mode", "target", "name", "match-field", "disable", "match-severity", "digest", "match-calendar", "comment", "invert-match")
