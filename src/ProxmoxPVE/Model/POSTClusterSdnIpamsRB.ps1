...
function Initialize-PVEPOSTClusterSdnIpamsRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Url"="url"; "LockToken"="lock-token"; "Token"="token"; "Section"="section"; "Type"="type"; "Fingerprint"="fingerprint"; "Ipam"="ipam"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterSdnIpamsRB {
    ...
    Process {
        ...
        $AllProperties = ("url", "lock-token", "token", "section", "type", "fingerprint", "ipam")
