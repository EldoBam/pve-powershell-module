...
function Initialize-PVENodesVzdumpDefaults {
    ...
    Process {
        ...
        if ($Ionice -and $Ionice -gt 8) {
		 ...
		 $DisplayNameMapping =@{
			"Maxfiles"="maxfiles"; "NotificationMode"="notification-mode"; "Pool"="pool"; "All"="all"; "NotesTemplate"="notes-template"; "Stdexcludes"="stdexcludes"; "Fleecing"="fleecing"; "Zstd"="zstd"; "Stopwait"="stopwait"; "PbsChangeDetectionMode"="pbs-change-detection-mode"; "Vmid"="vmid"; "Script"="script"; "Stop"="stop"; "Ionice"="ionice"; "Mailnotification"="mailnotification"; "Compress"="compress"; "Pigz"="pigz"; "Lockwait"="lockwait"; "Mailto"="mailto"; "Bwlimit"="bwlimit"; "Performance"="performance"; "Quiet"="quiet"; "Mode"="mode"; "Tmpdir"="tmpdir"; "Node"="node"; "Dumpdir"="dumpdir"; "Exclude"="exclude"; "Protected"="protected"; "Remove"="remove"; "Storage"="storage"; "PruneBackups"="prune-backups"; "ExcludePath"="exclude-path"
        }
...
function ConvertFrom-PVEJsonToNodesVzdumpDefaults {
    ...
    Process {
        ...
        $AllProperties = ("maxfiles", "notification-mode", "pool", "all", "notes-template", "stdexcludes", "fleecing", "zstd", "stopwait", "pbs-change-detection-mode", "vmid", "script", "stop", "ionice", "mailnotification", "compress", "pigz", "lockwait", "mailto", "bwlimit", "performance", "quiet", "mode", "tmpdir", "node", "dumpdir", "exclude", "protected", "remove", "storage", "prune-backups", "exclude-path")
