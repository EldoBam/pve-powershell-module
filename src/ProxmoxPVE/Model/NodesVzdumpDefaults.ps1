...
function Initialize-PVENodesVzdumpDefaults {
    ...
    Process {
        ...
        if ($Ionice -and $Ionice -gt 8) {
		 ...
		 $DisplayNameMapping =@{
			"Stop"="stop"; "Mailnotification"="mailnotification"; "All"="all"; "Protected"="protected"; "PruneBackups"="prune-backups"; "Exclude"="exclude"; "Node"="node"; "Dumpdir"="dumpdir"; "Zstd"="zstd"; "NotificationTarget"="notification-target"; "Quiet"="quiet"; "Performance"="performance"; "Maxfiles"="maxfiles"; "Mailto"="mailto"; "NotesTemplate"="notes-template"; "Bwlimit"="bwlimit"; "Fleecing"="fleecing"; "ExcludePath"="exclude-path"; "NotificationPolicy"="notification-policy"; "Stopwait"="stopwait"; "Compress"="compress"; "Pigz"="pigz"; "NotificationMode"="notification-mode"; "Mode"="mode"; "Vmid"="vmid"; "Remove"="remove"; "Stdexcludes"="stdexcludes"; "Ionice"="ionice"; "Lockwait"="lockwait"; "Tmpdir"="tmpdir"; "Pool"="pool"; "Script"="script"; "Storage"="storage"; "PbsChangeDetectionMode"="pbs-change-detection-mode"
        }
...
function ConvertFrom-PVEJsonToNodesVzdumpDefaults {
    ...
    Process {
        ...
        $AllProperties = ("stop", "mailnotification", "all", "protected", "prune-backups", "exclude", "node", "dumpdir", "zstd", "notification-target", "quiet", "performance", "maxfiles", "mailto", "notes-template", "bwlimit", "fleecing", "exclude-path", "notification-policy", "stopwait", "compress", "pigz", "notification-mode", "mode", "vmid", "remove", "stdexcludes", "ionice", "lockwait", "tmpdir", "pool", "script", "storage", "pbs-change-detection-mode")
