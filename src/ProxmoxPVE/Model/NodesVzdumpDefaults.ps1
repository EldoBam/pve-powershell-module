...
function ConvertFrom-PVEJsonToNodesVzdumpDefaults {
    ...
    Process {
        ...
        $AllProperties = ("maxfiles", "notification-mode", "mailnotification", "stdexcludes", "tmpdir", "vmid", "script", "performance", "compress", "pbs-change-detection-mode", "protected", "notes-template", "node", "all", "exclude", "bwlimit", "quiet", "fleecing", "mode", "pool", "lockwait", "stop", "zstd", "exclude-path", "dumpdir", "prune-backups", "stopwait", "mailto", "pigz", "remove", "ionice", "storage")
