...
function Initialize-PVENodesVzdumpDefaults {
    ...
    Process {
        ...
        if ($Maxfiles -and $Maxfiles -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Stop"="stop"; "Exclude"="exclude"; "NotesTemplate"="notes-template"; "Pool"="pool"; "Storage"="storage"; "All"="all"; "Stopwait"="stopwait"; "Node"="node"; "Quiet"="quiet"; "Fleecing"="fleecing"; "Stdexcludes"="stdexcludes"; "Mailto"="mailto"; "NotificationTarget"="notification-target"; "Zstd"="zstd"; "Protected"="protected"; "Script"="script"; "NotificationMode"="notification-mode"; "Pigz"="pigz"; "PbsChangeDetectionMode"="pbs-change-detection-mode"; "Lockwait"="lockwait"; "Compress"="compress"; "Tmpdir"="tmpdir"; "Bwlimit"="bwlimit"; "Mailnotification"="mailnotification"; "Remove"="remove"; "Mode"="mode"; "NotificationPolicy"="notification-policy"; "Dumpdir"="dumpdir"; "PruneBackups"="prune-backups"; "ExcludePath"="exclude-path"; "Ionice"="ionice"; "Performance"="performance"; "Maxfiles"="maxfiles"; "Vmid"="vmid"
        }
...
function ConvertFrom-PVEJsonToNodesVzdumpDefaults {
    ...
    Process {
        ...
        $AllProperties = ("stop", "exclude", "notes-template", "pool", "storage", "all", "stopwait", "node", "quiet", "fleecing", "stdexcludes", "mailto", "notification-target", "zstd", "protected", "script", "notification-mode", "pigz", "pbs-change-detection-mode", "lockwait", "compress", "tmpdir", "bwlimit", "mailnotification", "remove", "mode", "notification-policy", "dumpdir", "prune-backups", "exclude-path", "ionice", "performance", "maxfiles", "vmid")
