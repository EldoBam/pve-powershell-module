...
function ConvertFrom-PVEJsonToNodesVzdumpDefaults {
    ...
    Process {
        ...
        $AllProperties = ("lockwait", "mode", "quiet", "mailnotification", "exclude-path", "node", "tmpdir", "stdexcludes", "maxfiles", "vmid", "notification-mode", "exclude", "fleecing", "pigz", "storage", "notes-template", "performance", "notification-target", "remove", "bwlimit", "compress", "script", "dumpdir", "mailto", "pool", "stopwait", "prune-backups", "stop", "protected", "ionice", "all", "pbs-change-detection-mode", "notification-policy", "zstd")
