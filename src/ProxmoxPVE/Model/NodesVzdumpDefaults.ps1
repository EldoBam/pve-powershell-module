...
function Initialize-PVENodesVzdumpDefaults {
    ...
    Process {
        ...
        if ($Quiet -and $Quiet -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"PruneBackups"="prune-backups"; "Bwlimit"="bwlimit"; "Remove"="remove"; "Fleecing"="fleecing"; "All"="all"; "Pigz"="pigz"; "Protected"="protected"; "ExcludePath"="exclude-path"; "PbsChangeDetectionMode"="pbs-change-detection-mode"; "Script"="script"; "Tmpdir"="tmpdir"; "Pool"="pool"; "Zstd"="zstd"; "Stopwait"="stopwait"; "Exclude"="exclude"; "Stop"="stop"; "Mailto"="mailto"; "Storage"="storage"; "NotesTemplate"="notes-template"; "Dumpdir"="dumpdir"; "Stdexcludes"="stdexcludes"; "Mailnotification"="mailnotification"; "Mode"="mode"; "Lockwait"="lockwait"; "NotificationTarget"="notification-target"; "Performance"="performance"; "Maxfiles"="maxfiles"; "Ionice"="ionice"; "NotificationPolicy"="notification-policy"; "Vmid"="vmid"; "Compress"="compress"; "Node"="node"; "Quiet"="quiet"; "NotificationMode"="notification-mode"
        }
...
function ConvertFrom-PVEJsonToNodesVzdumpDefaults {
    ...
    Process {
        ...
        $AllProperties = ("prune-backups", "bwlimit", "remove", "fleecing", "all", "pigz", "protected", "exclude-path", "pbs-change-detection-mode", "script", "tmpdir", "pool", "zstd", "stopwait", "exclude", "stop", "mailto", "storage", "notes-template", "dumpdir", "stdexcludes", "mailnotification", "mode", "lockwait", "notification-target", "performance", "maxfiles", "ionice", "notification-policy", "vmid", "compress", "node", "quiet", "notification-mode")
