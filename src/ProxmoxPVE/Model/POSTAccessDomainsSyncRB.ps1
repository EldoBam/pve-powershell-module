...
function Initialize-PVEPOSTAccessDomainsSyncRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"RemoveVanished"="remove-vanished"; "DryRun"="dry-run"; "Scope"="scope"; "Full"="full"; "EnableNew"="enable-new"; "Purge"="purge"
        }
...
function ConvertFrom-PVEJsonToPOSTAccessDomainsSyncRB {
    ...
    Process {
        ...
        $AllProperties = ("remove-vanished", "dry-run", "scope", "full", "enable-new", "purge")
