...
function Initialize-PVEPOSTAccessDomainsSyncRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Purge"="purge"; "Full"="full"; "EnableNew"="enable-new"; "Scope"="scope"; "RemoveVanished"="remove-vanished"; "DryRun"="dry-run"
        }
...
function ConvertFrom-PVEJsonToPOSTAccessDomainsSyncRB {
    ...
    Process {
        ...
        $AllProperties = ("purge", "full", "enable-new", "scope", "remove-vanished", "dry-run")
