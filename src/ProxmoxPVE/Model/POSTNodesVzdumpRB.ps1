...
function ConvertFrom-PVEJsonToPOSTNodesVzdumpRB {
    ...
    Process {
        ...
        $AllProperties = ("all", "notification-mode", "stopwait", "pigz", "storage", "script", "pbs-change-detection-mode", "stdexcludes", "ionice", "dumpdir", "node", "mode", "stop", "zstd", "compress", "mailnotification", "notes-template", "mailto", "bwlimit", "vmid", "fleecing", "exclude-path", "notification-target", "lockwait", "notification-policy", "job-id", "stdout", "protected", "exclude", "quiet", "remove", "prune-backups", "performance", "tmpdir", "pool", "maxfiles")
