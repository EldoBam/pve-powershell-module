...
function Initialize-PVEPOSTNodesVzdumpRB {
    ...
    Process {
        ...
        if ($Ionice -and $Ionice -gt 8) {
		 ...
		 $DisplayNameMapping =@{
			"Maxfiles"="maxfiles"; "NotificationMode"="notification-mode"; "Mailnotification"="mailnotification"; "Stdexcludes"="stdexcludes"; "Tmpdir"="tmpdir"; "Vmid"="vmid"; "Script"="script"; "Performance"="performance"; "Compress"="compress"; "PbsChangeDetectionMode"="pbs-change-detection-mode"; "Protected"="protected"; "NotesTemplate"="notes-template"; "JobId"="job-id"; "All"="all"; "Exclude"="exclude"; "Bwlimit"="bwlimit"; "Quiet"="quiet"; "Stdout"="stdout"; "Fleecing"="fleecing"; "Mode"="mode"; "Pool"="pool"; "Lockwait"="lockwait"; "Stop"="stop"; "Zstd"="zstd"; "ExcludePath"="exclude-path"; "Dumpdir"="dumpdir"; "PruneBackups"="prune-backups"; "Stopwait"="stopwait"; "Mailto"="mailto"; "Pigz"="pigz"; "Remove"="remove"; "Ionice"="ionice"; "Storage"="storage"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesVzdumpRB {
    ...
    Process {
        ...
        $AllProperties = ("maxfiles", "notification-mode", "mailnotification", "stdexcludes", "tmpdir", "vmid", "script", "performance", "compress", "pbs-change-detection-mode", "protected", "notes-template", "job-id", "all", "exclude", "bwlimit", "quiet", "stdout", "fleecing", "mode", "pool", "lockwait", "stop", "zstd", "exclude-path", "dumpdir", "prune-backups", "stopwait", "mailto", "pigz", "remove", "ionice", "storage")
