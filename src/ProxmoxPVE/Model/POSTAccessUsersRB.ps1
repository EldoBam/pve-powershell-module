...
function Initialize-PVEPOSTAccessUsersRB {
    ...
    Process {
        ...
        if (!$Comment -and $Comment.length -gt 2048) {
		 ...
		 $DisplayNameMapping =@{
			"Password"="password"; "Groups"="groups"; "Enable"="enable"; "Firstname"="firstname"; "Expire"="expire"; "Userid"="userid"; "Lastname"="lastname"; "Email"="email"; "Keys"="keys"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToPOSTAccessUsersRB {
    ...
    Process {
        ...
        $AllProperties = ("password", "groups", "enable", "firstname", "expire", "userid", "lastname", "email", "keys", "comment")
