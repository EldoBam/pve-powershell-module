...
function Initialize-PVEPOSTAccessUsersRB {
    ...
    Process {
        ...
        if (!$Comment -and $Comment.length -gt 2048) {
		 ...
		 $DisplayNameMapping =@{
			"Firstname"="firstname"; "Userid"="userid"; "Password"="password"; "Enable"="enable"; "Lastname"="lastname"; "Email"="email"; "Comment"="comment"; "Groups"="groups"; "Keys"="keys"; "Expire"="expire"
        }
...
function ConvertFrom-PVEJsonToPOSTAccessUsersRB {
    ...
    Process {
        ...
        $AllProperties = ("firstname", "userid", "password", "enable", "lastname", "email", "comment", "groups", "keys", "expire")
