...
function Initialize-PVEPOSTAccessUsersRB {
    ...
    Process {
        ...
        if (!$Lastname -and $Lastname.length -gt 1024) {
		 ...
		 $DisplayNameMapping =@{
			"Expire"="expire"; "Email"="email"; "Keys"="keys"; "Userid"="userid"; "Password"="password"; "Groups"="groups"; "Comment"="comment"; "Firstname"="firstname"; "Enable"="enable"; "Lastname"="lastname"
        }
...
function ConvertFrom-PVEJsonToPOSTAccessUsersRB {
    ...
    Process {
        ...
        $AllProperties = ("expire", "email", "keys", "userid", "password", "groups", "comment", "firstname", "enable", "lastname")
