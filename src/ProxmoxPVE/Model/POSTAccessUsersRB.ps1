...
function Initialize-PVEPOSTAccessUsersRB {
    ...
    Process {
        ...
        if (!$Comment -and $Comment.length -gt 2048) {
		 ...
		 $DisplayNameMapping =@{
			"Expire"="expire"; "Userid"="userid"; "Password"="password"; "Lastname"="lastname"; "Groups"="groups"; "Enable"="enable"; "Keys"="keys"; "Email"="email"; "Firstname"="firstname"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToPOSTAccessUsersRB {
    ...
    Process {
        ...
        $AllProperties = ("expire", "userid", "password", "lastname", "groups", "enable", "keys", "email", "firstname", "comment")
