...
function Initialize-PVEPOSTAccessUsersRB {
    ...
    Process {
        ...
        if (!$Userid -and $Userid.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Password"="password"; "Email"="email"; "Comment"="comment"; "Enable"="enable"; "Groups"="groups"; "Firstname"="firstname"; "Lastname"="lastname"; "Userid"="userid"; "Expire"="expire"; "Keys"="keys"
        }
...
function ConvertFrom-PVEJsonToPOSTAccessUsersRB {
    ...
    Process {
        ...
        $AllProperties = ("password", "email", "comment", "enable", "groups", "firstname", "lastname", "userid", "expire", "keys")
