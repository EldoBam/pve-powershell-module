...
function Initialize-PVEPOSTAccessUsersRB {
    ...
    Process {
        ...
        if (!$Email -and $Email.length -gt 254) {
		 ...
		 $DisplayNameMapping =@{
			"Userid"="userid"; "Password"="password"; "Expire"="expire"; "Lastname"="lastname"; "Firstname"="firstname"; "Keys"="keys"; "Enable"="enable"; "Groups"="groups"; "Comment"="comment"; "Email"="email"
        }
...
function ConvertFrom-PVEJsonToPOSTAccessUsersRB {
    ...
    Process {
        ...
        $AllProperties = ("userid", "password", "expire", "lastname", "firstname", "keys", "enable", "groups", "comment", "email")
