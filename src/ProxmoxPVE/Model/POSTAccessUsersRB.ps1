...
function Initialize-PVEPOSTAccessUsersRB {
    ...
    Process {
        ...
        if (!$Email -and $Email.length -gt 254) {
		 ...
		 $DisplayNameMapping =@{
			"Keys"="keys"; "Groups"="groups"; "Expire"="expire"; "Comment"="comment"; "Lastname"="lastname"; "Password"="password"; "Firstname"="firstname"; "Userid"="userid"; "Email"="email"; "Enable"="enable"
        }
...
function ConvertFrom-PVEJsonToPOSTAccessUsersRB {
    ...
    Process {
        ...
        $AllProperties = ("keys", "groups", "expire", "comment", "lastname", "password", "firstname", "userid", "email", "enable")
