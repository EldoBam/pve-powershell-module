...
function Initialize-PVEPOSTClusterHaResourcesRB {
    ...
    Process {
        ...
        if (!$Comment -and $Comment.length -gt 4096) {
		 ...
		 $DisplayNameMapping =@{
			"MaxRestart"="max_restart"; "MaxRelocate"="max_relocate"; "Comment"="comment"; "Type"="type"; "Group"="group"; "State"="state"; "Sid"="sid"; "Failback"="failback"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterHaResourcesRB {
    ...
    Process {
        ...
        $AllProperties = ("max_restart", "max_relocate", "comment", "type", "group", "state", "sid", "failback")
