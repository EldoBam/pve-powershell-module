...
function Initialize-PVEPOSTClusterHaResourcesRB {
    ...
    Process {
        ...
        if (!$Comment -and $Comment.length -gt 4096) {
		 ...
		 $DisplayNameMapping =@{
			"MaxRelocate"="max_relocate"; "Group"="group"; "Type"="type"; "MaxRestart"="max_restart"; "Comment"="comment"; "Sid"="sid"; "Failback"="failback"; "State"="state"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterHaResourcesRB {
    ...
    Process {
        ...
        $AllProperties = ("max_relocate", "group", "type", "max_restart", "comment", "sid", "failback", "state")
