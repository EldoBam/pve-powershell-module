...
function Initialize-PVEPOSTClusterHaResourcesRB {
    ...
    Process {
        ...
        if (!$Comment -and $Comment.length -gt 4096) {
		 ...
		 $DisplayNameMapping =@{
			"MaxRelocate"="max_relocate"; "Group"="group"; "Type"="type"; "MaxRestart"="max_restart"; "Sid"="sid"; "State"="state"; "Comment"="comment"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterHaResourcesRB {
    ...
    Process {
        ...
        $AllProperties = ("max_relocate", "group", "type", "max_restart", "sid", "state", "comment")
