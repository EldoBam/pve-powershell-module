...
function Initialize-PVEPOSTClusterHaResourcesRB {
    ...
    Process {
        ...
        if (!$Comment -and $Comment.length -gt 4096) {
		 ...
		 $DisplayNameMapping =@{
			"Sid"="sid"; "MaxRestart"="max_restart"; "State"="state"; "Type"="type"; "MaxRelocate"="max_relocate"; "Comment"="comment"; "Group"="group"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterHaResourcesRB {
    ...
    Process {
        ...
        $AllProperties = ("sid", "max_restart", "state", "type", "max_relocate", "comment", "group")
