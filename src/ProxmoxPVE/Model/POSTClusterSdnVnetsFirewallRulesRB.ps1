...
function Initialize-PVEPOSTClusterSdnVnetsFirewallRulesRB {
    ...
    Process {
        ...
        if (!$Iface -and $Iface.length -lt 2) {
		 ...
		 $DisplayNameMapping =@{
			"Vnet"="vnet"; "Log"="log"; "Action"="action"; "IcmpType"="icmp-type"; "Macro"="macro"; "Comment"="comment"; "Source"="source"; "Dport"="dport"; "Proto"="proto"; "Dest"="dest"; "Sport"="sport"; "Type"="type"; "Enable"="enable"; "Digest"="digest"; "Pos"="pos"; "Iface"="iface"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterSdnVnetsFirewallRulesRB {
    ...
    Process {
        ...
        $AllProperties = ("vnet", "log", "action", "icmp-type", "macro", "comment", "source", "dport", "proto", "dest", "sport", "type", "enable", "digest", "pos", "iface")
