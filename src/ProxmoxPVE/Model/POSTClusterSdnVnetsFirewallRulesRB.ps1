...
function Initialize-PVEPOSTClusterSdnVnetsFirewallRulesRB {
    ...
    Process {
        ...
        if (!$Iface -and $Iface.length -lt 2) {
		 ...
		 $DisplayNameMapping =@{
			"Macro"="macro"; "Action"="action"; "Proto"="proto"; "Log"="log"; "Pos"="pos"; "Dest"="dest"; "Type"="type"; "Comment"="comment"; "Dport"="dport"; "Vnet"="vnet"; "Digest"="digest"; "Enable"="enable"; "Source"="source"; "Iface"="iface"; "IcmpType"="icmp-type"; "Sport"="sport"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterSdnVnetsFirewallRulesRB {
    ...
    Process {
        ...
        $AllProperties = ("macro", "action", "proto", "log", "pos", "dest", "type", "comment", "dport", "vnet", "digest", "enable", "source", "iface", "icmp-type", "sport")
