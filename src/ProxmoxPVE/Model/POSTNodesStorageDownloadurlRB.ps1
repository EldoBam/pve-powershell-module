...
function Initialize-PVEPOSTNodesStorageDownloadurlRB {
    ...
    Process {
        ...
        if (!$Filename -and $Filename.length -gt 255) {
		 ...
		 $DisplayNameMapping =@{
			"VerifyCertificates"="verify-certificates"; "Url"="url"; "ChecksumAlgorithm"="checksum-algorithm"; "Content"="content"; "Compression"="compression"; "Checksum"="checksum"; "Filename"="filename"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesStorageDownloadurlRB {
    ...
    Process {
        ...
        $AllProperties = ("verify-certificates", "url", "checksum-algorithm", "content", "compression", "checksum", "filename")
