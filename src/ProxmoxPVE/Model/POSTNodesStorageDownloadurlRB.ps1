...
function Initialize-PVEPOSTNodesStorageDownloadurlRB {
    ...
    Process {
        ...
        if ($VerifyCertificates -and $VerifyCertificates -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Url"="url"; "Content"="content"; "ChecksumAlgorithm"="checksum-algorithm"; "Checksum"="checksum"; "Filename"="filename"; "Node"="node"; "Storage"="storage"; "VerifyCertificates"="verify-certificates"; "Compression"="compression"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesStorageDownloadurlRB {
    ...
    Process {
        ...
        $AllProperties = ("url", "content", "checksum-algorithm", "checksum", "filename", "node", "storage", "verify-certificates", "compression")
