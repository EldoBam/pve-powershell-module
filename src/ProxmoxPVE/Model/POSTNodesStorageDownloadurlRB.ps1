...
function Initialize-PVEPOSTNodesStorageDownloadurlRB {
    ...
    Process {
        ...
        if (!$Filename -and $Filename.length -gt 255) {
		 ...
		 $DisplayNameMapping =@{
			"Compression"="compression"; "Filename"="filename"; "Checksum"="checksum"; "Content"="content"; "ChecksumAlgorithm"="checksum-algorithm"; "VerifyCertificates"="verify-certificates"; "Url"="url"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesStorageDownloadurlRB {
    ...
    Process {
        ...
        $AllProperties = ("compression", "filename", "checksum", "content", "checksum-algorithm", "verify-certificates", "url")
