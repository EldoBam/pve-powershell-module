...
function Initialize-PVEPUTClusterOptionsRB {
    ...
    Process {
        ...
        if ($MaxWorkers -and $MaxWorkers -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Notify"="notify"; "Bwlimit"="bwlimit"; "Keyboard"="keyboard"; "Crs"="crs"; "Ha"="ha"; "Migration"="migration"; "NextId"="next-id"; "Fencing"="fencing"; "RegisteredTags"="registered-tags"; "Webauthn"="webauthn"; "Delete"="delete"; "MacPrefix"="mac_prefix"; "UserTagAccess"="user-tag-access"; "ConsentText"="consent-text"; "EmailFrom"="email_from"; "U2f"="u2f"; "TagStyle"="tag-style"; "HttpProxy"="http_proxy"; "MigrationUnsecure"="migration_unsecure"; "Language"="language"; "Console"="console"; "Replication"="replication"; "Description"="description"; "MaxWorkers"="max_workers"
        }
...
function ConvertFrom-PVEJsonToPUTClusterOptionsRB {
    ...
    Process {
        ...
        $AllProperties = ("notify", "bwlimit", "keyboard", "crs", "ha", "migration", "next-id", "fencing", "registered-tags", "webauthn", "delete", "mac_prefix", "user-tag-access", "consent-text", "email_from", "u2f", "tag-style", "http_proxy", "migration_unsecure", "language", "console", "replication", "description", "max_workers")
