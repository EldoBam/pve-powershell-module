...
function Initialize-PVEPUTClusterOptionsRB {
    ...
    Process {
        ...
        if ($MaxWorkers -and $MaxWorkers -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Delete"="delete"; "U2f"="u2f"; "Console"="console"; "Webauthn"="webauthn"; "Keyboard"="keyboard"; "MacPrefix"="mac_prefix"; "Ha"="ha"; "MigrationUnsecure"="migration_unsecure"; "Fencing"="fencing"; "EmailFrom"="email_from"; "Description"="description"; "TagStyle"="tag-style"; "HttpProxy"="http_proxy"; "Notify"="notify"; "Crs"="crs"; "Language"="language"; "Bwlimit"="bwlimit"; "ConsentText"="consent-text"; "NextId"="next-id"; "Migration"="migration"; "UserTagAccess"="user-tag-access"; "MaxWorkers"="max_workers"; "RegisteredTags"="registered-tags"
        }
...
function ConvertFrom-PVEJsonToPUTClusterOptionsRB {
    ...
    Process {
        ...
        $AllProperties = ("delete", "u2f", "console", "webauthn", "keyboard", "mac_prefix", "ha", "migration_unsecure", "fencing", "email_from", "description", "tag-style", "http_proxy", "notify", "crs", "language", "bwlimit", "consent-text", "next-id", "migration", "user-tag-access", "max_workers", "registered-tags")
