...
function Initialize-PVEPUTClusterSdnZonesRB {
    ...
    Process {
        ...
        if (!$Delete -and $Delete.length -gt 4096) {
		 ...
		 $DisplayNameMapping =@{
			"VxlanPort"="vxlan-port"; "Ipam"="ipam"; "BridgeDisableMacLearning"="bridge-disable-mac-learning"; "Dnszone"="dnszone"; "RtImport"="rt-import"; "Dns"="dns"; "Peers"="peers"; "Digest"="digest"; "VlanProtocol"="vlan-protocol"; "Exitnodes"="exitnodes"; "DpId"="dp-id"; "Tag"="tag"; "Reversedns"="reversedns"; "Nodes"="nodes"; "Mac"="mac"; "VrfVxlan"="vrf-vxlan"; "DisableArpNdSuppression"="disable-arp-nd-suppression"; "Controller"="controller"; "Delete"="delete"; "ExitnodesLocalRouting"="exitnodes-local-routing"; "Dhcp"="dhcp"; "Bridge"="bridge"; "Mtu"="mtu"; "ExitnodesPrimary"="exitnodes-primary"; "AdvertiseSubnets"="advertise-subnets"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnZonesRB {
    ...
    Process {
        ...
        $AllProperties = ("vxlan-port", "ipam", "bridge-disable-mac-learning", "dnszone", "rt-import", "dns", "peers", "digest", "vlan-protocol", "exitnodes", "dp-id", "tag", "reversedns", "nodes", "mac", "vrf-vxlan", "disable-arp-nd-suppression", "controller", "delete", "exitnodes-local-routing", "dhcp", "bridge", "mtu", "exitnodes-primary", "advertise-subnets")
