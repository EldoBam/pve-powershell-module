...
function Initialize-PVEPUTClusterSdnZonesRB {
    ...
    Process {
        ...
        if ($VxlanPort -and $VxlanPort -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Delete"="delete"; "Digest"="digest"; "VrfVxlan"="vrf-vxlan"; "RtImport"="rt-import"; "Bridge"="bridge"; "ExitnodesLocalRouting"="exitnodes-local-routing"; "VxlanPort"="vxlan-port"; "DpId"="dp-id"; "Tag"="tag"; "Mtu"="mtu"; "DisableArpNdSuppression"="disable-arp-nd-suppression"; "Dhcp"="dhcp"; "Dns"="dns"; "Ipam"="ipam"; "Dnszone"="dnszone"; "AdvertiseSubnets"="advertise-subnets"; "ExitnodesPrimary"="exitnodes-primary"; "Exitnodes"="exitnodes"; "Mac"="mac"; "Controller"="controller"; "Nodes"="nodes"; "BridgeDisableMacLearning"="bridge-disable-mac-learning"; "Peers"="peers"; "VlanProtocol"="vlan-protocol"; "Reversedns"="reversedns"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnZonesRB {
    ...
    Process {
        ...
        $AllProperties = ("delete", "digest", "vrf-vxlan", "rt-import", "bridge", "exitnodes-local-routing", "vxlan-port", "dp-id", "tag", "mtu", "disable-arp-nd-suppression", "dhcp", "dns", "ipam", "dnszone", "advertise-subnets", "exitnodes-primary", "exitnodes", "mac", "controller", "nodes", "bridge-disable-mac-learning", "peers", "vlan-protocol", "reversedns")
