...
function Initialize-PVEPUTClusterSdnZonesRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Delete"="delete"; "Mtu"="mtu"; "Nodes"="nodes"; "Tag"="tag"; "VrfVxlan"="vrf-vxlan"; "Controller"="controller"; "VxlanPort"="vxlan-port"; "RtImport"="rt-import"; "Exitnodes"="exitnodes"; "Reversedns"="reversedns"; "DisableArpNdSuppression"="disable-arp-nd-suppression"; "Dhcp"="dhcp"; "Mac"="mac"; "LockToken"="lock-token"; "AdvertiseSubnets"="advertise-subnets"; "ExitnodesLocalRouting"="exitnodes-local-routing"; "Dnszone"="dnszone"; "Ipam"="ipam"; "Bridge"="bridge"; "BridgeDisableMacLearning"="bridge-disable-mac-learning"; "Dns"="dns"; "Peers"="peers"; "ExitnodesPrimary"="exitnodes-primary"; "Fabric"="fabric"; "DpId"="dp-id"; "VlanProtocol"="vlan-protocol"; "Digest"="digest"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnZonesRB {
    ...
    Process {
        ...
        $AllProperties = ("delete", "mtu", "nodes", "tag", "vrf-vxlan", "controller", "vxlan-port", "rt-import", "exitnodes", "reversedns", "disable-arp-nd-suppression", "dhcp", "mac", "lock-token", "advertise-subnets", "exitnodes-local-routing", "dnszone", "ipam", "bridge", "bridge-disable-mac-learning", "dns", "peers", "exitnodes-primary", "fabric", "dp-id", "vlan-protocol", "digest")
