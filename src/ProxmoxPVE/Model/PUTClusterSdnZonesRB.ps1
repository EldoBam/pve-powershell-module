...
function Initialize-PVEPUTClusterSdnZonesRB {
    ...
    Process {
        ...
        if ($VxlanPort -and $VxlanPort -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"VlanProtocol"="vlan-protocol"; "ExitnodesLocalRouting"="exitnodes-local-routing"; "Digest"="digest"; "Delete"="delete"; "VrfVxlan"="vrf-vxlan"; "Peers"="peers"; "Dnszone"="dnszone"; "Mtu"="mtu"; "AdvertiseSubnets"="advertise-subnets"; "LockToken"="lock-token"; "DisableArpNdSuppression"="disable-arp-nd-suppression"; "Reversedns"="reversedns"; "Dhcp"="dhcp"; "Dns"="dns"; "Bridge"="bridge"; "RtImport"="rt-import"; "VxlanPort"="vxlan-port"; "Controller"="controller"; "DpId"="dp-id"; "BridgeDisableMacLearning"="bridge-disable-mac-learning"; "Exitnodes"="exitnodes"; "Nodes"="nodes"; "Ipam"="ipam"; "Mac"="mac"; "ExitnodesPrimary"="exitnodes-primary"; "Fabric"="fabric"; "Tag"="tag"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnZonesRB {
    ...
    Process {
        ...
        $AllProperties = ("vlan-protocol", "exitnodes-local-routing", "digest", "delete", "vrf-vxlan", "peers", "dnszone", "mtu", "advertise-subnets", "lock-token", "disable-arp-nd-suppression", "reversedns", "dhcp", "dns", "bridge", "rt-import", "vxlan-port", "controller", "dp-id", "bridge-disable-mac-learning", "exitnodes", "nodes", "ipam", "mac", "exitnodes-primary", "fabric", "tag")
