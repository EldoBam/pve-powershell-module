...
function Initialize-PVEPOSTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        if ($Disable -and $Disable -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"InvertMatch"="invert-match"; "Mode"="mode"; "MatchSeverity"="match-severity"; "Target"="target"; "MatchCalendar"="match-calendar"; "Comment"="comment"; "MatchField"="match-field"; "Disable"="disable"; "Name"="name"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        $AllProperties = ("invert-match", "mode", "match-severity", "target", "match-calendar", "comment", "match-field", "disable", "name")
