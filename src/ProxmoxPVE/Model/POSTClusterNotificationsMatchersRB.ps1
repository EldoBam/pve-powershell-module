...
function Initialize-PVEPOSTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        if ($InvertMatch -and $InvertMatch -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Name"="name"; "MatchCalendar"="match-calendar"; "MatchSeverity"="match-severity"; "Disable"="disable"; "Comment"="comment"; "Target"="target"; "MatchField"="match-field"; "InvertMatch"="invert-match"; "Mode"="mode"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        $AllProperties = ("name", "match-calendar", "match-severity", "disable", "comment", "target", "match-field", "invert-match", "mode")
