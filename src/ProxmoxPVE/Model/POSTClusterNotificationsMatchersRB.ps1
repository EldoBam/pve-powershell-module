...
function Initialize-PVEPOSTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Target"="target"; "MatchField"="match-field"; "Mode"="mode"; "Comment"="comment"; "MatchCalendar"="match-calendar"; "Name"="name"; "MatchSeverity"="match-severity"; "InvertMatch"="invert-match"; "Disable"="disable"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        $AllProperties = ("target", "match-field", "mode", "comment", "match-calendar", "name", "match-severity", "invert-match", "disable")
