...
function Initialize-PVEPOSTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        if ($InvertMatch -and $InvertMatch -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"MatchSeverity"="match-severity"; "Comment"="comment"; "Disable"="disable"; "MatchCalendar"="match-calendar"; "MatchField"="match-field"; "InvertMatch"="invert-match"; "Target"="target"; "Name"="name"; "Mode"="mode"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        $AllProperties = ("match-severity", "comment", "disable", "match-calendar", "match-field", "invert-match", "target", "name", "mode")
