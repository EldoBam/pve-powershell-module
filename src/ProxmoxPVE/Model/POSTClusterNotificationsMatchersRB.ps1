...
function Initialize-PVEPOSTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Mode"="mode"; "Target"="target"; "Name"="name"; "Disable"="disable"; "MatchSeverity"="match-severity"; "MatchField"="match-field"; "MatchCalendar"="match-calendar"; "Comment"="comment"; "InvertMatch"="invert-match"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        $AllProperties = ("mode", "target", "name", "disable", "match-severity", "match-field", "match-calendar", "comment", "invert-match")
