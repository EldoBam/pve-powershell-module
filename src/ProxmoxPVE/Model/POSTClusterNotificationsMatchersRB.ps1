...
function Initialize-PVEPOSTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Name"="name"; "MatchField"="match-field"; "Target"="target"; "Comment"="comment"; "InvertMatch"="invert-match"; "Disable"="disable"; "MatchCalendar"="match-calendar"; "Mode"="mode"; "MatchSeverity"="match-severity"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        $AllProperties = ("name", "match-field", "target", "comment", "invert-match", "disable", "match-calendar", "mode", "match-severity")
