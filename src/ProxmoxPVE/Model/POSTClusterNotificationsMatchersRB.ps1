...
function Initialize-PVEPOSTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Mode"="mode"; "MatchCalendar"="match-calendar"; "InvertMatch"="invert-match"; "Disable"="disable"; "MatchSeverity"="match-severity"; "Name"="name"; "Target"="target"; "Comment"="comment"; "MatchField"="match-field"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterNotificationsMatchersRB {
    ...
    Process {
        ...
        $AllProperties = ("mode", "match-calendar", "invert-match", "disable", "match-severity", "name", "target", "comment", "match-field")
