...
function Initialize-PVENodesCephCfgDbInner {
    ...
    Process {
        ...
        if ($CanUpdateAtRuntime -and $CanUpdateAtRuntime -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Value"="value"; "Name"="name"; "Section"="section"; "Level"="level"; "Mask"="mask"; "CanUpdateAtRuntime"="can_update_at_runtime"
        }
...
function ConvertFrom-PVEJsonToNodesCephCfgDbInner {
    ...
    Process {
        ...
        $AllProperties = ("value", "name", "section", "level", "mask", "can_update_at_runtime")
