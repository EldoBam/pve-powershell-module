...
function Initialize-PVENodesCephCfgDbInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Level"="level"; "Value"="value"; "Section"="section"; "Name"="name"; "CanUpdateAtRuntime"="can_update_at_runtime"; "Mask"="mask"
        }
...
function ConvertFrom-PVEJsonToNodesCephCfgDbInner {
    ...
    Process {
        ...
        $AllProperties = ("level", "value", "section", "name", "can_update_at_runtime", "mask")
