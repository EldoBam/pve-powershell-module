...
ClusterReplication<PSCustomObject>
#>

function Initialize-PVEClusterReplication {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: ProxmoxPVE => PVEClusterReplication' | Write-Debug
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Schedule"="schedule"; "Jobnum"="jobnum"; "Id"="id"; "Comment"="comment"; "Type"="type"; "Source"="source"; "Rate"="rate"; "Target"="target"; "Digest"="digest"; "Guest"="guest"; "RemoveJob"="remove_job"; "Disable"="disable"
        }
...
Convert from JSON to ClusterReplication<PSCustomObject>
...
ClusterReplication<PSCustomObject>
#>
function ConvertFrom-PVEJsonToClusterReplication {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: ProxmoxPVE => PVEClusterReplication' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PVEClusterReplication
        $AllProperties = ("schedule", "jobnum", "id", "comment", "type", "source", "rate", "target", "digest", "guest", "remove_job", "disable")
