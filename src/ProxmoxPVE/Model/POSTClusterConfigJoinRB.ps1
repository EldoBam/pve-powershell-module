...
function Initialize-PVEPOSTClusterConfigJoinRB {
    ...
    Process {
        ...
        if ($Nodeid -and $Nodeid -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Password"="password"; "Fingerprint"="fingerprint"; "Force"="force"; "Votes"="votes"; "Hostname"="hostname"; "LinkN"="link[n]"; "Nodeid"="nodeid"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterConfigJoinRB {
    ...
    Process {
        ...
        $AllProperties = ("password", "fingerprint", "force", "votes", "hostname", "link[n]", "nodeid")
