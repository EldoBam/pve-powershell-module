...
function Initialize-PVEPOSTClusterConfigJoinRB {
    ...
    Process {
        ...
        if ($Nodeid -and $Nodeid -lt 1) {
		 ...
		 $DisplayNameMapping =@{
			"Fingerprint"="fingerprint"; "Password"="password"; "Force"="force"; "Nodeid"="nodeid"; "Votes"="votes"; "Hostname"="hostname"; "LinkN"="link[n]"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterConfigJoinRB {
    ...
    Process {
        ...
        $AllProperties = ("fingerprint", "password", "force", "nodeid", "votes", "hostname", "link[n]")
