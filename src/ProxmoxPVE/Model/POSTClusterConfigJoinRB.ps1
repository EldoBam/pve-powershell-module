...
function Initialize-PVEPOSTClusterConfigJoinRB {
    ...
    Process {
        ...
        if ($Force -and $Force -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Votes"="votes"; "Fingerprint"="fingerprint"; "Password"="password"; "LinkN"="link[n]"; "Nodeid"="nodeid"; "Force"="force"; "Hostname"="hostname"
        }
...
function ConvertFrom-PVEJsonToPOSTClusterConfigJoinRB {
    ...
    Process {
        ...
        $AllProperties = ("votes", "fingerprint", "password", "link[n]", "nodeid", "force", "hostname")
