...
function Initialize-PVEPUTClusterFirewallGroupsRB {
    ...
    Process {
        ...
        if (!$Source -and $Source.length -gt 512) {
		 ...
		 $DisplayNameMapping =@{
			"Macro"="macro"; "Action"="action"; "Proto"="proto"; "Log"="log"; "Pos"="pos"; "Moveto"="moveto"; "Dest"="dest"; "Type"="type"; "Comment"="comment"; "Dport"="dport"; "Digest"="digest"; "Enable"="enable"; "Delete"="delete"; "Iface"="iface"; "IcmpType"="icmp-type"; "Group"="group"; "Source"="source"; "Sport"="sport"
        }
...
function ConvertFrom-PVEJsonToPUTClusterFirewallGroupsRB {
    ...
    Process {
        ...
        $AllProperties = ("macro", "action", "proto", "log", "pos", "moveto", "dest", "type", "comment", "dport", "digest", "enable", "delete", "iface", "icmp-type", "group", "source", "sport")
