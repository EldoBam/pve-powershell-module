...
function Initialize-PVEPUTClusterFirewallGroupsRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Pos"="pos"; "Moveto"="moveto"; "Type"="type"; "Dest"="dest"; "Source"="source"; "Comment"="comment"; "Enable"="enable"; "Macro"="macro"; "Action"="action"; "Dport"="dport"; "Log"="log"; "Sport"="sport"; "Iface"="iface"; "Delete"="delete"; "Proto"="proto"; "Group"="group"; "Digest"="digest"; "IcmpType"="icmp-type"
        }
...
function ConvertFrom-PVEJsonToPUTClusterFirewallGroupsRB {
    ...
    Process {
        ...
        $AllProperties = ("pos", "moveto", "type", "dest", "source", "comment", "enable", "macro", "action", "dport", "log", "sport", "iface", "delete", "proto", "group", "digest", "icmp-type")
