...
function Initialize-PVENodesTasksInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"VarPid"="pid"; "Pstart"="pstart"; "Endtime"="endtime"; "Node"="node"; "Upid"="upid"; "Type"="type"; "Id"="id"; "Status"="status"; "Starttime"="starttime"; "User"="user"
        }
...
function ConvertFrom-PVEJsonToNodesTasksInner {
    ...
    Process {
        ...
        $AllProperties = ("pid", "pstart", "endtime", "node", "upid", "type", "id", "status", "starttime", "user")
