...
function Initialize-PVENodesTasksInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Starttime"="starttime"; "User"="user"; "Node"="node"; "Status"="status"; "VarPid"="pid"; "Upid"="upid"; "Type"="type"; "Id"="id"; "Pstart"="pstart"; "Endtime"="endtime"
        }
...
function ConvertFrom-PVEJsonToNodesTasksInner {
    ...
    Process {
        ...
        $AllProperties = ("starttime", "user", "node", "status", "pid", "upid", "type", "id", "pstart", "endtime")
