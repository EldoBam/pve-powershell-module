...
function Initialize-PVENodesTasksInner {
    ...
    Process {
        ...
        $PSBoundParameters | Out-DebugParameter | Write-Debug
		 ...
		 $DisplayNameMapping =@{
			"Endtime"="endtime"; "Type"="type"; "Status"="status"; "Node"="node"; "Id"="id"; "Starttime"="starttime"; "User"="user"; "Upid"="upid"; "VarPid"="pid"; "Pstart"="pstart"
        }
...
function ConvertFrom-PVEJsonToNodesTasksInner {
    ...
    Process {
        ...
        $AllProperties = ("endtime", "type", "status", "node", "id", "starttime", "user", "upid", "pid", "pstart")
