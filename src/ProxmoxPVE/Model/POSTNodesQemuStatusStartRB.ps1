...
function Initialize-PVEPOSTNodesQemuStatusStartRB {
    ...
    Process {
        ...
        if (!$Stateuri -and $Stateuri.length -gt 128) {
		 ...
		 $DisplayNameMapping =@{
			"Skiplock"="skiplock"; "Stateuri"="stateuri"; "Machine"="machine"; "Migratedfrom"="migratedfrom"; "Targetstorage"="targetstorage"; "ForceCpu"="force-cpu"; "MigrationNetwork"="migration_network"; "MigrationType"="migration_type"; "Timeout"="timeout"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuStatusStartRB {
    ...
    Process {
        ...
        $AllProperties = ("skiplock", "stateuri", "machine", "migratedfrom", "targetstorage", "force-cpu", "migration_network", "migration_type", "timeout")
