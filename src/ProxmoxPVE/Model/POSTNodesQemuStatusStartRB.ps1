...
function Initialize-PVEPOSTNodesQemuStatusStartRB {
    ...
    Process {
        ...
        if (!$Stateuri -and $Stateuri.length -gt 128) {
		 ...
		 $DisplayNameMapping =@{
			"Migratedfrom"="migratedfrom"; "MigrationNetwork"="migration_network"; "Skiplock"="skiplock"; "Timeout"="timeout"; "ForceCpu"="force-cpu"; "WithConntrackState"="with-conntrack-state"; "Stateuri"="stateuri"; "MigrationType"="migration_type"; "Targetstorage"="targetstorage"; "Machine"="machine"; "NetsHostMtu"="nets-host-mtu"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuStatusStartRB {
    ...
    Process {
        ...
        $AllProperties = ("migratedfrom", "migration_network", "skiplock", "timeout", "force-cpu", "with-conntrack-state", "stateuri", "migration_type", "targetstorage", "machine", "nets-host-mtu")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "nets-host-mtu"))) { #optional property not found
            $NetsHostMtu = $null
        } else {
            $NetsHostMtu = $JsonParameters.PSobject.Properties["nets-host-mtu"].value
        }
