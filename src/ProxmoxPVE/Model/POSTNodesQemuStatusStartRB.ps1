...
function Initialize-PVEPOSTNodesQemuStatusStartRB {
    ...
    Process {
        ...
        if (!$Stateuri -and $Stateuri.length -gt 128) {
		 ...
		 $DisplayNameMapping =@{
			"Machine"="machine"; "Stateuri"="stateuri"; "Skiplock"="skiplock"; "MigrationType"="migration_type"; "MigrationNetwork"="migration_network"; "ForceCpu"="force-cpu"; "Timeout"="timeout"; "Migratedfrom"="migratedfrom"; "Targetstorage"="targetstorage"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuStatusStartRB {
    ...
    Process {
        ...
        $AllProperties = ("machine", "stateuri", "skiplock", "migration_type", "migration_network", "force-cpu", "timeout", "migratedfrom", "targetstorage")
