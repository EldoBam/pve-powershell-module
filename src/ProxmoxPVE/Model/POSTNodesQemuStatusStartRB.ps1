...
function Initialize-PVEPOSTNodesQemuStatusStartRB {
    ...
    Process {
        ...
        if (!$Stateuri -and $Stateuri.length -gt 128) {
		 ...
		 $DisplayNameMapping =@{
			"NetsHostMtu"="nets-host-mtu"; "Migratedfrom"="migratedfrom"; "WithConntrackState"="with-conntrack-state"; "Machine"="machine"; "Targetstorage"="targetstorage"; "MigrationNetwork"="migration_network"; "Timeout"="timeout"; "Skiplock"="skiplock"; "Stateuri"="stateuri"; "MigrationType"="migration_type"; "ForceCpu"="force-cpu"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuStatusStartRB {
    ...
    Process {
        ...
        $AllProperties = ("nets-host-mtu", "migratedfrom", "with-conntrack-state", "machine", "targetstorage", "migration_network", "timeout", "skiplock", "stateuri", "migration_type", "force-cpu")
