...
function Initialize-PVENodesQemuInner {
    ...
    Process {
        ...
        if ($Vmid -and $Vmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Cpu"="cpu"; "Pressurememorysome"="pressurememorysome"; "Template"="template"; "VarPid"="pid"; "Maxdisk"="maxdisk"; "Pressurememoryfull"="pressurememoryfull"; "Maxmem"="maxmem"; "RunningMachine"="running-machine"; "Pressurecpufull"="pressurecpufull"; "Pressurecpusome"="pressurecpusome"; "Vmid"="vmid"; "Qmpstatus"="qmpstatus"; "Status"="status"; "Diskread"="diskread"; "Cpus"="cpus"; "Mem"="mem"; "Lock"="lock"; "Uptime"="uptime"; "Pressureiofull"="pressureiofull"; "Name"="name"; "RunningQemu"="running-qemu"; "Memhost"="memhost"; "Tags"="tags"; "Netout"="netout"; "Pressureiosome"="pressureiosome"; "Netin"="netin"; "Serial"="serial"; "Diskwrite"="diskwrite"
        }
...
function ConvertFrom-PVEJsonToNodesQemuInner {
    ...
    Process {
        ...
        $AllProperties = ("cpu", "pressurememorysome", "template", "pid", "maxdisk", "pressurememoryfull", "maxmem", "running-machine", "pressurecpufull", "pressurecpusome", "vmid", "qmpstatus", "status", "diskread", "cpus", "mem", "lock", "uptime", "pressureiofull", "name", "running-qemu", "memhost", "tags", "netout", "pressureiosome", "netin", "serial", "diskwrite")
