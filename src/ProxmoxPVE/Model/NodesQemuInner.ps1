...
function Initialize-PVENodesQemuInner {
    ...
    Process {
        ...
        if ($Vmid -and $Vmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Maxdisk"="maxdisk"; "Pressureiofull"="pressureiofull"; "Qmpstatus"="qmpstatus"; "Pressurememoryfull"="pressurememoryfull"; "Uptime"="uptime"; "Pressureiosome"="pressureiosome"; "Netout"="netout"; "Serial"="serial"; "Diskread"="diskread"; "Vmid"="vmid"; "Diskwrite"="diskwrite"; "Lock"="lock"; "Cpus"="cpus"; "Mem"="mem"; "Maxmem"="maxmem"; "RunningQemu"="running-qemu"; "Template"="template"; "Name"="name"; "Pressurememorysome"="pressurememorysome"; "Netin"="netin"; "Status"="status"; "VarPid"="pid"; "Pressurecpusome"="pressurecpusome"; "Pressurecpufull"="pressurecpufull"; "RunningMachine"="running-machine"; "Memhost"="memhost"; "Tags"="tags"; "Cpu"="cpu"
        }
...
function ConvertFrom-PVEJsonToNodesQemuInner {
    ...
    Process {
        ...
        $AllProperties = ("maxdisk", "pressureiofull", "qmpstatus", "pressurememoryfull", "uptime", "pressureiosome", "netout", "serial", "diskread", "vmid", "diskwrite", "lock", "cpus", "mem", "maxmem", "running-qemu", "template", "name", "pressurememorysome", "netin", "status", "pid", "pressurecpusome", "pressurecpufull", "running-machine", "memhost", "tags", "cpu")
