...
function Initialize-PVEDELETENodesDisksLvmthinRB {
    ...
    Process {
        ...
        if ($CleanupConfig -and $CleanupConfig -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"VolumeGroup"="volume-group"; "CleanupDisks"="cleanup-disks"; "Name"="name"; "CleanupConfig"="cleanup-config"; "Node"="node"
        }
...
function ConvertFrom-PVEJsonToDELETENodesDisksLvmthinRB {
    ...
    Process {
        ...
        $AllProperties = ("volume-group", "cleanup-disks", "name", "cleanup-config", "node")
