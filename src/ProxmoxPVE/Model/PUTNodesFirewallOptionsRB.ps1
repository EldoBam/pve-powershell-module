...
function Initialize-PVEPUTNodesFirewallOptionsRB {
    ...
    Process {
        ...
        if ($Ndp -and $Ndp -lt 0) {
		 ...
		 $DisplayNameMapping =@{
			"Digest"="digest"; "TcpFlagsLogLevel"="tcp_flags_log_level"; "Enable"="enable"; "Nosmurfs"="nosmurfs"; "LogNfConntrack"="log_nf_conntrack"; "NfConntrackMax"="nf_conntrack_max"; "NfConntrackAllowInvalid"="nf_conntrack_allow_invalid"; "LogLevelForward"="log_level_forward"; "NfConntrackTcpTimeoutEstablished"="nf_conntrack_tcp_timeout_established"; "LogLevelIn"="log_level_in"; "ProtectionSynflood"="protection_synflood"; "Node"="node"; "Nftables"="nftables"; "ProtectionSynfloodRate"="protection_synflood_rate"; "Tcpflags"="tcpflags"; "Delete"="delete"; "NfConntrackTcpTimeoutSynRecv"="nf_conntrack_tcp_timeout_syn_recv"; "SmurfLogLevel"="smurf_log_level"; "Ndp"="ndp"; "ProtectionSynfloodBurst"="protection_synflood_burst"; "NfConntrackHelpers"="nf_conntrack_helpers"; "LogLevelOut"="log_level_out"
        }
...
function ConvertFrom-PVEJsonToPUTNodesFirewallOptionsRB {
    ...
    Process {
        ...
        $AllProperties = ("digest", "tcp_flags_log_level", "enable", "nosmurfs", "log_nf_conntrack", "nf_conntrack_max", "nf_conntrack_allow_invalid", "log_level_forward", "nf_conntrack_tcp_timeout_established", "log_level_in", "protection_synflood", "node", "nftables", "protection_synflood_rate", "tcpflags", "delete", "nf_conntrack_tcp_timeout_syn_recv", "smurf_log_level", "ndp", "protection_synflood_burst", "nf_conntrack_helpers", "log_level_out")
