...
function Initialize-PVEPUTNodesFirewallOptionsRB {
    ...
    Process {
        ...
        if ($NfConntrackTcpTimeoutEstablished -and $NfConntrackTcpTimeoutEstablished -lt 7875) {
		 ...
		 $DisplayNameMapping =@{
			"ProtectionSynfloodRate"="protection_synflood_rate"; "Nftables"="nftables"; "LogLevelIn"="log_level_in"; "NfConntrackAllowInvalid"="nf_conntrack_allow_invalid"; "LogNfConntrack"="log_nf_conntrack"; "Ndp"="ndp"; "Enable"="enable"; "NfConntrackMax"="nf_conntrack_max"; "SmurfLogLevel"="smurf_log_level"; "NfConntrackTcpTimeoutSynRecv"="nf_conntrack_tcp_timeout_syn_recv"; "ProtectionSynflood"="protection_synflood"; "Tcpflags"="tcpflags"; "LogLevelOut"="log_level_out"; "ProtectionSynfloodBurst"="protection_synflood_burst"; "LogLevelForward"="log_level_forward"; "Delete"="delete"; "NfConntrackHelpers"="nf_conntrack_helpers"; "Digest"="digest"; "TcpFlagsLogLevel"="tcp_flags_log_level"; "Nosmurfs"="nosmurfs"; "NfConntrackTcpTimeoutEstablished"="nf_conntrack_tcp_timeout_established"
        }
...
function ConvertFrom-PVEJsonToPUTNodesFirewallOptionsRB {
    ...
    Process {
        ...
        $AllProperties = ("protection_synflood_rate", "nftables", "log_level_in", "nf_conntrack_allow_invalid", "log_nf_conntrack", "ndp", "enable", "nf_conntrack_max", "smurf_log_level", "nf_conntrack_tcp_timeout_syn_recv", "protection_synflood", "tcpflags", "log_level_out", "protection_synflood_burst", "log_level_forward", "delete", "nf_conntrack_helpers", "digest", "tcp_flags_log_level", "nosmurfs", "nf_conntrack_tcp_timeout_established")
