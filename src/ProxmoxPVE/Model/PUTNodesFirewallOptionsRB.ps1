...
function Initialize-PVEPUTNodesFirewallOptionsRB {
    ...
    Process {
        ...
        if ($NfConntrackTcpTimeoutSynRecv -and $NfConntrackTcpTimeoutSynRecv -lt 30) {
		 ...
		 $DisplayNameMapping =@{
			"ProtectionSynfloodBurst"="protection_synflood_burst"; "NfConntrackMax"="nf_conntrack_max"; "Ndp"="ndp"; "NfConntrackHelpers"="nf_conntrack_helpers"; "NfConntrackAllowInvalid"="nf_conntrack_allow_invalid"; "SmurfLogLevel"="smurf_log_level"; "TcpFlagsLogLevel"="tcp_flags_log_level"; "Digest"="digest"; "Tcpflags"="tcpflags"; "NfConntrackTcpTimeoutEstablished"="nf_conntrack_tcp_timeout_established"; "NfConntrackTcpTimeoutSynRecv"="nf_conntrack_tcp_timeout_syn_recv"; "ProtectionSynfloodRate"="protection_synflood_rate"; "Enable"="enable"; "Nosmurfs"="nosmurfs"; "Nftables"="nftables"; "LogLevelOut"="log_level_out"; "LogNfConntrack"="log_nf_conntrack"; "Delete"="delete"; "LogLevelForward"="log_level_forward"; "LogLevelIn"="log_level_in"; "ProtectionSynflood"="protection_synflood"
        }
...
function ConvertFrom-PVEJsonToPUTNodesFirewallOptionsRB {
    ...
    Process {
        ...
        $AllProperties = ("protection_synflood_burst", "nf_conntrack_max", "ndp", "nf_conntrack_helpers", "nf_conntrack_allow_invalid", "smurf_log_level", "tcp_flags_log_level", "digest", "tcpflags", "nf_conntrack_tcp_timeout_established", "nf_conntrack_tcp_timeout_syn_recv", "protection_synflood_rate", "enable", "nosmurfs", "nftables", "log_level_out", "log_nf_conntrack", "delete", "log_level_forward", "log_level_in", "protection_synflood")
