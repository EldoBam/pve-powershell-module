...
function Initialize-PVEPUTClusterSdnVnetsSubnetsRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Gateway"="gateway"; "Delete"="delete"; "DhcpDnsServer"="dhcp-dns-server"; "Snat"="snat"; "Digest"="digest"; "DhcpRange"="dhcp-range"; "Dnszoneprefix"="dnszoneprefix"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnVnetsSubnetsRB {
    ...
    Process {
        ...
        $AllProperties = ("gateway", "delete", "dhcp-dns-server", "snat", "digest", "dhcp-range", "dnszoneprefix")
