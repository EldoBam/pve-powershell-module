...
function Initialize-PVEPUTClusterSdnVnetsSubnetsRB {
    ...
    Process {
        ...
        if (!$Delete -and $Delete.length -gt 4096) {
		 ...
		 $DisplayNameMapping =@{
			"Digest"="digest"; "Delete"="delete"; "Dnszoneprefix"="dnszoneprefix"; "Gateway"="gateway"; "DhcpRange"="dhcp-range"; "DhcpDnsServer"="dhcp-dns-server"; "Snat"="snat"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnVnetsSubnetsRB {
    ...
    Process {
        ...
        $AllProperties = ("digest", "delete", "dnszoneprefix", "gateway", "dhcp-range", "dhcp-dns-server", "snat")
