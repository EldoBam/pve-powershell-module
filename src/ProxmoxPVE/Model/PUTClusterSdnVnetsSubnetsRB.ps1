...
function Initialize-PVEPUTClusterSdnVnetsSubnetsRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 64) {
		 ...
		 $DisplayNameMapping =@{
			"Dnszoneprefix"="dnszoneprefix"; "LockToken"="lock-token"; "Delete"="delete"; "DhcpRange"="dhcp-range"; "Snat"="snat"; "DhcpDnsServer"="dhcp-dns-server"; "Digest"="digest"; "Gateway"="gateway"
        }
...
function ConvertFrom-PVEJsonToPUTClusterSdnVnetsSubnetsRB {
    ...
    Process {
        ...
        $AllProperties = ("dnszoneprefix", "lock-token", "delete", "dhcp-range", "snat", "dhcp-dns-server", "digest", "gateway")
