...
function ConvertFrom-PVEJsonToPOSTNodesQemuConfigRB {
    ...
    Process {
        ...
        $AllProperties = ("keyboard", "efidisk0", "net[n]", "delete", "vcpus", "cores", "ciuser", "startup", "cdrom", "usb[n]", "cicustom", "ciupgrade", "cpulimit", "spice_enhancements", "name", "freeze", "tpmstate0", "ipconfig[n]", "args", "localtime", "rng0", "migrate_speed", "balloon", "import-working-storage", "skiplock", "hookscript", "tdf", "lock", "smp", "numa", "vmid", "vmstatestorage", "scsihw", "shares", "onboot", "cpu", "reboot", "cpuunits", "autostart", "description", "background_delay", "cipassword", "hotplug", "force", "citype", "kvm", "memory", "bios", "ivshmem", "vga", "agent", "audio0", "parallel[n]", "scsi[n]", "digest", "unused[n]", "ide[n]", "boot", "smbios1", "keephugepages", "node", "tablet", "startdate", "protection", "numa[n]", "template", "sata[n]", "nameserver", "revert", "machine", "arch", "ostype", "serial[n]", "affinity", "sockets", "bootdisk", "searchdomain", "tags", "acpi", "virtio[n]", "watchdog", "sshkeys", "amd-sev", "hugepages", "vmgenid", "hostpci[n]", "migrate_downtime")
