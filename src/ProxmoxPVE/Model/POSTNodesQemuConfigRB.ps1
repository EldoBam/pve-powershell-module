...
function ConvertFrom-PVEJsonToPOSTNodesQemuConfigRB {
    ...
    Process {
        ...
        $AllProperties = ("unused[n]", "hostpci[n]", "autostart", "vga", "protection", "vmstatestorage", "balloon", "ostype", "kvm", "sockets", "affinity", "virtiofs[n]", "ipconfig[n]", "description", "tdf", "keyboard", "cpulimit", "memory", "agent", "sata[n]", "vcpus", "watchdog", "migrate_speed", "numa[n]", "revert", "template", "args", "migrate_downtime", "rng0", "onboot", "force", "audio0", "hookscript", "tags", "boot", "name", "bootdisk", "numa", "localtime", "efidisk0", "hotplug", "tablet", "scsi[n]", "machine", "ciupgrade", "startup", "acpi", "freeze", "serial[n]", "cores", "import-working-storage", "parallel[n]", "cpu", "keephugepages", "ciuser", "bios", "cpuunits", "ivshmem", "cicustom", "smbios1", "amd-sev", "net[n]", "vmgenid", "sshkeys", "searchdomain", "nameserver", "digest", "spice_enhancements", "shares", "delete", "arch", "smp", "citype", "scsihw", "skiplock", "virtio[n]", "ide[n]", "startdate", "reboot", "background_delay", "tpmstate0", "usb[n]", "hugepages", "cipassword", "lock", "cdrom")
