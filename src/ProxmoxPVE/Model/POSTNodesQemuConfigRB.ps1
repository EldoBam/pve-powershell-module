...
POSTNodesQemuConfigRB<PSCustomObject>
#>

function Initialize-PVEPOSTNodesQemuConfigRB {
    [CmdletBinding()]
    Param (
...
Convert from JSON to POSTNodesQemuConfigRB<PSCustomObject>
...
POSTNodesQemuConfigRB<PSCustomObject>
#>
function ConvertFrom-PVEJsonToPOSTNodesQemuConfigRB {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
