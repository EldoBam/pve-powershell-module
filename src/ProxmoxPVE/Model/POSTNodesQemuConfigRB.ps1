...
function ConvertFrom-PVEJsonToPOSTNodesQemuConfigRB {
    ...
    Process {
        ...
        $AllProperties = ("watchdog", "bootdisk", "cdrom", "migrate_downtime", "vga", "numa", "template", "skiplock", "digest", "tablet", "ipconfig[n]", "scsihw", "agent", "scsi[n]", "cicustom", "bios", "cpuunits", "protection", "sata[n]", "startdate", "name", "acpi", "citype", "cpu", "localtime", "args", "nameserver", "machine", "ivshmem", "hostpci[n]", "delete", "kvm", "lock", "amd-sev", "startup", "cpulimit", "ciupgrade", "migrate_speed", "smbios1", "shares", "vcpus", "description", "boot", "freeze", "arch", "numa[n]", "cipassword", "tags", "keyboard", "searchdomain", "cores", "efidisk0", "keephugepages", "ciuser", "sshkeys", "affinity", "virtio[n]", "sockets", "vmgenid", "parallel[n]", "force", "smp", "background_delay", "net[n]", "onboot", "usb[n]", "balloon", "import-working-storage", "running-nets-host-mtu", "hotplug", "vmstatestorage", "hugepages", "reboot", "memory", "serial[n]", "autostart", "hookscript", "virtiofs[n]", "rng0", "tdf", "unused[n]", "ostype", "spice_enhancements", "audio0", "ide[n]", "tpmstate0", "revert")
