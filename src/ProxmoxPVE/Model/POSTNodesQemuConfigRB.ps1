...
function ConvertFrom-PVEJsonToPOSTNodesQemuConfigRB {
    ...
    Process {
        ...
        $AllProperties = ("localtime", "hugepages", "cipassword", "vmstatestorage", "tablet", "watchdog", "usb[n]", "bios", "reboot", "digest", "spice_enhancements", "tags", "numa[n]", "ide[n]", "audio0", "tpmstate0", "searchdomain", "machine", "cicustom", "cpuunits", "efidisk0", "scsi[n]", "vcpus", "migrate_downtime", "revert", "cpu", "onboot", "ipconfig[n]", "cdrom", "tdf", "autostart", "unused[n]", "import-working-storage", "agent", "rng0", "freeze", "cpulimit", "name", "template", "protection", "sshkeys", "affinity", "net[n]", "sata[n]", "sockets", "nameserver", "args", "vmgenid", "kvm", "citype", "keephugepages", "numa", "force", "cores", "hostpci[n]", "acpi", "ostype", "hotplug", "background_delay", "virtio[n]", "delete", "vga", "boot", "bootdisk", "smp", "hookscript", "lock", "amd-sev", "startup", "description", "balloon", "ciupgrade", "migrate_speed", "shares", "ivshmem", "serial[n]", "keyboard", "virtiofs[n]", "arch", "skiplock", "ciuser", "smbios1", "scsihw", "parallel[n]", "memory", "startdate")
