...
function ConvertFrom-PVEJsonToPOSTNodesQemuConfigRB {
    ...
    Process {
        ...
        $AllProperties = ("ivshmem", "ide[n]", "net[n]", "vcpus", "ostype", "unused[n]", "rng0", "amd-sev", "autostart", "acpi", "revert", "boot", "scsi[n]", "agent", "ipconfig[n]", "args", "migrate_speed", "name", "startup", "vmstatestorage", "keyboard", "memory", "tpmstate0", "description", "spice_enhancements", "freeze", "reboot", "smbios1", "cipassword", "bootdisk", "citype", "smp", "hookscript", "hotplug", "balloon", "tags", "parallel[n]", "sshkeys", "efidisk0", "arch", "delete", "background_delay", "virtio[n]", "vga", "tdf", "import-working-storage", "watchdog", "migrate_downtime", "vmgenid", "hugepages", "serial[n]", "cpuunits", "shares", "cpulimit", "cpu", "affinity", "onboot", "cicustom", "sockets", "node", "ciuser", "skiplock", "protection", "digest", "lock", "numa", "cores", "hostpci[n]", "cdrom", "sata[n]", "vmid", "tablet", "bios", "localtime", "template", "nameserver", "kvm", "force", "usb[n]", "startdate", "scsihw", "ciupgrade", "keephugepages", "audio0", "numa[n]", "searchdomain", "machine")
