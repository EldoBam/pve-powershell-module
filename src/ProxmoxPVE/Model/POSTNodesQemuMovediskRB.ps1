...
function Initialize-PVEPOSTNodesQemuMovediskRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 40) {
		 ...
		 $DisplayNameMapping =@{
			"TargetVmid"="target-vmid"; "TargetDisk"="target-disk"; "Delete"="delete"; "TargetDigest"="target-digest"; "Bwlimit"="bwlimit"; "Digest"="digest"; "Disk"="disk"; "Format"="format"; "Storage"="storage"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuMovediskRB {
    ...
    Process {
        ...
        $AllProperties = ("target-vmid", "target-disk", "delete", "target-digest", "bwlimit", "digest", "disk", "format", "storage")
