...
function Initialize-PVEPOSTNodesQemuMovediskRB {
    ...
    Process {
        ...
        if (!$Digest -and $Digest.length -gt 40) {
		 ...
		 $DisplayNameMapping =@{
			"TargetDisk"="target-disk"; "Bwlimit"="bwlimit"; "TargetDigest"="target-digest"; "Storage"="storage"; "Delete"="delete"; "Disk"="disk"; "Format"="format"; "TargetVmid"="target-vmid"; "Digest"="digest"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuMovediskRB {
    ...
    Process {
        ...
        $AllProperties = ("target-disk", "bwlimit", "target-digest", "storage", "delete", "disk", "format", "target-vmid", "digest")
