...
function Initialize-PVEPOSTNodesQemuMovediskRB {
    ...
    Process {
        ...
        if ($TargetVmid -and $TargetVmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Delete"="delete"; "TargetDigest"="target-digest"; "TargetDisk"="target-disk"; "Bwlimit"="bwlimit"; "Disk"="disk"; "Storage"="storage"; "Format"="format"; "Digest"="digest"; "TargetVmid"="target-vmid"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuMovediskRB {
    ...
    Process {
        ...
        $AllProperties = ("delete", "target-digest", "target-disk", "bwlimit", "disk", "storage", "format", "digest", "target-vmid")
