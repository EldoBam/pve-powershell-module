...
function Initialize-PVEPOSTNodesQemuMovediskRB {
    ...
    Process {
        ...
        if (!$TargetDigest -and $TargetDigest.length -gt 40) {
		 ...
		 $DisplayNameMapping =@{
			"Delete"="delete"; "TargetVmid"="target-vmid"; "Disk"="disk"; "TargetDisk"="target-disk"; "Digest"="digest"; "TargetDigest"="target-digest"; "Bwlimit"="bwlimit"; "Storage"="storage"; "Format"="format"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuMovediskRB {
    ...
    Process {
        ...
        $AllProperties = ("delete", "target-vmid", "disk", "target-disk", "digest", "target-digest", "bwlimit", "storage", "format")
