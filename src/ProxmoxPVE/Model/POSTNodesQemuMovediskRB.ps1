...
function Initialize-PVEPOSTNodesQemuMovediskRB {
    ...
    Process {
        ...
        if ($TargetVmid -and $TargetVmid -lt 100) {
		 ...
		 $DisplayNameMapping =@{
			"Digest"="digest"; "Disk"="disk"; "Delete"="delete"; "Format"="format"; "TargetDigest"="target-digest"; "TargetVmid"="target-vmid"; "Bwlimit"="bwlimit"; "TargetDisk"="target-disk"; "Storage"="storage"
        }
...
function ConvertFrom-PVEJsonToPOSTNodesQemuMovediskRB {
    ...
    Process {
        ...
        $AllProperties = ("digest", "disk", "delete", "format", "target-digest", "target-vmid", "bwlimit", "target-disk", "storage")
