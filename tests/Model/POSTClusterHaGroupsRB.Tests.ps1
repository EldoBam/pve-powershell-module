...
Describe -tag 'ProxmoxPVE' -name 'PVEPOSTClusterHaGroupsRB' {
    Context 'PVEPOSTClusterHaGroupsRB' {
        It 'Initialize-PVEPOSTClusterHaGroupsRB' {
            ...
            #$NewObject = Initialize-PVEPOSTClusterHaGroupsRB -Group "TEST_VALUE" -Comment "TEST_VALUE" -Nofailback "TEST_VALUE" -Type "TEST_VALUE" -Nodes "TEST_VALUE" -Restricted "TEST_VALUE"
