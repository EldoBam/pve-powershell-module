...
Describe -tag 'ProxmoxPVE' -name 'PVENodesCephMdsInner' {
    Context 'PVENodesCephMdsInner' {
        It 'Initialize-PVENodesCephMdsInner' {
            ...
            #$NewObject = Initialize-PVENodesCephMdsInner -Rank "TEST_VALUE" -VarHost "TEST_VALUE" -StandbyReplay "TEST_VALUE" -Name "TEST_VALUE" -Addr "TEST_VALUE" -State "TEST_VALUE"
