...
Describe -tag 'ProxmoxPVE' -name 'PVEPOSTClusterJobsRealmsyncRB' {
    Context 'PVEPOSTClusterJobsRealmsyncRB' {
        It 'Initialize-PVEPOSTClusterJobsRealmsyncRB' {
            ...
            #$NewObject = Initialize-PVEPOSTClusterJobsRealmsyncRB -EnableNew "TEST_VALUE" -Scope "TEST_VALUE" -Realm "TEST_VALUE" -Enabled "TEST_VALUE" -Comment "TEST_VALUE" -RemoveVanished "TEST_VALUE" -Schedule "TEST_VALUE"
