...
Describe -tag 'ProxmoxPVE' -name 'PVEPUTClusterMappingPciRB' {
    Context 'PVEPUTClusterMappingPciRB' {
        It 'Initialize-PVEPUTClusterMappingPciRB' {
            ...
            #$NewObject = Initialize-PVEPUTClusterMappingPciRB -Delete "TEST_VALUE" -Mdev "TEST_VALUE" -LiveMigrationCapable "TEST_VALUE" -Digest "TEST_VALUE" -Map "TEST_VALUE" -Description "TEST_VALUE"
