...
Describe -tag 'ProxmoxPVE' -name 'PVEPUTAccessAclRB' {
    Context 'PVEPUTAccessAclRB' {
        It 'Initialize-PVEPUTAccessAclRB' {
            ...
            #$NewObject = Initialize-PVEPUTAccessAclRB -Tokens "TEST_VALUE" -Groups "TEST_VALUE" -Delete "TEST_VALUE" -Path "TEST_VALUE" -Users "TEST_VALUE" -Propagate "TEST_VALUE" -Roles "TEST_VALUE"
