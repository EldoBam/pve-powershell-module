...
Describe -tag 'ProxmoxPVE' -name 'PVEPOSTClusterConfigJoinRB' {
    Context 'PVEPOSTClusterConfigJoinRB' {
        It 'Initialize-PVEPOSTClusterConfigJoinRB' {
            ...
            #$NewObject = Initialize-PVEPOSTClusterConfigJoinRB -Fingerprint "TEST_VALUE" -Password "TEST_VALUE" -Force "TEST_VALUE" -Nodeid "TEST_VALUE" -Votes "TEST_VALUE" -Hostname "TEST_VALUE" -LinkN "TEST_VALUE"
