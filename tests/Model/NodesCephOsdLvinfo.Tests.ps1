...
Describe -tag 'ProxmoxPVE' -name 'PVENodesCephOsdLvinfo' {
    Context 'PVENodesCephOsdLvinfo' {
        It 'Initialize-PVENodesCephOsdLvinfo' {
            ...
            #$NewObject = Initialize-PVENodesCephOsdLvinfo -LvName "TEST_VALUE" -CreationTime "TEST_VALUE" -VgName "TEST_VALUE" -LvSize "TEST_VALUE" -LvUuid "TEST_VALUE" -LvPath "TEST_VALUE"
