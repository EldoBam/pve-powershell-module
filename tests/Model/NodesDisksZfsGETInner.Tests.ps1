...
Describe -tag 'ProxmoxPVE' -name 'PVENodesDisksZfsGETInner' {
    Context 'PVENodesDisksZfsGETInner' {
        It 'Initialize-PVENodesDisksZfsGETInner' {
            ...
            #$NewObject = Initialize-PVENodesDisksZfsGETInner -Free "TEST_VALUE" -Name "TEST_VALUE" -Alloc "TEST_VALUE" -Health "TEST_VALUE" -Size "TEST_VALUE" -Dedup "TEST_VALUE" -Frag "TEST_VALUE"
