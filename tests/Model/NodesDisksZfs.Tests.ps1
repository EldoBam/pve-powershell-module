...
Describe -tag 'ProxmoxPVE' -name 'PVENodesDisksZfs' {
    Context 'PVENodesDisksZfs' {
        It 'Initialize-PVENodesDisksZfs' {
            ...
            #$NewObject = Initialize-PVENodesDisksZfs -Status "TEST_VALUE" -Errors "TEST_VALUE" -Children "TEST_VALUE" -Scan "TEST_VALUE" -Action "TEST_VALUE" -Name "TEST_VALUE" -State "TEST_VALUE"
