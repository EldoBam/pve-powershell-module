...
Describe -tag 'ProxmoxPVE' -name 'PVEPUTClusterSdnVnetsFirewallOptionsRB' {
    Context 'PVEPUTClusterSdnVnetsFirewallOptionsRB' {
        It 'Initialize-PVEPUTClusterSdnVnetsFirewallOptionsRB' {
            ...
            #$NewObject = Initialize-PVEPUTClusterSdnVnetsFirewallOptionsRB -Delete "TEST_VALUE" -Enable "TEST_VALUE" -LogLevelForward "TEST_VALUE" -PolicyForward "TEST_VALUE" -Digest "TEST_VALUE"
